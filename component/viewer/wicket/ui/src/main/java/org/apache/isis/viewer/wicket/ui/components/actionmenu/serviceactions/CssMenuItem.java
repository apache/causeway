...
class CssMenuItem implements Serializable {
    ...
    public static class Builder {
        ...
        public Builder withCssClassFaPosition(ActionLayout.ClassFaPosition position) {
    ...
    private ActionLayout.ClassFaPosition cssClassFaPosition;
    ...
    public void setCssClassFaPosition(ActionLayout.ClassFaPosition position) {
        this.cssClassFaPosition = position;
    }

    public ActionLayout.ClassFaPosition getCssClassFaPosition() {
