...
/**
 * {@link org.apache.isis.viewer.wicket.ui.panels.PanelAbstract Panel} representing the properties of an entity, as per
 * the provided {@link org.apache.isis.viewer.wicket.model.models.EntityModel}.
 */
public class WizardPropertiesPanel extends PanelAbstract<EntityModel> {

    private static final long serialVersionUID = 1L;

    private static final String ID_ENTITY_PROPERTIES = "entityProperties";

    private WizardPropertiesForm form;
    ...
    private void buildEntityPropertiesAndOrCollectionsGui() {
        ...
        if (adapter != null) {
            form = new WizardPropertiesForm(ID_ENTITY_PROPERTIES, model, this);
            addOrReplace(form);
        } else {
