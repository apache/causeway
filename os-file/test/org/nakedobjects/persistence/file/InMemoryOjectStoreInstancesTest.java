...
public class InMemoryOjectStoreInstancesTest extends NakedObjectStoreInstancesTestCase {
    public static void main(String[] args) {
        junit.textui.TestRunner.run(InMemoryOjectStoreInstancesTest.class);
    }
    
    public InMemoryOjectStoreInstancesTest(String name) {
        super(name);
    }
