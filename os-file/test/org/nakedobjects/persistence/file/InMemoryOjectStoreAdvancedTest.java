...
public class InMemoryOjectStoreAdvancedTest extends NakedObjectStoreAdvancedTestCase {
    public static void main(String[] args) {
        junit.textui.TestRunner.run(InMemoryOjectStoreAdvancedTest.class);
    }
    
    public InMemoryOjectStoreAdvancedTest(String name) {
        super(name);
    }
