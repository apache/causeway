...
public class XmlOjectStoreAdvancedTest extends NakedObjectStoreAdvancedTestCase {
	public XmlOjectStoreAdvancedTest(String name) {
		super(name);
	}

	public static void main(String[] args) {
		junit.textui.TestRunner.run(XmlOjectStoreAdvancedTest.class);
	}
