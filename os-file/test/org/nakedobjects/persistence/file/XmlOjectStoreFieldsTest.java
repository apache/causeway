...
public class XmlOjectStoreFieldsTest extends NakedObjectStoreFieldsTestCase {
	public XmlOjectStoreFieldsTest(String name) {
		super(name);
	}

	public static void main(String[] args) {
		junit.textui.TestRunner.run(XmlOjectStoreFieldsTest.class);
	}
