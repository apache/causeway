...
public class HsqlTest extends SqlIntegrationTestCommon {
	...
	public Properties getProperties(){
		...
		//properties.put("isis.services","org.apache.isis.runtime.testsystem.SqlDataClassFactory");
		...
		//properties.put("isis.persistence.sql.automapper.default.mapper.simpleClasses1", "association-table-multicolumn");
