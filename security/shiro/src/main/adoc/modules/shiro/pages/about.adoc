...
Apache Causeway provides its own `CausewayPermission` which introduces the concept of a "veto".
...
The string representation of the `CausewayPermission` uses the following format:
