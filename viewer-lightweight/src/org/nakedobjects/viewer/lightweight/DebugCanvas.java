...
public class DebugCanvas extends Canvas {
	...
	public DebugCanvas(StringBuffer buffer) {
		this(buffer, 3);
	}
	...
	public void drawFullRectangle(Bounds bounds, Color color) {
		indent();
		buffer.append("Rectangle (full) " + bounds.x + "," + bounds.y + " " + (bounds.width - 1) + "x"  + (bounds.height - 1) + " " + color);
	}
	...
	public void drawRectangle(Bounds bounds, Color color) {
		indent();
		buffer.append("Rectangle " + bounds.x + "," + bounds.y + " " + (bounds.width - 1) + "x"  + (bounds.height - 1) + " " + color);
	}
