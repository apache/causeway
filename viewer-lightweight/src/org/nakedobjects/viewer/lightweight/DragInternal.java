...
public interface DragInternal {
     ...
     */
    public abstract void drag(InternalDrag drag);

    /**
     * Default implementation - does nothing
     */
    public abstract void dragCancel(InternalDrag drag);

    /**
     * Indicates the start of a drag within this view's bounds.  By default does nothing.
     */
    public abstract void dragFrom(InternalDrag drag);
     ...
     */
    public abstract void dragTo(InternalDrag drag);
}
