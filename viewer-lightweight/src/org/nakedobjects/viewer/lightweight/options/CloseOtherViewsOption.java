...
public class CloseOtherViewsOption extends AbstractObjectOption {
    ...
    public Permission disabled(Workspace frame, ObjectView component, Location location) {
        return new Allow("Close all other views (except this one)");
    }

    public void execute(Workspace workspace, ObjectView view, Location at) {
        workspace.removeOtherRootViews((RootView) view);
    }
