 ...
 */
public class AdapterLoadPreEventListener extends AdapterEventListenerAbstract
        implements PreLoadEventListener {

    private static final long serialVersionUID = 1L;
    private final static Logger LOG = Logger.getLogger(AdapterLoadPreEventListener.class);
