...
/**
 * Sets up a role with access to the menu actions contributed by the <i>Extension Outbox</i> extension.
 *
 * @since 2.0 {@index}
 */
public class IsisExtExecutionOutboxRoleAndPermissions extends AbstractRoleAndPermissionsFixtureScript {
