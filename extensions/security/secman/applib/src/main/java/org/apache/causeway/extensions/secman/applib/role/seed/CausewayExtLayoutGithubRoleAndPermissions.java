...
/**
 * Sets up a role with access to the menu actions contributed by the <i>LayoutGithub</i> extension.
 *
 * @since 2.0 {@index}
 */
public class CausewayExtLayoutGithubRoleAndPermissions extends AbstractRoleAndPermissionsFixtureScript {

    public static final String NAMESPACE = "causeway.ext.layoutGithub";

    public static final String ROLE_NAME = NAMESPACE.replace(".","-");

    public CausewayExtLayoutGithubRoleAndPermissions() {
