...
/**
 * Sets up a role with access to the menu actions contributed by the <i>Documentation</i> extension.
 *
 * @since 2.0 {@index}
 */
public class IsisExtDocgenRoleAndPermissions extends AbstractRoleAndPermissionsFixtureScript {

    public static final String NAMESPACE = "isis.ext.docgen";

    public static final String ROLE_NAME = NAMESPACE.replace(".","-");

    public IsisExtDocgenRoleAndPermissions() {
        super(ROLE_NAME, "Access to the documentation menu and pages");
    }
