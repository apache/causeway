...
/**
 * Sets up a role with access to the menu actions contributed by the <i>LayoutLoaders</i> extension.
 *
 * @since 2.0 {@index}
 */
public class IsisExtLayoutLoadersRoleAndPermissions extends AbstractRoleAndPermissionsFixtureScript {

    public static final String NAMESPACE = "isis.ext.layoutLoaders";

    public static final String ROLE_NAME = NAMESPACE.replace(".","-");

    public IsisExtLayoutLoadersRoleAndPermissions() {
        super(ROLE_NAME, "Access to dynamic layout loading");
    }
