...
public class IsisExtSecmanRegularUserRoleAndPermissions extends AbstractRoleAndPermissionsFixtureScript {
    ...
    @Inject private IsisSystemEnvironment env;
    ...
    protected void execute(final ExecutionContext executionContext) {
        ...
        val allowChanging = Can.of(
                ...
                env.getIocContainer().containsBean("org.apache.isis.extensions.docgen.help.IsisModuleExtDocgenHelp")
                    ? ApplicationFeatureId.newNamespace(IsisExtDocgenRoleAndPermissions.NAMESPACE)
                    : null,

                // optionally allow access to layout menu and pages, based on module presence
                env.getIocContainer().containsBean("org.apache.isis.extensions.layoutloaders.github.IsisModuleExtLayoutLoadersGithub")
                    ? ApplicationFeatureId.newNamespace(IsisExtLayoutLoadersRoleAndPermissions.NAMESPACE)
                    : null
        );
