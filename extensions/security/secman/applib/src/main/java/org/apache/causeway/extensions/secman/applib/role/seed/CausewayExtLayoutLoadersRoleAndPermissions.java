 ...
 * @since 2.0 {@index}
 */
public class CausewayExtLayoutLoadersRoleAndPermissions extends AbstractRoleAndPermissionsFixtureScript {

    public static final String NAMESPACE = "causeway.ext.layoutLoaders";

    public static final String ROLE_NAME = NAMESPACE.replace(".","-");

    public CausewayExtLayoutLoadersRoleAndPermissions() {
