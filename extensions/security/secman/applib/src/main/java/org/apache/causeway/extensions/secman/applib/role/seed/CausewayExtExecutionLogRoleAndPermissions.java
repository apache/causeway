...
/**
 * Sets up a role with access to the menu actions contributed by the <i>Extension Log</i> extension.
 *
 * @since 2.0 {@index}
 */
public class CausewayExtExecutionLogRoleAndPermissions extends AbstractRoleAndPermissionsFixtureScript {

    public static final String NAMESPACE = "causeway.ext.executionLog";

    public static final String ROLE_NAME = NAMESPACE.replace(".","-");

    public CausewayExtExecutionLogRoleAndPermissions() {
