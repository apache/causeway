...
<.> specify either `CausewayModuleExtSecmanPersistenceJdo` or `CausewayModuleExtSecmanPersistenceJpa`, as required
  ...
  public UserToRole__bob_allRoles() {
    super(
      ...
      Can.of(
        ...
        , CausewayExtCommandReplayPrimaryRoleAndPermissions.ROLE_NAME                 // <7>
        , CausewayExtCommandReplaySecondaryRoleAndPermissions.ROLE_NAME               // <7>
