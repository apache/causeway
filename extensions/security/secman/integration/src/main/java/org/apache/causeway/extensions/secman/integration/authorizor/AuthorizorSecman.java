...
public class AuthorizorSecman implements Authorizor {
    ...
    private final _Lazy<Identifier> logoutIdentifier = _Lazy.threadSafe(this::logoutIdentifier);
    ...
    static class PermissionCache implements DisposableBean {
        ...
        private final Map<String, Optional<ApplicationPermissionValueSet>> permissionsByUsername = new HashMap<>();
