...
import org.apache.isis.extensions.secman.integration.permissions.exampledomain.Customer;
...
import static org.apache.isis.applib.services.appfeat.ApplicationFeatureId.*;
import static org.apache.isis.core.config.IsisConfiguration.Extensions.Secman.PermissionsEvaluationPolicy.ALLOW_BEATS_VETO;
import static org.apache.isis.extensions.secman.applib.permission.dom.ApplicationPermissionMode.CHANGING;
import static org.apache.isis.extensions.secman.applib.permission.dom.ApplicationPermissionMode.VIEWING;
import static org.apache.isis.extensions.secman.applib.permission.dom.ApplicationPermissionRule.ALLOW;
import static org.apache.isis.extensions.secman.applib.permission.dom.ApplicationPermissionRule.VETO;
...
class PermissionsEvaluationServiceForSecmanV1_evaluate_Test {
    ...
    void granted_viewing_via_namespace_viewing() {
        ApplicationPermissionValueSet.Evaluation evaluate = evaluator.evaluate(
                ...
                VIEWING,
                List.of(
                    new ApplicationPermissionValue(newNamespace("org.apache.isis.extensions.secman.integration.permissions.exampledomain"), ALLOW, VIEWING)
                )
        );
    ...
    void granted_viewing_via_namespace_changing() {
        ApplicationPermissionValueSet.Evaluation evaluate = evaluator.evaluate(
                ...
                VIEWING,
                List.of(
                    new ApplicationPermissionValue(newNamespace("org.apache.isis.extensions.secman.integration.permissions.exampledomain"), ALLOW, CHANGING)
                )
        );
        assertThat(evaluate.isGranted()).isTrue();
    }
    ...
    void veto_viewing_via_namespace_viewing() {
        ApplicationPermissionValueSet.Evaluation evaluate = evaluator.evaluate(
                ...
                VIEWING,
                List.of(
                        new ApplicationPermissionValue(newNamespace("org.apache.isis.extensions.secman.integration.permissions.exampledomain"), VETO, VIEWING)
                )
        );
