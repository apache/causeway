...
* download ApacheDS 2.0.0-AM26 or later
...
// think this isn't a problem after all; I did a clean reinstall and this issue didn't re-occur.
// * rename the `ou=config` folder (the server won't start if it exists as well as the `config.ldif`)
