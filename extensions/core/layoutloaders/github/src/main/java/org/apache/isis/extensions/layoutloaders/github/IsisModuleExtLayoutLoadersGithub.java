 ...
 *  under the License.
 */
package org.apache.isis.extensions.layoutloaders.github;
...
import org.apache.isis.extensions.layoutloaders.github.spiimpl.LayoutResourceLoaderFromGithub;
...
public class IsisModuleExtLayoutLoadersGithub {

    // keep in sync with IsisExtLayoutLoadersRoleAndPermissions.NAMESPACE
    public static final String NAMESPACE = "isis.ext.layoutLoaders";
     ...
     * Append for example:
     *
     * <pre>/search/code?q=SimpleObject.layout.xml+in:path+repo:apache/isis-app-simpleapp</pre>
     *
     * <p>
     * Returns for example:
     *
    ...
    public RestTemplate restTemplateForGithubSearch(final IsisConfiguration isisConfiguration) {

        val apiKey = isisConfiguration.getExtensions().getLayoutLoaders().getGithub().getApiKey();
    ...
    public RestTemplate restTemplateForGithubContent(final IsisConfiguration isisConfiguration) {
