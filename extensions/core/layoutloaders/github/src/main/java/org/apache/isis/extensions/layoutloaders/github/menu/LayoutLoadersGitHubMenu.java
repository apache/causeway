 ...
 *  under the License.
 */
package org.apache.isis.extensions.layoutloaders.github.menu;
 ...
 * @since 2.x {@index}
 */
@Named(IsisModuleExtLayoutLoadersGithub.NAMESPACE + ".LayoutLoadersGitHubMenu")
...
public class LayoutLoadersGitHubMenu {
    ...
    boolean isConfigured() {
        val layoutLoadersGitHub = isisConfiguration.getExtensions().getLayoutLoaders().getGithub();
