...
class CommandExportManagerUnexcludeCommandsTest {
    ...
    private static Fixture fixtureWith(
        ...
        final var manager = new CommandExportManager(
                ...
                replayContext);
        final var action = new CommandExportManager_unexcludeCommands(manager);
    ...
    private static class Fixture {
        ...
        final CommandExportManager_unexcludeCommands action;
