...
import org.apache.isis.extensions.commandlog.applib.dom.BackgroundService;
...
import org.apache.isis.extensions.commandlog.applib.job.RunBackgroundCommandsJob;
...
public abstract class BackgroundService_IntegTestAbstract extends IsisIntegrationTestAbstract {
    ...
    static void setup_environment() {
        prototypingOrig = new IsisSystemEnvironment().isPrototyping();
        new IsisSystemEnvironment().setPrototyping(true);
    }

    @AfterAll
    static void reset_environment() {
        new IsisSystemEnvironment().setPrototyping(prototypingOrig);
    }
