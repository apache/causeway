...
implements Comparable<CommandLogEntry>, DomainChangeRecord, HasCommandDto {
    ...
    public @interface ExecuteIn {
        class DomainEvent extends PropertyDomainEvent<org.apache.isis.extensions.commandlog.applib.dom.ExecuteIn> {}
        int MAX_LENGTH = 10;
     ...
     */
    @ExecuteIn
    public abstract org.apache.isis.extensions.commandlog.applib.dom.ExecuteIn getExecuteIn();
    public abstract void setExecuteIn(org.apache.isis.extensions.commandlog.applib.dom.ExecuteIn replayState);
     ...
     *     {@link org.apache.isis.extensions.commandlog.applib.subscriber.CommandSubscriberForCommandLog}'s
