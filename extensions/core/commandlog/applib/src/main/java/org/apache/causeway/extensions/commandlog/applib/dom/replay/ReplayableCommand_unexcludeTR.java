...
@Action(
        ...
        domainEvent = ReplayableCommand_unexcludeTR.DomainEvent.class,
...
public class ReplayableCommand_unexcludeTR {

    public static class DomainEvent extends ReplayableCommand.ActionDomainEvent<ReplayableCommand_unexcludeTR> { }
