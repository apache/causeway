...
public record CommandReplayManager(
    ...
    public class importCommands {
        ...
        private Optional<Timestamp> oldestTimestamp(final List<CommandDto> commandDtos) {
    ...
    private Stream<ReplayableCommand> streamPendingOrFailed() {
