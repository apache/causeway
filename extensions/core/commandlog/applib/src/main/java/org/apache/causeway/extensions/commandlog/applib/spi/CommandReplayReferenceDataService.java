 ...
 * expected to be stable, well-known, and present in every replay environment. Implementations classify bookmark
 * identity only and must not require the bookmark to have appeared in a command sequence.</p>
 *
 * <p>Applications may register any number of implementations. A bookmark is reference data when any registered
...
public interface CommandReplayReferenceDataService {
     ...
     *
     * <p>Classifier failures are deliberately propagated so configuration errors remain visible.</p>
     */
