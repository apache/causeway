...
/**
 * Reusable repository behavior for persistence-specific replay-result mapping entities.
 *
 * @since 4.0 {@index}
 */
...
implements CommandReplayResultMappingRepository {
    ...
    public CommandReplayResultMapping createAndPersist(
        ...
        var mapping = factoryService.detachedEntity(entityClass);
    ...
    @Override
    public void remove(final CommandReplayResultMapping mapping) {
        repositoryService().removeAndFlush(mapping);
    }
