...
/**
 * Default {@link CommandReplayReferenceDataService} that recognizes domain types implementing {@link RefData}.
 *
 * <p>Classification uses metamodel type information only; it never loads or instantiates the bookmarked object.</p>
 *
 * @since 4.0 {@index}
 */
@Component
