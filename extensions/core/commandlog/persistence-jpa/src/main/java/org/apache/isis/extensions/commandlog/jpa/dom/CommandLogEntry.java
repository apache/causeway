...
@NamedQueries({
    ...
    @NamedQuery(
            ...
            query = "SELECT cl "
                  + "  FROM CommandLogEntry cl "
                  + " WHERE cl.executeIn = org.apache.isis.extensions.commandlog.applib.dom.ExecuteIn.BACKGROUND "
...
public class CommandLogEntry extends org.apache.isis.extensions.commandlog.applib.dom.CommandLogEntry {
    ...
    @ExecuteIn
    @Getter @Setter
    private org.apache.isis.extensions.commandlog.applib.dom.ExecuteIn executeIn;
