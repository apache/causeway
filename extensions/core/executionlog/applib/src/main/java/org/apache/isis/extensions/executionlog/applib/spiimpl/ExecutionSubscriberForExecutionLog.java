...
public class ExecutionSubscriberForExecutionLog implements ExecutionSubscriber {
    ...
    static final String LOGICAL_TYPE_NAME = IsisModuleExtExecutionLogApplib.NAMESPACE + ".ExecutionSubscriberForExecutionLog";
    ...
    public boolean isEnabled() {
        return isisConfiguration.getExtensions().getExecutionLog().getPersist().isEnabled();
    }
