 ...
 * @since 2.0 {@index}
 */
public abstract class ExecutionOutboxEntryRepositoryAbstract<E extends ExecutionOutboxEntry>
        implements ExecutionOutboxEntryRepository {
    ...
    protected ExecutionOutboxEntryRepositoryAbstract(final Class<E> executionOutboxEntryClass) {
     ...
     * for testing only.
     */
    protected ExecutionOutboxEntryRepositoryAbstract(final Class<E> executionOutboxEntryClass, final Provider<RepositoryService> repositoryServiceProvider, final FactoryService factoryService) {
        this.executionOutboxEntryClass = executionOutboxEntryClass;
