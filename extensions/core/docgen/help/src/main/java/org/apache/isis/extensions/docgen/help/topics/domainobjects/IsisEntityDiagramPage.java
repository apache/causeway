...
@Component
@Named(IsisModuleExtDocgenHelp.NAMESPACE + ".IsisEntityDiagramPage")
public class IsisEntityDiagramPage extends EntityDiagramPageAbstract {

    @Inject
    public IsisEntityDiagramPage(final MetaModelService metaModelService) {
        super(metaModelService);
    }

    @Override
    public String getTitle() {
        return "Isis Entity Diagram";
    }
