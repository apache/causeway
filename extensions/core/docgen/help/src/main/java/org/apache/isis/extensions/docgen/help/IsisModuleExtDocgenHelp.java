 ...
 *  under the License.
 */
package org.apache.isis.extensions.docgen.help;
...
import org.apache.isis.extensions.docgen.help.applib.HelpNode.HelpTopic;
import org.apache.isis.extensions.docgen.help.menu.DocumentationMenu;
import org.apache.isis.extensions.docgen.help.topics.domainobjects.IsisEntityDiagramPage;
import org.apache.isis.extensions.docgen.help.topics.domainobjects.DomainEntityDiagramPage;
import org.apache.isis.extensions.docgen.help.topics.domainobjects.DomainEntityDiagramPage2;
import org.apache.isis.extensions.docgen.help.topics.welcome.WelcomeHelpPage;
...
@Import({
    ...
    IsisEntityDiagramPage.class,
    DomainEntityDiagramPage.class,
    DomainEntityDiagramPage2.class

})
// keep class-name in sync with IsisExtSecmanRegularUserRoleAndPermissions
public class IsisModuleExtDocgenHelp {

    // keep in sync with IsisExtDocgenRoleAndPermissions.NAMESPACE
    public static final String NAMESPACE = "isis.ext.docgen";
    ...
    public HelpTopic rootHelpTopic(
            ...
            final IsisEntityDiagramPage isisEntityDiagramPage,
