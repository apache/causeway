...
import org.apache.isis.extensions.fixtures.FixturesEventService;
...
public class FixturesInstallerDelegate {
     ...
     * {@link org.apache.isis.extensions.fixtures.legacy.installer.FixturesInstallerAbstract} to be
    ...
    private FixturesEventService getRuntimeEventService() {
        return IsisContext.getServiceRegistry().lookupServiceElseFail(FixturesEventService.class);
    }
