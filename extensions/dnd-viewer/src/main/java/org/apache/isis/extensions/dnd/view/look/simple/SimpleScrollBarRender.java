...
import org.apache.isis.extensions.dnd.view.border.ScrollBarRender;
...
public class SimpleScrollBarRender implements ScrollBarRender {
  ...
  //     canvas.drawSolidRectangle(x + 1, y + 1, width - 2, height - 2, Toolkit.getColor(ColorsAndFonts.COLOR_SECONDARY3));
        if (isHorizontal) {
//            canvas.drawSolidRectangle(x + scrollPosition, y  + 2, visibleAmount, height - 4, Toolkit.getColor(ColorsAndFonts.COLOR_SECONDARY3));
//            canvas.drawRectangle(x + scrollPosition, y  + 1, visibleAmount, height - 2, Toolkit.getColor(ColorsAndFonts.COLOR_SECONDARY2));
  ...
  //          canvas.drawSolidRectangle(x + 2, y  + scrollPosition, width - 4, visibleAmount, Toolkit.getColor(ColorsAndFonts.COLOR_SECONDARY3));
   //         canvas.drawRectangle(x + 1, y  + scrollPosition, width - 2, visibleAmount, Toolkit.getColor(ColorsAndFonts.COLOR_SECONDARY2));
