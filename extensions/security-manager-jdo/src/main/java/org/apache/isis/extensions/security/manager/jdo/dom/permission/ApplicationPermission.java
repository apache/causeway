...
@javax.jdo.annotations.Queries( {
        @javax.jdo.annotations.Query(
                ...
                value = "SELECT "
                        + "FROM org.apache.isis.extensions.security.manager.jdo.dom.permission.ApplicationPermission "
                        + "WHERE role == :role"),
        @javax.jdo.annotations.Query(
                ...
                value = "SELECT "
                        ...
                        + "VARIABLES org.apache.isis.extensions.security.manager.jdo.dom.user.ApplicationUser u"),
        @javax.jdo.annotations.Query(
