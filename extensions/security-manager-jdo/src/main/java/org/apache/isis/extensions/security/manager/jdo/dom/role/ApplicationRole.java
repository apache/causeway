 ...
 *  under the License.
 */
package org.apache.isis.extensions.security.manager.jdo.dom.role;
...
@javax.jdo.annotations.Queries({
        @javax.jdo.annotations.Query(
                ...
                value = "SELECT "
                        + "FROM org.apache.isis.extensions.security.manager.jdo.dom.role.ApplicationRole "
                        + "WHERE name == :name"),
        @javax.jdo.annotations.Query(
...
public class ApplicationRole implements Comparable<ApplicationRole> {
    ...
    /**
     * Adds a {@link org.apache.isis.extensions.security.manager.jdo.dom.permission.ApplicationPermission permission} for this role to a
