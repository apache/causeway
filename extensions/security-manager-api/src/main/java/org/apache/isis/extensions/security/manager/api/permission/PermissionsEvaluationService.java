 ...
 *     an instance is serialized into {@link org.apache.isis.extensions.security.manager.api.permission.ApplicationPermissionValueSet}.
 * </p>
 */
public interface PermissionsEvaluationService extends Serializable {
     ...
     * @param mode - the mode required, ie {@link org.apache.isis.extensions.security.manager.api.permission.ApplicationPermissionMode#VIEWING viewing} or {@link org.apache.isis.extensions.security.manager.api.permission.ApplicationPermissionMode#CHANGING changing}.
     * @param permissionValues - permissions to evaluate, guaranteed to passed through in natural order, as per {@link org.apache.isis.extensions.security.manager.api.permission.ApplicationPermissionValue.Comparators#natural()}.
     */
    @Programmatic
