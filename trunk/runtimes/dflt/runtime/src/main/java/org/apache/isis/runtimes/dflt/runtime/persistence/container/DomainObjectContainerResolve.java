...
/**
 * Helper class that encapsulates the processing performed by domain object containers that are performing a resolve.
 * 
 * <p>
 * Implementation note: rather than inject in its dependencies, we instead look up dependencies from the
