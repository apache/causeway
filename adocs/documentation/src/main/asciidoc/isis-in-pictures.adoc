...
On this page we want to show you what a modern Isis application looks like.
...
[NOTE]
====
Please note that the Isis Addons are not part of ASF, but they _are_ all licensed under Apache License 2.0 and are maintained by the Isis committers.
====
