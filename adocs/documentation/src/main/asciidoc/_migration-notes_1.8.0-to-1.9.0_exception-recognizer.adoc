...
Prior to 1.9.0 this implementation was _not_ annotated with xref:rgant.adoc#_rgant_manpage-DomainService[`@DomainService`] and thus needed to be explicitly registered in `isis.properties`.
