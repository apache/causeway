...
* https://www.apache.org/dyn/closer.cgi/isis/isis-core/isis-1.16.1-source-release.zip[isis-1.16.1] (https://www.apache.org/dist/isis/isis-core/isis-1.16.1-source-release.zip.asc[asc], https://www.apache.org/dist/isis/isis-core/isis-1.16.1-source-release.zip.md5[md5])

HelloWorld Archetype:

* https://www.apache.org/dyn/closer.cgi/isis/archetype/helloworld-archetype/helloworld-archetype-1.16.1-source-release.zip[helloworld-archetype-1.16.1] (https://www.apache.org/dist/isis/archetype/helloworld-archetype/helloworld-archetype-1.16.1-source-release.zip.asc[asc], https://www.apache.org/dist/isis/archetype/helloworld-archetype/helloworld-archetype-1.16.1-source-release.zip.md5[md5])

SimpleApp Archetype:

* https://www.apache.org/dyn/closer.cgi/isis/archetype/simpleapp-archetype/simpleapp-archetype-1.16.1-source-release.zip[simpleapp-archetype-1.16.1] (https://www.apache.org/dist/isis/archetype/simpleapp-archetype/simpleapp-archetype-1.16.1-source-release.zip.asc[asc], https://www.apache.org/dist/isis/archetype/simpleapp-archetype/simpleapp-archetype-1.16.1-source-release.zip.md5[md5])
...
----
pgpk -a KEYS
pgpv isis-1.16.1-source-release.zip.asc isis-1.16.1-source-release.zip
----
...
----
pgp -ka KEYS
pgp isis-1.16.1-source-release.zip.asc isis-1.16.1-source-release.zip
----
...
----
gpg –import KEYS
gpg -verify isis-1.16.1-source-release.zip.asc isis-1.16.1-source-release.zip
----
