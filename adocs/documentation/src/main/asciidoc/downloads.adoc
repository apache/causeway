...
* https://www.apache.org/dyn/closer.cgi/isis/isis-core/isis-1.14.0-source-release.zip[isis-1.14.0] (http://www.apache.org/dist/isis/isis-core/isis-1.14.0-source-release.zip.asc[asc], http://www.apache.org/dist/isis/isis-core/isis-1.14.0-source-release.zip.md5[md5])


Archetype:

* https://www.apache.org/dyn/closer.cgi/isis/archetype/simpleapp-archetype/simpleapp-archetype-1.14.0-source-release.zip[simpleapp-archetype-1.14.0] (http://www.apache.org/dist/isis/archetype/simpleapp-archetype/simpleapp-archetype-1.14.0-source-release.zip.asc[asc], http://www.apache.org/dist/isis/archetype/simpleapp-archetype/simpleapp-archetype-1.14.0-source-release.zip.md5[md5])
...
----
pgpk -a KEYS
pgpv isis-1.14.0-source-release.zip.asc
----
...
----
pgp -ka KEYS
pgp isis-1.14.0-source-release.zip.asc
----
...
----
gpg –import KEYS
gpg –verify isis-1.14.0-source-release.zip.asc
----
