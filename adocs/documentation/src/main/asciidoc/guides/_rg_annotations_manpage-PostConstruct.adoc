...
It is also recognized for xref:ug.adoc#http://localhost:4000/guides/ug.html#_ugbtb_more-advanced_view-models[view models] (eg annotated with xref:rg.adoc#_rg_annotations_manpage-ViewModel[`@ViewModel`]).
