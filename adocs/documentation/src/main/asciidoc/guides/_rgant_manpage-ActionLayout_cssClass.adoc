[[_rgant_manpage-ActionLayout_cssClass]]
= `cssClass()`
...
[NOTE]
====
The similar xref:rgant.adoc#_rgant_manpage-ActionLayout_cssClassFa[`@ActionLayout#cssClassFa()`] annotation attribute is also used as a hint
