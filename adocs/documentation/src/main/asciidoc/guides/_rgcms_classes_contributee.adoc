...
include::_rgcms_classes_contributee_manpage-HasTransactionId.adoc[leveloffset=+1]
include::_rgcms_classes_contributee_manpage-HasUserName.adoc[leveloffset=+1]
