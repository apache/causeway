...
examples can be found xref:ug.adoc#_ugfun_core-concepts_building-blocks_oid[here].
...
xref:rgcms.adoc#_rgcms_schema-aim[action invocation memento] schema. +
+
...
xref:rgcms.adoc#_rgcms_schema-aim[action iInvocation memento] schema.  The first, `valueDto` is intended to hold any valid
