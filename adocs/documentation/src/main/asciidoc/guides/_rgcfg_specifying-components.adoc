...
This property is IGNORED if the `isis.appManifest` configuration property is specified, or if an xref:rgcms.adoc#_rgcms_classes_super_manpage-AppManifest[`AppManifest`] is provided programmatically.
