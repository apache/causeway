[[_ugbtb_more-advanced_tips-n-tricks_are-you-sure]]
= 'Are you sure?' idiom
...
One way to meet this requirement is using the framework's built-in xref:rgant.adoc#_rgant_manpage-Action_semantics[`@Action#semantics()`] attribute:
