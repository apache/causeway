[[_rg_annotations_manpage-Action]]
= `@Action`
...
|xref:rg.adoc#_rg_annotations_manpage-Action_command[`command()`]
|`AS_CONFIGURED`, `ENABLED`, `DISABLED` +
(`AS_CONFIGURED`)
|whether the action invocation should be reified into a `o.a.i.applib.` +
`services.command.Command` object through the xref:rg.adoc#_rg_services-api_manpage-CommandContext[`CommandContext`] service.


|`commandExecuteIn()`
|`FOREGROUND`,`BACKGROUND` +
(`FOREGROUND`)
|whether to execute the command immediately, or to persist it (assuming that an appropriate implementation of xref:rg.adoc#_rg_services-spi_manpage-CommandService[`CommandService`] has been configured) such that a background scheduler can execute the command asynchronously


|`commandPersistence()`
|`PERSISTED`, `NOT_PERSISTED`, `IF_HINTED` +
(`PERSISTED`)
|whether the reified `Command` (as provided by the `CommandContext` domain service) should actually be persisted (assuming an appropriate implementation of xref:rg.adoc#_rg_services-spi_manpage-CommandService[`CommandService`] has been configured).
...
|xref:rg.adoc#_rg_annotations_manpage-Action_invokeOn[`invokeOn()`]
...
|xref:rg.adoc#_rg_annotations_manpage-Action_publishing[`publishing()`]
|`AS_CONFIGURED`, `ENABLED`, `DISABLED` +
(`AS_CONFIGURED`)
|whether the action invocation should be published to the registered xref:rg.adoc#_rg_services-spi_manpage-PublishingService[`PublishingService`].
...
|xref:rg.adoc#_rg_annotations_manpage-Action_restrictTo[`restrictTo()`]
...
|xref:rg.adoc#_rg_annotations_manpage-Action_semantics[`semantics()`]
...
The `...ARE_YOU_SURE` variants cause a confirmation dialog to be displayed in the xref:ugvw.adoc#_ugvw[Wicket viewer].
...
include::_rg_annotations_manpage-Action_command.adoc[leveloffset=+1]
include::_rg_annotations_manpage-Action_domainEvent.adoc[leveloffset=+1]
include::_rg_annotations_manpage-Action_hidden.adoc[leveloffset=+1]
include::_rg_annotations_manpage-Action_invokeOn.adoc[leveloffset=+1]
include::_rg_annotations_manpage-Action_publishing.adoc[leveloffset=+1]
include::_rg_annotations_manpage-Action_restrictTo.adoc[leveloffset=+1]
include::_rg_annotations_manpage-Action_semantics.adoc[leveloffset=+1]
include::_rg_annotations_manpage-Action_typeOf.adoc[leveloffset=+1]
