[[_rg_classes_super_manpage-AbstractFactoryAndRepository]]
...
Instead, indicate that a service is repository using the xref:rg.adoc#_rg_annotations_manpage-DomainService_repositoryFor[`@DomainService#repositoryFor()`] attribute.
