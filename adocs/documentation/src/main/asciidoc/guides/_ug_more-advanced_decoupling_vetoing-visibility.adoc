...
IMPORTANT: TODO - a write-up of the "vetoing subscriber" design pattern, eg as described in the  xref:rg.adoc#_rg_services-api_manpage-BookmarkService[`BookmarkService`]
