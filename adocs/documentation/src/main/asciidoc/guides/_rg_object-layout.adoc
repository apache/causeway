...
include::_rg_object-layout_static.adoc[leveloffset=+1]
include::_rg_object-layout_dynamic.adoc[leveloffset=+1]
include::_rg_object-layout_application-menu.adoc[leveloffset=+1]
include::_rg_object-layout_static-vs-dynamic.adoc[leveloffset=+1]
