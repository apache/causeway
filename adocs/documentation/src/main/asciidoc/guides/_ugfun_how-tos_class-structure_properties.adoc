...
[[_ugfun_how-tos_class-structure_properties_value-vs-reference-types]]
...
[[_ugfun_how-tos_class-structure_properties_optional-properties]]
== Optional Properties
...
[[_ugfun_how-tos_class-structure_properties_editable-properties]]
== Editable Properties
...
[[_ugfun_how-tos_class-structure_properties_ignoring-properties]]
== Ignoring Properties
...
[[_ugfun_how-tos_class-structure_properties_derived-properties]]
== Derived Properties
...
[[_ugfun_how-tos_class-structure_properties_mapping-strings]]
...
[[_ugfun_how-tos_class-structure_properties_mapping-bigdecimals]]
...
[[_ugfun_how-tos_class-structure_properties_mapping-blobs-and-clobs]]
...
[[_ugfun_how-tos_class-structure_properties_mapping-blobs-and-clobs_mapping-blobs]]
=== Mapping ``Blob``s
...
[[_ugfun_how-tos_class-structure_properties_mapping-blobs-and-clobs_mapping-clobs]]
=== Mapping ``Clob``s
...
[[_ugfun_how-tos_class-structure_properties_mapping-blobs-and-clobs_mapping-to-varbinary-or-varchar]]
...
[[_ugfun_how-tos_class-structure_properties_handling-mandatory-properties-in-subtypes]]
