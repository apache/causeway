[[_rgcms_classes_domainevent_manpage-CollectionDomainEvent]]
...
Subclass of xref:rgcms.adoc#_rgcms_classes_domainevent_manpage-AbstractDomainEvent[`AbstractDomainEvent`] for collections.
