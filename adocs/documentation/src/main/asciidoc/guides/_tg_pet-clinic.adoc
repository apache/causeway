...
This is a step-by-step tutorial to build up a simple "petclinic" application, starting from the xref:ug.adoc#_ugfun_getting-started_simpleapp-archetype[SimpleApp archetype].  It was originally written by Jeroen van der Wal.
