...
== Collection Parameter types (`1.14.0-SNAPSHOT`)

As of `1.14.0-SNAPSHOT` Apache Isis action parameters can be collections of types scalar (values such as `String`, `int`, or references such as `Customer`).
