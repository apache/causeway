...
If necessary the icon specified can be overridden by a particular object instance using the xref:rgcms.adoc#_rgcms_methods_reserved_manpage-iconName[`iconName()`] method.
