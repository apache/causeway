...
[TIP]
====
In this particular use case, it is generally simpler to just subclass from xref:rgcms.adoc#_rgcms_classes_super_manpage-AbstractSubscriber[`AbstractSubscriber`].
====
