[[_rgant_manpage-ActionLayout_contributedAs]]
= `contributedAs()`
...
In such cases, though, it would probably make more sense to annotate the action as either xref:rgant.adoc#_rgant_manpage-Action_hidden[hidden] or indeed xref:rgant.adoc#_rgant_manpage-Programmatic[`@Programmatic`].
