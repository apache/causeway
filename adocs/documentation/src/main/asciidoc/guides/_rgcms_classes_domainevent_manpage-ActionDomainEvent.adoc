[[_rgcms_classes_domainevent_manpage-ActionDomainEvent]]
= `ActionDomainEvent`
...
Subclass of xref:rgcms.adoc#_rgcms_classes_domainevent_manpage-AbstractDomainEvent[`AbstractDomainEvent`] for actions.
