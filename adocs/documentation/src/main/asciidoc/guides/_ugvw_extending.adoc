...
The first two of these options are discussed in the xref:ugvw.adoc#_ugvw[Wicket viewer] chapter.  This chapter describes the remaining "heavier-weight/more powerful" options.
...
include::_ugvw_extending_isis-addons-extensions.adoc[leveloffset=+1]
