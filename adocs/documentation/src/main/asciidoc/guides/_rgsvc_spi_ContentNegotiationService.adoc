[[_rgsvc_spi_ContentNegotiationService]]
...
[_rgsvc_spi_ContentNegotiationService_Configuration]]
== Configuration
...
The `ContentNegotiationService` is itself called by the (default implementation of) xref:rgsvc.adoc#_rgsvc_spi_RepresentationService[`RepresentationService`].