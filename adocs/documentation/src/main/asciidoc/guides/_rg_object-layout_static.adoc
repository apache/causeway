...
+
The name of these "member groups" are then referenced by xref:rgant.adoc#_rgant_manpage-MemberGroupLayout[`@MemberGroupLayout`].
...
+
If the `name()` attribute matches a property name, then the action's button is rendered close to the property, according to xref:rgant.adoc#_rgant_manpage-ActionLayout_position[`@ActionLayout#position()`] attribute. +
+
...
As of 1.8.0, all the layout annotations have been consolidated into the various `XxxLayout` annotations: xref:rgant.adoc#_rgant_manpage-ActionLayout, [`@ActionLayout`] xref:rgant.adoc#_rgant_manpage-CollectionLayout[`@CollectionLayout`],  xref:rgant.adoc#_rgant_manpage-DomainObjectLayout[`@DomainObjectLayout`],  xref:rgant.adoc#_rgant_manpage-DomainServiceLayout[`@DomainServiceLayout`],  xref:rgant.adoc#_rgant_manpage-ParameterLayout[`@ParameterLayout`], xref:rgant.adoc#_rgant_manpage-PropertyLayout[`@PropertyLayout`], and xref:rgant.adoc#_rgant_manpage-ViewModelLayout[`@ViewModelLayout`]
