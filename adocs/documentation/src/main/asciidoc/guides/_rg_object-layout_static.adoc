...
+
The name of these "member groups" are then referenced by xref:rg.adoc#_rg_annotations_manpage-MemberGroupLayout[`@MemberGroupLayout`].
...
+
If the `name()` attribute matches a property name, then the action's button is rendered close to the property, according to xref:rg.adoc#_rg_annotations_manpage-ActionLayout_position[`@ActionLayout#position()`] attribute. +
+
...
As of 1.8.0, all the layout annotations have been consolidated into the various `XxxLayout` annotations: xref:rg.adoc#_rg_annotations_manpage-ActionLayout, [`@ActionLayout`] xref:rg.adoc#_rg_annotations_manpage-CollectionLayout[`@CollectionLayout`],  xref:rg.adoc#_rg_annotations_manpage-DomainObjectLayout[`@DomainObjectLayout`],  xref:rg.adoc#_rg_annotations_manpage-DomainServiceLayout[`@DomainServiceLayout`],  xref:rg.adoc#_rg_annotations_manpage-ParameterLayout[`@ParameterLayout`], xref:rg.adoc#_rg_annotations_manpage-PropertyLayout[`@PropertyLayout`], and xref:rg.adoc#_rg_annotations_manpage-ViewModelLayout[`@ViewModelLayout`]
