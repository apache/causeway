...
<2> what the servlet should do if no existing session was found.  Usual values are either `unauthorized` or `basicAuthChallenge`.  Discussed in more detail below.
