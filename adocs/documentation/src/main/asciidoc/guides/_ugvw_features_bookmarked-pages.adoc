...
The Wicket viewer supports the bookmarking of both domain objects and query-only (xref:rgant.adoc#_rgant_manpage-Action_semantics[@Action(semantics=...)]) actions.
...
To indicate a class is bookmarkable, use the xref:rgant.adoc#_rgant_manpage-DomainObjectLayout[@DomainObjectLayout] annotation:
...
To indicate that a safe (query only) action is bookmarkable, use the xref:rgant.adoc#_rgant_manpage-ActionLayout[@ActionLayout] annotation:
