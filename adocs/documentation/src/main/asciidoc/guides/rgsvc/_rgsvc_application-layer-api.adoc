...
|xref:../rgsvc/rgsvc.adoc#_rgsvc_application-layer-api_BackgroundService[`o.a.i.applib.` +
`services.background` +
`BackgroundService`]
...
``isis-core-runtime``
|depends on: +
xref:../rgsvc/rgsvc.adoc#_rgsvc_application-layer-spi_BackgroundCommandService[`BackgroundCommand-Service`]


|xref:../rgsvc/rgsvc.adoc#_rgsvc_application-layer-api_CommandContext[`o.a.i.applib.` +
`services.command` +
`CommandContext`]
...
depends on: +
xref:../rgsvc/rgsvc.adoc#_rgsvc_application-layer-spi_CommandService[`CommandService`] for persistent `Command`, else in-memory impl. used.
...
|xref:../rgsvc/rgsvc.adoc#_rgsvc_application-layer-api_MessageService[`o.a.i.applib.` +
`services.message` +
`MessageService`]
...
|xref:../rgsvc/rgsvc.adoc#_rgsvc_application-layer-api_TitleService[`o.a.i.applib.` +
`services.title` +
`TitleService`]
...
|xref:../rgsvc/rgsvc.adoc#_rgsvc_application-layer-api_TransactionService[`o.a.i.applib.` +
`services.xactn` +
`TransactionService`]
...
|xref:../rgsvc/rgsvc.adoc#_rgsvc_application-layer-api_WrapperFactory[`o.a.i.applib.` +
`services.wrapper` +
`WrapperFactory`]
