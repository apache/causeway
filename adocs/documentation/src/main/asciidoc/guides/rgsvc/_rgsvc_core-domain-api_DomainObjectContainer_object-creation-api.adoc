...
Doing this will not inject any domain services, but they can be injected manually using xref:rgsvc.adoc#_rgsvc_core-domain-api_DomainObjectContainer_services-api[#injectServicesInto(...)`].
