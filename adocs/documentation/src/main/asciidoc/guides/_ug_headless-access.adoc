...
This chapter tackles the topic of enabling access to an Isis application directly, or at least, not through either the xref:ugvw.adoc#_ugvw[Wicket] or xref:ug.adoc#_ug_restfulobjects-viewer[Restful] viewers.
