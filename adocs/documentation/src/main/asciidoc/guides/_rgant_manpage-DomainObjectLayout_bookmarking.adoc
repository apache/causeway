[[_rgant_manpage-DomainObjectLayout_bookmarking]]
= `bookmarking()`
...
The `bookmarking()` attribute indicates that an entity is automatically bookmarked. This attribute is also supported for  xref:rgant.adoc#_rgant_manpage-Action_bookmarking[domain objects].
