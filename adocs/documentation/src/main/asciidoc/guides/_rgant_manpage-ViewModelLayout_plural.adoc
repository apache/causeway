[[_rgant_manpage-ViewModelLayout_plural]]
= `plural()`
...
The `plural()` attribute allows the plural form of the class name to be specified explicitly.  This attribute is also supported for xref:rgant.adoc#_rgant_manpage-DomainObjectLayout_plural[domain objects].
