[[_rgcms_classes_domainevent_manpage-AbstractDomainEvent]]
= `AbstractDomainEvent`
...
* xref:rgcms.adoc#_rgcms_classes_domainevent_manpage-ActionDomainEvent[`ActionDomainEvent`]

* xref:rgcms.adoc#_rgcms_classes_domainevent_manpage-PropertyDomainEvent[`PropertyDomainEvent`]

* xref:rgcms.adoc#_rgcms_classes_domainevent_manpage-CollectionDomainEvent[`CollectionDomainEvent`]
