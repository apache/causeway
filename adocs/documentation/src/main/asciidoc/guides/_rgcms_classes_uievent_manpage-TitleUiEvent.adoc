[[_rgcms_classes_uievent_manpage-TitleUiEvent]]
...
[NOTE]
====
If the domain object defines its own xref:rgcms.adoc#_rgcms_methods_reserved_manpage-title[`title()`] supporting method, or
