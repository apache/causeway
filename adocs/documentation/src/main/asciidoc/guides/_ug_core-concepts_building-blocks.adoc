...
obvious is as the menu actions on the top-level menu bars in the xref:ugvw.adoc#_ugvw[Wicket viewer]'s UI.
...
visible as the object's URL in the xref:ugvw.adoc#_ugvw[Wicket viewer] or
