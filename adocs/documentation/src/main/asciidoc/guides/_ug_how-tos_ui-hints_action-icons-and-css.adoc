...
NOTE: TODO - xref:rgant.adoc#_rgant_manpage-ActionLayout_cssClass[`@ActionLayout#cssClass()`] and xref:rgant.adoc#_rgant_manpage-ActionLayout_cssClassFa[`@ActionLayout#cssClassFa()`]
...
Rather than annotating every action with xref:rgant.adoc#_rgant_manpage-ActionLayout_cssClassFa[`@ActionLayout#cssClassFa()`] and xref:rgant.adoc#_rgant_manpage-ActionLayout_cssClass[`@ActionLayout#cssClass()`] you can instead specify the UI hint globally using regular expressions.
