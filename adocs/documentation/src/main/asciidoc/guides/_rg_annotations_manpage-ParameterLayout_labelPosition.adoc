...
To get an idea of how these are rendered (in the xref:ugvw.adoc#_ugvw[Wicket viewer]), see xref:rg.adoc#_rg_annotations_manpage-PropertyLayout_labelPosition[PropertyLayout#labelPosition()].
