...
One of the built-in domain services that uses this annotation is xref:rgsvc.adoc#_rgsvc-api_manpage-Scratchpad[`Scratchpad`], intended to allow the arbitrary sharing of data between objects.  Here is the full source code of this service is:
