[[_rg_annotations_manpage-ActionLayout_cssClass]]
= `cssClass()`
...
[NOTE]
====
The similar xref:rg.adoc#_rg_annotations_manpage-ActionLayout_cssClassFa[`@ActionLayout#cssClassFa()`] annotation attribute is also used as a hint
