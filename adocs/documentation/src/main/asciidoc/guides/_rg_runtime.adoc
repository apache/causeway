...
[NOTE]
====
Configuration properties for the viewers can be found in the xref:ugvw.adoc[Wicket Viewer] chapter and the xref:ugvro.adoc[RestfulObjects viewer] chapter.  Likewise[details of configuring security (Apache Shiro) can be found in the xref:ug.adoc#_ug_security[Security] chapter.
