[[_ug_wicket-viewer_customisation_default-theme]]
...
If you have developed a custom Bootstrap theme (as described xref:ug.adoc#_ug_extending_wicket-viewer_custom-bootstrap-theme[here]) then this can also be specified using the https://github.com/l0rdn1kk0n/wicket-bootstrap/wiki/Themes[Wicket Bootstrap API].
