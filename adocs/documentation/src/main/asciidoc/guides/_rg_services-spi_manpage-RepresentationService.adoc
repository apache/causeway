[[_rg_services-spi_manpage-RepresentationService]]
...
The `RepresentationService` is the main plug-in point for the xref:ug.adoc#_ug_restfulobjects-viewer[RestfulObjects viewer] to generate representations.
