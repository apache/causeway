...
Only properties supported by the configured xref:rgsvc.adoc#_rgsvc-api_MementoService[`MementoService`] can be used. The default implementation supports all the value types and persisted entities.
