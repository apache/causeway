[[_rgant_manpage-DomainServiceLayout]]
= `@DomainServiceLayout`
...
|xref:rgant.adoc#_rgant_manpage-DomainServiceLayout_menuBar[`menuBar()`]
|`PRIMARY`, `SECONDARY`, `TERTIARY` (`PRIMARY`).
|the menubar in which the menu that holds this service's actions should reside.


|xref:rgant.adoc#_rgant_manpage-DomainServiceLayout_menuOrder[`menuOrder()`]
|
|the order of the service's menu with respect to other service's.


|xref:rgant.adoc#_rgant_manpage-DomainServiceLayout_named[`named()`]
|string, eg "Customers"
...
include::_rgant_manpage-DomainServiceLayout_menuBar.adoc[leveloffset=+1]
include::_rgant_manpage-DomainServiceLayout_menuOrder.adoc[leveloffset=+1]
include::_rgant_manpage-DomainServiceLayout_named.adoc[leveloffset=+1]
