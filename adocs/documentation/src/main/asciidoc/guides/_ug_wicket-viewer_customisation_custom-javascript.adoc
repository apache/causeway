[[_ug_wicket-viewer_customisation_custom-javascript]]
= Custom Javascript
...
If possible, consider using the `ComponentFactory` API described in the xref:ug.adoc#_ug_extending_wicket-viewer[Extending] chapter.
====
