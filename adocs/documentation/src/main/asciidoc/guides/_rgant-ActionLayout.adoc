...
As an alternative to using the `@ActionLayout` annotation, a dynamic layout using  xref:ug.adoc#_ug_object-layout_dynamic[`.layout.json`] file can be specified; for example:
