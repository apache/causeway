...
[NOTE]
====
In this respect the wrapper is more functional than the xref:ugvw.adoc#_ugvw[Wicket viewer] (which does not expose the ability to mutate collections directly).
====
