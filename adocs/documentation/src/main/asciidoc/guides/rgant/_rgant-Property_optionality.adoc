...
The attribute is also supported for xref:../rgant/rgant.adoc#_rgant-Parameter_optionality[parameters].

That said, properties are most commonly defined on persistent domain objects (entities), in which case the JDO xref:../rgant/rgant.adoc#_rgant-Column[`@Column`] should be specified.
