[[_ugbtb_more-advanced_decoupling_pushing-changes]]
= Pushing Changes
...
<3> the xref:rgcms.adoc#_rgcms_methods_prefixes_manpage-addTo[`addTo...()`] method increments the derived properties
<4> the xref:rgcms.adoc#_rgcms_methods_prefixes_manpage-removeFrom[`removeFrom...()`] method similarly decrements the derived properties
