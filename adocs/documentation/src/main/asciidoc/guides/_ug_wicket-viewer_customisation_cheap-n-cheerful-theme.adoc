...
[TIP]
====
Alternatively you could "do it properly" and create your xref:ug.adoc#_ug_extending_wicket-viewer_custom-bootstrap-theme[own Bootstrap theme], as described in the <<Extending>> chapter.
====
