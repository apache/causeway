...
|the event type to be posted (`1.11.0-SNAPSHOT`) to the xref:rgsvc.adoc#_rgsvc-api_manpage-EventBusService[`EventBusService`] to obtain a CSS class for the domain object.
...
(`IconUiEvent.Default`)
|the event type to be posted (`1.11.0-SNAPSHOT`) to the xref:rgsvc.adoc#_rgsvc-api_manpage-EventBusService[`EventBusService`] to obtain the icon (name) for the domain object.
...
|the event type to be posted (`1.11.0-SNAPSHOT`) to the xref:rgsvc.adoc#_rgsvc-api_manpage-EventBusService[`EventBusService`] to obtain the title for the domain object.
