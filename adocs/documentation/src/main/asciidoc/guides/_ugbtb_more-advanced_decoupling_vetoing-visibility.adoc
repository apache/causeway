[[_ugbtb_more-advanced_decoupling_vetoing-visibility]]
= Vetoing Visibility
...
NOTE: TODO - a write-up of the "vetoing subscriber" design pattern, eg as described in the  xref:rgsvc.adoc#_rgsvc-api_BookmarkService[`BookmarkService`]
