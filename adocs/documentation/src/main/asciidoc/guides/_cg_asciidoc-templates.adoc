...
pass:[<pre>xref:ug.adoc#_ugfun_object-layout_dynamic_[Dynamic object layout]</pre>]

|xref:ug.adoc#_ugfun_object-layout_dynamic[Dynamic object layout]
...
pass:[<pre>xref:ug.adoc#_ugfun_core-concepts[Core concepts\]</pre>]

|xref:ug.adoc#_ugfun_core-concepts[Core concepts]
...
pass:[<pre>xref:ug.adoc#_ugfun_core-concepts_philosophy_naked-objects-pattern[Naked objects pattern\]</pre>]

|xref:ug.adoc#_ugfun_core-concepts_philosophy_naked-objects-pattern[Naked objects pattern]




|`adugsimpleapp`
|pass:[<pre>xref:ug.adoc#_ugfun_getting-started_simpleapp-archetype[SimpleApp archetype\]</pre>]

A hyperlink to the `simpleapp` archetype in the "getting started" chapter.

|xref:ug.adoc#_ugfun_getting-started_simpleapp-archetype[SimpleApp archetype]
