...
IMPORTANT: TODO - xref:rg.adoc#_rg_methods_prefixes_manpage-choices[`choices...()`]

### Auto-complete for property

IMPORTANT: TODO - xref:rg.adoc#_rg_methods_prefixes_manpage-autoComplete[`autoComplete...()`]

### Default for property

IMPORTANT: TODO -  xref:rg.adoc#_rg_methods_prefixes_manpage-default[`default...()`]
...
IMPORTANT: TODO - xref:rg.adoc#_rg_annotations_manpage-DomainObject_bounded[`@DomainObject#bounded()`]
