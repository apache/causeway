...
|`--manifest`
|FQCN
|Fully qualified class name of the xref:rgcms.adoc#_rgcms_classes_super_manpage-AppManifest[`AppManifest`] to use to bootstrap the system. +
...
|`--fixture`
|FQCN
|Fully qualified class name of the fixture (extending xref:rgcms.adoc#_rgcms_classes_super_manpage-FixtureScript[`FixtureScript`]) to be run to setup data. +
