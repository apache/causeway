...
image::{_imagesdir}dialog-mode/modal.png[width="800px",link="{_imagesdir}dialog-mode/modal.png"]


And here's what it looks like with the sidebar dialog:

image::{_imagesdir}dialog-mode/sidebar.png[width="800px",link="{_imagesdir}dialog-mode/sidebar.png"]
