...
|xref:rgcms.adoc#_rgcms_classes_lifecycleevent_manpage-AbstractLifecycleEvent[`o.a.i.applib.` +
...
|xref:rgcms.adoc#_rgcms_classes_lifecycleevent_manpage-ObjectCreatedDomainEvent[`o.a.i.applib.` +
`ObjectCreatedEvent`]
|``o.a.i.core`` +
``services.eventbus`` +
``isis-core-applib``
...
using the xref:rgsvc.adoc#_rgsvc-api_DomainObjectContainer_object-creation-api[`DomainObjectContainer`]'s
`#newTransientInstance(...)` method.


|xref:rgcms.adoc#_rgcms_classes_lifecycleevent_manpage-ObjectLoadedDomainEvent[`o.a.i.applib.` +
`ObjectLoadedEvent`]
|``o.a.i.core`` +
``services.eventbus`` +
``isis-core-applib``
...
|xref:rgcms.adoc#_rgcms_classes_lifecycleevent_manpage-ObjectPersistedDomainEvent[`o.a.i.applib.` +
...
|xref:rgcms.adoc#_rgcms_classes_lifecycleevent_manpage-ObjectPersistingDomainEvent[`o.a.i.applib.` +
...
|xref:rgcms.adoc#_rgcms_classes_lifecycleevent_manpage-ObjectRemovingDomainEvent[`o.a.i.applib.` +
`ObjectRemovingEvent`]
|``o.a.i.core`` +
``services.eventbus`` +
``isis-core-applib``
...
|xref:rgcms.adoc#_rgcms_classes_lifecycleevent_manpage-ObjectUpdatedDomainEvent[`o.a.i.applib.` +
`ObjectUpdatedEvent`]
|``o.a.i.core`` +
``services.eventbus`` +
``isis-core-applib``
...
|xref:rgcms.adoc#_rgcms_classes_lifecycleevent_manpage-ObjectUpdatingDomainEvent[`o.a.i.applib.` +
`ObjectUpdatingEvent`]
|``o.a.i.core`` +
``services.eventbus`` +
``isis-core-applib``
...
include::_rgcms_classes_lifecycleevent_manpage-AbstractLifecycleEvent.adoc[leveloffset=+1]
include::_rgcms_classes_lifecycleevent_manpage-ObjectCreatedEvent.adoc[leveloffset=+1]
include::_rgcms_classes_lifecycleevent_manpage-ObjectLoadedEvent.adoc[leveloffset=+1]
include::_rgcms_classes_lifecycleevent_manpage-ObjectPersistedEvent.adoc[leveloffset=+1]
include::_rgcms_classes_lifecycleevent_manpage-ObjectPersistingEvent.adoc[leveloffset=+1]
include::_rgcms_classes_lifecycleevent_manpage-ObjectRemovingEvent.adoc[leveloffset=+1]
include::_rgcms_classes_lifecycleevent_manpage-ObjectUpdatedEvent.adoc[leveloffset=+1]
include::_rgcms_classes_lifecycleevent_manpage-ObjectUpdatingEvent.adoc[leveloffset=+1]
