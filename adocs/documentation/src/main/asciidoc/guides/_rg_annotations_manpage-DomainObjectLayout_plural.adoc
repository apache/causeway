[[_rg_annotations_manpage-DomainObjectLayout_plural]]
= `plural()`
...
The `plural()` attribute allows the plural form of the class name to be specified explicitly.  This attribute is also supported for xref:rg.adoc#_rg_annotations_manpage-ViewModelLayout_plural[view models].
