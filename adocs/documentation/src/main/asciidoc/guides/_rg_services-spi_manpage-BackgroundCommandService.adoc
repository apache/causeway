[[_rg_services-spi_manpage-BackgroundCommandService]]
...
The declarative approach involves annotating an action using xref:rgant.adoc#_rgant_manpage-Action_command[`@Action#command()`] with `@Action#commandExecuteIn=CommandExecuteIn.BACKGROUND`.
