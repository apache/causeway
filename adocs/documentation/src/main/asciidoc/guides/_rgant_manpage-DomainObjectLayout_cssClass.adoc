[[_rgant_manpage-DomainObjectLayout_cssClass]]
= `cssClass()`
...
[NOTE]
====
The similar xref:rgant.adoc#_rgant_manpage-DomainObjectLayout_cssClassFa[`@DomainObjectLayout#cssClassFa()`] annotation attribute is also used as a hint to apply CSS, but in particular to allow http://fortawesome.github.io/Font-Awesome/icons/[Font Awesome icons]
