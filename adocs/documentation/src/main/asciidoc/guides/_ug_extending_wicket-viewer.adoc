...
The first two of these options are discussed in the xref:ug.adoc#_ug_wicket-viewer[Wicket viewer] chapter.  This chapter describes the remaining "heavier-weight/more powerful" options.
...
include::_ug_extending_wicket-viewer_login-via-query-args-prototyping.adoc[leveloffset=+1]
