...
The metadata for domain objects is obtained both xref:ug.adoc#_ugfun_object-layout_static[statically] and xref:ug.adoc#_ugfun_object-layout_dynamic[dynamically].
