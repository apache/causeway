...
The metadata for domain objects is obtained both xref:ug.adoc#_ug_object-layout_static[statically] and xref:ug.adoc#_ug_object-layout_dynamic[dynamically].
