...
Here's a sample of the release from Apache Isis 1.15.0:

[source]
----
http://repository.apache.org/content/repositories/orgapacheisis-1058/org/apache/isis/core/isis/1.15.0/isis-1.15.0-source-release.zip
http://repository.apache.org/content/repositories/orgapacheisis-1059/org/apache/isis/archetype/helloworld-archetype/1.15.0/helloworld-archetype-1.15.0-source-release.zip
http://repository.apache.org/content/repositories/orgapacheisis-1059/org/apache/isis/archetype/simpleapp-archetype/1.15.0/simpleapp-archetype-1.15.0-source-release.zip
----
