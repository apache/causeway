...
The xref:ugvw.adoc[Wicket viewer] provides a "clear hints" mixin action that is for use by end-users of the application
to clear any UI hints that have accumulated for a domain object.
