...
See xref:ug.adoc#_ugfun_how-tos_ui-hints_action-icons-and-css[UI hints] for more details.
...
|`FQCN`,`FQCN2`,...
|Fully qualified class names of classes to be instantiated to read layout metadata, as used in for xref:ug.adoc#_ugfun_object-layout_dynamic[dynamic layout]s. +
