...
[[_rgsvc-api_SwaggerService_api-and-implementation]]
== API & Implementation
...
xref:ugbtb.adoc#_ugbtb_more-advanced_view-models[view model]s and to domain services with a xref:rgant.adoc#_rgant_DomainService_nature[nature] of `VIEW_REST_ONLY`.
