...
xref:rgant.adoc#_rgant_manpage-DomainObject_nature[`@DomainObject#nature()`] annotation with a nature of `MIXIN`.


For further discussion on using mixins, see xref:ugbtb.adoc#_ugbtb_more-advanced_decoupling_mixins[mixins] in the user guide.
