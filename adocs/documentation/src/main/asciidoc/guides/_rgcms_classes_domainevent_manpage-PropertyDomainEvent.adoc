[[_rgcms_classes_domainevent_manpage-PropertyDomainEvent]]
= `PropertyDomainEvent`
...
Subclass of xref:rgcms.adoc#_rgcms_classes_domainevent_manpage-AbstractDomainEvent[`AbstractDomainEvent`] for properties.
