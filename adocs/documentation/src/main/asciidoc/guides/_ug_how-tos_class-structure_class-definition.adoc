[[_ug_how-tos_class-structure_class-definition]]
= Class Definition
...
[TIP]
====
For more on this topic, see the topic discussing modules and xref:ugbtb.adoc#_ugbtb_more-advanced_decoupling[decoupling].
====
