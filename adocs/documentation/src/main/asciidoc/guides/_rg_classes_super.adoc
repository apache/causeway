...
``isis-core-applib``
|(abstract class). +
`FixtureScriptsDefault` is a default implementation that is used when the alternative xref:rgsvc.adoc#_rgsvc-api_manpage-FixtureScriptsSpecificationProvider[`FixtureScriptsSpecificationProvider`] is provided
