...
To indicate that an action invocation should be published, annotate it with the xref:rgant.adoc#_rgant_manpage-Action_publishing[`@Action#publishing()`] annotation.

To indicate that a changed object should be published is to annotate it with the xref:rgant.adoc#_rgant_manpage-DomainObject_publishing[`@DomainObject#publishing()`] annotation.
