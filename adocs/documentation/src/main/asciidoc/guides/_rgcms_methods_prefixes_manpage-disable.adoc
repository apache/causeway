[[_rgcms_methods_prefixes_manpage-disable]]
= `disable...()`
...
The reason for vetoing a modification/invocation is normally returned as a string.  However, Apache Isis' xref:ugbtb.adoc#_ugbtb_more-advanced_i18n[i18n support] extends this so that reasons can be internationalized.
