[[_rg_annotations_manpage-Property]]
= `@Property`
...
|xref:rg.adoc#_rg_annotations_manpage-Property_domainEvent[`domainEvent()`]
...
|xref:rg.adoc#_rg_annotations_manpage-Property_editing[`editing()`]
|`ENABLED`, `DISABLED`, `AS_CONFIGURED` +
(`AS_CONFIGURED`)
|whether a property can be modified or cleared from within the UI


|xref:rg.adoc#_rg_annotations_manpage-Property_hidden[`hidden()`]
...
|xref:rg.adoc#_rg_annotations_manpage-Property_maxLength[`maxLength()`]
|
|maximum number of characters for string parameters; ignored otherwise +

In many/most cases you should however use xref:rg.adoc#_rg_annotations_manpage-Column[`@Column#length()`]


|xref:rg.adoc#_rg_annotations_manpage-Property_mustSatisfy[`mustSatisfy()`]
|implementation of `o.a.i.applib.spec.Specification`
|allows arbitrary validation to be applied


|xref:rg.adoc#_rg_annotations_manpage-Property_notPersisted[`notPersisted()`]
|`true`, `false` +
(`false`)
...
|xref:rg.adoc#_rg_annotations_manpage-Property_optionality[`optionality()`]
|
|specifies a property is optional rather than mandatory +

In many/most cases you should however use xref:rg.adoc#_rg_annotations_manpage-Column[`@Column#allowNulls()`]



|xref:rg.adoc#_rg_annotations_manpage-Property_regexPattern[`regexPattern()`]
|regular expression
...
include::_rg_annotations_manpage-Property_maxLength.adoc[leveloffset=+1]
include::_rg_annotations_manpage-Property_mustSatisfy.adoc[leveloffset=+1]
include::_rg_annotations_manpage-Property_notPersisted.adoc[leveloffset=+1]
include::_rg_annotations_manpage-Property_optionality.adoc[leveloffset=+1]
include::_rg_annotations_manpage-Property_regexPattern.adoc[leveloffset=+1]
