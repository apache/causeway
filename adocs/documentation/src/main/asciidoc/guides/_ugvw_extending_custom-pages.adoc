...
| SIGN_UP
| The sign-up page (if xref:rgsvc.adoc#_rgsvc-spi_UserRegistrationService[user registration] is enabled).

| SIGN_UP_VERIFY
| The sign-up verification page (if xref:rgsvc.adoc#_rgsvc-spi_UserRegistrationService[user registration] is enabled; as accessed by link from verification email)
