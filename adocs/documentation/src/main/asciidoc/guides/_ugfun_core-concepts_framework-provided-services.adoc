...
A full list of services can be found in the xref:rgsvc.adoc#_rgsvc_api[Domain Services (API)]  and xref:rgsvc.adoc#_rgsvc_spi[Domain Services (SPI)] chapters of the reference guide.
