[[_rgsvc-spi_FixtureScriptsSpecificationProvider]]
...
xref:rgsvc.adoc#_rgsvc-api_FixtureScriptsDefault[`FixtureScriptsDefault`] domain service, providing the
...
The xref:ug.adoc#_ugfun_getting-started_simpleapp-archetype[SimpleApp archetype] has a simple implementation of this service:
