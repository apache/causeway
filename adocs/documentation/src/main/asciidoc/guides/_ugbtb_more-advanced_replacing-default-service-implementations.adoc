...
The framework provides default implementations for many of the xref:rgsvc.adoc#_rgsvc_api[API Services].  This is convenient, but sometimes you will want to replace the default implementation with your own service implementation.
