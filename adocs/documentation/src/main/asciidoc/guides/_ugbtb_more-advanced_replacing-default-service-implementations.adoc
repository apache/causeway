[[_ugbtb_more-advanced_replacing-default-service-implementations]]
...
The framework provides default implementations for many of the xref:rgsvc.adoc#_rgsvc-api[API Services].  This is convenient, but sometimes you will want to replace the default implementation with your own service implementation.
...
For example, suppose you wanted to provide your own implementation of xref:rgsvc.adoc#_rgsvc-api_manpage-LocaleProvider[`LocaleProvider`].  Here's how:
