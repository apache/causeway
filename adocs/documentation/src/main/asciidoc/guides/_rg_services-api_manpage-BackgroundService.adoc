...
[TIP]
====
If you want to check business rules, you can use xref:rgant.adoc#_rgant_manpage-WrapperFactory[`@WrapperFactory#wrapNoExecute(...)`].
====
