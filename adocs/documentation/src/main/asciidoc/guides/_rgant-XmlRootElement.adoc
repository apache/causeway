...
xref:rgsvc.adoc#_rgsvc-spi_manpage-UrlEncodingService[`UrlEncodingService`], the default implementation of which
...
xref:rgant.adoc#_rgant-Mixin[`@Mixin`]), while xref:rg.adoc#_rg_classes_uievent[UI events] can be used
