[[_rgcms_methods_prefixes_manpage-autoComplete]]
= `autoComplete...()`
...
[TIP]
====
If the number of candidate objects is comparatively small, then use xref:rgcms.adoc#_rgcms_methods_prefixes_manpage-choices[`choices...()`] supporting method instead.
====
