...
[[_ugvro_ro-spec_apache-isis-implementation]]
...
[[_ugvro_ro-spec_extensions_content-negotiation]]
=== Content Negotiation (34.1)

Apache Isis provides two levels of support for content negotiation.

[[_ugvro_ro-spec_extensions_content-negotiation_x-ro-domain-type]]
==== `x-ro-domain-type`
...
The server will use the xref:rgsvc.adoc#_rgsvc-spi_ContentMappingService[`ContentMappingService`] to attempt to
...
[[_ugvro_ro-spec_extensions_content-negotiation_apache-isis-profile]]
==== Apache Isis profile
...
[[_ugvro_ro-spec_extensions_minimizing-round-trips]]
...
[[_ugvro_ro-spec_extensions_minimizing-round-trips_honor-ui-hints]]
==== Honor UI hints
