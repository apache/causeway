[[_rgsvc-api_manpage-DomainObjectContainer]]
...
include::_rgsvc-api_manpage-DomainObjectContainer_object-creation-api.adoc[leveloffset=+1]
include::_rgsvc-api_manpage-DomainObjectContainer_generic-repository-api.adoc[leveloffset=+1]
include::_rgsvc-api_manpage-DomainObjectContainer_object-persistence-api.adoc[leveloffset=+1]
include::_rgsvc-api_manpage-DomainObjectContainer_messages-api.adoc[leveloffset=+1]
include::_rgsvc-api_manpage-DomainObjectContainer_security-api.adoc[leveloffset=+1]
include::_rgsvc-api_manpage-DomainObjectContainer_presentation-api.adoc[leveloffset=+1]
include::_rgsvc-api_manpage-DomainObjectContainer_validation-api.adoc[leveloffset=+1]
include::_rgsvc-api_manpage-DomainObjectContainer_properties-api.adoc[leveloffset=+1]
include::_rgsvc-api_manpage-DomainObjectContainer_services-api.adoc[leveloffset=+1]
