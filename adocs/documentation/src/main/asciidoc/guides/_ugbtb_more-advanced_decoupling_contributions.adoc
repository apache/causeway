...
* there's also useful information in the reference guide, discussing the xref:rgant.adoc#_rgant_manpage-DomainService_nature[@DomainService#nature()] attribute, for the `NatureOfService.VIEW_CONTRIBUTIONS_ONLY` nature.
