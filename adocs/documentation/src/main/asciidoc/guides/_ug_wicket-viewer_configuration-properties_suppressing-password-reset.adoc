[[_ug_wicket-viewer_configuration-properties_suppressing-password-reset]]
...
The xref:ug.adoc#_ug_wicket-viewer_configuration-properties_suppressing-sign-up[sign up link] can be suppressed in a similar manner.
