[[_rgcms_classes_uievent_manpage-IconUiEvent]]
...
[NOTE]
====
If the domain object defines its own xref:rgcms.adoc#_rgcms_methods_reserved_manpage-iconName[`iconName()`] supporting method,
or if it has the
