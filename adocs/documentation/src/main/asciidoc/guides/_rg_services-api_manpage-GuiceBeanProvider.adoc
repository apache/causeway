...
The `GuiceBeanProvider` domain service acts as a bridge between Isis' xref:ug.adoc#_ug_wicket-viewer[Wicket viewer] internal bootstrapping using link:https://github.com/google/guice[Google Guice].
