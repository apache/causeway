[[_rgant_manpage-DomainObject_nature]]
= `nature()`
...
Equivalent to annotating with xref:rgant.adoc#_rgant_manpage-Mixin[`@Mixin`].  For further discussion on using mixins, see xref:ugbtb.adoc#_ugbtb_more-advanced_decoupling_mixins[mixins] in the user guide.
