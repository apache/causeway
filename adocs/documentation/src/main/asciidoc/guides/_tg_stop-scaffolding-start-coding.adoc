...
* specify a xref:ug.adoc#_ugfun_how-tos_ui-hints_object-titles-and-icons[title]
* specify an xref:ug.adoc#_ugfun_how-tos_ui-hints_object-titles-and-icons[icon]
...
** as per the docs describing xref:ug.adoc#_ugfun_how-tos_crud[how to create or delete objects]
* rename if you wish
** eg `newPet(...)` or `addPet(...)`
* review `listAll` action (acting as a repository)
* as per the docs describing xref:ug.adoc#_ugfun_how-tos_crud[how to write a custom repository]
...
* add some xref:ug.adoc#_ugfun_how-tos_class-structure_properties[value properties]; also:
...
** rather than the xref:rgcms.adoc#_rgcms_methods_reserved_title[`title()`] `title()` method
* order the properties using the xref:rgant.adoc#_rgant-MemberOrder[`@MemberOrder`], also `@MemberGroupLayout`
** see also the docs on xref:ug.adoc#_ugfun_object-layout_static[static layouts]
...
* add some xref:ug.adoc#_ugfun_how-tos_class-structure_properties[reference properties]
...
* Add xref:ug.adoc#_ugfun_how-tos_drop-downs-and-defaults[defaults] for action parameters
...
* Add a xref:ug.adoc#_ugfun_how-tos_class-structure_collections[collection] to one of the entities
...
* to create objects, xref:ug.adoc#_ugfun_how-tos_class-structure_inject-services[inject] associated domain service
...
It's also possible to use Font Awesome icons for the xref:ug.adoc#_ugfun_how-tos_ui-hints_object-titles-and-icons[domain object icon].
...
* Delete the various hint annotations and instead specify layout hints using a xref:ug.adoc#_ugfun_object-layout_dynamic[.layout.json] file.
