...
[NOTE]
====
Configuration properties for the viewers can be found in the xref:ugvw.adoc#[Wicket Viewer] guide and the xref:ugvro.adoc#[RestfulObjects viewer] guide.  Likewise[details of configuring security (Apache Shiro) can be found in the xref:ugsec.adoc#[Security] guide.
