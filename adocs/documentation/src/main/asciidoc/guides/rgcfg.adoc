...
[NOTE]
====
Configuration properties for the viewers can be found in the xref:ugvw.adoc#[Wicket Viewer] guide
and the xref:ugvro.adoc#[RestfulObjects viewer] guide.  Likewise[details of configuring security (Apache Shiro) can be
found in the xref:ugsec.adoc#[Security] guide.

Also, note that by default the configuration values are part of the built WAR file.  Details on how to override these
configuration properties externally for different environments can be found in the
xref:ugbtb.adoc#_ugbtb_deployment[Beyond the Basics] guide, (deployment chapter).
====
...
* xref:cgcon.adoc#[Developers' Guide] (how to set up a development environment
