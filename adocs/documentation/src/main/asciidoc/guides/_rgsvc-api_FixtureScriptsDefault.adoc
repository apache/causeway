...
[TIP]
====
We recommend using xref:rgsvc.adoc#_rgsvc-spi_FixtureScriptsSpecificationProvider[`FixtureScriptsSpecificationProvider`] rather than subclassing xref:rg.adoc#_rg_classes_super_manpage-FixtureScripts[`FixtureScripts`].
====
