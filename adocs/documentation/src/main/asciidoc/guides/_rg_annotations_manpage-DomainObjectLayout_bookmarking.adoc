[[_rg_annotations_manpage-DomainObjectLayout_bookmarking]]
= `bookmarking()`
...
The `bookmarking()` attribute indicates that an entity is automatically bookmarked. This attribute is also supported for  xref:rg.adoc#_rg_annotations_manpage-Action_bookmarking[domain objects].
