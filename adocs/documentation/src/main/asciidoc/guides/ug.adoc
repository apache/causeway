...
Other users guides cover:

* the xref:ugvw.adoc#_ugvw[Wicket viewer], both from an end-user perspective and also how as a programmer you can customize the UI.

There is a similar chapter discussing the xref:ug.adoc#_ug_restfulobjects-viewer[Restful Objects viewer] which provides Apache Isis' REST API.  The guide also explains how to configure xref:ug.adoc#_ug_security[security], principally involving Apache Isis' integration with Apache Shiro.
