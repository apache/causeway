...
The solution that Isis provides is a domain service called xref:rg.adoc#_rg_classes_super_manpage-FixtureScripts[Fixture Scripts], that defines a pattern and supporting classes to help ensure that the "data setup" for your tests are reusable and maintainable over time.
