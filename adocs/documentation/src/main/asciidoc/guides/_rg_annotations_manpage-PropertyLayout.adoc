[[_rg_annotations_manpage-PropertyLayout]]
= `@PropertyLayout`
...
|xref:rg.adoc#_rg_annotations_manpage-PropertyLayout_hidden[`hidden()`]
...
|xref:rg.adoc#_rg_annotations_manpage-PropertyLayout_labelPosition[`labelPosition()`]
|`LEFT`, `TOP`, `RIGHT`, `NONE` +
(`LEFT`)
...
If set > 1, then xref:rg.adoc#_rg_annotations_manpage-PropertyLayout_labelPosition[`labelPosition`] defaults to TOP.


|xref:rg.adoc#_rg_annotations_manpage-PropertyLayout_named[`named()`]
|String
...
|xref:rg.adoc#_rg_annotations_manpage-PropertyLayout_renderedAsDayBefore[`renderedAsDayBefore()`]
|`true`, `false` +
(`false`)
|for date properties only, render the date as one day prior to the actually stored date.


|xref:rg.adoc#_rg_annotations_manpage-PropertyLayout_typicalLength[`typicalLength()`]
|Positive integer.
...
include::_rg_annotations_manpage-PropertyLayout_labelPosition.adoc[leveloffset=+1]
include::_rg_annotations_manpage-PropertyLayout_multiLine.adoc[leveloffset=+1]
include::_rg_annotations_manpage-PropertyLayout_named.adoc[leveloffset=+1]
include::_rg_annotations_manpage-PropertyLayout_renderedAsDayBefore.adoc[leveloffset=+1]
include::_rg_annotations_manpage-PropertyLayout_typicalLength.adoc[leveloffset=+1]
