[[_ugbtb_more-advanced_overriding-jdo-annotations]]
...
* As of 1.9.0 Apache Isis will automatically (attempt) to create the owning schema for a given table if it does not exist. This behaviour can be customized, as described in the section on xref:_ugbtb_more-advanced_decoupling_db-schemas[using modules].
