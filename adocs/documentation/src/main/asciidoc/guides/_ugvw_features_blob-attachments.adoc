...
The Isis application library provides the xref:rgcms.adoc#_rgcms_classes_value-types_manpage-Blob[Blob] value type (binary large objects) and also the xref:rgcms.adoc#_rgcms_classes_value-types_manpage-Clob[Clob]
