...
from the xref:rgsvc.adoc#_rgsvc-api_BookmarkService[`BookmarkService`].
...
form, by way of the xref:rgsvc.adoc#_rgsvc-spi_UrlEncodingService[`UrlEncodingService`].
...
These use the xref:rgsvc.adoc#_rgsvc-api_JaxbService[`JaxbService`] to generate the schemas; using the
