[[_ug_wicket-viewer_configuration-properties_suppressing-sign-up]]
= Suppressing 'sign up'
...
The xref:ug.adoc#_ug_wicket-viewer_configuration-properties_suppressing-password-reset[password reset link] can be suppressed in a similar manner.
