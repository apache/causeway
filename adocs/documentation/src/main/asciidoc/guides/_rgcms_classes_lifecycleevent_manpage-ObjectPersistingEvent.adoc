[[_rgcms_classes_lifecycleevent_manpage-ObjectPersistingEvent]]
...
Subclass of xref:rgcms.adoc#_rgcms_classes_lifecycleevent_manpage-AbstractLifecycleEvent[`AbstractLifecycleEvent`], broadcast
