[[_rgcms_classes_uievent_manpage-CssClassUiEvent]]
...
[NOTE]
====
if the domain object defines its own xref:rgcms.adoc#_rgcms_methods_reserved_manpage-cssClass[`cssClass()`] supporting
