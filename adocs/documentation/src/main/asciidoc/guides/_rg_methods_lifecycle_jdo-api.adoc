...
You can gain access to the relevant JDO API using the xref:rgsvc.adoc#_rgsvc-api_IsisJdoSupport[`IsisJdoSupport`] domain service.
...
<3> use the injected xref:rgsvc.adoc#_rgsvc-api_IsisJdoSupport[`IsisJdoSupport`] service to obtain the `PersistenceManager`.
