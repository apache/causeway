...
* Set up a xref:rgcms.adoc#_rgcms_classes_domainevent[domain event] xref:rgcms.adoc#_rgcms_classes_super_AbstractSubscriber[subscriber] that can veto the changes.
