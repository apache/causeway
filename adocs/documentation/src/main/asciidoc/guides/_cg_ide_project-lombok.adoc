...
In the future we might extend/fork Lombok so that it understands Isis' own annotations (ie xref:rgant.adoc#_rgant_manpage-Property[`@Property`] and xref:rgant.adoc#_rgant_manpage-Collection[`@Collection`])
