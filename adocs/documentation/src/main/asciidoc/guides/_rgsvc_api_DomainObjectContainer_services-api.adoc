...
[NOTE]
====
(As of `1.12.0-SNAPSHOT`), some of these methods have been moved to the xref:rgsvc.adoc#_rgsvc_api_ServiceRegistry[`ServiceRegistry`]; the corresponding methods in `DomainObjectContainer` are deprecated.
====
