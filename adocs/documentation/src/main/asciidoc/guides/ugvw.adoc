...
In addition, there is a xref:dg.adoc#[Developers' Guide] (that describes how to set up a development environment
for Apache Isis and contribute back to the project), and a xref:cgcom.adoc#[Committers' Guide] (that describes release
