...
The wicket viewer has full support for the various methods of specifying the xref:ug.adoc#_ug_object-layout[layout of objects], either statically or dynamically.
...
To learn more about how to configure these types of layout, see the xref:ug.adoc#_ug_object-layout[object layout] chapter.
