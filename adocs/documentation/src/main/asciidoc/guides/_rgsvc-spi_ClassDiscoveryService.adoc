[[_rgsvc-spi_ClassDiscoveryService]]
...
This service is used by the xref:rgcms.adoc#_rgcms_classes_super_manpage-FixtureScripts[`FixtureScripts`] service to automatically locate any xref:rgcms.adoc#_rgcms_classes_super_manpage-FixtureScript[`FixtureScript`] implementations.
