...
|xref:rgant.adoc#_rgant_manpage-Action_command[`command()`]
...
|xref:rgant.adoc#_rgant_manpage-Action_domainEvent[`domainEvent()`]
...
|xref:rgant.adoc#_rgant_manpage-Action_hidden[`hidden()`]
|`EVERYWHERE`, `NOWHERE` +
(`NOWHERE`)
|indicates where (in the UI) the action should be hidden from the user.


|xref:rgant.adoc#_rgant_manpage-Action_invokeOn[`invokeOn()`]
...
|xref:rgant.adoc#_rgant_manpage-Action_publishing[`publishing()`]
|`AS_CONFIGURED`, `ENABLED`, `DISABLED` +
(`AS_CONFIGURED`)
...
|xref:rgant.adoc#_rgant_manpage-Action_restrictTo[`restrictTo()`]
...
|xref:rgant.adoc#_rgant_manpage-Action_semantics[`semantics()`]
...
|xref:rgant.adoc#_rgant_manpage-Action_typeOf[`typeOf()`]
|(none)
...
include::_rgant_manpage-Action_command.adoc[leveloffset=+1]
include::_rgant_manpage-Action_domainEvent.adoc[leveloffset=+1]
include::_rgant_manpage-Action_hidden.adoc[leveloffset=+1]
include::_rgant_manpage-Action_invokeOn.adoc[leveloffset=+1]
include::_rgant_manpage-Action_publishing.adoc[leveloffset=+1]
include::_rgant_manpage-Action_restrictTo.adoc[leveloffset=+1]
include::_rgant_manpage-Action_semantics.adoc[leveloffset=+1]
include::_rgant_manpage-Action_typeOf.adoc[leveloffset=+1]
