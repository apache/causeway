...
As an alternative to using the `@CollectionLayout` annotation, a dynamic layout using  xref:ug.adoc#_ugfun_object-layout_dynamic[`.layout.json`] file can be specified; for example:
