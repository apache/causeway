...
By and large the security mechanisms within Isis are transparent to the rest of the framework (the xref:ugvw.adoc[Wicket Viewer] and xref:ugvro.adoc[Restful Objects viewer], and the overall xref:rg.adoc#_rg_runtime[runtime]).
