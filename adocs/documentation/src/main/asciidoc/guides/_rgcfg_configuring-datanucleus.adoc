[[_rgcfg_configuring-datanucleus]]
...
Furthermore, DataNucleus will search for various other XML mapping files, eg `mappings.jdo`.  A full list can be found http://www.datanucleus.org/products/datanucleus/jdo/metadata.html[here].  The metadata in these XML can be used to override the annotations of annotated entities; see xref:ugbtb.adoc#_ugbtb_more-advanced_overriding-jdo-annotations[Overriding JDO Annotatons] for further discussion.


include::_rgcfg_configuring-datanucleus_properties.adoc[leveloffset=+1]
include::_rgcfg_configuring-datanucleus_persistence-xml.adoc[leveloffset=+1]
include::_rgcfg_configuring-datanucleus_eagerly-registering-entities.adoc[leveloffset=+1]
include::_rgcfg_configuring-datanucleus_disabling-persistence-by-reachability.adoc[leveloffset=+1]
include::_rgcfg_configuring-datanucleus_using-jndi-data-source.adoc[leveloffset=+1]
