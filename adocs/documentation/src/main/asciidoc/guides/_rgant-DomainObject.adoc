...
(`AS_CONFIGURED`)
|indicates whether each of the changed properties of an object should be submitted to the registered xref:rgsvc.adoc#_rgsvc_spi_AuditingService[`AuditingService`].
