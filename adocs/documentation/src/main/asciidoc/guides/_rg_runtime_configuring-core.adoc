...
|`true`,`false` +
(`true`)
|Whether objects' properties and collections can be edited directly (for objects annotated with xref:rgant.adoc#_rgant_manpage-DomainObject_editing[`@DomainObject#editing()`]); see xref:rg.adoc#_rg_runtime_configuring-core_isis-objects-editing[below] for further discussion.
...
|`true`,`false` +
(`true`)
|Whether an event should be posted if xref:rgant.adoc#_rgant_manpage-Action_domainEvent[`@Action#domainEvent()`] is not specified (is set to `ActionDomainEvent.Default`).
...
|`true`,`false` +
(`true`)
|Whether an event should be posted if xref:rgant.adoc#_rgant_manpage-Collection_domainEvent[`@Collection#domainEvent()`] is not specified (is set to `CollectionDomainEvent.Default`).
...
|`true`,`false` +
(`true`)
|Whether an event should be posted if xref:rgant.adoc#_rgant_manpage-DomainObject_createdLifecycleEvent[`@DomainObject#createdLifecycleEvent()`] is not specified (is set to `ObjectCreatedEvent.Default`).
...
|`true`,`false` +
(`true`)
|Whether an event should be posted if xref:rgant.adoc#_rgant_manpage-DomainObject_loadedLifecycleEvent[`@DomainObject#loadedLifecycleEvent()`] is not specified (is set to `ObjectLoadedEvent.Default`).
...
|`true`,`false` +
(`true`)
|Whether an event should be posted if xref:rgant.adoc#_rgant_manpage-DomainObject_persistingLifecycleEvent[`@DomainObject#persistingLifecycleEvent()`] is not specified (is set to `ObjectPersistingEvent.Default`).
...
|`true`,`false` +
(`true`)
|Whether an event should be posted if xref:rgant.adoc#_rgant_manpage-DomainObject_persistedLifecycleEvent[`@DomainObject#persistedLifecycleEvent()`] is not specified (is set to `ObjectPersistedEvent.Default`).
...
|`true`,`false` +
(`true`)
|Whether an event should be posted if xref:rgant.adoc#_rgant_manpage-DomainObject_removingLifecycleEvent[`@DomainObject#removingLifecycleEvent()`] is not specified (is set to `ObjectRemovingEvent.Default`).
...
|`true`,`false` +
(`true`)
|Whether an event should be posted if xref:rgant.adoc#_rgant_manpage-DomainObject_updatingLifecycleEvent[`@DomainObject#updatingLifecycleEvent()`] is not specified (is set to `ObjectUpdatingEvent.Default`).
...
|`true`,`false` +
(`true`)
|Whether an event should be posted if xref:rgant.adoc#_rgant_manpage-DomainObject_updatedLifecycleEvent[`@DomainObject#updatedLifecycleEvent()`] is not specified (is set to `ObjectUpdatedEvent.Default`).
...
|`true`,`false` +
(`true`)
|Whether an event should be posted if xref:rgant.adoc#_rgant_manpage-DomainObjectLayout_cssClassUiEvent[`@DomainObjectLayout#cssClassUiEvent()`] is not specified (is set to `CssClassUiEvent.Default`).
...
|`true`,`false` +
(`true`)
|Whether an event should be posted if xref:rgant.adoc#_rgant_manpage-DomainObjectLayout_iconUiEvent[`@DomainObjectLayout#iconUiEvent()`] is not specified (is set to `IconUiEvent.Default`).
...
|`true`,`false` +
(`true`)
|Whether an event should be posted if xref:rgant.adoc#_rgant_manpage-DomainObjectLayout_titleUiEvent[`@DomainObjectLayout#titleUiEvent()`] is not specified (is set to `TitleUiEvent.Default`).
...
|`true`,`false` +
(`true`)
|Whether an event should be posted if xref:rgant.adoc#_rgant_manpage-Property_domainEvent[`@Property#domainEvent()`] is not specified (is set to `PropertyDomainEvent.Default`).
...
Each entry can be optionally prefixed by "n:" specifying the relative order on the menu (corresponds to xref:rgant.adoc#_rgant_manpage-DomainServiceLayout_menuOrder[`@DomainServiceLayout#menuOrder()`]).
...
| `all`, `none` +
(`all`)
|Whether the changed properties of objects should be automatically audited (for objects annotated with xref:rgant.adoc#_rgant_manpage-DomainObject_auditing[`@DomainObject(auditing=Auditing.AS_CONFIGURED)`].

|`isis.services.` +
`command.actions`
| `all`, `ignoreSafe`, `none` (`all`)
|Whether actions should be automatically reified into commands (for actions annotated with xref:rgant.adoc#_rgant_manpage-Action_command[`@Action(command=CommandReification.AS_CONFIGURED)`].  +
...
| `all`, `none` +
(`all`)
|Whether changed objects should be automatically published (for objects annotated with xref:rgant.adoc#_rgant_manpage-DomainObject_publishing[`@DomainObject(publishing=Publishing.AS_CONFIGURED)`].

|`isis.services.` +
`publish.actions`
| `all`, `ignoreSafe`, `none` (`all`)
|Whether actions should be automatically published (for actions annotated with xref:rgant.adoc#_rgant_manpage-Action_publishing[`@Action(publishing=Publishing.AS_CONFIGURED)`]. +
...
|`TOP`, `LEFT` +
(`LEFT`)
|Default for label position for all properties if not explicitly specified using xref:rgant.adoc#_rgant_manpage-PropertyLayout_labelPosition[`@PropertyLayout#labelPosition()`]
...
Filtering is supported by the Wicket viewer, and by the xref:rg.adoc#_rg_services-api_manpage-WrapperFactory[`WrapperFactory`] domain service (provided the wrapper's execution mode is _not_ "skip rules").  However the Restful Objects viewer does _not_ currently support filtering.
