...
NOTE: TODO - using xref:rgant.adoc#_rgant_manpage-Parameter_mustSatisfy[`@Parameter#mustSatisfy()`], xref:rgant.adoc#_rgant_manpage-Property_mustSatisfy[`@Property#mustSatisfy()`]
