[[_ugbtb_more-advanced_decoupling]]
= Decoupling
...
include::_ugbtb_more-advanced_decoupling_db-schemas.adoc[leveloffset=+1]
include::_ugbtb_more-advanced_decoupling_mixins.adoc[leveloffset=+1]
include::_ugbtb_more-advanced_decoupling_contributions.adoc[leveloffset=+1]
include::_ugbtb_more-advanced_decoupling_vetoing-visibility.adoc[leveloffset=+1]
include::_ugbtb_more-advanced_decoupling_event-bus.adoc[leveloffset=+1]
include::_ugbtb_more-advanced_decoupling_pushing-changes.adoc[leveloffset=+1]
