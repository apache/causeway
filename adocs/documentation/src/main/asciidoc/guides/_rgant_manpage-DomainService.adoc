...
|xref:rgant.adoc#_rgant_manpage-DomainService_nature[`nature()`]
...
|xref:rgant.adoc#_rgant_manpage-DomainService_repositoryFor[`repositoryFor()`]
|
...
|`menuOrder()`
|
|Deprecated in 1.8.0; use instead xref:rgant.adoc#_rgant_manpage-DomainServiceLayout_menuOrder[`@DomainServiceLayout#menuOrder()`]
...
include::_rgant_manpage-DomainService_nature.adoc[leveloffset=+1]
include::_rgant_manpage-DomainService_repositoryFor.adoc[leveloffset=+1]
