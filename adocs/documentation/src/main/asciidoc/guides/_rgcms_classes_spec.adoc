...
The `Specification2` interface extends the `Specification` API to add support for i18n.  This is done by defining an additional method that returns a xref:rgcms.adoc#_rgcms_classes_i18n_manpage-TranslatableString[translatable string]:
