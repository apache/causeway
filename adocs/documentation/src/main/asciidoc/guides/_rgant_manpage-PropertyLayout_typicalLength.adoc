[[_rgant_manpage-PropertyLayout_typicalLength]]
= `typicalLength()`
...
The `typicalLength()` attribute indicates the typical length of a string property.  It is ignored for properties of other types.  The attribute is also supported for xref:rgant.adoc#_rgant_manpage-ParameterLayout_typicalLength[parameters].
