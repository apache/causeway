[[_rg_annotations_manpage-CollectionLayout_describedAs]]
= `describedAs()`
...
The `describedAs()` attribute is used to provide a short description of the collection to the user.  In the xref:ugvw.adoc#_ugvw[Wicket viewer] it is displayed as a 'tool tip'.
