...
The xref:rgsvc.adoc#_rgsvc-api_manpage-ActionInteractionContext[`ActionInteractionContext`] service allows xref:rgant.adoc#_rgant-Action_invokeOn[bulk actions] to co-ordinate with each other.

The xref:rgsvc.adoc#_rgsvc-api_manpage-QueryResultsCache[`QueryResultsCache`] is useful for caching the results of expensive method calls.
