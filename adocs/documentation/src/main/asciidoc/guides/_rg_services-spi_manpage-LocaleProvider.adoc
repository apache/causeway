...
Isis' xref:ugvw.adoc#_ugvw[Wicket viewer] provides an implementation of this service (`LocaleProviderWicket`) which leverages Apache Wicket APIs.
...
xref:ugvw.adoc#_ugvw[Wicket viewer] is being used, then an implementation of `LocaleProvider` is
