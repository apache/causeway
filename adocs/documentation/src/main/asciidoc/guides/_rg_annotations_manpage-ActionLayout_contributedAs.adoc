[[_rg_annotations_manpage-ActionLayout_contributedAs]]
= `contributedAs()`
...
In such cases, though, it would probably make more sense to annotate the action as either xref:rg.adoc#_rg_annotations_manpage-Action_hidden[hidden] or indeed xref:rg.adoc#_rg_annotations_manpage-Programmatic[`@Programmatic`].
