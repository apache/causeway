...
events are broadcast as a result of being specified in the xref:rgant.adoc#_rgant_manpage-Action_domainEvent[`@Action#domainEvent()`],  xref:rgant.adoc#_rgant_manpage-Property_domainEvent[`@Property#domainEvent()`] or xref:rgant.adoc#_rgant_manpage-Collection_domainEvent[`@Collection#domainEvent()`] attributes.
