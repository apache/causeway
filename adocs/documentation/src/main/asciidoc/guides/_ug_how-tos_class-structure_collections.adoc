[[_ug_how-tos_class-structure_collections]]
= Collections
...
One workaround is to mark the collection as xref:rg.adoc#_rg_annotations_manpage-Progammatic[`@Progammatic`].  This ensures that the collection is ignored by Apache Isis.
