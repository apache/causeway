...
One workaround is to mark the collection as xref:rg.adoc#_rg_annotations_manpage-Progammatic[`@Progammatic`].  This ensures that the collection is ignored by Isis.
