...
* `viewer_wicket.properties` - if the xref:ug.adoc#_ug_wicket-viewer[Wicket viewer] is in use

* `viewer_restfulobjects.properties` - if the xref:ug.adoc#_ug_restfulobjects-viewer[RestfulObjects viewer] is in use
