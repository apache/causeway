[[_ug_wicket-viewer_features_titles-in-tables]]
= Titles in Tables
...
[TIP]
====
It is also possible to configure the Wicket viewer to xref:ug.adoc#_ug_wicket-viewer_configuration-properties_abbreviating-titles[abbreviate titles or suppress them] completely.
====
