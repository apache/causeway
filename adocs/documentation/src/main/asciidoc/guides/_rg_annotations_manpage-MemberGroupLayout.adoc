[[_rg_annotations_manpage-MemberGroupLayout]]
= `@MemberGroupLayout`
...
The `@MemberGroupLayout` annotation specifies how an object's properties and collections are grouped together into columns, also specifying the relative positioning of those columns.  It works in conjunction with the xref:rg.adoc#_rg_annotations_manpage-MemberOrder[`@MemberOrder`] annotation.
