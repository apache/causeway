[[_rgcms_classes_super_manpage-AbstractFactoryAndRepository]]
...
This class extends xref:rgcms.adoc#_rgcms_classes_super_manpage-AbstractContainedObject[`AbstractContainedObject`].  Its
