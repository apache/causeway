[[_ugbtb_more-advanced_view-models]]
= View Models
...
include::_ugbtb_more-advanced_view-models_use-cases.adoc[leveloffset=+1]
include::_ugbtb_more-advanced_view-models_programming-model.adoc[leveloffset=+1]
include::_ugbtb_more-advanced_view-models_jaxb.adoc[leveloffset=+1]
