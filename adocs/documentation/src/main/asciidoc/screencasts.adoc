...
There are also a couple of screencasts on the Apache Isis documentation: link:https://www.youtube.com/watch?v=vJYeuVfrctc[using/searching^] docs, and link:https://www.youtube.com/watch?v=RQ_FFYd7npU[contributing patches/editing ^].
...
[cols="4a,1a,1a,1a,1a,1a,1a,1a,1a,1a,1a"]
|===
...
11+| [big]#*Fixture scripts, rules, tests*#
...
11+| [big]#*Swagger UI, Maven plugin*#
...
11+| [big]#*Titles and icons, UI event subscribers*#
...
11+| [big]#*More on fixture scripts*#
...
11+| [big]#*Page size of collections*#
...
11+| [big]#*Hints and end-user features*#
...
11+| [big]#*Decoupling (mixins & subscribers)*#
...
11+| [big]#*Titles using the @Title annotation*#
...
11+| [big]#*Integration testing of mixins*#
...
11+| [big]#*Instantiating/Initializing Objects*#
...
11+| [big]#*Property and parameter choices*#
...
11+| [big]#*Fixture scripts defaults / fake data*#
