...
_This screencast is for Isis v1.1.0 (ie very out of date)_
...
Learn more link:./user-guide/ug.html#_ug_appendices_dev-env_eclipse[here]
...
Learn more link:./user-guide/ug.html#_ug_appendices_dev-env_intellij[here]
...
Learn more link:./user-guide/ug.html#_ug_reference-object-layout[here]

|video::zmrg49WeEPc[youtube,width="420px",height="236px"]
...
_Interacting with the REST API using Chrome Plugins_
