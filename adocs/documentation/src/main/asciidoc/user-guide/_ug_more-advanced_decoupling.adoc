= anchor:more-advanced[]Decoupling
...
The xref:_assembling[following section] describes how to re-assemble an application, in particular where some modules are in-house but others are potentially third-party (eg the Isis Addons modules).
