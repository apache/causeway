...
The metadata for domain objects is obtained both xref:_ug_wicket-viewer_layout_static-object-layout[statically] and xref:_ug_wicket-viewer_layout_dynamic-object-layout[dynamically].
