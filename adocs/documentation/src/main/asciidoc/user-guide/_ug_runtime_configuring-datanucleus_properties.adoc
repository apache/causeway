= anchor:runtime_configuring_datanucleus[]Configuration Properties
...
Further xref:_registering_entity_types[discussion below].
...
Further xref:_disabling_persistence_by_reachability[discussion below].
