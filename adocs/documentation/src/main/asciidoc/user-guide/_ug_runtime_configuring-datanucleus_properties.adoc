...
Further xref:_ug_runtime_configuring-datanucleus_eagerly-registering-entities[discussion below].
...
Further xref:_ug_runtime_configuring-datanucleus_disabling-persistence-by-reachability[discussion below].
