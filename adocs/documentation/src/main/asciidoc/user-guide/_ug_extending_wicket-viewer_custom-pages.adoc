= anchor:extending_wicket-viewer[]Custom pages
...
| SIGN_UP
| The sign-up page (if xref:_user_registration[user registration] is enabled).

| SIGN_UP_VERIFY
| The sign-up verification page (if xref:_user_registration[user registration] is enabled; as accessed by link from verification email)
