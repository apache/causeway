...
This chapter tackles the topic of enabling access to an Isis application directly, or at least, not through either the <<_wicket_viewer, Wicket>> or <<_restfulobjects_viewer, Restful>> viewers.
