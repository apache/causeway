...
The xref:_ug_reference-services-api_manpage-BookmarkService[`BookmarkService`] provides a mechanism for obtaining a string representations of a single domain object.

The xref:_ug_reference-services-api_manpage-MementoService[`MementoService`] also provides a mechanism for generating string representations of domain objects.
