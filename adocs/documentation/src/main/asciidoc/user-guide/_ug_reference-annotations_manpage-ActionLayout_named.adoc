[[_ug_reference-annotations_manpage-ActionLayout_named]]
= `named()`
...
[NOTE]
====
This attribute can also be specified for xref:_ug_reference-annotations_manpage-CollectionLayout_named[collections], xref:_ug_reference-annotations_manpage-PropertyLayout_named[properties], xref:_ug_reference-annotations_manpage-ParameterLayout_named[action parameters], xref:_ug_reference-annotations_manpage-DomainObjectLayout_named[domain objects], xref:_ug_reference-annotations_manpage-ViewModelLayout_named[view models] and xref:_ug_reference-annotations_manpage-DomainServiceLayout_named[domain services].
====


By default, the name of the action as presented to the user is derived, reflectively, from the name of the member defined in the program code. To specify a different name use the `@ActionLayout(named=...)` annotation immediately before the member declaration.
