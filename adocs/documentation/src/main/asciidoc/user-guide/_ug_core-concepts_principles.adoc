= anchor:core-concepts[]Principles and Values
...
include::_ug_core-concepts_principles_your-apps.adoc[leveloffset=+1]
include::_ug_core-concepts_principles_isis-itself.adoc[leveloffset=+1]
include::_ug_core-concepts_principles_apache-isis-vs.adoc[leveloffset=+1]
