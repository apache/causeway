...
xref:_ug_wicket-viewer_layout_dynamic-object-layout[dynamic layout file]
can be specified, eg:
...
[TIP]
====
The similar xref:_ug_reference-annotations_manpage_DomainObjectLayout_cssClass[`@DomainObjectLayout#cssClass()`] annotation attribute is also used as a hint
