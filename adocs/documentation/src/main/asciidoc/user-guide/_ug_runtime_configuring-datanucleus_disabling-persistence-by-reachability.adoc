= anchor:runtime_configuring_datanucleus[]Disabling Persistence by Reachability
...
This change has been made to the xref:__a_id_getting_started_a_simpleapp_archetype[SimpleApp archetype]
