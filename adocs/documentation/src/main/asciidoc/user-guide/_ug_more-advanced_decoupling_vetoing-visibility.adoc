...
IMPORTANT: TODO - a write-up of the "vetoing subscriber" design pattern, eg as described in the  xref:_ug_reference-services-api_manpage-BookmarkService[`BookmarkService`]
