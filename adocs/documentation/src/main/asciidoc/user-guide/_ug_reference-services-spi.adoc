...
Apache Isis includes an extensive number of domain services for your domain objects to use; these are listed in xref:_ug_reference-services-api[Reference: Domain Services (API)].  But some of the services interfaces defined in the applib are intended to be used (primarily) not by your domain objects but instead by Isis itself.
