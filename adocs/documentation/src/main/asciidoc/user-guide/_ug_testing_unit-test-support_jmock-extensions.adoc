= anchor:testing_unit-test-support[]JMock Extensions
...
As noted earlier, for unit tests we tend to use link:http://jmock.org[JMock] as our mocking library.  The usual given/when/then format gets an extra step:
