...
The `ContentNegotiationService` is itself called by the (default implementation of) xref:_ug_reference-services-spi_manpage-RepresentationService[`RepresentationService`].