...
`honorUiHints`
| `true`,`false` (`_false_`)
| See xref:_ug_restfulobjects-viewer_configuration-properties_honor-ui-hints[discussion], below.

|`isis.viewer.restfulobjects.` +
`suppressDescribedByLinks`
| `true`,`false` (`_false_`)
.6+| See xref:_ug_restfulobjects-viewer_configuration-properties_suppressing-elements[discussion], below.
...
| `true`,`false` (`_false_`)
| See xref:_ug_restfulobjects-viewer_configuration-properties_simplified-object[discussion], below.
