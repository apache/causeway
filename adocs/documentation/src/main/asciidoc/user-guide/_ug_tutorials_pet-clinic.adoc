...
This is a step-by-step tutorial to build up a simple "petclinic" application, starting from the xref:__a_id_getting_started_a_simpleapp_archetype[SimpleApp archetype].
...
====
[source]
.DSL (http://yuml.me/edit/3db2078c[http://yuml.me/3db2078c]):
----
