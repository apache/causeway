...
This is a step-by-step tutorial to build up a simple "petclinic" application, starting from the xref:_ug_getting-started_simpleapp-archetype[SimpleApp archetype].
