...
The `EmailService` in particular requires additional xref:_ug_runtime_configuring-core[configuration properties] to specify the external SMTP service.