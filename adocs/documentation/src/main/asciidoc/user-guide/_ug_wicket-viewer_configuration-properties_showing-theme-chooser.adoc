...
Unless a xref:_ug_wicket-viewer_customisation_default-theme[default theme has been specified], the viewer uses the default bootstrap theme. However,
...
[TIP]
====
You can also develop and install a custom themes (eg to fit your company's look-n-feel/interface guidelines); see the xref:_ug_extending_wicket-viewer_custom-bootstrap-theme[Extending] chapter for further details.
====
