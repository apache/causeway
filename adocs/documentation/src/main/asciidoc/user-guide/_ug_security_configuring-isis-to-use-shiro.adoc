[[_ug_security_configuring-isis-to-use-shiro]]
...
[TIP]
====
The xref:_ug_getting-started_simpleapp-archetype[SimpleApp archetype] is pre-configured to use Apache Shiro, so much of what follows is set up already.
====

== Telling Isis to use Shiro
