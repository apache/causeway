...
See the earlier section on <<_datanucleus_enhancer,DataNucleus enhancer>> for details of the contents of the `pom.xml`.  Chances are it is already set up from running the <<_simpleapp_archetype, SimpleApp archetype>>.
