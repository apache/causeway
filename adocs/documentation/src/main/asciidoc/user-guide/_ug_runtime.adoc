...
[NOTE]
====
Configuration properties for the viewers can be found in the xref:_ug_wicket-viewer[Wicket Viewer] chapter and the <<Restful Objects Viewer>> chapter.  Likewise[details of configuring security (Apache Shiro) can be found in the xref:_ug_security[Security] chapter.
