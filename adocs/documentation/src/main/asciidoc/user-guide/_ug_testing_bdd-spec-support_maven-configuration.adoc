= anchor:testing_bdd-spec-support[]Maven Configuration
...
Apache Isis' BDD spec support is automatically configured if you use the xref:__a_id_getting_started_a_simpleapp_archetype[SimpleApp archetype].  To set it up manually, update the `pom.xml` of your domain object model module:
