...
Unlike xref:_ug_reference-annotations_manpage_PropertyLayout[`@PropertyLayout`], it (currently) isn't possible to specify layout hints for action parameters using the `.layout.json` file.
