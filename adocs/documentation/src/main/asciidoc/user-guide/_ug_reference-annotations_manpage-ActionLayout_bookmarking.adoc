...
This attribute is also supported for  xref:_ug_reference-annotations_manpage-DomainObjectLayout_bookmarking[domain objects].
...
[NOTE]
====
Note that this screenshot relates to a earlier version of the UI (specfically, pre 1.8.0).
====
