...
The default value for the attribute is `AS_CONFIGURED`, meaning that the xref:_ug_runtime_configuring-core[configuration property] `isis.services.audit.objects` is used to determine the whether the action is published:
