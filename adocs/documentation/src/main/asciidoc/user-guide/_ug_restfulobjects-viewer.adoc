= anchor:chapter[]Restful Objects Viewer
...
include::_ug_restfulobjects-viewer_configuration_properties.adoc[leveloffset=+1]
...
Discussed in xref:_extending_the_restful_viewer[Extending the Restful viewer].
