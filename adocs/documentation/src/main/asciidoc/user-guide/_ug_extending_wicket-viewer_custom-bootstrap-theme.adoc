[[_ug_extending_wicket-viewer_custom-bootstrap-theme]]
...
By default the viewer uses the default bootstrap theme. It is possible to configure the Wicket viewer to allow the user to xref:_ug_wicket-viewer_configuration-properties_showing-theme-chooser[select other themes] provided by http://bootswatch.com[bootswatch.com], and if required one of these can be xref:_ug_wicket-viewer_customisation_default-theme[set as the default].
