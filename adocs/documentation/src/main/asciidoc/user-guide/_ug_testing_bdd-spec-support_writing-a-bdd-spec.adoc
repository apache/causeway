...
* a system initializer class.  You can reuse the  system initializer from any integration tests (as described in xref:_ug_testing_integ-test-support[Integration Test Support], bootstrapping section).
