...
Here's an example of a feature from the xref:_simpleapp_archetype[SimpleApp archetype]:
...
The JSON formatter allows integration with enhanced reports, for example as provided by http://www.masterthought.net/section/cucumber-reporting[Masterthought.net] (screenshots at end of page). (Commented out) configuration for this is provided in the xref:_simpleapp_archetype[SimpleApp archetype].
