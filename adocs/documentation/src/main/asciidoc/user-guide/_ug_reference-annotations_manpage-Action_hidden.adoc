...
[NOTE]
====
This attribute can also be applied to xref:_ug_reference-annotations_manpage-Property_hidden[properties] and xref:_ug_reference-annotations_manpage-Collection_hidden[collections].
====
