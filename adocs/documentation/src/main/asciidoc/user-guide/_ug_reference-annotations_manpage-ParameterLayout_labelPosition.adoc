[[_ug_reference-annotations_manpage-ParameterLayout_labelPosition]]
= `labelPosition()`
...
To get an idea of how these are rendered (in the xref:_ug_wicket-viewer[Wicket viewer]), see xref:_ug_reference-annotations_manpage-PropertyLayout_labelPosition[PropertyLayout#labelPosition()].
