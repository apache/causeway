...
The xref:_ug_reference-services-api_manpage-ActionInteractionContext[`ActionInteractionContext`] service allows xref:_ug_reference-annotations_manpage_Action_invokeOn[bulk actions] to co-ordinate with each other.
