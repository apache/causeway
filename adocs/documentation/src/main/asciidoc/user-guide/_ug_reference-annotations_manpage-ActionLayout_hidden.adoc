...
[NOTE]
====
This attribute can also be applied to xref:_ug_reference-annotations_manpage-PropertyLayout_hidden[properties] and xref:_ug_reference-annotations_manpage-CollectionLayout_hidden[collections].
====
