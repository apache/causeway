...
For this, we recommend that you ensure that all such methods are tested through _an integration test_ (not unit test). For example, here's the corresponding integration test for the "Exclamation mark" example from the simpleapp (above):
