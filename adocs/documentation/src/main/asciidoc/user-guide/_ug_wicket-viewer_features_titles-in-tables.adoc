...
[TIP]
====
It is also possible to configure the Wicket viewer to xref:_ug_wicket-viewer_configuration-properties_abbreviating-titles[abbreviate titles or suppress them] completely.
====
