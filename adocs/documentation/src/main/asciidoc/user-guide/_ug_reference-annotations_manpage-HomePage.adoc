[[_ug_reference-annotations_manpage-HomePage]]
= `@HomePage`
...
----
<1> associated using xref:_ug_wicket-viewer_layout_dynamic-object-layout[dynamic layouts] with the `notYetComplete` collection.
