= anchor:testing_bdd-spec-support[]How it works
...
* These in turn are matched to http://cukes.info/step-definitions.html[step definition]s through regular expressions. +
+
