...
public class DatePeriod extends BusinessValue {
    ...
    public boolean isDatePeriod(BusinessValue object) {
    ...
    public void parseUserEntry(String text) throws ValueParseException {
        if (text.trim().equals("")) {
            ...
            getStart().parseUserEntry(text.substring(0, dash).trim());
            getEnd().parseUserEntry(text.substring(dash + 1).trim());
    ...
    public void restoreFromEncodedString(String data) {
        if (data == null || data.equals("NULL")) {
            ...
            getEnd().restoreFromEncodedString(data.substring(split + 1));
        }
    }
    ...
    public String asEncodedString() {
        if (getStart().isEmpty() || getEnd().isEmpty()) {
            ...
            return getStart().asEncodedString() + "~" + getEnd().asEncodedString();
        }
    }
