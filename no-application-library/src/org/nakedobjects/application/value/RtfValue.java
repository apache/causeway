 ...
 */
public class RtfValue extends BusinessValue {
     ...
     */
    public void copyObject(final BusinessValue other) {
     ...
     *                 different.
     */
    public boolean isSameAs(final BusinessValue other) {
     ...
     * data, and delegate to {@link #restoreFromEncodedString(String)}.
     * 
     ...
     *  
     */
    public void restoreFromEncodedString(String utf8Encoded) {
        if (utf8Encoded == null) {
            clear();
        } else {
    ...
    public void setValue(String value) {
        ...
        restoreFromEncodedString(value);
    }
