...
public class TextString extends BusinessValueHolder {
    ...
    /**
     * Creates a TextString containing a copy of the text in the specified
     * TextString.
     */
    ...
    /**
     * Returns true if the specified text is found withing this object. If
    ...
    /**
     * Returns true if the specified text is found at the end of this object's
     * text.
     */
    ...
    /**
     * Returns true if the specified text is found at the end of this object's
     * text. If caseSensitive is false then differences in case are ignored.
     */
    ...
    /**
     * delegates the comparsion to the <code>isSameAs(TextString)</code>
     * method if specified object is a <code>TextString</code> else returns
     * false.
     * 
    ...
    /**
     * Returns true if the specified text is the same as (for all characters)
     * the object's text.
     */
    ...
    /**
     * Returns true if the specified text is the same as (for all characters)
     * the object's text. If caseSensitive is false then differences in case are
     * ignored.
     */
    ...
    /**
     * Returns true if the specified text is found at the beginning of this
     * object's text.
     */
    ...
    /**
     * Returns true if the specified text is found at the beginning of this
     * object's text. If caseSensitive is false then differences in case are
     * ignored.
     */
