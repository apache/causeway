...
public class SimpleObjectData implements ObjectData {
    ...
    public SimpleObjectData(NakedObject object, boolean completeGraph, SimpleRemoteObjectFactory factory) {
        memento = new Memento(object);
    }
    
    public NakedObject recreateObject(LoadedObjects loadedObjects, NakedObjectContext context) {
        return memento.recreateObject(loadedObjects, context);
    }

    public void update(NakedObject object, LoadedObjects loadedObjects, NakedObjectContext context) {
