...
public class DefaultOidObjectMapping implements ObjectMapping {
    ...
    public String encodedObject(ObjectAdapter object) {
        try {
            ...
            JSONObject data = saveData(object, savedObject);
    ...
    protected JSONObject saveData(ObjectAdapter object, List<ObjectAdapter> savedObject) throws JSONException {
    ...
    static String encodedOid(Oid oid) {
        if (oid instanceof AggregatedOid) {
            AggregatedOid aoid = (AggregatedOid) oid;
            Oid parentOid = aoid.getParentOid();
    ...
    public ObjectAdapter decodeObject(String data) {
        ...
        try {
            ...
            ObjectAdapter object = readObject(jsonObject);
            return object;
        } catch (JSONException e) {
    ...
    protected ObjectAdapter readObject(JSONObject jsonObject) throws JSONException {
