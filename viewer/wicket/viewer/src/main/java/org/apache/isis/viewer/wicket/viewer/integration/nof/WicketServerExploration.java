 ...
 * 
 * <p>
 * TODO: this is currently only partly honoured; exploration actions are shown and the
 * correct object store is defaulted (ie in-memory); however Wicket Objects will always pop up a login dialog.
 */
