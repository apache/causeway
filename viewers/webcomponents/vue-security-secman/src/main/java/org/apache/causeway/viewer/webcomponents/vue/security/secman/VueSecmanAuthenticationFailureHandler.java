...
final class VueSecmanAuthenticationFailureHandler implements AuthenticationFailureHandler {

    private final VueSecmanPaths paths;

    VueSecmanAuthenticationFailureHandler(final VueSecmanPaths paths) {
        this.paths = paths;
    }
