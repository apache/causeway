...
final class VueSecmanAuthenticationSuccessHandler implements AuthenticationSuccessHandler {

    private final VueSecmanPaths paths;
    private final RequestCache requestCache;

    VueSecmanAuthenticationSuccessHandler(final VueSecmanPaths paths, final RequestCache requestCache) {
        this.paths = paths;
