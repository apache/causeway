...
import org.apache.causeway.viewer.webcomponents.vue.security.secman.CausewayModuleViewerWebcomponentsVueSecuritySecman;
...
@Import({
        ...
        CausewayModuleViewerWebcomponentsVueSecuritySecman.class,
        PetClinicDomainModule.class,
        PetClinicVueSecuredRouteController.class,
...
public class PetClinicVueSecuredApplication extends SpringBootServletInitializer {

    public static void main(final String[] args) {
        SpringApplication.run(PetClinicVueSecuredApplication.class, args);
    }
}
