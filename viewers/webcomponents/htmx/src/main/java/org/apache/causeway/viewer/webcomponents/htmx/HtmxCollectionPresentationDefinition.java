...
final class HtmxCollectionPresentationDefinition {
    ...
    static HtmxCollectionPresentationDefinition resource(
            final String logicalTypeName,
            final String safeSourceIdentifier,
            final String html) {
        final var cached = Objects.requireNonNull(html);
        return new HtmxCollectionPresentationDefinition(logicalTypeName, safeSourceIdentifier, () -> cached);
    }

    static HtmxCollectionPresentationDefinition reloadingResource(
            final String logicalTypeName,
            final String safeSourceIdentifier,
            final Supplier<String> content) {
        return new HtmxCollectionPresentationDefinition(logicalTypeName, safeSourceIdentifier, content);
    }
