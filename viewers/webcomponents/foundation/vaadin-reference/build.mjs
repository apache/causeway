...
const bundlePath = resolve(assets, 'vaadin-reference.js');
...
if (updatePolicy) {
  ...
  throw new Error(`Generated bundle checksum ${bundleSha256} does not match policy ${policy.bundleSha256}. Review the closure and run npm run update-policy deliberately.`);
}
const metadata = {
  bundle: {file: 'vaadin-reference.js', rawBytes: bundle.length, gzipBytes: bundleGzipBytes, sha256: bundleSha256},
  entryPoints: ['@vaadin/combo-box', '@vaadin/multi-select-combo-box'],
