...
export const COLLECTION_PEEK_STATE_EVENT = 'causeway-collection-peek-state-change';
export const COLLECTION_PEEK_DIAGNOSTIC_EVENT = 'causeway-collection-peek-diagnostic';
