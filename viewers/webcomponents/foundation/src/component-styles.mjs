...
cw-unreferenced-collections[data-causeway-unreferenced-state="loading"],
cw-unreferenced-collections[data-causeway-unreferenced-state="empty"],
cw-unreferenced-collections[data-causeway-unreferenced-state="error"],
cw-unreferenced-actions[data-causeway-unreferenced-state="loading"],
cw-unreferenced-actions[data-causeway-unreferenced-state="empty"],
cw-unreferenced-actions[data-causeway-unreferenced-state="error"] {
  display: none;
}
.causeway-layout-row {
  display: grid;
  gap: var(--causeway-layout-gap, var(--causeway-object-gap, 1rem));
  grid-template-columns: repeat(12, minmax(0, 1fr));
}
.causeway-layout-column {
  align-content: start;
  display: grid;
  gap: var(--causeway-layout-gap, var(--causeway-object-gap, 1rem));
  min-inline-size: 0;
}
.causeway-layout-column[data-causeway-layout-span="1"] { grid-column: span 1; }
.causeway-layout-column[data-causeway-layout-span="2"] { grid-column: span 2; }
.causeway-layout-column[data-causeway-layout-span="3"] { grid-column: span 3; }
.causeway-layout-column[data-causeway-layout-span="4"] { grid-column: span 4; }
.causeway-layout-column[data-causeway-layout-span="5"] { grid-column: span 5; }
.causeway-layout-column[data-causeway-layout-span="6"] { grid-column: span 6; }
.causeway-layout-column[data-causeway-layout-span="7"] { grid-column: span 7; }
.causeway-layout-column[data-causeway-layout-span="8"] { grid-column: span 8; }
.causeway-layout-column[data-causeway-layout-span="9"] { grid-column: span 9; }
.causeway-layout-column[data-causeway-layout-span="10"] { grid-column: span 10; }
.causeway-layout-column[data-causeway-layout-span="11"] { grid-column: span 11; }
.causeway-layout-column[data-causeway-layout-span="12"] { grid-column: span 12; }
.causeway-layout-fieldset,
.causeway-layout-tabgroup,
.causeway-metadata-fieldset {
  border: var(--causeway-object-group-border, 1px solid color-mix(in srgb, currentColor 24%, transparent));
  border-radius: var(--causeway-object-group-radius, 0.5rem);
  margin-block: 0.5rem;
  min-inline-size: 0;
  padding: var(--causeway-object-group-padding, 1rem);
}
.causeway-layout-tabgroup,
.causeway-layout-tab-panel {
  background: var(--causeway-surface, Canvas);
  box-sizing: border-box;
  inline-size: 100%;
  max-inline-size: 100%;
}
.causeway-layout-fieldset-heading,
.causeway-metadata-fieldset > legend {
  font-size: 1.1rem;
  font-weight: 700;
...
.causeway-layout-tablist {
  border-block-end: var(--causeway-object-group-border, 1px solid color-mix(in srgb, currentColor 24%, transparent));
  display: flex;
  flex-wrap: wrap;
  gap: 0.25rem;
  margin-block-end: 0.75rem;
}
.causeway-layout-tablist [role="tab"] {
  background: none;
  border: 0;
...
.causeway-layout-tablist [role="tab"][aria-selected="true"] {
  border-block-end-color: var(--causeway-object-tab-accent, LinkText);
  color: var(--causeway-object-tab-accent, LinkText);
  font-weight: 700;
}
.causeway-layout-tablist [role="tab"]:focus-visible,
.causeway-metadata-actions > summary:focus-visible {
  outline: 0.2rem solid var(--causeway-object-tab-accent, LinkText);
  outline-offset: 0.1rem;
}
.causeway-layout-tab-panel[hidden],
[data-causeway-layout-invalid] {
  display: none !important;
}
.causeway-metadata-fieldset {
  inline-size: 100%;
}
.causeway-metadata-actions {
  inset-block-start: 0.3rem;
  inset-inline-end: 0.65rem;
  position: absolute;
  z-index: 5;
}
.causeway-metadata-actions > summary {
  align-items: center;
  background: var(--causeway-surface, Canvas);
  border: var(--causeway-object-group-border, 1px solid color-mix(in srgb, currentColor 24%, transparent));
...
.causeway-metadata-actions > summary::-webkit-details-marker {
  display: none;
}
.causeway-metadata-actions-menu {
  background: var(--causeway-surface-raised, var(--causeway-surface, Canvas));
  border: var(--causeway-object-group-border, 1px solid color-mix(in srgb, currentColor 24%, transparent));
  border-radius: var(--causeway-object-group-radius, 0.5rem);
  box-shadow: 0 0.5rem 1.25rem color-mix(in srgb, CanvasText 18%, transparent);
  box-sizing: border-box;
...
.causeway-metadata-actions-menu > .causeway-object-actions {
  align-items: stretch;
  display: grid;
  margin: 0;
}
@media (max-width: 48rem) {
  .causeway-layout-column[data-causeway-layout-span] {
    grid-column: 1 / -1;
  }
}
...
cw-collection[data-causeway-collection-heading-actions] {
  align-items: center;
  column-gap: var(--causeway-collection-heading-action-gap, var(--causeway-associated-action-gap, 0.5rem));
  justify-content: flex-start;
  row-gap: 0;
}
cw-collection[data-causeway-collection-heading-actions] > [data-causeway-collection-heading] {
  flex: 1 1 12rem;
  min-inline-size: 0;
}
cw-collection[data-causeway-collection-heading-actions] > cw-action[data-causeway-associated-action] {
  --vaadin-button-height: var(--causeway-collection-heading-action-height, 2.25rem);
  align-self: center;
  flex: 0 1 auto;
  margin-block: 0;
}
cw-collection[data-causeway-collection-heading-actions] > cw-action[data-causeway-associated-action]:last-of-type {
  margin-inline-end: var(--causeway-space-4, 1rem);
}
cw-collection[data-causeway-collection-heading-actions] > cw-action[data-causeway-associated-action] .causeway-action > button {
  min-block-size: var(--causeway-collection-heading-action-height, 2.25rem);
  padding: var(--causeway-collection-heading-action-padding-block, 0.3rem) var(--causeway-collection-heading-action-padding-inline, 0.65rem);
}
...
cw-collection[data-causeway-action-group]:not([data-causeway-collection-heading-actions]) > cw-action[data-causeway-associated-action] {
  flex: 0 1 auto;
  margin-block-end: var(--causeway-associated-action-margin-block-end, 0.75rem);
  min-inline-size: 0;
}
@container cw-collection (max-width: 32rem) {
  cw-collection[data-causeway-collection-heading-actions] > [data-causeway-collection-heading] {
    flex-basis: 100%;
  }
  cw-collection[data-causeway-collection-heading-actions] > cw-action[data-causeway-associated-action]:first-of-type {
    margin-inline-start: var(--causeway-space-4, 1rem);
  }
  cw-collection[data-causeway-collection-heading-actions] > cw-action[data-causeway-associated-action] {
    margin-block-end: var(--causeway-space-3, 0.75rem);
  }
}
...
.causeway-object-column[data-span="3"] { grid-column: span 3; }
.causeway-object-column[data-span="4"] { grid-column: span 4; }
.causeway-object-column[data-span="5"] { grid-column: span 5; }
.causeway-object-column[data-span="6"] { grid-column: span 6; }
.causeway-object-column[data-span="7"] { grid-column: span 7; }
.causeway-object-column[data-span="8"] { grid-column: span 8; }
.causeway-object-column[data-span="9"] { grid-column: span 9; }
.causeway-object-column[data-span="10"] { grid-column: span 10; }
.causeway-object-column[data-span="11"] { grid-column: span 11; }
.causeway-object-column[data-span="12"] { grid-column: span 12; }
...
cw-action-results,
cw-action-results.causeway-action-results,
...
cw-action-results[data-causeway-presentation-style="DIALOG"],
cw-action-results[data-causeway-presentation-style="SIDEBAR"] {
...
cw-action-results[data-causeway-presentation-style="INLINE"] > :not(.causeway-result-dismiss),
.causeway-action-results[data-causeway-presentation-style="INLINE"] > :not(.causeway-result-dismiss) {
  max-block-size: var(--causeway-action-results-content-max-block-size, min(70dvh, 45rem));
  min-block-size: 0;
  overflow: auto;
...
.causeway-action-results-surface > :not(.causeway-result-dismiss) {
  min-inline-size: 0;
  order: 1;
}
cw-action-results > .causeway-result-dismiss,
.causeway-action-results > .causeway-result-dismiss,
.causeway-action-results-surface > .causeway-result-dismiss {
  align-self: end;
  flex: 0 0 auto;
  order: 2;
}
...
.causeway-action-results-surface > cw-standalone-collection .causeway-collection {
  margin-block-start: 0;
}
.causeway-action-results-surface {
  align-items: stretch;
  background: var(--causeway-action-results-surface-background, Canvas);
  border: var(--causeway-action-results-surface-border, 1px solid color-mix(in srgb, currentColor 25%, transparent));
  border-radius: var(--causeway-action-results-surface-radius, 0.5rem);
  box-shadow: var(--causeway-action-results-surface-shadow, 0 1rem 3rem color-mix(in srgb, #000 28%, transparent));
  box-sizing: border-box;
  color: var(--causeway-action-results-surface-color, CanvasText);
  display: flex;
  flex-direction: column;
  gap: var(--causeway-action-results-gap, 0.75rem);
  margin: 0;
  ...
  overflow: hidden;
  padding: var(--causeway-action-results-surface-padding, 1rem);
  z-index: var(--causeway-action-results-z-index, 1000);
}
.causeway-action-results-surface > :not(.causeway-result-dismiss) {
  max-block-size: var(--causeway-action-results-content-max-block-size, 100%);
  min-block-size: 0;
  overflow: auto;
  overscroll-behavior: contain;
}
.causeway-action-results-surface > cw-standalone-collection {
  flex: 1 1 auto;
}
.causeway-action-results-dialog {
  inset: 0;
  margin: auto;
  max-block-size: calc(100dvh - 2rem);
  inline-size: min(var(--causeway-action-results-dialog-width, 60rem), calc(100vw - 2rem));
}
.causeway-action-results-dialog::backdrop {
  background: var(--causeway-action-results-backdrop, rgb(0 0 0 / 42%));
}
.causeway-action-results-sidebar {
  block-size: 100dvh;
  border-block: 0;
  border-end-end-radius: 0;
  border-start-end-radius: 0;
  inset: 0 0 0 auto;
  inline-size: min(var(--causeway-action-results-sidebar-width, 32rem), calc(100vw - 1rem));
...
.causeway-property-disabled-tooltip {
  cursor: help;
  position: relative;
}
...
.causeway-property-disabled-tooltip:hover::after,
.causeway-property-disabled-tooltip:focus-visible::after {
  opacity: 1;
  transform: translateY(0);
  visibility: visible;
}
.causeway-member-tooltip,
.causeway-action-control-tooltip {
  cursor: help;
  position: relative;
}
...
.causeway-member-tooltip:hover::after,
.causeway-member-tooltip:focus-visible::after,
.causeway-action-control-tooltip:hover::after,
.causeway-action-control-tooltip:focus-visible::after,
.causeway-action-control-tooltip:focus-within::after {
  opacity: 1;
  transform: translateY(0);
  visibility: visible;
}
.causeway-action [data-causeway-action-control],
...
.causeway-action-prompt-description {
  color: var(--causeway-muted, GrayText);
  font-size: var(--causeway-action-description-font-size, 0.82em);
  line-height: 1.35;
  margin: 0;
}
.causeway-breadcrumbs-list {
  align-items: center;
  display: flex;
  flex-wrap: wrap;
  gap: 0.35rem;
...
.causeway-breadcrumbs-item + .causeway-breadcrumbs-item::before {
  content: "/";
  margin-inline-end: 0.35rem;
  opacity: 0.65;
}
.causeway-breadcrumbs-current {
  font-weight: 600;
}
.causeway-breadcrumbs .causeway-object-link-identity,
.causeway-object-header-link .causeway-object-link-identity {
  display: none;
}
...
.causeway-object-link-icon {
  align-self: center;
  block-size: var(--causeway-object-icon-size, 1.5rem);
  flex: 0 0 var(--causeway-object-icon-size, 1.5rem);
  inline-size: var(--causeway-object-icon-size, 1.5rem);
  object-fit: var(--causeway-object-icon-fit, contain);
}
...
.causeway-collection-search {
  ...
  margin-block-end: var(--causeway-collection-search-margin, 0.75rem);
}
.causeway-collection-search label {
  font-weight: 600;
}
.causeway-collection-search input {
...
.causeway-menubar-toolkit .causeway-menubar,
cw-menubar-control,
cw-menubar-control > vaadin-menu-bar {
  display: block;
  inline-size: 100%;
  max-inline-size: 100%;
  min-inline-size: 0;
...
cw-menubar-control {
  --lumo-body-text-color: var(--causeway-menubar-color, CanvasText);
  --lumo-primary-text-color: var(--causeway-menubar-color, CanvasText);
  --lumo-contrast-5pct: var(--causeway-menubar-control-background, transparent);
  --lumo-contrast-10pct: var(--causeway-menubar-control-active-background, color-mix(in srgb, LinkText 14%, transparent));
  --lumo-border-radius-m: var(--causeway-menubar-control-radius, 0.25rem);
  color: var(--causeway-menubar-color, CanvasText);
  font: inherit;
}
cw-menubar-control > vaadin-menu-bar {
  --vaadin-menu-bar-gap: var(--causeway-menubar-menu-gap, 0.25rem);
  background: var(--causeway-menubar-background, Canvas);
  color: inherit;
}
cw-menubar-control vaadin-menu-bar-button[focused] {
  outline: var(--causeway-menubar-focus, 0.2rem solid LinkText);
  outline-offset: 0.1rem;
}
.causeway-menubar-section-label {
  border-block-start: var(--causeway-menubar-section-border, 1px solid color-mix(in srgb, currentColor 18%, transparent));
  color: var(--causeway-menubar-section-color, currentColor);
  font: inherit;
  font-size: var(--causeway-menubar-section-font-size, 0.8em);
  font-weight: var(--causeway-menubar-section-font-weight, 700);
  margin-block-start: var(--causeway-menubar-section-margin, 0.25rem);
  opacity: 0.8;
  padding: var(--causeway-menubar-section-padding, 0.5rem 1rem 0.25rem);
  pointer-events: none;
}
.causeway-menu {
  min-inline-size: 0;
...
.causeway-pdf-zoom-select:focus-visible,
...
.causeway-pdf-toolbar > .causeway-value-lob {
  align-items: baseline;
  display: inline-flex;
  flex: 1 1 14rem;
  flex-wrap: wrap;
