...
.causeway-metadata-actions {
  border-block-start: var(--causeway-object-group-border, 1px solid color-mix(in srgb, currentColor 24%, transparent));
...
.causeway-metadata-actions > .causeway-object-actions {
