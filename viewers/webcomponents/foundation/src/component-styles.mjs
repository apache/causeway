...
.causeway-object-member-composition[data-causeway-associated-kind="collection"] {
  align-items: flex-start;
  display: flex;
  flex-wrap: wrap;
...
.causeway-object-member-composition[data-causeway-associated-kind="collection"] > .causeway-object-associated-actions {
  margin-block: 0 0.75rem;
}
.causeway-object-member-composition[data-causeway-associated-kind="collection"] > cw-collection {
  flex: 1 0 100%;
  min-inline-size: 0;
}
