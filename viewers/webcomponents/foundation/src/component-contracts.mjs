...
export const CausewayElementName = Object.freeze({
    ...
    ACTION: 'cw-action',
    ACTION_RESULTS: 'cw-action-results',
    ...
    UNREFERENCED_PROPERTIES: 'cw-unreferenced-properties',
    UNREFERENCED_COLLECTIONS: 'cw-unreferenced-collections',
    UNREFERENCED_ACTIONS: 'cw-unreferenced-actions',
...
export const CausewayHostClass = Object.freeze({
    ...
    ACTION_RESULTS: 'causeway-action-results',
    ...
    PDF_READER: 'causeway-pdf-reader',
    ...
    UNREFERENCED_PROPERTIES: 'causeway-unreferenced-properties',
    UNREFERENCED_COLLECTIONS: 'causeway-unreferenced-collections',
    UNREFERENCED_ACTIONS: 'causeway-unreferenced-actions',
...
export const CausewayAttribute = Object.freeze({
    ...
    PDF_INITIAL_PAGE: 'pdf-initial-page',
    PDF_ZOOM: 'pdf-zoom',
...
export const CausewaySemanticEvent = Object.freeze({
    ...
    PDF_READER_STATE: 'causeway-pdf-reader-state-change',
    PDF_READER_DIAGNOSTIC: 'causeway-pdf-reader-diagnostic',
    COLLECTION_STATE: 'causeway-collection-state-change',
    COLLECTION_CONFIGURATION: 'causeway-collection-configuration-change',
    COLLECTION_PREVIEW_STATE: 'causeway-collection-preview-state-change',
