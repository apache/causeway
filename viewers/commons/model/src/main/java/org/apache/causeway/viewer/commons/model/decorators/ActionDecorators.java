...
public class ActionDecorators {
    ...
    public static final class ActionDecorationModel {
            private final ObjectAction action;
            private final ActionStyle actionStyle;
            private final VisualRank visualRank;
            private final LabelIndent labelIndent;
        ...
        public static ActionDecorationModel of(
            ...
            var labelIndent = labelIndent(actionStyle);
        ...
        private static LabelIndent labelIndent(final ActionStyle actionStyle) {
        	switch (actionStyle) {
            	case BUTTON: return LabelIndent.NONE;
            	case MENU_ITEM: return LabelIndent.FORCE_ALIGNMENT_WITH_BLANK_ICON;
        	};
        	throw _Exceptions.unmatchedCase(actionStyle);
        }
