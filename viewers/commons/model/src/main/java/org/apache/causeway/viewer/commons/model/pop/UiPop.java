 ...
 *  under the License.
 */
package org.apache.causeway.viewer.commons.model.pop;
...
/**
 * PoP .. Property or Parameter
 */
public interface UiPop extends UiModel, HasMetaModelContext {
    ...
    public static enum ChoiceProviderSort {
        ...
        public static ChoiceProviderSort valueOf(final UiPop popModel) {
            if (popModel.hasChoices()) {
                return ChoiceProviderSort.CHOICES;
            } else if(popModel.hasAutoComplete()) {
                return ChoiceProviderSort.AUTO_COMPLETE;
            } else if(popModel.hasObjectAutoComplete()) {
