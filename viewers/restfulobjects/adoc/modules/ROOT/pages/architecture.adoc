...
+
The xref:core:runtime-services:RepresentationService.adoc[`RepresentationService`] is an SPI domain service (plugin-point)
...
xref:core:runtime-services:ContentNegotiationService.adoc[`ContentNegotiationService`], each one handling a particular
