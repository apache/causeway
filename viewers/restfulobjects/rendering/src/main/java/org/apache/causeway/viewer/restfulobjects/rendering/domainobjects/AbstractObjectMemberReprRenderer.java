...
extends ReprRendererAbstract<ManagedMember> {
    ...
    protected final VisibilityConstraint visibilityConstraint;
    ...
    public AbstractObjectMemberReprRenderer(
        ...
        this.visibilityConstraint = ResourceContext.visibilityConstraint(where);
    }
    ...
    protected Consent usability() {
        return objectMember.isUsable(objectAdapter, getInteractionInitiatedBy(), visibilityConstraint);
    }

    protected Consent visibility() {
        return objectMember.isVisible(objectAdapter, getInteractionInitiatedBy(), visibilityConstraint);
    }
