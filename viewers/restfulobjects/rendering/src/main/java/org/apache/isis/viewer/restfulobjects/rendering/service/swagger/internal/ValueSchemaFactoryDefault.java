...
@Component
@Named(IsisModuleViewerRestfulObjectsApplib.NAMESPACE + ".ValueSchemaFactoryDefault")
public class ValueSchemaFactoryDefault implements ValueSchemaFactory {
    ...
    public ValueSchemaFactoryDefault() {
        ...
        propertyFactoryByClass.put(org.apache.isis.applib.value.Blob.class, ByteArraySchema::new);
