...
implements DomainObjectResource {
    ...
    public ResponseEntity<Object> modifyProperty(
        ...
        PropertyInteraction
            .start(objectAdapter, propertyId, resourceContext.visibilityConstraint())
            .checkVisibility()
    ...
    public ResponseEntity<Object> clearProperty(
        ...
        PropertyInteraction.start(objectAdapter, propertyId, resourceContext.visibilityConstraint())
        .checkVisibility()
        .checkUsability(AccessIntent.MUTATE)
