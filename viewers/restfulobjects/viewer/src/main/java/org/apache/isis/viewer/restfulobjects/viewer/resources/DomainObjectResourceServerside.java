...
import org.apache.isis.commons.io.UrlUtils;
...
import org.apache.isis.viewer.restfulobjects.rendering.util.RequestParams;
...
//    }
    ...
    public Response invokeActionQueryOnly(
        ...
        final String urlUnencodedQueryString = UrlUtils.urlDecodeUtf8(
                xIsisUrlEncodedQueryString != null
                    ? xIsisUrlEncodedQueryString
