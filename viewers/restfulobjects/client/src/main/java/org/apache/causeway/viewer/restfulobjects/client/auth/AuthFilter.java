...
public class AuthFilter implements ClientRequestFilter {
    ...
    public static AuthFilter of(final AuthorizationHeaderFactory authorizationHeaderFactory) {
    ...
    public void filter(final ClientRequestContext requestContext) throws IOException {
        requestContext.getHeaders().add("Authorization", authorizationHeaderFactory.create());
    }
