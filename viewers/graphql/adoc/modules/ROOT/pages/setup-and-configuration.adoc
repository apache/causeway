...
* xref:refguide:config:sections/causeway.viewer.graphql.adoc#causeway.viewer.graphql.top-level-field-name-for-simple[top-level-field-name-for-simple]
+
...
* xref:refguide:config:sections/causeway.viewer.graphql.adoc#causeway.viewer.graphql.top-level-field-name-for-rich[top-level-field-name-for-rich]
+
...
* xref:refguide:config:sections/causeway.viewer.graphql.adoc#causeway.viewer.graphql.include-testing-field-in-rich[include-testing-field-in-rich]
+
Enable xref:about.adoc#testing[testing support].
