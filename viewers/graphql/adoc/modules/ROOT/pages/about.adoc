...
Because the "rich" schema exposes pretty much all of the behaviour of the domain model, it's possible to use GraphQL queries as a way to write end-to-end tests.
This works especially well with approval tests, which can be used to efficiently assert the contents of the returned response.
