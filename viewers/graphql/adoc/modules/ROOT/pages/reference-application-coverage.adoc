...
. Implement `<causeway-object>` after accepted value and collection capabilities, safe effective-grid retrieval, and correct object interactions.
. Implement `<causeway-menubars>` after application entry points, safe menu-resource retrieval, and correct service-action inputs.
