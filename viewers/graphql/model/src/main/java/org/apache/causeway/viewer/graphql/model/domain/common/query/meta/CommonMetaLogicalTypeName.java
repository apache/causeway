...
public class CommonMetaLogicalTypeName extends Element {

    public CommonMetaLogicalTypeName(final Context context) {
        super(context);
    ...
    protected String fetchData(DataFetchingEnvironment environment) {
        return environment.<CommonMetaFetcher>getSource().logicalTypeName();
    }
