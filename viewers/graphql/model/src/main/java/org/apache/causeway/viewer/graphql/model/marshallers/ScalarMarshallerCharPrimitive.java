...
public class ScalarMarshallerCharPrimitive extends ScalarMarshallerAbstract<Character> {
    ...
    @Override
    public Character unmarshal(final Object graphValue, final Class<?> targetType) {
        return ((String)graphValue).charAt(0);
    }
}
