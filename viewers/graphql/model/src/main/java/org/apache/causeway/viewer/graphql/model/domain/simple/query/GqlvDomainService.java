...
public class GqlvDomainService
    ...
    private final static SchemaType SCHEMA_TYPE = SchemaType.SIMPLE;
    ...
    public static GqlvDomainService of(
        ...
        return context.simpleDomainServiceBySpec.computeIfAbsent(objectSpecification, spec -> new GqlvDomainService(spec, servicePojo, context));
    }
