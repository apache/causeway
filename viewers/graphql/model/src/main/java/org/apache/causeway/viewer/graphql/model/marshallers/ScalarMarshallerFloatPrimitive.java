...
public class ScalarMarshallerFloatPrimitive extends ScalarMarshallerAbstract<Float> {
    ...
    @Override
    public Float unmarshal(final Object graphValue, final Class<?> targetType) {
        return ((Double) graphValue).floatValue();
    }
}
