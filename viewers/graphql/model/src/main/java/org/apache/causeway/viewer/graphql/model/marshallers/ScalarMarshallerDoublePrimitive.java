...
public class ScalarMarshallerDoublePrimitive extends ScalarMarshallerAbstract<Double> {
    ...
    @Override
    public Double unmarshal(final Object graphValue, final Class<?> targetType) {
        return (Double)graphValue;
    }
}
