...
public class RichTopLevelMutation
    ...
    private final List<RichMutationForAction> actions = new ArrayList<>();
    private final List<RichMutationForProperty> properties = new ArrayList<>();

    public RichTopLevelMutation(final Context context) {
