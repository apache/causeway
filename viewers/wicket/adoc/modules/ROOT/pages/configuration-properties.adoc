...
//
//Note though that if a xref:system:generated:index/applib/annotation/HomePage.adoc[@HomePage] action exists, then that will take precedence.
//
...
//|`hidden`, `table` +
//(`hidden`)
//|Default for the default view for all (parented) collections if not explicitly specified using xref:system:generated:index/applib/annotation/CollectionLayout.adoc#defaultView[`@CollectionLayout#defaultView()`]
//
//By default the framework renders (parented) collections as "hidden", ie collapsed.
//These can be overridden on a case-by-case basis using the xref:system:generated:index/applib/annotation/CollectionLayout.adoc#defaultView[`@CollectionLayout#defaultView()`] or the corresponding `<collectionLayout defaultView="...">` element in the `Xxx.layout.xml` layout file.
//
...
//|`TOP`, `LEFT` +
//(`LEFT`)
//|Default for label position for all properties if not explicitly specified using xref:system:generated:index/applib/annotation/PropertyLayout.adoc#labelPosition[`@PropertyLayout#labelPosition()`]
//
//
...
//
//The property can be overridden on a property-by-property basis using xref:system:generated:index/applib/annotation/PropertyLayout.adoc#promptStyle[`@Property#promptStyle()`]) or  xref:system:generated:index/applib/annotation/ActionLayout.adoc#promptStyle[`@Action#promptStyle()`]).
//
