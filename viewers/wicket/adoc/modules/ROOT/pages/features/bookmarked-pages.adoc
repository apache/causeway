...
The Wicket viewer supports the bookmarking of both domain objects and query-only (xref:system:generated:index/applib/annotation/Action.adoc#semantics[@Action(semantics=...)]) actions.
...
To indicate a class is bookmarkable, use the xref:system:generated:index/applib/annotation/DomainObjectLayout.adoc[@DomainObjectLayout] annotation:
...
To indicate that a safe (query only) action is bookmarkable, use the xref:system:generated:index/applib/annotation/ActionLayout.adoc[@ActionLayout] annotation:
