...
public class IsisEnvelopeEvent extends IsisEventAbstract {
    ...
    /**
     * Opens the event, checks the event is an {@link org.apache.causeway.viewer.wicket.model.hints.IsisEnvelopeEvent envelope} (event),
     * fetches the {@link org.apache.causeway.viewer.wicket.model.hints.IsisEventLetterAbstract letter} (event) inside, and
