...
implements
    ...
    public final void detach() {
        if(isDataTableModelDetachable()) {
            // at time of writing breaks object deletion on JDO, see [ISIS-3530]
            super.detach();
        }
        //FIXME[ISIS-3522]
    ...
    private final static String PROPERTY_NAME_MODEL_REUSE = "isis.viewer.wicket.dataTableModelReuse";
    /**
