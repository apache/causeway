...
extends HasBookmarkedOwnerAbstract<ActionInteraction> {
    ...
    private ActionInteractionWkt(
            ...
            final Where where,
            /**
             *[ISIS-3648] Optional in support of the composite value type's 'Xxx_default' mixin,
    ...
    public final ObjectAction getMetaModel() {
        ...
        //[ISIS-3648] In support of the composite value type's 'Xxx_default' mixin.
    ...
    /**
     * [ISIS-3649] safe guard against access to the model while it is not attached
     */
