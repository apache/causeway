...
public class ManagedActionWkt
extends HasBookmarkedOwnerAbstract<ManagedAction> {
    ...
    @Override
    protected ManagedAction load() {
        return ManagedAction.lookupAction(getBookmarkedOwner(), memberId, where)
