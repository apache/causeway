 ...
 */
public class PopPanelTextFieldWithValueSemantics<T>
extends PopPanelTextFieldAbstract<T> {

    private static final long serialVersionUID = 1L;

    public PopPanelTextFieldWithValueSemantics(
            final String id,
    ...
    protected final Optional<IConverter<T>> converter() {
        return popModel().getConverter(type);
    }
