 ...
 */
class TitleBadgeAttributePanel<T> extends ValueAttributePanel<T> {

    private static final long serialVersionUID = 1L;

    public TitleBadgeAttributePanel(final String id, final UiAttributeWkt attributeModel, final Class<T> type) {
