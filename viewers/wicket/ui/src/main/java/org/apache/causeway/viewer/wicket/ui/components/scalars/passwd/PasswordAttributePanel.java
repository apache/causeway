 ...
 */
class PasswordAttributePanel
extends ValueAttributePanel<Password> {

    private static final long serialVersionUID = 1L;

    public PasswordAttributePanel(final String id, final UiAttributeWkt attributeModel) {
        super(id, attributeModel, Password.class);
    }
