 ...
 */
public class Jdk8LocalTimePanel
extends ScalarPanelTextFieldWithTemporalPickerAbstract<LocalTime> {

    private static final long serialVersionUID = 1L;

    public Jdk8LocalTimePanel(final String id, final ScalarModel scalarModel) {
