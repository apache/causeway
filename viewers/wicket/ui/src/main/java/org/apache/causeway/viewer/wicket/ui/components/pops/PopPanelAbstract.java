...
import org.apache.causeway.viewer.wicket.ui.components.pops.PopFragmentFactory.RegularFrame;
import org.apache.causeway.viewer.wicket.ui.components.pops.blobclob.CausewayBlobOrClobPanelAbstract;
import org.apache.causeway.viewer.wicket.ui.components.pops.bool.BooleanPanel;
import org.apache.causeway.viewer.wicket.ui.components.pops.choices.ObjectChoicesSelect2Panel;
import org.apache.causeway.viewer.wicket.ui.components.pops.choices.ValueChoicesSelect2Panel;
...
public abstract class PopPanelAbstract
...
implements PopModelChangeListener {
    ...
    public enum RenderScenario {
        ...
        static RenderScenario inferFrom(final PopPanelAbstract popPanel) {
            val popModel = popPanel.popModel();
            if(!popModel.getRenderingHint().isRegular()) {
                return COMPACT;
            }
            if(popModel.isParameter()
                    && !(popPanel instanceof PopPanelSelectAbstract)
     ...
     * ({@link PopPanelAbstract}, {@link ObjectChoicesSelect2Panel}, {@link ValueChoicesSelect2Panel})
    ...
    protected PopPanelAbstract(final String id, final PopModel popModel) {
        super(id, popModel);
    ...
    implements PopModelChangeDispatcher, Serializable {
        ...
        public void notifyUpdate(final AjaxRequestTarget target) {
            ...
            _Xray.onParamOrPropertyEdited(popPanel);
    ...
    @Override
    public void onError(final AjaxRequestTarget target, final PopPanelAbstract popPanel) {
    }
