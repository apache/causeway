 ...
 */
public class ObjectLinkSimplePanel
extends FormComponentPanelAbstract<ManagedObject>
implements CancelHintRequired, HasMetaModelContext  {

    private static final long serialVersionUID = 1L;

    private static final String ID_OBJECT_ICON_AND_TITLE = "objectIconAndTitle";
    private static final String ID_OBJECT_TITLE_NULL = "objectTitleNull";

    public ObjectLinkSimplePanel(final String id, final IModel<ManagedObject> model) {
        super(id, model);
    ...
    private void buildGui() {
        ...
        if(isEmpty) {
            ...
            Wkt.markupAdd(this, ID_OBJECT_TITLE_NULL,
                    getPlaceholderRenderService().asHtml(PlaceholderLiteral.NULL_REPRESENTATION));
            permanentlyHide(ID_OBJECT_ICON_AND_TITLE);

        } else {

            var componentFactory = getComponentFactoryRegistry()
                    .findComponentFactory(UiComponentType.OBJECT_ICON_AND_TITLE, objectModelForLink);

            final Component component = componentFactory
                    .createComponent(ID_OBJECT_ICON_AND_TITLE, objectModelForLink);
            ...
            permanentlyHide(ID_OBJECT_TITLE_NULL);
        }
    }
