...
import org.apache.causeway.viewer.wicket.ui.components.scalars.AttributeFragmentFactory.FieldFragment;
...
/**
 *  Adds inline prompt logic on top of the underling {@link AttributePanel}.
 */
...
extends AttributePanel {
    ...
    protected AttributePanelWithInlinePrompt(final String id, final UiAttributeWkt attributeModel) {
    ...
    private void addAdditionalButtonsTo(
        ...
        for(var additionalButton : AttributePanelAdditionalButton.values()) {
    ...
    private void clearBootstrapFileInputField() {
        if(this instanceof AttributePanelWithFormField) {
            var formContainer = ((AttributePanelWithFormField<?>)this);
