...
import org.apache.causeway.viewer.wicket.ui.components.scalars.AttributeFragmentFactory.RegularFrame;
...
implements AttributeModelChangeListener {
   ...
   private boolean isCurrentlyRenderedAsUsable() {
       ...
       return _Casts.castTo(AttributePanelWithFormField.class, this)
           .map(AttributePanelWithFormField::getFormComponent)
