...
import org.apache.causeway.viewer.wicket.ui.components.attributes.AttributePanelWithTextField;
 ...
 */
public class ValueAttributePanel<T>
extends AttributePanelWithTextField<T> {

    private static final long serialVersionUID = 1L;

    public ValueAttributePanel(
            final String id,
