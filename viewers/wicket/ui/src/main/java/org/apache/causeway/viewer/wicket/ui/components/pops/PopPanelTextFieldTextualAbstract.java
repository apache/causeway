...
/**
 * Specialization of {@link PopPanelTextFieldAbstract},
 * where the scalar (parameter or property) is a value-type, that is
 * textual and requires no conversion.
 */
public abstract class PopPanelTextFieldTextualAbstract
extends PopPanelTextFieldAbstract<String> {

    private static final long serialVersionUID = 1L;

    protected PopPanelTextFieldTextualAbstract(
            final String id, final PopModel popModel) {
        super(id, popModel, String.class);
    }
