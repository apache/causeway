...
@UtilityClass
public class PopFragmentFactory {
    ...
    public static enum CompactFragment {
        ...
        public <T extends Component> Fragment createFragment(
            ...
            fragment.add(componentFactory.apply(PopPanelAbstract.ID_SCALAR_VALUE));
            return fragment;
        }
        /**
         * @param id - Where to 'put' the fragment
    ...
    public static enum PromptFragment {
        LABEL("fragment-prompt-label", promptLabelModel->
            Wkt.label(PopPanelAbstract.ID_SCALAR_VALUE, promptLabelModel)),
        TEXTAREA("fragment-prompt-textarea", promptLabelModel->
            Wkt.textArea(PopPanelAbstract.ID_SCALAR_VALUE, promptLabelModel)),
