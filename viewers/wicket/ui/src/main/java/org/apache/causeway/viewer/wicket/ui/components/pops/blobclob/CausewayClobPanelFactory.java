 ...
 */
public class CausewayClobPanelFactory extends ComponentFactoryPopTypeConstrainedAbstract {

    private static final long serialVersionUID = 1L;

    public CausewayClobPanelFactory() {
        super(CausewayClobPanel.class, org.apache.causeway.applib.value.Clob.class);
    }

    @Override
    public Component createComponent(final String id, final PopModel popModel) {
        return new CausewayClobPanel(id, popModel);
    }
