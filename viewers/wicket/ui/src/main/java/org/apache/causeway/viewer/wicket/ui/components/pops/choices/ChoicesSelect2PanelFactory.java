...
import org.apache.causeway.viewer.wicket.ui.components.pops.string.ScalarTitleBadgePanel;
...
extends ComponentFactoryPopAbstract {
    ...
    public ChoicesSelect2PanelFactory() {
        super(PopPanelAbstract.class);
    }

    @Override
    protected PopPanelAbstract createComponent(final String id, final PopModel popModel) {
