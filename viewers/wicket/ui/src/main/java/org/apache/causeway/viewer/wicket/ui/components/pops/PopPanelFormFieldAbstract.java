...
public abstract class PopPanelFormFieldAbstract<T>
extends PopPanelAbstract2 {
    ...
    protected PopPanelFormFieldAbstract(
            final String id,
...
//                            prop->""+prop.getPendingPropertyModel().getValueAsTitle().getValue()));
        ...
        if(renderScenario.isReadonly()) {
            ...
            // link stuff is handled later in PopPanelAbstract2.setupInlinePrompt
