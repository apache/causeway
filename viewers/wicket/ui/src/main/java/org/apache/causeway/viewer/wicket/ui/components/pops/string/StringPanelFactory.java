...
public class StringPanelFactory extends ComponentFactoryPopTypeConstrainedAbstract {
    ...
    public Component createComponent(final String id, final PopModel popModel) {
        return Facets.multilineIsPresent(popModel.getMetaModel())
            ? new MultiLineStringPanel(id, popModel)
            : new StringPanel(id, popModel);
    }
}
