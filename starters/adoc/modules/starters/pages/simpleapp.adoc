...
As with the xref:docs:starters:helloworld.adoc[HelloWorld] starter app, this will download a very simple one-class domain model, namely the `SimpleObject` entity and a supporting `SimpleObjects` domain service.
...
image::simpleapp/using/010-root-page.png[width="600px",link="{imagesdir}/simpleapp/using/010-root-page.png"]

Choose the generic Wicket UI, and navigate to the login page:

image::simpleapp/using/020-login-to-wicket-viewer.png[width="600px",link="{imagesdir}/simpleapp/using/020-login-to-wicket-viewer.png"]
...
image::simpleapp/using/030-home-page.png[width="600px",link="{imagesdir}/simpleapp/using/030-home-page.png"]
...
image::simpleapp/using/032-run-fixture-script-prompt.png[width="600px",link="{imagesdir}/simpleapp/using/032-run-fixture-script-prompt.png"]

This brings up a dialog to select the fixture script:

image::simpleapp/using/033-run-fixture-script-prompt.png[width="600px",link="{imagesdir}/simpleapp/using/033-run-fixture-script-prompt.png"]
...
image::simpleapp/using/034-run-fixture-script-result.png[width="600px",link="{imagesdir}/simpleapp/using/034-run-fixture-script-result.png"]

Navigating back to the home page shows the newly created objects:

image::simpleapp/using/036-home-page-after-fixture-scriptpng.png[width="600px",link="{imagesdir}/simpleapp/using/036-home-page-after-fixture-scriptpng.png"]
...
image::simpleapp/using/040-create-object-from-menu.png[width="600px",link="{imagesdir}/simpleapp/using/040-create-object-from-menu.png"]

To avoid obscuring the current page, this is configured to bring up a sidebar dialog:

image::simpleapp/using/050-create-object-from-menu-prompt.png[width="600px",link="{imagesdir}/simpleapp/using/050-create-object-from-menu-prompt.png"]

Hitting OK returns the created object:

image::simpleapp/using/060-created-object.png[width="600px",link="{imagesdir}/simpleapp/using/060-created-object.png"]
...
image::simpleapp/using/070-update-name.png[width="600px",link="{imagesdir}/simpleapp/using/070-update-name.png"]
...
----
<.> Publishing enabled means that the action invocation is converted into XML and dispatched to all configured implementations of the xref:refguide:applib-svc:PublisherService.adoc[PublisherService] SPI.
+
The framework provides a default implementation that just logs the interaction:
+
image::simpleapp/using/075-publish-logging-1.png[width="600px",link="{imagesdir}/simpleapp/using/075-publish-logging-1.png"]
+
It also logs the fact that the object itself was modified:
+
image::simpleapp/using/076-publish-logging-2.png[width="600px",link="{imagesdir}/simpleapp/using/076-publish-logging-2.png"]
...
image::simpleapp/using/080-edit-notes.png[width="600px",link="{imagesdir}/simpleapp/using/080-edit-notes.png"]
...
image::simpleapp/using/090-delete-object.png[width="600px",link="{imagesdir}/simpleapp/using/090-delete-object.png"]

The viewer displays a message confirming that the object has been deleted:

image::simpleapp/using/100-object-deleted.png[width="600px",link="{imagesdir}/simpleapp/using/100-object-deleted.png"]
...
image::simpleapp/using/200-swagger-ui-before-reload.png[width="600px",link="{imagesdir}/simpleapp/using/200-swagger-ui-before-reload.png"]
...
image::simpleapp/using/210-simpleapp-resources.png[width="600px",link="{imagesdir}/simpleapp/using/210-simpleapp-resources.png"]

For example, an object can be created using the resource that represents the `SimpleObjects#create` action:

image::simpleapp/using/220-create-object-thru-rest-api.png[width="600px",link="{imagesdir}/simpleapp/using/220-create-object-thru-rest-api.png"]
...
image::simpleapp/using/230-create-object-thru-rest-api-response.png[width="600px",link="{imagesdir}/simpleapp/using/230-create-object-thru-rest-api-response.png"]

The Swagger UI also provides a resource to retrieve any object:

image::simpleapp/using/240-retrieve-object-using-rest-api.png[width="600px",link="{imagesdir}/simpleapp/using/240-retrieve-object-using-rest-api.png"]

This results in a representation of the domain object (as per the requested `Response Content Type`, ie `ACCEPT` header):

image::simpleapp/using/250-retrieve-object-using-rest-api-response.png[width="600px",link="{imagesdir}/simpleapp/using/250-retrieve-object-using-rest-api-response.png"]
...
.Module Dependencies
image::simpleapp/simpleapp-modules-dependencies.png[width="800px",link="{imagesdir}/simpleapp/simpleapp-modules-dependencies.png"]
...
These use the xref:refguide:applib-svc:WrapperFactory.adoc[WrapperFactory] to simulate interactions through the UI.
...
Optional (though if omitted then only xref:userguide:fun:building-blocks.adoc#view-models[view models] may be used, with hand-rolled persistence).
...
image::simpleapp/simpleapp-webapp.png[width="600px",link="{imagesdir}/simpleapp/simpleapp-webapp.png"]

which uses an IntelliJ feature to run a different run configuration to run DataNucleus enhancer beforehand:

image::simpleapp/simpleapp-webapp-before-launch.png[width="600px",link="{imagesdir}/simpleapp/simpleapp-webapp-before-launch.png"]
