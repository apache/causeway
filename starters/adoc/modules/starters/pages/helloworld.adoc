...
<8> Normally configuration properties are picked up from Spring Boot's `application.properties` or `application.yaml` files, but additional properties can be overridden directly.
