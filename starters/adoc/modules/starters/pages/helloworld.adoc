...
This will download a tiny Apache Isis app, consisting of a simple one-class domain model, namely the `HelloWorldObject` entity and a supporting `HelloWorldObjects` repository domain service.
...
image::helloworld/using/010-root-page.png[width="600px",link="{imagesdir}/helloworld/using/010-root-page.png"]

Choose the generic Wicket UI, and navigate to the login page:

image::helloworld/using/020-login-to-wicket-viewer.png[width="600px",link="{imagesdir}/helloworld/using/020-login-to-wicket-viewer.png"]
...
image::helloworld/using/030-home-page.png[width="600px",link="{imagesdir}/helloworld/using/030-home-page.png"]
...
image::helloworld/using/040-create-object-from-menu.png[width="600px",link="{imagesdir}/helloworld/using/040-create-object-from-menu.png"]

which brings up a modal dialog:

image::helloworld/using/050-create-object-from-menu-prompt.png[width="600px",link="{imagesdir}/helloworld/using/050-create-object-from-menu-prompt.png"]

hitting OK returns the created object:

image::helloworld/using/060-created-object.png[width="600px",link="{imagesdir}/helloworld/using/060-created-object.png"]
...
image::helloworld/using/070-update-name.png[width="600px",link="{imagesdir}/helloworld/using/070-update-name.png"]
...
+
image::helloworld/using/075-logged-action.png[width="600px",link="{imagesdir}using/075-logged-action.png"]
...
image::helloworld/using/080-edit-notes.png[width="600px",link="{imagesdir}/helloworld/using/080-edit-notes.png"]
...
image::helloworld/using/090-delete-object.png[width="600px",link="{imagesdir}/helloworld/using/090-delete-object.png"]

The viewer displays a message confirming that the object has been deleted:

image::helloworld/using/100-object-deleted.png[width="600px",link="{imagesdir}/helloworld/using/100-object-deleted.png"]
...
image::helloworld/using/200-swagger-ui-before-reload.png[width="600px",link="{imagesdir}/helloworld/using/200-swagger-ui-before-reload.png"]
...
image::helloworld/using/210-helloworld-resources.png[width="600px",link="{imagesdir}/helloworld/using/210-helloworld-resources.png"]

For example, an object can be created using the resource that represents the `HelloWorldObjects#create` action:

image::helloworld/using/220-create-object-thru-rest-api.png[width="600px",link="{imagesdir}/helloworld/using/220-create-object-thru-rest-api.png"]
...
image::helloworld/using/230-create-object-thru-rest-api-response.png[width="600px",link="{imagesdir}/helloworld/using/230-create-object-thru-rest-api-response.png"]

The Swagger UI also provides a resource to retrieve any object:

image::helloworld/using/240-retrieve-object-using-rest-api.png[width="600px",link="{imagesdir}/helloworld/using/240-retrieve-object-using-rest-api.png"]

This results in a representation of the domain object (as per the requested `Response Content Type`, ie `ACCEPT` header):

image::helloworld/using/250-retrieve-object-using-rest-api-response.png[width="600px",link="{imagesdir}/helloworld/using/250-retrieve-object-using-rest-api-response.png"]
...
image::helloworld/helloworld.png[width="600px",link="{imagesdir}/helloworld/helloworld.png"]

which uses an IntelliJ feature to execute a different _Run Configuration_ for the DataNucleus enhancer beforehand:

image::helloworld/helloworld-before-launch.png[width="600px",link="{imagesdir}/helloworld/helloworld-before-launch.png"]
