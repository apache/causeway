...
public class MockObjectPersistor extends AbstracObjectPersistor {

    public static MockObjectPersistor setup() {
        MockObjectPersistor manager;
        manager = new MockObjectPersistor();
        manager.reset();
        return manager;
    }
    ...
    public NakedObject getObject(Oid oid, NakedObjectSpecification hint) {
        ...
        if(nakedObject == null) {
            throw new NakedObjectRuntimeException("No object to get for " + oid);
        }
        return nakedObject;
    }
    ...
    public void setupMakePersistentOid(Oid oid) {
        this.oid = oid;
    }

    public void setupMakePersistentVersion(Version version) {
