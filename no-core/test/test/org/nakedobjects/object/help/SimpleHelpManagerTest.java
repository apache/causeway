...
public class SimpleHelpManagerTest extends TestCase {
    ...
    public void testNoLines() {
        MemberIdentifier identifier = new MemberIdentifierImpl("cls", "mth");
    ...
    public void testClass() {
        ...
        MemberIdentifier identifier = new MemberIdentifierImpl("cls");
        String s = manager.help(identifier);
    ...
    public void testFieldWithNoEntry() {
        ...
        MemberIdentifier identifier = new MemberIdentifierImpl("cls", "fld2");
        String s = manager.help(identifier);
        assertEquals("", s);
    }
