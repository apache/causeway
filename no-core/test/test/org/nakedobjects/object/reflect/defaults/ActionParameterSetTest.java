...
import test.org.nakedobjects.object.defaults.MockNakedObjectSpecificationLoaderNew;
...
public class ActionParameterSetTest extends TestCase {
    ...
    public void testMultipleParameters() {
        ActionParameterSet parameters = new ActionParameterSetImpl(new Object[] { new Date(), new String(), new Vector() },
    ...
    public void testMultipleParametersWithNoDefault() {
        ActionParameterSet parameters = new ActionParameterSetImpl(new Object[] { new Date(), null, new Vector() },
                new String[3], new boolean[3]);
        parameters.checkParameters("methodName", parameterSpecs);
    }

    public void testMultipleParametersWithWrongType() {
        ActionParameterSet parameters = new ActionParameterSetImpl(new Object[] { new Date(), new Integer(10), new Vector() },
                new String[3], new boolean[3]);
    ...
    public void testZeroParameters() {
        ...
        ActionParameterSet parameters = new ActionParameterSetImpl(new Object[0], new String[0], new boolean[0]);
