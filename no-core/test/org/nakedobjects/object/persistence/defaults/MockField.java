...
public class MockField extends NakedObjectField {
    ...
    protected Naked get(NakedObject fromObject) {
        ReferencedObject referencedObject = ((TestObject) fromObject.getObject()).getReferencedObject();
        return NakedObjects.getPojoAdapterFactory().createNOAdapter(referencedObject);
    }
