...
public class MockValueField implements ValueField {
    ...
    public MockValueField(Method method, String name, Method aboutMethod, Method validMethod) {
        this.method = method;
        this.name = name;
    ...
    public void saveValue(NakedObject inObject, String encodeValue) throws InvalidEntryException {}
