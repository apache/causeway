...
public class MockRole extends MockNakedObject {
    ...
    public void aboutPerson(FieldAbout about, MockPerson person) {}

    public void associatePerson(MockPerson person) {
        setPerson(person);
    }

    public void dissociatePerson(MockPerson person) {
        setPerson(null);
    }
    ...
    public void setPerson(MockPerson v) {
        person = v;
    }
