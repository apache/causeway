...
public class AssociationTest extends NakedObjectTestCase {
    ...
    public void setUp()  throws ObjectStoreException {
        ...
        personField = (OneToOneAssociation) c.getField(PERSON_FIELD);
    ...
    public void testName() {
    	assertEquals(PERSON_FIELD, personField.getName());
    }
    
    public void testLabel() {
    	assertEquals(PERSON_FIELD, personField.getLabel(new SecurityContext(), object));
    }
