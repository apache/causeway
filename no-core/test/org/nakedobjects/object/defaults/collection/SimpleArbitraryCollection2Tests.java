...
public class SimpleArbitraryCollection2Tests extends TestCase {
     ...
     *  
     */
    private Role[] setupCollection(AbstractNakedCollectionVector collection, int size) throws ObjectStoreException {
    ...
    public void testElements() throws ObjectStoreException {
        AbstractNakedCollectionVector collection = new ArbitraryCollectionVector();
        collection.setContext(context);
    ...
    public void testTitle() {
        AbstractNakedCollectionVector ac = new ArbitraryCollectionVector("Objects");
