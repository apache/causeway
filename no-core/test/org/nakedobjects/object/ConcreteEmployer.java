...
public class ConcreteEmployer extends Employer {
    private InternalCollection employees = new InternalCollection(Employee.class, this);
    ...
    public void setIntraCompanyTeam(ArbitraryCollection newIntraCompanyTeam) {
