...
public interface Reflector {
    ...
    /**
     * The name of this reflector's class's superclass. Returns null if this reflector's class does
     * not extend a class that implements the Naked interface.
     */
    ...
    /**
     * The natural language (eg english, spanish) name in the plural form - for a number of objects
     * of this type.
     */
    String pluralName();
    ...
    /**
     * The natural language (eg english, spanish) name in the singular form - for a single object of
     * this type.
     */
    String singularName();
