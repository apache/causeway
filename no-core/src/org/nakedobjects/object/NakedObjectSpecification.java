...
public interface NakedObjectSpecification {
     ...
     * the be accomodated as there should always a specification available even though it might not be
     * complete.
     */
    void introspect();
    ...
    /**
     * Returns true if this specification represents a collection of objects; will be adapted using a
     * NakedCollection.
     */
    ...
    /**
     * Determines if this specification respresents the same specification, or a subclass, of the specified
     * specification.
     */
