...
public abstract class SimpleTypedCollection extends AbstractVectorCollection implements TypedNakedCollection {
    private NakedObjectSpecification specification;

    public SimpleTypedCollection(Class type) {
        this(NakedObjectSpecification.getNakedClass(type));
    }

    public SimpleTypedCollection(NakedObjectSpecification specification) {
        this.specification = specification;
    }

    public SimpleTypedCollection(String typeName) {
        this(NakedObjectSpecification.getNakedClass(typeName));
    }
