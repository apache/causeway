...
public class SimpleArbitraryCollection extends AbstractVectorCollection implements ArbitraryNakedCollection {
    private final TextString name = new TextString();

    public SimpleArbitraryCollection() {
        super();
    }
     ...
     */
    public SimpleArbitraryCollection(final String name) {
        this();
        setName(name);
    }
