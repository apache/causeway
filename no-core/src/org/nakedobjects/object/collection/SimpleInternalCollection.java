...
public class SimpleInternalCollection extends SimpleTypedCollection implements InternalCollection {
    private NakedObject parent;
    
    public SimpleInternalCollection(Class type, NakedObject parent) {
        super(type);
        this.parent = parent;
    }

    public SimpleInternalCollection(String typeName, NakedObject parent) {
        super(typeName);
        this.parent = parent;
    }
