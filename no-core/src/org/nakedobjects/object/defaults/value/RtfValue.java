...
* 
* This is a little risky, but just using <code>data.getBytes(&quot;UTF-8&quot;)</code>.
* This perhaps should be replaced with UUDecoding, or (more fundamentally) the NakedValue
* interface should change.
* <p>
* But the above *might* do (haven't tested this out yet), because RTF uses either 7-bit or
* (for MS Word) 8-bit character sets and no more.   To quote the RTF 1.5 spec:
* <pre>
...
public class RtfValue extends AbstractNakedValue {
	 ...
	 * 
	 * For RtfValues, we expect the string to be a UTF-8 encoding of binary data, and delegate to
	 * {@link #restoreString(String)}.
	 * 
