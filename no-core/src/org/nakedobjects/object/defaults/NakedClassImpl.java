...
public class NakedClassImpl implements NakedClass {
    ...
    private NakedObject newInstance() {
        ...
        if (createPersistentInstances) {
            try {
                ...
                object = NakedObjects.getObjectLoader().createAdapterForTransient(new Error("Failed to create instance of " + this, e));
