...
public class LocalNakedClassManager extends NakedClassManager {
    ...
    protected NakedClass loadClass(String name) throws ObjectNotFoundException, ObjectStoreException {
