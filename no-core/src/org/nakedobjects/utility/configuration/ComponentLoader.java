...
public class ComponentLoader {
    ...
    public static Object loadComponent(String className, Class requiredClass) throws ConfigurationException {
        return loadComponent(className, null, requiredClass);
    }
    
    public static Object loadComponent(String className, Class defaultType, Class requiredClass) throws ConfigurationException {
