...
public class SecurityContext {
	public final static Logger LOG = Logger.getLogger(SecurityContext.class);
	...
	public SecurityContext(Certificate certificate, User user) {
	...
	public String toString() {
		...
		return "SecurityContext [user=" + (user == null ? "none" : user.getName().stringValue()) + ",roles=" + rls + "]";
	}
}
