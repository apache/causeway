...
public class ExplorationSetUp {
    ...
    protected final NakedObject createInstance(Class type) {
        NakedObjectSpecification nc = NakedObjectSpecification.getNakedClass(type.getName());
    ...
    protected final boolean needsInstances(String className) {
        return !objectManager.hasInstances(NakedObjectSpecification.getNakedClass(className));
    }
