...
Or, you can just start coding using one of the http://isis.apache.org/guides/ugfun/ugfun.html#_ugfun_getting-started_helloworld-archetype[Maven archetype]s.
