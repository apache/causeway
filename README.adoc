...
Explore features with our daily built demo docker image https://github.com/apache/isis/blob/master/examples/demo/demo-domain/src/main/adoc/modules/demo/pages/about.adoc["DemoApp"]. 
