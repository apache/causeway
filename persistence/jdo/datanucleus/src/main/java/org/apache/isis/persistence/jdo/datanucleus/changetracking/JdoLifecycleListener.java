...
import org.apache.isis.persistence.jdo.datanucleus.entities.DnStateManagerForIsis;
...
DetachLifecycleListener, DirtyLifecycleListener, LoadLifecycleListener, StoreLifecycleListener {
    ...
    public void preDirty(final InstanceLifecycleEvent event) {
        ...
        DnStateManagerForIsis.extractFrom(pojo).ifPresentOrElse(
                stateManager->
     ...
     * @see org.apache.isis.persistence.jpa.applib.integration.IsisEntityListener#onPreUpdate(Object)
     * @see org.apache.isis.persistence.jpa.applib.integration.IsisEntityListener#gatherPropertyChangeRecords(ManagedObject)
     */
    ...
    private boolean isInserting(
            final @NonNull Persistable pojo) {
        return DnStateManagerForIsis.extractFrom(pojo)
                .map(DnStateManagerForIsis::isInsertingOrInsertingCallbacks)
                .orElse(false);
    }
