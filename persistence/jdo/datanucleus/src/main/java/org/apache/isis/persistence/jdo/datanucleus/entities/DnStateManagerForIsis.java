 ...
 */
@Log4j2
public class DnStateManagerForIsis
extends ReferentialStateManagerImpl {

    public DnStateManagerForIsis(final ExecutionContext ec, final AbstractClassMetaData cmd) {
        super(ec, cmd);
    }
    ...
    public static Optional<DnStateManagerForIsis> extractFrom(final @Nullable Persistable pojo) {
        return pojo!=null
                ? _Casts.castTo(DnStateManagerForIsis.class, pojo.dnGetStateManager())
                : Optional.empty();
    }
