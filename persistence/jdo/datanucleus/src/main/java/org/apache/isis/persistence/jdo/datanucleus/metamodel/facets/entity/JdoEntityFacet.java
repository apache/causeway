...
import org.apache.isis.core.metamodel.facets.object.entity.EntityOrmMetadata;
...
import org.apache.isis.persistence.jdo.datanucleus.entities.DnOidStoreAndRecoverHelper;
...
implements EntityFacet {
    ...
    public boolean isInjectionPointsResolved(final Object pojo) {
        if(pojo instanceof Persistable) {
            DnStateManagerForIsis.extractFrom((Persistable) pojo)
            .map(DnStateManagerForIsis::injectServicesIfNotAlready)
            .orElse(false);
        }
        return pojo==null;
    }
