...
To set other EclipseLink configuration properties, use a subclass of xref:refguide:persistence:index/jpa/eclipselink/IsisModuleJpaEclipselink.adoc[] and override `getVendorProperties()`.
