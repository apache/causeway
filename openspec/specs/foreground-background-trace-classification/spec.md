# foreground-background-trace-classification Specification

## Purpose
TBD - created by archiving change classify-foreground-background-traces. Update Purpose after archive.
