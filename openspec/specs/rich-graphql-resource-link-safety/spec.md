# Rich GraphQL Resource-Link Safety Specification

## Purpose

Define valid same-origin resource references, independent structural and value-content policies, authorization rechecks, and compatible migration for rich GraphQL resources.
