# Service Registry Lifecycle Safety Specification

## Purpose

Define service-registry selection behavior while the Spring context is active and after context closure has begun.
