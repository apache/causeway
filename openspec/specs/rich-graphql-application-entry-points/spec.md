# Rich GraphQL Application Entry Points Specification

## Purpose

Define discoverable, authorized, localized, and framework-neutral application menus and configured home-page resolution for rich GraphQL clients.
