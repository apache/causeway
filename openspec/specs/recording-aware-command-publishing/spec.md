...
Defines how command-log recording support broadens safe-action and property-edit command-publishing eligibility while preserving normal publication flow, opt-outs, suppression, and disabled-mode compatibility.
