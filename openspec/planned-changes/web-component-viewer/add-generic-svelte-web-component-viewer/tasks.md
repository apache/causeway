...
- [ ] 2.2 Implement the generic route page with one object context and `<causeway-object>` fallback.
- [ ] 2.3 Dispose disconnected requirements and superseded component loaders deterministically across SvelteKit navigation.
- [ ] 2.4 Verify `<causeway-object>` never reads SvelteKit route or page-registry state.

## 3. Shell, Upgrade, Events, and Policy

- [ ] 3.1 Implement the stable SvelteKit layout, `<causeway-menubars>` placement, page slot, and route lifecycle states.
...
- [ ] 4.2 Test custom-element attributes, properties, slots, native events, upgrade ordering, route reuse, disconnect, and selected SSR behavior.
