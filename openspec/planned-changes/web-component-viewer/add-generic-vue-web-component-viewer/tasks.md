...
- [ ] 2.3 Key page lifecycle by canonical bookmark identity and dispose disconnected requirements deterministically.
- [ ] 2.4 Verify `<causeway-object>` never reads Vue router or page-registry state.

## 3. Shell, Events, and Policy

- [ ] 3.1 Implement the stable Vue shell, `<causeway-menubars>` placement, `RouterView` page region, and route lifecycle states.
...
- [ ] 4.2 Test custom-element attributes, properties, slots, native events, upgrade ordering, disconnect, and route reuse.
