...
| 6 | `expand-vaadin-semantic-editor-families` *(active)* | Qualify free-core adapters beyond reference controls with independent lazy closures and CSP gates. | Corrected codecs and Reference Application family journeys pass. |
