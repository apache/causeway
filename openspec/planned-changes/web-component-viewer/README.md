...
The archived `add-paged-graphql-reference-autocomplete` change adds honest bounded server response windows before the planned Vaadin expansion and default sequence in `vaadin-default-roadmap.md`.
