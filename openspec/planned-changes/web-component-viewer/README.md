...
The next change should be a focused versionless-identity and preparation correction, followed by separate union-projection and opaque-route corrections before the proposal-only paged-autocomplete and Vaadin-default sequence in `vaadin-default-roadmap.md`.
