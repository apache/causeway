...
The current active change is `fix-webcomponent-union-projection-correctness`, followed by opaque-route handling before the proposal-only paged-autocomplete and Vaadin-default sequence in `vaadin-default-roadmap.md`.
