...
When replay notifies the listener with a recorded result bookmark and a different actual result bookmark, the listener SHALL remember the actual bookmark for the recorded bookmark.
...
When the same recorded bookmark is notified more than once with different actual result bookmarks, the listener SHALL use the most recent actual bookmark for later remapping.
