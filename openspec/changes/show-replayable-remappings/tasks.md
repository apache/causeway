...
- [x] 2.1 Add a remappings collection to `ReplayableCommand` that parses command targets from the recorded command DTO.
...
- [x] 3.3 Update `ReplayableCommand.layout.fallback.xml` to show the remappings collection as a table.
...
- [x] 4.5 Run `openspec validate show-replayable-remappings --strict`.
