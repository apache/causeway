...
A later replayable action command targeting an ordinary domain object SHALL report exportable `true` when an earlier command result establishes that object.
