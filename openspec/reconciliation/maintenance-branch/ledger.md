...
| CAUSEWAY-3989 | Initial command replay and YAML baseline | Main retains the earlier baseline | Adapt | D1, P2, and E1 reconciled |
...
| Later background-completion specs | B1, B2 | Global pending-background detection, recording rejection, row/unified/legacy replay gates, and bounded replay pause/continuation reconciled | Adapt | Completed by `reconcile-command-background-gates` |
...
| `reconcile-command-background-gates` | B1, B2 | `openspec/specs/command-recording-background-completion/spec.md`; `openspec/specs/command-replay-background-completion/spec.md`; `openspec/specs/replayable-command-projection/spec.md`; `openspec/specs/unified-command-manager/spec.md` | `openspec/changes/archive/2026-08-07-reconcile-command-background-gates/` | Planning `98ab364c990`; implementation `e9706db67ee`; archive `b868014751b`; focused applib and JPA tests plus the full affected 40-project reactor under JDK 21, strict OpenSpec validation, JDO-absence, persistence-scope, and whitespace checks passed |
| `guard-service-selection-during-context-shutdown` | CAUSEWAY-4002 | `openspec/specs/service-registry-lifecycle-safety/spec.md` | `openspec/changes/archive/2026-08-07-guard-service-selection-during-context-shutdown/` | Planning `d3c5046854c`; implementation `0bf08ca664e`; archive `f54e19c91ec`; focused lifecycle regression and shutdown integration tests plus the full affected 40-project reactor under JDK 21 and strict OpenSpec validation passed |
