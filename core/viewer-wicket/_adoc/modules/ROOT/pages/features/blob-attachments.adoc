...
The Apache Isis application library provides the xref:rg:cms:classes/value-types/Blob.adoc[Blob] value type (binary large objects) and also the xref:rg:cms:classes/value-types/Clob.adoc[Clob]
