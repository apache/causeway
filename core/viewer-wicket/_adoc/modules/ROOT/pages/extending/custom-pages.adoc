...
| SIGN_UP
| The sign-up page (if xref:refguide:applib-svc:persistence-layer-spi/UserRegistrationService.adoc[user registration] is enabled).

| SIGN_UP_VERIFY
| The sign-up verification page (if xref:refguide:applib-svc:persistence-layer-spi/UserRegistrationService.adoc[user registration] is enabled; as accessed by link from verification email)
