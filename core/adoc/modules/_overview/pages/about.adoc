...
****
com.h2database:h2:jar:<managed> +
org.apache.isis.extensions:isis-extensions-commandlog-jdo:jar:<managed> +
org.apache.isis.extensions:isis-extensions-commandlog-jpa:jar:<managed> +
org.apache.isis.extensions:isis-extensions-exceldownload-ui:jar:<managed> +
...
****
org.apache.isis.examples.apps:demo-domain:jar:${project.version} +
org.apache.isis.extensions:isis-extensions-commandreplay-primary:jar:<managed> +
org.apache.isis.extensions:isis-extensions-commandreplay-secondary:jar:<managed> +
...
.Document Index Entries
****
xref:refguide:extensions:index/excel/applib/IsisModuleExtExcelApplib.adoc[IsisModuleExtExcelApplib], xref:refguide:extensions:index/excel/applib/dom/AggregationType.adoc[AggregationType], xref:refguide:extensions:index/excel/applib/dom/ExcelMetaDataEnabled.adoc[ExcelMetaDataEnabled], xref:refguide:extensions:index/excel/applib/dom/ExcelService.adoc[ExcelService], xref:refguide:extensions:index/excel/applib/dom/HyperLink.adoc[HyperLink], xref:refguide:extensions:index/excel/applib/dom/PivotColumn.adoc[PivotColumn], xref:refguide:extensions:index/excel/applib/dom/PivotDecoration.adoc[PivotDecoration], xref:refguide:extensions:index/excel/applib/dom/PivotRow.adoc[PivotRow], xref:refguide:extensions:index/excel/applib/dom/PivotValue.adoc[PivotValue], xref:refguide:extensions:index/excel/applib/dom/RowHandler.adoc[RowHandler], xref:refguide:extensions:index/excel/applib/dom/WorksheetContent.adoc[WorksheetContent], xref:refguide:extensions:index/excel/applib/dom/WorksheetSpec.adoc[WorksheetSpec], xref:refguide:extensions:index/excel/applib/util/AnnotationList.adoc[AnnotationList], xref:refguide:extensions:index/excel/applib/util/AnnotationTriplet.adoc[AnnotationTriplet], xref:refguide:extensions:index/excel/applib/util/ExcelFileBlobConverter.adoc[ExcelFileBlobConverter], xref:refguide:extensions:index/excel/applib/util/Mode.adoc[Mode], xref:refguide:extensions:index/excel/applib/util/PivotUtils.adoc[PivotUtils], xref:refguide:extensions:index/excel/applib/util/SheetPivoter.adoc[SheetPivoter]
****
...
----
Group: org.apache.isis.extensions
Artifact: isis-extensions-commandlog-jdo
Type: jar
Directory: /extensions/core/commandlog/jdo
----
|.Components
****
...
----
Group: org.apache.isis.extensions
Artifact: isis-extensions-commandlog-jpa
Type: jar
Directory: /extensions/core/commandlog/jpa
----
|.Components
****
...
Type: jar
Directory: /extensions/core/commandreplay/primary
----
...
Type: jar
Directory: /extensions/core/commandreplay/secondary
----
