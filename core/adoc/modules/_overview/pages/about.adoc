...
o.a.i.persistence.commons.integration.changetracking.EntityChangeTrackerDefault$TransactionSubscriber +
...
org.apache.causeway.core:causeway-core-internaltestsupport:jar:<managed> +
org.apache.causeway.persistence:causeway-persistence-jpa-integration:jar:<managed> +
org.eclipse.persistence:org.eclipse.persistence.jpa:jar:2.7.13 +
...
org.webjars:font-awesome:jar:6.4.2 +
****
...
skinparam rectangle<<Extensions.ApacheCausewayExtLayoutGitHub>> {
  BackgroundColor #438dd5
  FontColor #fffffe
  BorderColor #2e6295
  shadowing false
}
skinparam rectangle<<Extensions.ApacheCausewayExtLayoutGitHubLoader>> {
  BackgroundColor #438dd5
  FontColor #fffffe
  BorderColor #2e6295
  shadowing false
...
skinparam rectangle<<Extensions.ApacheCausewayExtTabularApplib>> {
  BackgroundColor #438dd5
  FontColor #fffffe
  BorderColor #2e6295
  shadowing false
}
skinparam rectangle<<Extensions.ApacheCausewayExtTabularExcel>> {
  BackgroundColor #438dd5
  FontColor #fffffe
  BorderColor #2e6295
  shadowing false
}
skinparam rectangle<<Extensions.ApacheCausewayExtTabularparent>> {
  BackgroundColor #438dd5
  FontColor #fffffe
  BorderColor #2e6295
  shadowing false
...
rectangle "Extensions\n<size:10>[Software System]</size>" <<Extensions>> {
  ...
  rectangle "==Apache Causeway Ext - LayoutGitHub\n<size:10>[Container: packaging: pom]</size>" <<Extensions.ApacheCausewayExtLayoutGitHub>> as Extensions.ApacheCausewayExtLayoutGitHub
  rectangle "==Apache Causeway Ext - LayoutGitHub Loader\n<size:10>[Container: packaging: jar]</size>" <<Extensions.ApacheCausewayExtLayoutGitHubLoader>> as Extensions.ApacheCausewayExtLayoutGitHubLoader
  ...
  rectangle "==Apache Causeway Ext - Tabular (parent)\n<size:10>[Container: packaging: pom]</size>" <<Extensions.ApacheCausewayExtTabularparent>> as Extensions.ApacheCausewayExtTabularparent
  rectangle "==Apache Causeway Ext - Tabular (Applib)\n<size:10>[Container: packaging: jar]</size>" <<Extensions.ApacheCausewayExtTabularApplib>> as Extensions.ApacheCausewayExtTabularApplib
  rectangle "==Apache Causeway Ext - Tabular (Excel)\n<size:10>[Container: packaging: jar]</size>" <<Extensions.ApacheCausewayExtTabularExcel>> as Extensions.ApacheCausewayExtTabularExcel
...
Extensions.ApacheCausewayExtensions .[#707070,thickness=2].> Extensions.ApacheCausewayExtLayoutGitHub : "<color:#707070>"
...
Extensions.ApacheCausewayExtensions .[#707070,thickness=2].> Extensions.ApacheCausewayExtTabularparent : "<color:#707070>"
...
Extensions.ApacheCausewayExtLayoutGitHub .[#707070,thickness=2].> Extensions.ApacheCausewayExtLayoutGitHubLoader : "<color:#707070>"
...
Extensions.ApacheCausewayExtTabularparent .[#707070,thickness=2].> Extensions.ApacheCausewayExtTabularApplib : "<color:#707070>"
Extensions.ApacheCausewayExtTabularparent .[#707070,thickness=2].> Extensions.ApacheCausewayExtTabularExcel : "<color:#707070>"
@enduml
----
...
|Apache Causeway Ext - LayoutGitHub
[source,yaml]
----
Group: org.apache.causeway.extensions
Artifact: causeway-extensions-layoutgithub
Type: pom
Directory: /extensions/core/layoutgithub
----
|Allows layouts to be dynamically loaded from a github repo.

|Apache Causeway Ext - LayoutGitHub Loader
[source,yaml]
----
Group: org.apache.causeway.extensions
Artifact: causeway-extensions-layoutgithub-loader
Type: jar
Directory: /extensions/core/layoutgithub/loader
----
|Allows layout.xml files to be dynamically loaded from a github repo.

.Components
****
o.a.i.extensions.layoutgithub.loader.spi.LayoutResourceLoaderFromGithub +
****
...
.Document Index Entries
****
xref:refguide:extensions:index/layoutgithub/loader/CausewayModuleExtLayoutGithubLoader.adoc[CausewayModuleExtLayoutGithubLoader], xref:refguide:extensions:index/layoutgithub/loader/menu/LayoutLoaderMenu.adoc[LayoutLoaderMenu]
****
...
org.checkerframework:checker-qual:jar:3.39.0 +
