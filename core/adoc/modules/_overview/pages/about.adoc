...
o.a.i.security.spring.authconverters.AuthenticationConverterOfOAuth2UserPrincipal +
...
Type: jar
Directory: /mappings/jaxrsclient/impl
----
|.Dependencies
****
...
.Document Index Entries
****
xref:refguide:extensions:index/jaxrsclient/impl/IsisModuleExtJaxRsClientImpl.adoc[IsisModuleExtJaxRsClientImpl]
****
|===
...
|.Components
****
o.a.i.core.runtimeservices.user.ImpersonateMenuAdvisorForSecman +
