...
The alternative is to use the xref:refguide:applib-svc:core-domain-api/FactoryService.adoc[`FactoryService`] API which performs both steps in a single factory method.
