...
In fact, it also injects domain services into xref:testing:integ-test-support:about.adoc[integration tests] and xref:fixtures:ROOT:about.adoc[fixture scripts].
