...
These events are broadcast on the xref:refguide:applib-svc:core-domain-api/EventBusService.adoc[`EventBusService`].
...
|xref:refguide:applib-cm:classes.adoc#AbstractDomainEvent[`o.a.i.applib.` +
`AbstractDomainEvent`]
|``o.a.i.core`` +
``events.domain`` +
``isis-core-applib``
...
|xref:refguide:applib-cm:classes.adoc#ActionDomainEvent[`o.a.i.applib.` +
`ActionDomainEvent`]
|``o.a.i.core`` +
``events.domain`` +
``isis-core-applib``
...
|xref:refguide:applib-cm:classes.adoc#CollectionDomainEvent[`o.a.i.applib.` +
...
|xref:refguide:applib-cm:classes.adoc#PropertyDomainEvent[`o.a.i.applib.` +
`PropertyDomainEvent`]
|``o.a.i.core`` +
``events.domain`` +
``isis-core-applib``
