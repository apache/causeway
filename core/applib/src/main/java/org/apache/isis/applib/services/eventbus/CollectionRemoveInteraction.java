...
public class CollectionRemoveInteraction<S,T> extends AbstractInteraction<S> {

    private static final long serialVersionUID = 1L;

    //region > Default class (used by annotation)

    public static class Default extends CollectionRemoveInteraction<Object, Object> {
        private static final long serialVersionUID = 1L;
    ...
    //region > constructors
    public CollectionRemoveInteraction(
            final S source,
