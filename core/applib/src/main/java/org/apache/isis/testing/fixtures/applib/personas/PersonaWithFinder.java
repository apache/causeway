 ...
 * @since 2.x {@index}
 */
public interface PersonaWithFinder<T> extends org.apache.isis.applib.fixturescripts.PersonaWithFinder<T> {
     ...
     */
    default T findUsing(final ServiceRegistry serviceRegistry){
        throw new RuntimeException("Not implemented");
    };

    @Override
    default T findUsing(ServiceRegistry2 serviceRegistry){
        return findUsing((ServiceRegistry) serviceRegistry);
    };
}