...
A common use case is for domain services that interact with the xref:refguide:applib-svc:core-domain-api/EventBusService.adoc[`EventBusService`].  For example:
