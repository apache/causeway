...
+
The code to boostrap an integration test is shown in the xref:testing:integ-test-support:about.adoc#bootstrapping[testing guide], but once again an `AppManifest` is required.
