...
+
The xref:rg:cms:classes/utility/ObjectContracts.adoc[`ObjectContracts`]  utility class substantially simplifies the task of implementing `Comparable` in your domain classes.
