...
Apache Isis' own configuration properties are simple key-value pairs, typically held in the `WEB-INF/isis.properties`
...
Details on how to override these configuration properties externally for different environments can be found in the xref:userguide:btb:deployment.adoc[Beyond the Basics] guide, (deployment chapter).
====
