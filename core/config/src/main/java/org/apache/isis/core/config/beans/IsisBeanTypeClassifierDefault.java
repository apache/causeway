...
//        });
        ...
        //[ISIS-3585] when implements ViewModel, then don't consider alternatives, yield VIEW_MODEL
        ...
        if(entityAnnotation!=null) {
            return IsisBeanMetaData.entity(PersistenceStack.JPA, LogicalType.infer(type));
        }
        ...
        if(aDomainObject!=null) {
            ...
            case ENTITY:
                return IsisBeanMetaData.entity(PersistenceStack.UNSPECIFIED, LogicalType.infer(type));
            case VIEW_MODEL:
            case NOT_SPECIFIED:
