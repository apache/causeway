...
public interface IsisBeanTypeRegistry {
    ...
    @NonNull Map<Class<?>, IsisBeanMetaData> getManagedBeansContributing();
    @NonNull Map<Class<?>, IsisBeanMetaData> getEntityTypes();
    @NonNull Map<Class<?>, IsisBeanMetaData> getMixinTypes();
    @NonNull Map<Class<?>, IsisBeanMetaData> getViewModelTypes();
    /** discovered per {@code @Value} annotation (vs. registered using a {@link ValueSemanticsProvider})*/
    @NonNull Map<Class<?>, IsisBeanMetaData> getDiscoveredValueTypes();
    ...
    /**
     * Returns 'JDO' or 'JPA' based on metadata found during {@link IsisBeanTypeClassifier type-classification}.
