...
public class IsisBeanMetaData {
    ...
    public static IsisBeanMetaData entity(
            final @NonNull PersistenceStack persistenceStack,
            final @NonNull LogicalType logicalType) {
        return of(BeanSort.ENTITY, Optional.of(persistenceStack), logicalType, ManagedBy.ISIS);
    }

    public static IsisBeanMetaData isisManaged(
            final @NonNull BeanSort beanSort,
            final @NonNull LogicalType logicalType) {
        return of(beanSort, Optional.empty(), logicalType, ManagedBy.ISIS);
    }
