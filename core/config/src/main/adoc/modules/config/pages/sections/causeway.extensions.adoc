...
Marked targets and owners remain excluded by command-recording suppression.
When disabled, existing action and property publishing policies are unchanged.
