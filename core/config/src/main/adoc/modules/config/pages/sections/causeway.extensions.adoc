...
|
[[causeway.extensions.command-log.safe-action-command-publishing]]
causeway.extensions.command-log. +
safe-action-command-publishing
...
|
[[causeway.extensions.command-log.parented-collection-selector-actions-enabled]]
causeway.extensions.command-log. +
parented-collection-selector-actions-enabled
