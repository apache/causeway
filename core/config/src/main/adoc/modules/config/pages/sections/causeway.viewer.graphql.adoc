...
|
[[causeway.viewer.graphql.include-testing-field-in-rich]]
causeway.viewer.graphql. +
include-testing-field-in-rich
...
| 
| Which ``SchemaStyle`` to expose.


|
[[causeway.viewer.graphql.top-level-field-name-for-rich]]
causeway.viewer.graphql. +
top-level-field-name-for-rich
...
|
[[causeway.viewer.graphql.top-level-field-name-for-simple]]
causeway.viewer.graphql. +
top-level-field-name-for-simple
