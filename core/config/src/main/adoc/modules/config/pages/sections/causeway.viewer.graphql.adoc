...
|
[[causeway.viewer.graphql.autocomplete.default-window-size]]
causeway.viewer.graphql. +
autocomplete.default-window-size
...
|
[[causeway.viewer.graphql.autocomplete.max-window-size]]
causeway.viewer.graphql. +
autocomplete.max-window-size
...
causeway.viewer.graphql. +
collections.default-window-size
