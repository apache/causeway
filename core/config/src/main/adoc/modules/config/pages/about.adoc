...
But if configured to run instead in prototyping mode, then any actions xref:system:generated:index/applib/annotation/Action.adoc#restrictTo[restricted to] to prototype mode are visible.
