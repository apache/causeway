...
* xref:system:generated:index/applib/annotation/DomainObjectLayout.adoc#cssClass[`@DomainObjectLayout#cssClass()`]
* xref:system:generated:index/applib/annotation/ActionLayout.adoc#cssClass[`@ActionLayout#cssClass()`]
* xref:system:generated:index/applib/annotation/PropertyLayout.adoc#cssClass[`@PropertyLayout#cssClass()`]
* xref:system:generated:index/applib/annotation/CollectionLayout.adoc#cssClass[`@CollectionLayout#cssClass()`]
