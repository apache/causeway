...
xref:ug:fun:programming-model.adoc#view-models[here].
====
...
[TIP]
====
Details of how to consume such DTOs can be found xref:ug:fun:programming-model.adoc#dto-consumers[here].
====
