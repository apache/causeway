...
One decoupled approach is using xref:ug:fun:building-blocks.adoc#domain-events[domain events]; the checks above correspond to the phases of the domain event.
