...
As described in the xref:ug:fun:building-blocks/types-of-domain-objects/view-models.adoc[introduction], view models are domain objects like domain entities, with behaviour and state.
