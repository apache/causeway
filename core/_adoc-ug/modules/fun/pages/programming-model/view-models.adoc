...
As described in the xref:ug:fun:building-blocks.adoc#view-models[introduction], view models are domain objects like domain entities, with behaviour and state.
