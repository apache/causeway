...
In the section xref:ug:fun:programming-model/view-models/jaxb/referencing-domain-entities.adoc[above] it was explained how a view model DTO can transparently reference any "backing" entities; these references are converted to internal object identifiers.
