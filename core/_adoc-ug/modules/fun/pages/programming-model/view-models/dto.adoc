...
<9> reference to a persistent entity; discussed xref:ug:fun:programming-model.adoc#referencing-domain-entities[here]
<10> reference to a collection of persistent entities; again discussed xref:ug:fun:programming-model.adoc#referencing-domain-entities[here]
