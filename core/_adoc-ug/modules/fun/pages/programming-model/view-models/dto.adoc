...
----
<1> package name encodes major version; see discussion on xref:ug:fun:programming-model/view-models/dto/versioning.adoc[versioning]
...
<5> class name encodes (major and) minor version; see discussion on xref:ug:fun:programming-model/view-models/dto/versioning.adoc[versioning]
<6> again, see discussion on xref:ug:fun:programming-model/view-models/dto/versioning.adoc[versioning]
<7> again, see discussion on xref:ug:fun:programming-model/view-models/dto/versioning.adoc[versioning]
<8> simple scalar properties
<9> reference to a persistent entity; discussed xref:ug:fun:programming-model/view-models/jaxb/referencing-domain-entities.adoc[here]
<10> reference to a collection of persistent entities; again discussed xref:ug:fun:programming-model/view-models/jaxb/referencing-domain-entities.adoc[here]
