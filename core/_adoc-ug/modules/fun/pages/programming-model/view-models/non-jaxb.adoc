...
As was explained xref:ug:fun:programming-model.adoc#view-models[earlier], the approach is described here is neither as flexible nor as powerful as using the JAXB-style of view models.
...
----
|Implement xref:rg:cms:classes/super/ViewModel.adoc[`ViewModel`] interface.  The memento is as defined by the
