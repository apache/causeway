...
This is done using either a supporting xref:rg:cms:methods/prefixes.adoc#choices[`choices`] or xref:rg:cms:methods/prefixes.adoc#autoComplete[`autoComplete`] method.
