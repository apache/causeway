...
<3> the xref:rg:cms:methods/prefixes.adoc#addTo[`addTo...()`] method increments the derived properties
<4> the xref:rg:cms:methods/prefixes.adoc#removeFrom[`removeFrom...()`] method similarly decrements the derived properties
