...
This is intended to support deployment through Docker, as discussed xref:ug:btb:about.adoc#docker[next].
====
...
[TIP]
====
Subsequent sections explain how to externalize configuration for xref:ug:btb:about.adoc#docker[Docker].
====
