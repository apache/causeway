...
|`--manifest`
|FQCN
|Fully qualified class name of the xref:rg:cms:classes/super/AppManifest.adoc[`AppManifest`] to use to bootstrap the system. +
...
|`--fixture`
|FQCN
|Fully qualified class name of the fixture (extending xref:rg:cms:classes/super/FixtureScript.adoc[`FixtureScript`]) to be run to setup data. +
