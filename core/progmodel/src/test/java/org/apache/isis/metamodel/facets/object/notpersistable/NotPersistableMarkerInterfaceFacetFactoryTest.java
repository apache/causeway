...
public class NotPersistableMarkerInterfaceFacetFactoryTest extends AbstractFacetFactoryTest {
    ...
    public void testProgramPersistableMeansNotPersistableByUser() {
        ...
        final org.apache.isis.metamodel.facets.object.notpersistable.InitiatedBy value = notPersistableFacetMarkerInterface.value();
        assertEquals(org.apache.isis.metamodel.facets.object.notpersistable.InitiatedBy.USER, value);
    ...
    public void testNotPersistable() {
        ...
        final NotPersistableFacetMarkerInterface notPersistableFacetMarkerInterface = (NotPersistableFacetMarkerInterface) facet;
        final org.apache.isis.metamodel.facets.object.notpersistable.InitiatedBy value = notPersistableFacetMarkerInterface.value();
        assertEquals(org.apache.isis.metamodel.facets.object.notpersistable.InitiatedBy.USER_OR_PROGRAM, value);
