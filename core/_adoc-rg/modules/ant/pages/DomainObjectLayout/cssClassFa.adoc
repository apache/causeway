...
If necessary the icon specified can be overridden by a particular object instance using the xref:rg:cms:methods/reserved/iconName.adoc[`iconName()`] method.
