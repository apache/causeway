...
This is as an alternative to implementing xref:rg:cms:methods/reserved.adoc#title[`title()`] reserved method, or using the xref:rg:ant:Title.adoc[`@Title`] annotation, within the class itself.
