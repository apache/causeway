...
Using Eclipse IDE you may need to configure annotation processing manually; see the xref:toc:devguide:ide/eclipse.adoc#enable-annotation-processing[Developers' Guide].
