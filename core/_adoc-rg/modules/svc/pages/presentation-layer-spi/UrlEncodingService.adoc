...
The service is used by the framework to map xref:ug:fun:building-blocks.adoc#view-models[view model] mementos (derived from the state of the view model itself) into a form that can be used as a view model.
