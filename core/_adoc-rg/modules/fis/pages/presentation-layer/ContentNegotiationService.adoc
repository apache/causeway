...
* first is to solve the problem at the domain layer by defining a regular Apache Isis xref:ug:fun:building-blocks.adoc#view-models[view model].  This is then surfaced over the RO viewer.  +
+
