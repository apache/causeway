...
----
<1> simple xref:rg:cms:classes/utility.adoc#TitleBuffer[utility class] to help construct the title string
...
* xref:rg:cms:methods/reserved.adoc#iconName[`iconName()`]
* xref:rg:cms:methods/reserved.adoc#cssClass[`cssClass()`]
* xref:rg:cms:methods/reserved.adoc#layout[`layout()`]
