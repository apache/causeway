...
The `paramsDto` type is defined xref:rg:cms:schema/cmd/ancillary.adoc[below].
...
Note also that there is a corresponding xref:rg:cms:schema/ixn/memberExecutionDto.adoc[`memberExecutionDto`]
