...
A number of other xref:rg:cms:classes/mixins.adoc#Object[mixins] also contribute properties or actions to the "Metadata" fieldset.
...
----
<1> returns the XML text wrapped up in a xref:rg:cms:classes/value-types.adoc#Clob[`Clob`].
