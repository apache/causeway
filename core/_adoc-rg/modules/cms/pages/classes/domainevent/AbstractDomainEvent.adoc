...
* xref:rg:cms:classes/domainevent.adoc#ActionDomainEvent[`ActionDomainEvent`]
* xref:rg:cms:classes/domainevent.adoc#PropertyDomainEvent[`PropertyDomainEvent`]
* xref:rg:cms:classes/domainevent.adoc#CollectionDomainEvent[`CollectionDomainEvent`]
