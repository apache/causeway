...
Entities that implement this interface often also implement xref:rg:cms:classes/roles.adoc#HoldsUpdatedBy[`HoldsUpdatedBy`] role interface; as a convenience the xref:rg:cms:classes/roles.adoc#Timestampable[`Timestampable`] interface combines the two roles.
