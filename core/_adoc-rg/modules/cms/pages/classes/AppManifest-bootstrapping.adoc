...
[NOTE]
====
The recommendations in this section no longer apply if using the xref:rg:cms:classes/AppManifest2-bootstrapping.adoc#bootstrapping[`AppManifest2`] interface and ``Module``s to bootstrap your application.
====
