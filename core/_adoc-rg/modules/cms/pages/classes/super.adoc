...
|xref:rg:cms:classes/super.adoc#AbstractService[`o.a.i.applib.` +
`AbstractService`]
|``o.a.i.core`` +
``isis-core-applib``
|(abstract class)
...
|xref:rg:cms:classes/super.adoc#AbstractSubscriber[`o.a.i.applib.` +
`AbstractSubscriber`]
|``o.a.i.core`` +
``isis-core-applib``
|(abstract class)
...
|xref:rg:cms:classes/super.adoc#AbstractViewModel[`o.a.i.applib.` +
`AbstractViewModel`]
|``o.a.i.core`` +
``isis-core-applib``
|(abstract class)
...
|xref:rg:cms:classes/super.adoc#FixtureScript[`o.a.i.applib.` +
`fixturescript` +
`FixtureScript`]
|``o.a.i.core`` +
``isis-core-applib``
...
|xref:rg:cms:classes/super.adoc#FixtureScripts[`o.a.i.applib.` +
`fixturescripts` +
`FixtureScripts`]
|``o.a.i.core`` +
``isis-core-applib``
