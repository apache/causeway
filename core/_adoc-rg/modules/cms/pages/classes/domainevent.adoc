...
|xref:rg:cms:classes/domainevent.adoc#AbstractDomainEvent[`o.a.i.applib.` +
`AbstractDomainEvent`]
|``o.a.i.core`` +
``events.domain`` +
``isis-core-applib``
...
|xref:rg:cms:classes/domainevent.adoc#ActionDomainEvent[`o.a.i.applib.` +
`ActionDomainEvent`]
|``o.a.i.core`` +
``events.domain`` +
``isis-core-applib``
...
|xref:rg:cms:classes/domainevent.adoc#CollectionDomainEvent[`o.a.i.applib.` +
...
|xref:rg:cms:classes/domainevent.adoc#PropertyDomainEvent[`o.a.i.applib.` +
`PropertyDomainEvent`]
|``o.a.i.core`` +
``events.domain`` +
``isis-core-applib``
