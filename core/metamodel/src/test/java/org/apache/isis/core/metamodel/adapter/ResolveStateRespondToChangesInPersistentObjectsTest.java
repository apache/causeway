...
public class ResolveStateRespondToChangesInPersistentObjectsTest  {
    ...
    public ResolveStateRespondToChangesInPersistentObjectsTest(final boolean whetherIs, final ResolveState state) {
