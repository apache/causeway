...
package org.apache.isis.core.progmodel.facets.object.wizard;
...
import org.apache.isis.core.progmodel.facets.object.wizard.iface.iface.WizardFacetForInterface;
import org.apache.isis.core.progmodel.facets.object.wizard.iface.iface.WizardInterfaceFacetFactory;

public class WizardInteraceFacetFactoryTest extends AbstractFacetFactoryTest {

    private WizardInterfaceFacetFactory facetFactory;

    @Override
    protected void setUp() throws Exception {
        super.setUp();

        facetFactory = new WizardInterfaceFacetFactory();
    }
    ...
    public void testWizardInterfacePickedUpOnClassAndDefaultsToAlways() {
        class CustomerWizard implements Wizard<CustomerWizard> {
            ...
            @Override
            public CustomerWizard previous() {
                return null;
            }
