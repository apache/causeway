...
import org.apache.isis.metamodel.facets.param.choices.method.ActionChoicesFacetViaMethod;
import org.apache.isis.metamodel.facets.param.choices.method.ActionChoicesFacetViaMethodFactory;
import org.apache.isis.metamodel.facets.param.choices.methodnum.ActionParameterChoicesFacetViaMethod;
...
import org.apache.isis.metamodel.facets.param.defaults.methodnum.ActionParameterDefaultsFacetViaMethod;
...
public class ActionMethodsFacetFactoryTest extends AbstractFacetFactoryTest {
    ...
    public void testBothChoicesMethodCausesException() {
        ...
        } catch (final org.apache.isis.metamodel.exceptions.MetaModelException expected) {
            // ignore
        }
    }
