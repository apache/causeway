...
class BigDecimalValueSemanticsProvider_configureDecimalFormat_Test {
    ...
    void setUpObjects() throws Exception {
        ...
        isisConfiguration = new IsisConfiguration(null);
        isisConfiguration.getValueTypes().getBigDecimal().setMinScale(null);
        ...
        valueSemantics.setIsisConfiguration(isisConfiguration);
    }
    ...
    void min_facets_not_set_but_fallback() {
        ...
        isisConfiguration.getValueTypes().getBigDecimal().setMinScale(fallbackScale);
