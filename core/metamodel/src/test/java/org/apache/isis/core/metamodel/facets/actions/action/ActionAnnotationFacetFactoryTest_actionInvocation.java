...
public class ActionAnnotationFacetFactoryTest_actionInvocation extends AbstractFacetFactoryTest {
    ...
    public void testActionInvocationFacetIsInstalledAndMethodRemoved() {
        ...
        facetFactory.processDomainEvent(new ProcessMethodContext(Customer.class, null, null, actionMethod, methodRemover, facetedMethod));
    ...
    public void testActionsPickedUpFromSuperclass() {
        ...
        facetFactory.processDomainEvent(new ProcessMethodContext(CustomerEx.class, null, null, actionMethod, methodRemover, facetHolderWithParms));
