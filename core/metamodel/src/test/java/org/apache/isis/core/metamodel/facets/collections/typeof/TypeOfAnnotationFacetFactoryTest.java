...
package org.apache.isis.core.metamodel.facets.collections.typeof;
...
public class TypeOfAnnotationFacetFactoryTest extends AbstractFacetFactoryTest {
    ...
    private TypeOfFacetOnCollectionAnnotationFactory facetFactory;
    ...
    public void testTypeOfFacetInferredForActionWithJavaUtilCollectionReturnType() {
        ...
        assertNotNull(facet);
        assertTrue(facet instanceof TypeOfFacetOnCollectionAnnotation);
        final TypeOfFacetOnCollectionAnnotation typeOfFacetOnCollectionAnnotation = (TypeOfFacetOnCollectionAnnotation) facet;
