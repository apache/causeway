...
public class ActionParameterChoicesFacetForParentedCollectionNavigationParent
extends ActionParameterChoicesFacetAbstract {

    public ActionParameterChoicesFacetForParentedCollectionNavigationParent(final FacetHolder holder) {
        super(holder);
    }
