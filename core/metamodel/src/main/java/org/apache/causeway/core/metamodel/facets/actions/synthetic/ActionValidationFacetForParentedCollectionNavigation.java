...
public class ActionValidationFacetForParentedCollectionNavigation
    ...
    public String invalidates(final ValidityContext context) {
        ...
        return invalidReason(
                actionValidityContext.objectAction().getId(),
                actionValidityContext.target(),
                actionValidityContext.args(),
                actionValidityContext.initiatedBy());
    }
    ...
    public String invalidReason(
        ...
        return invalidReason(facetHolder().getFeatureIdentifier().memberLogicalName(), target, arguments, InteractionInitiatedBy.USER);
    }
