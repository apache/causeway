...
public class GridMarshallerXml implements GridMarshaller {

	private final JaxbService jaxbService;
	private final XsiSchemaLocationProviderForGrid schemaLocationProvider;
    ...
    public String marshal(final @NonNull BSGrid bsGrid, final @NonNull CommonMimeType format) {
        ...
        switch (format) {
        case XML: return jaxbService.toXml(bsGrid,
                            Map.of(javax.xml.bind.Marshaller.JAXB_SCHEMA_LOCATION,
    ...
    public Try<BSGrid> unmarshal(
        ...
        throwIfFormatNotSupported(format);
        switch (format) {
        case XML: return Try.call(()->jaxbService.fromXml(BSGrid.class, content))
