...
public abstract class CommandPublishingFacetForActionFromConfiguration extends CommandPublishingFacetAbstract {
    ...
    static class SafeEnabledByRecordingSupport extends CommandPublishingFacetForActionFromConfiguration {

        private final CausewayConfiguration configuration;

        SafeEnabledByRecordingSupport(
        ...
        @Override
        public boolean isEnabled() {
            return configuration.extensions().commandLog().recordingSupport().isEnabled();
        }
    }
