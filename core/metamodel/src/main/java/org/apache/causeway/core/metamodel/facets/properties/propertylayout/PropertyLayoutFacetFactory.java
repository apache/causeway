...
extends FacetFactoryAbstract {
    ...
    // public for testing
    public static Optional<PromptStyleFacet> createPromptStyleFacetForPropertyLayoutAnnotation(
        ...
        if(holder instanceof FacetedMethod
                && ((FacetedMethod)holder).getFeatureType() != FeatureType.PROPERTY) {
        ...
        return Optional.ofNullable(
            ...
            propertyLayoutIfAny
                ...
                .<PromptStyleFacet>map(promptStyle -> {switch (promptStyle) {
                    ...
                    case DIALOG_SIDEBAR:
                    case INLINE:
                        return new PromptStyleFacet("PropertyLayoutAnnotation", promptStyle, holder);
                    case INLINE_AS_IF_EDIT:
                        return new PromptStyleFacet("PropertyLayoutAnnotation", PromptStyle.INLINE, holder);
                    case AS_CONFIGURED:
