...
implements OrderRelation<LocalDateTime, Duration> {
    ...
    public static class AutoConfiguration {
        ...
        public LocalDateTimeValueSemantics defaultLocalDateTimeValueSemantics() {
    ...
    @Override
    public Optional<TemporalDecomposition> decomposeTemporal(final @Nullable LocalDateTime temporal) {
