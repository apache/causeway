 ...
 * @since 2.0
 */
@Deprecated //TODO[CAUSEWAY-3646] remove
public abstract class FaStaticFacetAbstractLegacy {
    ...
    static List<String> parse(final String value) {
        ...
        .map(FaStaticFacetAbstractLegacy::faPrefix)
    ...
    private static List<String> sanitize(final Set<String> parsedClasses) {
        ...
        .filter(FaStaticFacetAbstractLegacy::isFaPrimaryPrefix)
        .findFirst()
        ...
        .filter(_Predicates.not(FaStaticFacetAbstractLegacy::isFaPrimaryPrefix))
        .filter(_Predicates.not(FaStaticFacetAbstractLegacy::isFixedWidth))
