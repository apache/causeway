...
import org.apache.causeway.core.metamodel.spec.impl.ObjectSpecificationMutable;
 ...
 * per-type inside {@link ObjectSpecificationMutable#synthesizeNavigationActions()} (read live from
...
public class SynthesizeNavigationActionsPostProcessor
    ...
    public void postProcessObject(final ObjectSpecification objSpec) {
        if (objSpec instanceof ObjectSpecificationMutable mutable) {
            mutable.synthesizeNavigationActions();
        }
    }
