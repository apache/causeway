...
/**
 * Associates a synthetic navigation action with the scalar reference it navigates from.
 */
public class LayoutGroupFacetForScalarReferenceNavigation
        extends LayoutGroupFacetAbstract {

    public LayoutGroupFacetForScalarReferenceNavigation(
            final String referenceId,
            final String referenceName,
            final FacetHolder holder) {
        super(new GroupIdAndName(referenceId, referenceName), holder);
    }
