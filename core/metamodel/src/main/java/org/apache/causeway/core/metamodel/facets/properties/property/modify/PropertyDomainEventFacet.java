...
implements
    ...
    /**
     * Creates a mixee-specific (object-type-specific) overlay facet for a mixed-in property, honoring the
     * mixee's {@code @DomainObject} property domain-event default. Returns empty when the mixee declares no
