...
public class ActionInvocationFacetForParentedCollectionNavigation
    ...
    public ManagedObject invoke(
        ...
        var matchResult = ParentedCollectionNavigationMatchingUtil.match(
                collection,
                filterProperties,
                head.target(),
                argumentAdapters,
                interactionInitiatedBy);
        var validationMessage = ParentedCollectionNavigationMatchingUtil.validationMessage(
                owningAction.getId(), matchResult);
