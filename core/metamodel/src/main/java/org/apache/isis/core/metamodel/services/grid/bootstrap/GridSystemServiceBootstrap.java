 ...
 *  under the License.
 */
package org.apache.isis.core.metamodel.services.grid.bootstrap;
...
import org.apache.isis.applib.services.grid.GridMarshallerService;
...
extends GridSystemServiceAbstract<BSGrid> {
    ...
    public static final String SCHEMA_LOCATION = "https://isis.apache.org/applib/layout/grid/bootstrap3/bootstrap3.xsd";
    ...
    private final IsisConfiguration config;
    ...
    public GridSystemServiceBootstrap(
        ...
        super(metaModelContext.getSpecificationLoader(), translationService, jaxbService, messageService, isisSystemEnvironment);
