...
public final class XmlSchema {
    ...
    Element createElement(final Document doc, final String localName, final String fullyQualifiedClassName, final String singularName) {
        ...
        element.setAttributeNS(IsisSchema.NS_URI, IsisSchema.NS_PREFIX + ":plural", "");
    ...
    void setTargetNamespace(final Document xsdDoc, final String fullyQualifiedClassName) {
        ...
        // targetNamespace="https://isis.apache.org/ns/app/<fully qualified class
        // name>
     ...
     *     xsi:schemaLocation=&quot;https://isis.apache.org/ns/app/sdm.common.fixture.schemes.ao.communications ddd.xsd&quot;
     * </pre>
     *
    ...
    void assignSchema(final Document xmlDoc, final String fullyQualifiedClassName, final String schemaLocationFileName) {
        ...
        // xsi:schemaLocation="https://isis.apache.org/ns/app/<fully qualified
        // class name>
