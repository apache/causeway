...
public class RegExFacetFromRegExAnnotationOnProperty extends RegExFacetAbstract {
    ...
    public static RegExFacet create(final RegEx annotation, final Class<?> returnType, final FacetHolder holder) {
        ...
        return new RegExFacetFromRegExAnnotationOnProperty(validationExpression, formatExpression, caseSensitive, holder);
    }

    private RegExFacetFromRegExAnnotationOnProperty(final String validation, final String format, final boolean caseSensitive, final FacetHolder holder) {
