 ...
 */
public interface InteractionWithCollectionAddFacet
        extends SingleValueFacet<Class<? extends CollectionInteractionEvent<?,?>>>,
    ...
    public static class Util {
        ...
        public static <S, T> CollectionInteractionEvent<S, T> newEvent(
            ...
            for (final Constructor<?> constructor : constructors) {
                ...
                final Object event = constructor.newInstance(source, identifier, CollectionInteractionEvent.Of.ADD_TO, value);
