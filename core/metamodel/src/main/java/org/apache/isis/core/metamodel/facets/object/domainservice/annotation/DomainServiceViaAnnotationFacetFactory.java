...
public class DomainServiceViaAnnotationFacetFactory extends FacetFactoryAbstract {

    public DomainServiceViaAnnotationFacetFactory() {
    ...
    public void process(ProcessClassContext processClassContext) {
        ...
        FacetUtil.addFacet(
                new DomainServiceFacetViaAnnotation(
