...
public class RenderedAsDayBeforeAnnotationOnParameterFacetFactory extends FacetFactoryAbstract {

    public RenderedAsDayBeforeAnnotationOnParameterFacetFactory() {
    ...
    private RenderedAdjustedFacet create(final RenderedAsDayBefore annotation, final FacetHolder holder) {
        return annotation != null ? new RenderedAsDayBeforeFacetAnnotationOnParameter(holder) : null;
    }
