...
package org.apache.isis.metamodel.spec.identifier;
...
public class IdentifierFactory {
     ...
     */
    private static String[] toParameterStringArray(final ObjectSpecification[] specifications) {
    ...
    public static Identifier create(
            ...
            final ObjectSpecification[] specifications) {
