...
import static org.apache.isis.applib.annotation.Where.PARENTED_TABLES;
import static org.apache.isis.applib.annotation.Where.STANDALONE_TABLES;
        ...
        public static Predicate<ObjectAssociation> referencesParent(
            ...
            return (final ObjectAssociation assoc) -> {
                    if(assoc.isCollection()) {
                        // this semantic doesn't apply to collections; https://github.com/apache/isis/pull/1887#discussion_r1333919544
                        return false;
                    }
