...
public class DoublePrimitiveValueFacetUsingSemanticsProviderFactory extends ValueFacetUsingSemanticsProviderFactory<Double> {

    public DoublePrimitiveValueFacetUsingSemanticsProviderFactory() {
        super();
    }
