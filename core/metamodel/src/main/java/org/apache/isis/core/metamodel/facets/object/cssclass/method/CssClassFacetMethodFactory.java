...
extends MethodPrefixBasedFacetFactoryAbstract {
    ...
    private static final ObjectSupportMethod SUPPORT_METHOD = ObjectSupportMethod.CSS_CLASS;
    ...
    public void process(final ProcessClassContext processClassContext) {
        ...
        .forEach(methodName->{
            ...
            addFacetIfPresent(CssClassFacetViaCssClassMethod.create(method, facetHolder));
