...
import org.apache.isis.core.metamodel.facets.actions.interaction.ActionInteractionFacet;
...
public abstract class InteractionWithActionFacetAbstract
    ...
    private void postEvent(
        ...
        try {
            ...
            final ActionInteractionEvent<?> event = ActionInteractionFacet.Util.newEvent(type, source, actionIdentifier, arguments);
