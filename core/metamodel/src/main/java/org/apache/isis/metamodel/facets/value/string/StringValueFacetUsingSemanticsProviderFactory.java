...
public class StringValueFacetUsingSemanticsProviderFactory extends ValueFacetUsingSemanticsProviderFactory<String> {

    public StringValueFacetUsingSemanticsProviderFactory() {
        super();
    }
