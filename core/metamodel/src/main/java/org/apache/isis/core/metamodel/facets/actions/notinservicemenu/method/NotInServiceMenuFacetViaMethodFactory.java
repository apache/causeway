...
public class NotInServiceMenuFacetViaMethodFactory extends MethodPrefixBasedFacetFactoryAbstract {
    ...
    public void process(final ProcessMethodContext processMethodContext) {
        ...
        FacetUtil.addFacet(new NotInServiceMenuFacetViaMethod(notInServiceMenuMethod, facetedMethod));
    }
