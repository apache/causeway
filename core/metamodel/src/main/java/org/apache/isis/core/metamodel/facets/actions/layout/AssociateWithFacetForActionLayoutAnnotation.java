...
public class AssociateWithFacetForActionLayoutAnnotation extends AssociateWithFacetAbstract {
    ...
    public static AssociateWithFacetForActionLayoutAnnotation create(
        ...
        return actionLayoutIfAny
                ...
                .map(associateWith -> new AssociateWithFacetForActionLayoutAnnotation(associateWith, holder))
                .orElse(null);
    }
