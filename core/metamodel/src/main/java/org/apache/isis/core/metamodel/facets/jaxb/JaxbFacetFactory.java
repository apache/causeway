...
import static org.apache.isis.commons.internal.reflection._Reflect.predicates.isPublic;
        ...
        void validate(
            ...
            if (dateType.isAssignableFrom(elementType)
                ...
                ValidationFailure.raiseFormatted(
                        ...
                        + "@XmlJavaTypeAdapter(org.apache.isis.applib.jaxb.XxxJaxbAdapters.XxxToStringAdapter.class) "
                        + "or equivalent, "
