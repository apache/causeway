...
public class MaxLengthFacetOnParamForMaxLengthAnnotation extends MaxLengthFacetAbstract {

    public static MaxLengthFacet create(final MaxLength annotation, final FacetHolder holder) {
        return annotation == null ? null : new MaxLengthFacetOnParamForMaxLengthAnnotation(annotation.value(), holder);
    }

    private MaxLengthFacetOnParamForMaxLengthAnnotation(final int value, final FacetHolder holder) {
        super(value, holder);
    }
