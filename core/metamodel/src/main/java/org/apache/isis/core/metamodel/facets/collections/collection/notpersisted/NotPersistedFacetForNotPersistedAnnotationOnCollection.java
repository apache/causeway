...
public class NotPersistedFacetForNotPersistedAnnotationOnCollection extends NotPersistedFacetAbstract {
    ...
    public NotPersistedFacetForNotPersistedAnnotationOnCollection(final FacetHolder holder) {
        super(holder);
    }

    public static NotPersistedFacet create(final NotPersisted annotation, final FacetHolder holder) {
        return annotation == null ? null : new NotPersistedFacetForNotPersistedAnnotationOnCollection(holder);
    }
}
