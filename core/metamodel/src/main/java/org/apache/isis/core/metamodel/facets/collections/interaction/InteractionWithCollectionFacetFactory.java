    ...
    public void process(final ProcessMethodContext processMethodContext) {
        ...
        if (collectionAddToFacet != null) {
            ...
            if(interactionWithCollection != null) {
                ...
                FacetUtil.addFacet(new InteractionWithCollectionFacetAddAnnotation(eventType, getterFacet, collectionAddToFacet, servicesInjector, holder));
        ...
        if (collectionRemoveFromFacet != null) {
            ...
            if(interactionWithCollection != null) {
                final Class<? extends CollectionInteractionEvent<?,?>> eventType = interactionWithCollection.value();
                FacetUtil.addFacet(new InteractionWithCollectionFacetRemoveAnnotation(eventType, getterFacet, collectionRemoveFromFacet, servicesInjector, holder));
