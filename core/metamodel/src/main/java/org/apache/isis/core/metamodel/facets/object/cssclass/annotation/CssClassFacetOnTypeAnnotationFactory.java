 ...
 */
@Deprecated
public class CssClassFacetOnTypeAnnotationFactory extends FacetFactoryAbstract implements MetaModelValidatorRefiner, IsisConfigurationAware {
    ...
    public void process(final ProcessClassContext processClassContext) {
        ...
        final CssClassFacet facet = create(annotation, processClassContext.getFacetHolder());
        FacetUtil.addFacet(validator.flagIfPresent(facet));
    }

    private static CssClassFacet create(final CssClass annotation, final FacetHolder holder) {
        return annotation == null ? null : new CssClassFacetOnTypeAnnotation(annotation, holder);
    }
