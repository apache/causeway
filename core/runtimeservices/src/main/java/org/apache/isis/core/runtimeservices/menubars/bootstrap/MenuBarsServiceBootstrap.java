...
import org.apache.isis.applib.services.menu.MenuBarsMarshallerService;
...
import org.apache.isis.core.metamodel.facets.actions.layout.FaFacetForMenuBarXml;
...
@Service
@Named(IsisModuleCoreRuntimeServices.NAMESPACE + ".MenuBarsServiceBootstrap")
...
implements MenuBarsService {
    ...
    public static final String MB3_SCHEMA_LOCATION = "https://isis.apache.org/applib/layout/menubars/bootstrap3/menubars.xsd";
