...
[TIP]
====
If you use Eclipse IDE on Windows then xref:toc:devguide:ide/eclipse.adoc#workaround-for-path-limits[note the importance] of the `persistence.xml` file to make DataNucleus enhancer work correctly.
====
