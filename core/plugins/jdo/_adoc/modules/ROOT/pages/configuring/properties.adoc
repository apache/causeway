...
|This property is derived automatically derived from the set of modules provided in the xref:rg:cms:classes/super/AppManifest.adoc[`AppManifest`], and so does not need to be specified explicitly.
