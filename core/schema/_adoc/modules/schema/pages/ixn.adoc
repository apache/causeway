...
<2> uses complex types defined in the xref:rg:schema:common["common" schema] and also the xref:rg:schema:about.adoc#cmd.adoc["cmd" schema]
...
The transaction Id is used to correlate back to the xref:rg:schema:command[command] that represented the intention to perform this execution, as well as to any xref:rg:schema:about.adoc#changes.adoc[changes] to domain objects that occur as a side-effect of the interaction.
...
It corresponds to the xref:rg:schema:cmd/memberDto.adoc[`memberDto`] of the "cmd" schema; some elements are copied directly:
...
<3> the target object, corresponding to one of the elements of the `targets` element of the xref:rg:schema:cmd/memberDto.adoc[`memberDto`]
<4> the member identifier; corresponds to `memberIdentifier` of the `member` element of the xref:rg:schema:cmd/memberDto.adoc[`memberDto`]
<5> the _logical_ member identifier; corresponds to `logicalMemberIdentifier` of the `member` element of the xref:rg:schema:cmd/memberDto.adoc[`memberDto`]
<6> the user executing the action invocation/property edit; corresponds to the `user` element of the xref:rg:schema:cmd/memberDto.adoc[`memberDto`]
<7> the current "human-friendly" title of the target object
<8> the set of metrics captured for this execution, of type `metricsDto` defined xref:rg:schema:ixn/ancillary.adoc[below].
...
xref:rg:schema:cmd/memberDto.adoc[`actionDto`] complex type of the "cmd" schema
...
It corresponds to the similar xref:rg:schema:cmd/memberDto.adoc[`propertyDto`] complex type of the "cmd" schema
...
The xref:rg:schema:changes.adoc[changes] schema also provides metrics on the number of objects loaded/changed, but relates to the entire interaction rather than just one (sub)execution of an interaction.