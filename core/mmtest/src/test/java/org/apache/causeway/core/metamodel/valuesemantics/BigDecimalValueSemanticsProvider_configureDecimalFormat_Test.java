...
class BigDecimalValueSemanticsProvider_configureDecimalFormat_Test {
    ...
    ObjectFeature mockObjectFeature;
    ...
    void setUpObjects() throws Exception {
        ...
        mockIdentifier = Mockito.mock(Identifier.class);
        mockObjectFeature = Mockito.mock(ObjectFeature.class);
    ...
    void min_facets_not_set_but_fallback() {
        ...
        new ConfigurationTester(TestPropertyValues.of("causeway.valueTypes.bigDecimal.display.minScale=" + fallbackScale))
            .test(causewayConfiguration->{
                valueSemantics.setCausewayConfiguration(causewayConfiguration);
