...
public class SetAssociation extends AbstractRequest {
    ...
    public SetAssociation(Session session, String fieldIdentifier, IdentityData target, IdentityData associate) {
        super(session);
    ...
    public void execute(Distribution distribution) {
        response = distribution.setAssociation(session, fieldIdentifier, target, associate);
    }
