...
public class JavaDataFactory implements DataFactory {
    ...
    public NullData createNullData(String type) {
        return new JavaNullData(type);
    }

    public ObjectData createObjectData(Oid oid, String type, boolean hasCompleteData, Version version) {
    ...
    public ServerActionResultData createActionResultData(
            ...
            String[] messages,
            String[] warnings) {
        return new JavaResult(result, updatesData, persistedTarget, persistedParameters, messages, warnings);
    }
    ...
    public ClientActionResultData createActionResultData(ObjectData[] madePersistent, Version[] changedVersion) {
        return new JavaClientResult(madePersistent, changedVersion);
    }
}
