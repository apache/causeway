...
import org.apache.isis.viewer.restfulobjects.jaxrsresteasy.IsisModuleViewerRestfulObjectsJaxrsResteasy;
...
@Import({
    ...
    IsisModuleViewerRestfulObjectsJaxrsResteasy.class
})
class RestServiceTest extends RegressionTestWithJdoFixtures {
    ...
    void calendarEvent_echo_viaRestEndpoint() {
         ...
         *     ],
         * "type":"org.apache.isis.extensions.fullcalendar.applib.value.CalendarEvent",
         * "cardinality":4
         * }
         */
