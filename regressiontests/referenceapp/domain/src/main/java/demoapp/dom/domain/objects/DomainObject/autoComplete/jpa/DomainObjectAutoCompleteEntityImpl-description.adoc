...
This entity uses `@DomainObject#autoCompleteRepository` to indicate that instances of it may be searched for using the specified repository.

[source,java,indent=0]
.DomainObjectAutoCompleteEntityImpl.java
----
include::DomainObjectAutoCompleteEntityImpl.java[tags=class]
----
