...
@Profile("demo-jpa")
@Service
public class DomainObjectLayoutBookmarkingEntityImplRepository
extends ValueHolderRepository<String, DomainObjectLayoutBookmarkingEntityImpl> implements DomainObjectLayoutBookmarkingEntityRepository {

    protected DomainObjectLayoutBookmarkingEntityImplRepository() {
        super(DomainObjectLayoutBookmarkingEntityImpl.class);
    }
