...
@Profile("demo-jpa")
@Service
public class DomainObjectLayoutDescribedAsEntityImplRepository
extends ValueHolderRepository<String, DomainObjectLayoutDescribedAsEntityImpl> implements DomainObjectLayoutDescribedAsEntityRepository {

    protected DomainObjectLayoutDescribedAsEntityImplRepository() {
        super(DomainObjectLayoutDescribedAsEntityImpl.class);
    }
