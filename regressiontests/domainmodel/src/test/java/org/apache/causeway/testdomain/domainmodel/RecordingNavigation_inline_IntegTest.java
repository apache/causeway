...
@SpringBootTest(
        ...
        properties = {
                ...
                "causeway.extensions.command-log.navigation-action-synthesis=INLINE",
        })
@TestPropertySource({
    CausewayPresets.SilenceMetaModel,
    CausewayPresets.SilenceProgrammingModel,
})
class RecordingNavigation_inline_IntegTest extends RecordingNavigation_IntegTestAbstract {
}
