...
@SpringBootTest(
        ...
        properties = {
                "causeway.security.allowActionsWithSafeSemanticsToBeInvokedWithOnlyViewingPermission=TRUE",
...
class ActionInteractionTest_usingAllowSafeSemantics extends InteractionTestAbstract {
    ...
    void assert_prereq() {
        ...
        assertTrue(config.getSecurity().isAllowActionsWithSafeSemanticsToBeInvokedWithOnlyViewingPermission());
    }
