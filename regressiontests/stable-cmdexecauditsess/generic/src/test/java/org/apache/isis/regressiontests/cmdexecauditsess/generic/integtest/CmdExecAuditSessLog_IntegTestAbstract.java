 ...
 *  under the License.
 */
package org.apache.isis.regressiontests.cmdexecauditsess.generic.integtest;
...
public abstract class CmdExecAuditSessLog_IntegTestAbstract extends IsisIntegrationTestAbstract {
    ...
    void invoke_mixin() {
        ...
        assertThat(executionLogEntry)
                .satisfies(x -> assertThat(x.getInteractionId()).isEqualTo(interaction.getInteractionId()))
                .satisfies(x -> assertThat(x.getCompletedAt()).isNotNull())
                .satisfies(x -> assertThat(x.getDuration()).isNotNull())
                .satisfies(x -> assertThat(x.getLogicalMemberIdentifier()).isNotNull())
                .satisfies(x -> assertThat(x.getLogicalMemberIdentifier()).isEqualTo("cmdexecauditsess.test.Counter#bumpUsingMixin"))
                .satisfies(x -> assertThat(x.getUsername()).isEqualTo("__system"))
                .satisfies(x -> assertThat(x.getTarget()).isEqualTo(target1))
                .satisfies(x -> assertThat(x.getTimestamp()).isNotNull())
                .satisfies(x -> assertThat(x.getType()).isEqualTo(DomainChangeRecord.ChangeType.EXECUTION))
                .satisfies(x -> assertThat(x.getInteractionDto())
        ...
        assertThat(commandLogEntry)
                ...
                .satisfies(x -> assertThat(x.getCompletedAt()).isNotNull())
                .satisfies(x -> assertThat(x.getDuration()).isNotNull())
                .satisfies(x -> assertThat(x.getException()).isEqualTo(""))
                .satisfies(x -> assertThat(x.getLogicalMemberIdentifier()).isNotNull())
                .satisfies(x -> assertThat(x.getLogicalMemberIdentifier()).isEqualTo("cmdexecauditsess.test.Counter#bumpUsingMixin"))
                .satisfies(x -> assertThat(x.getUsername()).isEqualTo("__system"))
                .satisfies(x -> assertThat(x.getResult()).isNotNull())
                .satisfies(x -> assertThat(x.getResultSummary()).isEqualTo("OK"))
                ...
                .satisfies(x -> assertThat(x.getTarget()).isEqualTo(target1))
                .satisfies(x -> assertThat(x.getTimestamp()).isNotNull())
                .satisfies(x -> assertThat(x.getType()).isEqualTo(DomainChangeRecord.ChangeType.COMMAND))
                .satisfies(x -> assertThat(x.getCommandDto())
                        .satisfies(dto -> assertThat(dto).isNotNull())
