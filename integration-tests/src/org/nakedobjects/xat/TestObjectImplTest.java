...
//        NakedObjectSpecificationImpl.setReflectorFactory(new InternalReflectorFactory());
 ...
 //       ClientSession.setSession()
        Session session = new Session() {};//ClientSession.getSession();
 ...
 //       target.associate("Collection", element);
