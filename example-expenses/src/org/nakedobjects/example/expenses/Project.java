...
public class Project extends BaseObject {
    ...
    private final Vector teamMembers;
    ...
    public String titleString() {
        ...
        return name.isEmpty() ? "New Project": name.titleString();
    }
