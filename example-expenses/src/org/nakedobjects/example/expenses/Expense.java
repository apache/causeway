...
public class Expense extends BaseObject {
   ...
   private final TextString description;
    ...
    public void aboutActionAuthorise(ActionAbout about) {
        about.unusableOnCondition(! isValid(), "Claim must be valid first");
    }

    public void actionAuthorise() {
        status.setValue(AUTHORISED);
        objectChanged();
    }

    public void aboutActionDisallow(ActionAbout about) {
        about.unusableOnCondition(! isValid(), "Claim must be valid first");
    }

    public void actionDisallow() {
        status.setValue(DISALLOWED);
        objectChanged();
    }
    ...
    boolean isAuthorised() {
        return status.isSameAs(AUTHORISED);
    }

    public boolean isValid() {
        return getProject() != null && status.isSameAs(OPEN);
    }
