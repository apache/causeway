...
public class DummyWorkspaceView extends AbstractView implements Workspace {
    
    public DummyWorkspaceView() {
        this(new DummyContent(), new DummyViewSpecification(), null);
    }

    public DummyWorkspaceView(Content content, ViewSpecification specification, ViewAxis axis) {
