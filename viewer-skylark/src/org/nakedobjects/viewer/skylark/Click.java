...
public class Click extends PointerEvent {
 	 ...
 	 * @param view	the view over which the pointer was when this click occurred
 	 * @param location  the location within the specified view
 	 * @param mods  the button and key held down during the click (@see java.awt.event.MouseEvent)
 	 */
