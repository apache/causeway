...
public interface View extends Cloneable {
    ...
    /**
     * Called as mouse is dragged within and without this view.  This only occurs when
     * no content or view is being dragged.
     */
    ...
    /**
     * Called as the content being dragged is dragged into this view.  This only occurs
     * when view contents are being dragged, and not when views themselves are being
     * dragged.
     */
    void dragIn(ContentDrag drag);

    /**
     * Called as the content being dragged is dragged out of this view.  This only occurs
     * when view contents are being dragged, and not when views themselves are being
     * dragged.
     */
    ...
    /**
     * Called as the drag ends within and without this view.  This only occurs when
     * no content or view is being dragged.
     */
    ...
    /**
     * Called as another view's contents (the source) is dropped on this view's contents
     * (the target).  The source view can be obtained from the ViewDrag object.
     */
    void drop(ContentDrag drag);

    /**
     * Called as another view (the source) is dropped on this view (the target).  The
     ...
     * @param at        the location where the action took place
     */
