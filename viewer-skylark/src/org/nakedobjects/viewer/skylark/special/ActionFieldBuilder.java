...
public class ActionFieldBuilder extends AbstractViewBuilder {
    ...
    private void newBuild(View view, ActionContent actionContent) {
        ...
        view.addView(new TextView(actionContent.getLabel()));
