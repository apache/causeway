...
public class LookupBorder extends OpenOptionFieldBorder {
    ...
    protected View createOverlay() {        
        OneToOneField field = (OneToOneField) getContent();
        return spec.createView(getContent(), new LookupAxis(field, getParent()));
    }
 }


class LookupAxis implements ViewAxis {
    private final OneToOneField field;

    public LookupAxis(OneToOneField field, View parentVIew) {
        this.field = field;
        this.parentView = parentVIew;
    }
    
     OneToOneField getField() {
        return field;
    }
