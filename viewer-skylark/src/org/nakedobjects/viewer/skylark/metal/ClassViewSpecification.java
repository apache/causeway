...
public class ClassViewSpecification implements ViewSpecification {
    public boolean canDisplay(Content content) {
        return content.isObject() && content.getNaked() != null && content.getNaked().getObject() instanceof NakedClass;
    }

    public View createView(Content content, ViewAxis axis) {
        return new WindowBorder(new ClassView(content, this, axis), false);
    }
    ...
    static class ClassView extends AbstractView {

        protected ClassView(Content content, ViewSpecification specification, ViewAxis axis) {
