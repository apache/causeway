...
public class RemoveOneToOneAssociationOption extends MenuOption {
    ...
    public Permission disabled(View view) {
		...
		// associated object
        OneToOneContent content = ((OneToOneContent) view.getContent());
