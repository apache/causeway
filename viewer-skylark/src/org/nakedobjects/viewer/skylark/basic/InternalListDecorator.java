...
public class InternalListDecorator extends AbstractBuilderDecorator {
	...
	public View createCompositeView(Content content, CompositeViewSpecification specification, ViewAxis axis) {
		return new InternalCollectionBorder(wrappedBuilder.createCompositeView(content, specification, axis));
	}
