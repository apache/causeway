...
public class WindowDecorator extends AbstractBuilderDecorator {
...
//		return new Identifier(new WindowBorder(new ScrollBorder(wrappedBuilder.createCompositeView(content, specification, axis))));
		return new Identifier(new WindowBorder(wrappedBuilder.createCompositeView(content, specification, axis)));
	}
