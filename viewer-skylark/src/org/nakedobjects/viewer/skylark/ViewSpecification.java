...
public interface ViewSpecification {
    ...
    /**
     * Indicates whether views to this specification are open - displaying the attributes
     * of the content object - or are closed - display only the title of the content object. 
     */
    boolean isOpen();
