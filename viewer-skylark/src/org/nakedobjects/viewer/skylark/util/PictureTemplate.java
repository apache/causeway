...
/**
 * Many icons are based on the same image, but in different sizes and possibly different
 * colours.  The ImageTemplate class loads and holds them image, and can provide it clients 
 * with the full sized images or scaled images.
 */
class PictureTemplate {
    private final static Logger LOG = Logger.getLogger(PictureTemplate.class);
    private Image image;
    ...
    public Picture getFullSizeImage() {
        return new Picture(image);
    }

    public Picture getIcon(int height, Color tint) {
        Image iconImage;
