...
The xref:refguide:valuetypes:index/asciidoc/applib/value/AsciiDoc.adoc[] value type is intended to render HTML markup that is authored using https://asciidoctor.org/[AsciiDoc(tor)] markup language.

In addition, this module provides a number of variants: xref:refguide:valuetypes:index/asciidoc/applib/value/AsciiDocXml.adoc[], xref:refguide:valuetypes:index/asciidoc/applib/value/AsciiDocJson.adoc[],  xref:refguide:valuetypes:index/asciidoc/applib/value/AsciiDocYaml.adoc[] and xref:refguide:valuetypes:index/asciidoc/applib/value/AsciiDocJava.adoc[].
These are used to render XML, JSON or YAML as AsciiDoc link:https://docs.asciidoctor.org/asciidoc/latest/verbatim/source-blocks/[source blocks].
