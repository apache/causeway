...
public class ActionSemanticsAnnotationFacetFactoryTest extends AbstractFacetFactoryTest {

    private ActionSemanticsAnnotationFacetFactory facetFactory;

    @Override
    protected void setUp() throws Exception {
        super.setUp();

        facetFactory = new ActionSemanticsAnnotationFacetFactory();
    }
