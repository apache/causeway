...
public class CollectionOidTest_valueSemantics extends ValueTypeContractTestAbstract<CollectionOid> {
    ...
    protected List<CollectionOid> getObjectsWithSameValue() {
        return Arrays.asList(new CollectionOid(parent, "456"), new CollectionOid(parent, "456"), new CollectionOid(parent, "456"));
    }

    @Override
    protected List<CollectionOid> getObjectsWithDifferentValue() {
        return Arrays.asList(new CollectionOid(otherParent, "456"), new CollectionOid(parent, "457"), new CollectionOid(yetAnotherParent, "456"));
    }
