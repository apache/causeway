...
public abstract class ServicesInjectorAbstract implements ServicesInjector {
    ...
    @Override
    public void injectDependenciesInto(final List<Object> objects) {
        for (final Object object : objects) {
            injectDependenciesInto(object);
        }
    }
    ...
    private void autowireServicesAndContainer() {
        injectDependenciesInto(this.services);
        injectDependenciesInto(this.container);
    }
