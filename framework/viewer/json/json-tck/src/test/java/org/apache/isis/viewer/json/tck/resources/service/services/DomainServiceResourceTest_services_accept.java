...
public class DomainServiceResourceTest_services_accept {
    ...
    public void applicationJson() throws Exception {
        ...
        final RestfulRequest request = 
                client.createRequest(HttpMethod2.GET, "services").withHeader(RestfulRequest.Header.ACCEPT, MediaType.APPLICATION_JSON_TYPE);
    ...
    public void applicationJson_profileList() throws Exception {
        ...
        final RestfulRequest request = 
                client.createRequest(HttpMethod2.GET, "services").withHeader(RestfulRequest.Header.ACCEPT, RepresentationType.LIST.getMediaType());
        final RestfulResponse<HomePageRepresentation> restfulResponse = request.executeT();
    ...
    public void applicationJson_invalid() throws Exception {
        ...
        final RestfulRequest request = client.createRequest(HttpMethod2.GET, "services").withHeader(RestfulRequest.Header.ACCEPT, RepresentationType.USER.getMediaType());
        final RestfulResponse<HomePageRepresentation> restfulResponse = request.executeT();
