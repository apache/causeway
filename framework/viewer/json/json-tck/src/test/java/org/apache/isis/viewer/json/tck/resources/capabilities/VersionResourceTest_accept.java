...
public class VersionResourceTest_accept {
    ...
    public void applicationJson() throws Exception {
        ...
        final RestfulRequest request = 
                client.createRequest(HttpMethod2.GET, "version").withHeader(RestfulRequest.Header.ACCEPT, MediaType.APPLICATION_JSON_TYPE);
    ...
    public void applicationJson_profileVersion() throws Exception {
        ...
        final RestfulRequest request = 
                client.createRequest(HttpMethod2.GET, "version").withHeader(RestfulRequest.Header.ACCEPT, RepresentationType.VERSION.getMediaType());
        final RestfulResponse<VersionRepresentation> restfulResponse = request.executeT();
