...
@Service
public class ActionCommandDispatchJdoSeedService extends SeedServiceAbstract {

    public ActionCommandDispatchJdoSeedService() {
    ...
    static class PropertyPublishingJdoEntityFixture extends FixtureScript {
        ...
        protected void execute(ExecutionContext executionContext) {
            samples.stream()
                    .map(ActionCommandDispatchJdo::new)
