 ...
 *  under the License.
 */
package demoapp.dom.annotDomain.Action.executionDispatch;
...
public class ActionExecutionDispatchJdo
        implements HasAsciiDocDescription, ExposeCapturedInteractions {
    // ...
//end::class[]

    public ActionExecutionDispatchJdo(String initialValue) {
...
//tag::annotation[]
    ...
    public ActionExecutionDispatchJdo updatePropertyUsingAnnotation(final String value) {
        setProperty(value);
        return this;
    }
...
//tag::meta-annotation[]
    @ActionExecutionDispatchEnabledMetaAnnotation      // <.>
    @Action(
        semantics = SemanticsOf.IDEMPOTENT
    ...
    public ActionExecutionDispatchJdo updatePropertyUsingMetaAnnotation(final String value) {
...
//tag::meta-annotation-overridden[]
    ...
    public ActionExecutionDispatchJdo updatePropertyUsingMetaAnnotationButOverridden(final String value) {
