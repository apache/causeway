...
@PersistenceCapable(
    ...
    schema = "demo",
    table = "DomainObjectIntrospectionAnnotOptEntity"
)
...
public class DomainObjectIntrospectionAnnotOptEntityImpl
        extends DomainObjectIntrospectionAnnotOptEntity {
    // ...
//end::class[]

    public DomainObjectIntrospectionAnnotOptEntityImpl(String value) {
        setName(value);
    }
//tag::class[]
