...
But, for less experienced users, or for new features, the link:https://causeway.apache.org/refguide/2.0.0-SNAPSHOT/applib/index/annotation/ActionLayout.html#describedas[@ActionLayout#describedAs] allows you to provide brief additional information about all object members.
