...
The link:https://causeway.apache.org/refguide/2.0.0-SNAPSHOT/applib/index/annotation/Property.html#regexpattern[@Property#regexPattern] attribute specifies a regular expression that the value entered into the property must match:
