...
//end::class[]
    public JavaTimeLocalTimeVm(final java.time.LocalTime initialValue) {
        this.readOnlyProperty = initialValue;
        this.readWriteProperty = initialValue;
    }

//tag::class[]
    @Title(prepend = "java.time.LocalTime view model: ")
    @PropertyLayout(fieldSetId = "read-only-properties", sequence = "1")
    @XmlElement(required = true)                                                // <.>
    @XmlJavaTypeAdapter(JavaTimeJaxbAdapters.LocalTimeToStringAdapter.class)                // <.>
    @Getter @Setter
