...
[source,java]
----
include::ActionAssociateWithPage.java[tags=class-properties]
----
...
----
include::ActionAssociateWithPage.java[tags=action-associateWith-property]
----
...
[source,java]
----
include::ActionAssociateWithPage.java[tags=class-collections-children]
----
...
[source,java,indent=0]
----
include::ActionAssociateWithPage.java[tags=action-associateWith-children-1]
----
...
[source,java,indent=0]
----
include::ActionAssociateWithPage.java[tags=action-associateWith-children-2]
----
<.> associates with the "children" collection
...
[source,java,indent=0]
----
include::ActionAssociateWithPage.java[tags=action-associateWith-children-3]
----
<.> associates with the "children" collection
...
[source,java]
----
include::ActionAssociateWithPage.java[tags=class-collections-favorites]
----
