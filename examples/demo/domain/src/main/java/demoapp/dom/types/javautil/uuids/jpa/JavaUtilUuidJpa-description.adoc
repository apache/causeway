...
Apache Causeway provides its own implementation of the relevant JPA extension points for the `UUID` value type, meaning that JPA can persist properties of this value type without further configuration.
