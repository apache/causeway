...
The link:https://causeway.apache.org/refguide/2.0.0-SNAPSHOT/applib/index/annotation/ActionLayout.html#named[@ActionLayout#named] element allows you to override the name (as used for rendering) from that derived from the action's method name).
