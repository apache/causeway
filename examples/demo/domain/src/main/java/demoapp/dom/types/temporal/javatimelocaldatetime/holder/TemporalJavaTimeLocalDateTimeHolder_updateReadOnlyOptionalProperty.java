...
public class TemporalJavaTimeLocalDateTimeHolder_updateReadOnlyOptionalProperty {

    private final TemporalJavaTimeLocalDateTimeHolder holder;

    public TemporalJavaTimeLocalDateTimeHolder act(
            @Parameter(optionality = Optionality.OPTIONAL)              // <.>
            java.time.LocalDateTime newValue
    ) {
