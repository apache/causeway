...
The `labelPosition` attribute indicates where the label for a property to be rendered: typically to the left or the top, or sometimes none:
...
----
include::PropertyLayoutLabelPositionPage.java[tags=annotation]
----
...
For properties (not parameters), the CSS class can be specified using the `Xxx.layout.xml` file:

* property definition:
+
[source,java,indent=0]
----
include::PropertyLayoutLabelPositionPage.java[tags=layout-file]
----
...
[source,java,indent=0]
----
include::PropertyLayoutLabelPositionPage.java[tags=variants-left]
----
...
[source,java,indent=0]
----
include::PropertyLayoutLabelPositionPage.java[tags=variants-top]
----
...
[source,java,indent=0]
----
include::PropertyLayoutLabelPositionPage.java[tags=variants-right]
----
...
[source,java,indent=0]
----
include::PropertyLayoutLabelPositionPage.java[tags=variants-right-boolean]
----
...
[source,java,indent=0]
----
include::PropertyLayoutLabelPositionPage.java[tags=variants-none]
----
...
[source,java,indent=0]
----
include::PropertyLayoutLabelPositionPage.java[tags=variants-none-multiline]
----
...
[source,java,indent=0]
----
include::PropertyLayoutLabelPositionPage.java[tags=variants-not-specified]
----
