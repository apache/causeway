...
[NOTE]
====
In this demo we are somewhat misusing the `@PropertyLayout#repainting` element; normally this is used for components that are expensive to render _and_ which are generally unchanging.
