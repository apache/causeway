...
public class JavaLangStrings implements HasAsciiDocDescription {
    ...
    @ObjectSupport public String title() {
        return "java.lang.String data type";
    }

    @Action(semantics = SemanticsOf.SAFE)
    @ActionLayout(promptStyle = PromptStyle.DIALOG_MODAL)
    public JavaLangStringVm openViewModel(final java.lang.String initialValue) {
        return new JavaLangStringVm(initialValue);
    }
    @MemberSupport public java.lang.String default0OpenViewModel() {
    ...
    @Inject
    @XmlTransient
    ValueHolderRepository<java.lang.String, ? extends JavaLangStringEntity> entities;
