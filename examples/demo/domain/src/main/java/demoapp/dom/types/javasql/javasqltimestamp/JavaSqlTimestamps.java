...
import demoapp.dom.types.javasql.javasqltimestamp.jdo.JavaSqlTimestampJdoEntities;
import demoapp.dom.types.javasql.javasqltimestamp.jdo.JavaSqlTimestampJdo;
...
public class JavaSqlTimestamps implements HasAsciiDocDescription {
    ...
    @Collection
    public List<JavaSqlTimestampJdo> getEntities() {
        return entities.all();
    }

    @Inject
    @XmlTransient
    JavaSqlTimestampJdoEntities entities;
