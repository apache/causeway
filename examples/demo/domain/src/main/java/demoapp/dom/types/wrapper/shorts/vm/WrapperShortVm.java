 ...
 *  under the License.
 */
package demoapp.dom.types.wrapper.shorts.vm;
...
import demoapp.dom.types.wrapper.shorts.holder.WrapperShortHolder;
...
public class WrapperShortVm
        implements HasAsciiDocDescription, WrapperShortHolder {
