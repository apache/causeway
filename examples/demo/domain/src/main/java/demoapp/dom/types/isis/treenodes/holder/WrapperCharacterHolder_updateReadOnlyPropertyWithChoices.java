 ...
 *  under the License.
 */
package demoapp.dom.types.isis.treenodes.holder;
...
public class IsisTreeNodeHolder_updateReadOnlyPropertyWithChoices {

    private final IsisTreeNodeHolder holder;

    public IsisTreeNodeHolder act(Character newValue) {
