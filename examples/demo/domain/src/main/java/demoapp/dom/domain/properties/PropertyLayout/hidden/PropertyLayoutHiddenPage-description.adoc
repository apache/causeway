...
----
include::PropertyLayoutHiddenPage.java[tags=annotation]
----
...
For properties (not parameters), the `hidden` element can be specified using the `Xxx.layout.xml` file:

* property definition:
+
[source,java,indent=0]
----
include::PropertyLayoutHiddenPage.java[tags=layout-file]
----
...
[source,java,indent=0]
----
include::PropertyLayoutHiddenPage.java[tags=variants-everywhere]
----
...
[source,java,indent=0]
----
include::PropertyLayoutHiddenPage.java[tags=variants-anywhere]
----
...
[source,java,indent=0]
----
include::PropertyLayoutHiddenPage.java[tags=meta-annotated]
----
...
[source,java,indent=0]
----
include::PropertyLayoutHiddenPage.java[tags=meta-annotated-overridden]
----
