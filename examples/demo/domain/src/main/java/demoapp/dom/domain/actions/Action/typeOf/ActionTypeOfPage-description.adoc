...
+
CAUTION: this feature is currently broken - try entering 'M' and only the icons are shown.  Tracked with link:https://issues.apache.org/jira/browse/CAUSEWAY-3423[CAUSEWAY-3423].
