...
public class TemporalJavaTimeLocalDateTimeHolder_updateReadOnlyPropertyWithChoices {

    private final TemporalJavaTimeLocalDateTimeHolder holder;

    public TemporalJavaTimeLocalDateTimeHolder act(java.time.LocalDateTime newValue) {
