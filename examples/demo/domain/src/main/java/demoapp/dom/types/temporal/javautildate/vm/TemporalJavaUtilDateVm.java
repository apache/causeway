 ...
 *  under the License.
 */
package demoapp.dom.types.temporal.javautildate.vm;
...
import demoapp.dom.types.temporal.javautildate.holder.TemporalJavaUtilDateHolder;
...
public class TemporalJavaUtilDateVm
        implements HasAsciiDocDescription, TemporalJavaUtilDateHolder {

//end::class[]
    public TemporalJavaUtilDateVm(java.util.Date initialValue) {
        this.readOnlyProperty = initialValue;
        this.readWriteProperty = initialValue;
    }

//tag::class[]
    @Title(prepend = "java.util.Date (wrapper) view model: ")
