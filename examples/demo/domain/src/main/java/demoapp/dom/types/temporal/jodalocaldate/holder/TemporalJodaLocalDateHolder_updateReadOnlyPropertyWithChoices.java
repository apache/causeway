 ...
 *  under the License.
 */
package demoapp.dom.types.temporal.jodalocaldate.holder;
...
public class TemporalJodaLocalDateHolder_updateReadOnlyPropertyWithChoices {

    private final TemporalJodaLocalDateHolder holder;

    public TemporalJodaLocalDateHolder act(org.joda.time.LocalDate newValue) {
