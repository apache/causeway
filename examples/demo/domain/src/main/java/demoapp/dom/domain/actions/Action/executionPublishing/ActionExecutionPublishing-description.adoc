...
.ActionExecutionPublishing_changeNamePublished.java
----
include::ActionExecutionPublishing_changeNamePublished.java[tags=class]
----
...
+
[source,java,indent=0]
.ActionCommandPublishing_changeNamePublished.java
----
include::ActionExecutionPublishing_publishedExecutions.java[tags=class]
----
