...
* for properties, the attribute can be specified using the `@PropertyLayout` annotation, or using the `Xxx.layout.xml` layout file.
...
[source,java,indent=0]
----
include::PropertyLayoutMultiLinePage.java[tags=meta-annotated]
----
