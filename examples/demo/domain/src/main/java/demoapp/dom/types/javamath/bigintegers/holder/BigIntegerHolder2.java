...
public interface BigIntegerHolder2 extends BigIntegerHolder {
    ...
    default BigInteger getReadOnlyPropertyDerivedLabelPositionLeft() {
    ...
    default BigInteger getReadOnlyPropertyDerivedLabelPositionTop() {
        return getReadOnlyProperty();
    }
    ...
    default BigInteger getReadOnlyPropertyDerivedLabelPositionRight() {
        return getReadOnlyProperty();
    }
    ...
    default BigInteger getReadOnlyPropertyDerivedLabelPositionNone() {
        return getReadOnlyProperty();
    }
