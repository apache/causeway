...
//end::class[]
    public JavaLangStringJpa(final java.lang.String initialValue) {
...
//tag::class[]
    ...
    @Title(prepend = "java.lang.String JPA entity: ")
    ...
    @Column(nullable = false)
    @Getter @Setter
    private java.lang.String readWriteProperty;

    @Property(optionality = Optionality.OPTIONAL)                               // <.>
    @PropertyLayout(fieldSetId = "optional-properties", sequence = "1")
    @Column(nullable = true)                                                    // <.>
    @Getter @Setter
    private java.lang.String readOnlyOptionalProperty;

    @Property(editing = Editing.ENABLED, optionality = Optionality.OPTIONAL)
    @PropertyLayout(fieldSetId = "optional-properties", sequence = "2")
    @Column(nullable = true)
    @Getter @Setter
    private java.lang.String readWriteOptionalProperty;
