...
public class PropertyOptionalityPage_updateMandatoryWithParameterLayout {
...
//tag::annotation[]
    @MemberSupport public PropertyOptionalityPage act(
        ...
        page.setMandatoryPropertyUsingAnnotation(mandatoryParameterUsingAnnotation);
        return page;
    }
//end::annotation[]
    @MemberSupport public String default0Act() {
        return page.getMandatoryPropertyUsingAnnotation();
    }
