...
public interface ZonedDateTimeHolder2 extends ZonedDateTimeHolder {
    ...
    default ZonedDateTime getReadOnlyPropertyDerivedLabelPositionLeft() {
    ...
    default ZonedDateTime getReadOnlyPropertyDerivedLabelPositionTop() {
        return getReadOnlyProperty();
    }
    ...
    default ZonedDateTime getReadOnlyPropertyDerivedLabelPositionRight() {
        return getReadOnlyProperty();
    }
    ...
    default ZonedDateTime getReadOnlyPropertyDerivedLabelPositionNone() {
        return getReadOnlyProperty();
    }
