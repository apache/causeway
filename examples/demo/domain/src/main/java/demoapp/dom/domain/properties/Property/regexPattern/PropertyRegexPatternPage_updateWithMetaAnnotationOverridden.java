...
public class PropertyRegexPatternPage_updateWithMetaAnnotationOverridden {
...
//tag::meta-annotation-overridden[]
    @MemberSupport public PropertyRegexPatternPage act(
        ...
        propertyRegexPatternPage.setEmailAddressPropertyUsingMetaAnnotationButOverridden(emailAddressParameterUsingMetaAnnotationButOverridden);
        return propertyRegexPatternPage;
    }
//end::meta-annotation-overridden[]
    @MemberSupport public String default0Act() {
        return propertyRegexPatternPage.getEmailAddressPropertyUsingMetaAnnotationButOverridden();
    }
