 ...
 *  under the License.
 */
package demoapp.dom.domain.collections.Collection.typeOf.child;
...
//tag::class[]
@Named("demo.CollectionTypeOfChildVm")
@DomainObject(nature=Nature.VIEW_MODEL)
@XmlRootElement(name = "child")
@XmlType
@XmlAccessorType(XmlAccessType.FIELD)
@NoArgsConstructor
public class CollectionTypeOfChildVm implements HasAsciiDocDescription {

    public CollectionTypeOfChildVm(final String value) {
        setValue(value);
