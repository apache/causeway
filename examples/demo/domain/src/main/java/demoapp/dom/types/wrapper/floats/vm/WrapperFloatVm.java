 ...
 *  under the License.
 */
package demoapp.dom.types.wrapper.floats.vm;
...
import demoapp.dom.types.wrapper.floats.holder.WrapperFloatHolder;
...
public class WrapperFloatVm
        implements HasAsciiDocDescription, WrapperFloatHolder {
