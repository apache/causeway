...
[source,java,indent=0]
----
include::PropertyLayoutDescribedAsPage.java[tags=layout-file]
----
...
[source,java,indent=0]
----
include::PropertyLayoutDescribedAsPage.java[tags=meta-annotated]
----
...
[source,java,indent=0]
----
include::PropertyLayoutDescribedAsPage.java[tags=meta-annotated-overridden]
----
