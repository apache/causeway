...
public class TemporalJavaTimeLocalDateJdo                                          // <.>
        implements HasAsciiDocDescription, TemporalJavaTimeLocalDateHolder {

//end::class[]
    public TemporalJavaTimeLocalDateJdo(java.time.LocalDate initialValue) {
        this.readOnlyProperty = initialValue;
        this.readWriteProperty = initialValue;
    }

//tag::class[]
    @Title(prepend = "java.time.LocalDate (wrapper) JDO entity: ")
