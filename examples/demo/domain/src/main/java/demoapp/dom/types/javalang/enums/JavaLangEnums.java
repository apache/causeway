...
public class JavaLangEnums implements HasAsciiDocDescription {
    ...
    @ObjectSupport public String title() {
        return "demoapp.dom._infra.samples.DemoEnum data type";
    }

    @Action(semantics = SemanticsOf.SAFE)
    @ActionLayout(promptStyle = PromptStyle.DIALOG_MODAL)
    public JavaLangEnumVm openViewModel(final demoapp.dom._infra.samples.DemoEnum initialValue) {
        return new JavaLangEnumVm(initialValue);
    }
    @MemberSupport public demoapp.dom._infra.samples.DemoEnum default0OpenViewModel() {
    ...
    @Inject
    @XmlTransient
    ValueHolderRepository<demoapp.dom._infra.samples.DemoEnum, ? extends JavaLangEnumEntity> entities;
