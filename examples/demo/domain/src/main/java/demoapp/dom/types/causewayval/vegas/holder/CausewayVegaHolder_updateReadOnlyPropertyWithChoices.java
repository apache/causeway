...
public class CausewayVegaHolder_updateReadOnlyPropertyWithChoices {
    ...
    @MemberSupport public org.apache.causeway.valuetypes.vega.applib.value.Vega default0Act() {
        return holder.getReadOnlyProperty();
    }

    @MemberSupport public List<org.apache.causeway.valuetypes.vega.applib.value.Vega> choices0Act() {
        return samples.stream()
                .collect(Collectors.toList());
    }

    @Inject
    Samples<org.apache.causeway.valuetypes.vega.applib.value.Vega> samples;
