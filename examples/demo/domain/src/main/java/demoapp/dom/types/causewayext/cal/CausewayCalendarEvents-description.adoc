...
WARNING: TODO v2 - was copy pasted from UUID

The framework has built-in support for the `CalendarEvent` data type.

From here you can:

* navigate to an entity that uses the `CalendarEvent` datatype
* open a view model that uses the `CalendarEvent` datatype
