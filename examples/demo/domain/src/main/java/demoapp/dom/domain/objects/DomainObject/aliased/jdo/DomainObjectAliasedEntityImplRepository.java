...
@Profile("demo-jdo")
@Service
public class DomainObjectAliasedEntityImplRepository
extends ValueHolderRepository<String, DomainObjectAliasedEntityImpl> implements DomainObjectAliasedEntityRepository {

    protected DomainObjectAliasedEntityImplRepository() {
        super(DomainObjectAliasedEntityImpl.class);
    }
