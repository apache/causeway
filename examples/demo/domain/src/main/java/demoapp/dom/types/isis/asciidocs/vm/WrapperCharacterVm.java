 ...
 *  under the License.
 */
package demoapp.dom.types.isis.asciidoc.vm;
...
import demoapp.dom.types.isis.asciidoc.holder.IsisAsciiDocHolder;
...
//end::class[]
    public IsisAsciiDocVm(Character initialValue) {
