...
extends ValueHolderRepository<demoapp.dom._infra.samples.DemoEnum, JavaLangEnumJdo> {
    ...
    @Override
    protected JavaLangEnumJdo newDetachedEntity(demoapp.dom._infra.samples.DemoEnum value) {
