...
They don't contribute directly to the concrete `MixinVm` class.
Since all they require is a count value, they instead contribute to the `CountHolder` interface that the `MixinVm` class implements:
