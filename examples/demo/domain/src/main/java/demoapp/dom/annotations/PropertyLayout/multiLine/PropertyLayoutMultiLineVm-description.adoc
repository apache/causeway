The "multiLine" hint indicates that a textbox of the specified number of lines should be used to render a property or parameter:
...
The multiline hint can be specified explicitly using an annotation:
...
For properties (not parameters), the multiline hint can be specified using the `Xxx.layout.xml` file:
...
The multiline hint can also be specified using a custom meta-annotation:
