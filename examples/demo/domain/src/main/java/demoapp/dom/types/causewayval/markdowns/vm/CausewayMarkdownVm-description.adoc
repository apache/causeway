...
Apache Causeway provides its own implementation of `@XmlJavaTypeAdapter` for the `Markdown` value type, meaning that JAXB can serialize properties of this value type without further configuration.
