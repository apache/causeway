...
@Named("demo.CausewayClobVm")
@DomainObject(
        nature=Nature.VIEW_MODEL)
@lombok.NoArgsConstructor                                                       // <.>
public class CausewayClobVm
        implements HasAsciiDocDescription, CausewayClobHolder2 {

//end::class[]
    public CausewayClobVm(final Clob initialValue) {
