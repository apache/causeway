...
The link:https://causeway.apache.org/refguide/2.0.0-SNAPSHOT/applib/index/annotation/Action.html#executionpublishing[@Action#hidden] element specifies whether an action should be visible in the UI or not.
