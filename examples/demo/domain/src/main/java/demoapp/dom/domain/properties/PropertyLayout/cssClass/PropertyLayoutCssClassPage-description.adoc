...
[source,java,indent=0]
----
include::PropertyLayoutCssClassPage.java[tags=layout-file]
----
...
//include::PropertyLayoutCssClassPage.layout.xml[tags=layout-file]
...
[source,java,indent=0]
----
include::PropertyLayoutCssClassPage.java[tags=meta-annotated]
----
...
[source,java,indent=0]
----
include::PropertyLayoutCssClassPage.java[tags=meta-annotated-overridden]
----
