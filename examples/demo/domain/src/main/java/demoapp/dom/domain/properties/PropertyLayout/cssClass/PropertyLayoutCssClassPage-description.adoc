...
* for properties, the attribute can be specified using either the `@PropertyLayout` annotation, or using the `Xxx.layout.xml` layout file.
...
[source,java,indent=0]
----
include::PropertyLayoutCssClassPage_updateWithParameterLayout.java[tags=annotation]
----
...
[source,java,indent=0]
----
include::PropertyLayoutCssClassPage_updateWithMetaAnnotation.java[tags=meta-annotation]
----
<.> hint is inherited from the meta-annotation
...
[source,java,indent=0]
----
include::PropertyLayoutCssClassPage_mixinPropertyWithMetaAnnotation.java[tags=class]
----
<.> hint is inherited from the meta-annotation
...
[source,java,indent=0]
----
include::PropertyLayoutCssClassPage_updateWithMetaAnnotationOverridden.java[tags=meta-annotation-overridden]
----
<.> hint from meta-annotation ...
...
[source,java,indent=0]
----
include::PropertyLayoutCssClassPage_mixinPropertyWithMetaAnnotationOverridden.java[tags=meta-annotation-overridden]
----
<.> hint from meta-annotation ...
<.> \... is overridden by the `@PropertyLayout` annotation
