...
public class BigDecimalHolder_updateReadOnlyOptionalPropertyWithChoices {
    ...
    @MemberSupport public BigDecimal default0Act() {
        return holder.getReadOnlyOptionalProperty();
    }

    @MemberSupport public List<BigDecimal> choices0Act() {
