...
@Table(
      schema = "demo",
      name = "ZonedDateTimeJpa"
)
@EntityListeners(CausewayEntityListener.class)
@Named("demo.ZonedDateTimeEntity")
@DomainObject
@NoArgsConstructor                                                             // <.>
public class ZonedDateTimeJpa
        extends ZonedDateTimeEntity {

//end::class[]
    public ZonedDateTimeJpa(final ZonedDateTime initialValue) {
...
//tag::class[]
    ...
    @Title(prepend = "ZonedDateTime JPA entity: ")
