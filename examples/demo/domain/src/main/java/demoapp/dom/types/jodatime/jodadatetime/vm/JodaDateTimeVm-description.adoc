...
Apache Causeway provides its own implementation of `@XmlJavaTypeAdapter` for the `DateTime` value type, meaning that JAXB can serialize properties of this value type without further configuration.
