...
These objects both implement a common interface, `WrapperShortHolder`:
...
There is also an extension of this interface, `WrapperShortHolder2`, with default methods demonstrating the use of label positions:
