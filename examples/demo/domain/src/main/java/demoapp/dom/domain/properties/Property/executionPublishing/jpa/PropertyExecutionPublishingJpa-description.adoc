...
----
include::PropertyExecutionPublishingJpa.java[tags=annotation]
----
...
[source,java,indent=0]
----
include::PropertyExecutionPublishingJpa.java[tags=meta-annotated]
----
...
[source,java,indent=0]
----
include::PropertyExecutionPublishingJpa.java[tags=meta-annotated-overridden]
----
