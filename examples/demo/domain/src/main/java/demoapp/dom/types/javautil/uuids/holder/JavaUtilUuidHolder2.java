...
public interface JavaUtilUuidHolder2 extends JavaUtilUuidHolder {
    ...
    default UUID getReadOnlyPropertyDerivedLabelPositionLeft() {
    ...
    default UUID getReadOnlyPropertyDerivedLabelPositionTop() {
        return getReadOnlyProperty();
    }
    ...
    default UUID getReadOnlyPropertyDerivedLabelPositionRight() {
        return getReadOnlyProperty();
    }
    ...
    default UUID getReadOnlyPropertyDerivedLabelPositionNone() {
        return getReadOnlyProperty();
    }
