 ...
 *  under the License.
 */
package demoapp.dom.types.temporal.javatimeoffsetdatetime.vm;
...
public class TemporalJavaTimeOffsetDateTimeVm
        implements HasAsciiDocDescription, TemporalJavaTimeOffsetDateTimeHolder {

//end::class[]
    public TemporalJavaTimeOffsetDateTimeVm(java.time.OffsetDateTime initialValue) {
        this.readOnlyProperty = initialValue;
        this.readWriteProperty = initialValue;
    }

//tag::class[]
    @Title(prepend = "java.time.OffsetDateTime (wrapper) view model: ")
