...
extends ValueHolderRepository<demoapp.dom._infra.samples.DemoEnum, JavaLangEnumJpa> {
    ...
    @Override
    protected JavaLangEnumJpa newDetachedEntity(demoapp.dom._infra.samples.DemoEnum value) {
