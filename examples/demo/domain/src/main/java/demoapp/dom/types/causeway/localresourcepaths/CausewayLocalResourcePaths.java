...
//@Log4j2
public class CausewayLocalResourcePaths implements HasAsciiDocDescription {
    ...
    @Collection
    public List<? extends CausewayLocalResourcePathEntity> getEntities() {
        return entities.all();
    }

    @Inject
    @XmlTransient
    ValueHolderRepository<LocalResourcePath, ? extends CausewayLocalResourcePathEntity> entities;
