...
@Named("demo.CausewayLocalResourcePathVm")
@DomainObject(
        nature=Nature.VIEW_MODEL)
@lombok.NoArgsConstructor                                                       // <.>
public class CausewayLocalResourcePathVm
        implements HasAsciiDocDescription, CausewayLocalResourcePathHolder2 {

//end::class[]
    public CausewayLocalResourcePathVm(final LocalResourcePath initialValue) {
