...
public class ActionAssociateWithPage implements HasAsciiDocDescription {

//end::class-properties[]
//end::class-collections-children[]
//end::class-collections-favorites[]
    public ActionAssociateWithPage(final String text) {
        this.text = text;
    }
...
//tag::action-associateWith-property[]
    ...
    public ActionAssociateWithPage updateText(final String text) {
        setText(text);
        return this;
    }
...
//tag::action-associateWith-children-1[]
    ...
    public ActionAssociateWithPage addChild(final String value) {
...
//tag::action-associateWith-children-2[]
    ...
    public ActionAssociateWithPage removeChild(final ActionAssociateWithChildVm child) {
...
//tag::action-associateWith-children-3[]
    ...
    public ActionAssociateWithPage removeChildren(final List<ActionAssociateWithChildVm> children) {
