...
[source,java,indent=0]
----
include::PropertyLayoutNamedPage.java[tags=meta-annotated]
----
...
[source,java,indent=0]
----
include::PropertyLayoutNamedPAge_updateWithMetaAnnotation.java[tags=meta-annotation]
----
...
[source,java,indent=0]
----
include::PropertyLayoutNamedPage.java[tags=meta-annotated-overridden]
----
...
[source,java,indent=0]
----
include::PropertyLayoutNamedPage_updateWithMetaAnnotationOverridden.java[tags=meta-annotation-overridden]
----
<.> name from meta-annotation ...
<.> \... is overridden by the `@PropertyLayout` annotation
