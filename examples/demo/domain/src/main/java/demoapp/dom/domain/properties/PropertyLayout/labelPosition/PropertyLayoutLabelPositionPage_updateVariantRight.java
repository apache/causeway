...
public class PropertyLayoutLabelPositionPage_updateVariantRight {
...
//tag::annotation[]
    @MemberSupport public PropertyLayoutLabelPositionPage act(
        ...
        page.setPropertyLabelPositionRight(parameterLabelPositionRight);
        return page;
    }
//end::annotation[]
    @MemberSupport public String default0Act() {
        return page.getPropertyLabelPositionRight();
    }
