...
@Service
public class IsisMarkupSamples implements Samples<org.apache.isis.applib.value.Markup> {

    @Override
    public Stream<org.apache.isis.applib.value.Markup> stream() {
        return new org.apache.isis.core.metamodel.valuesemantics.MarkupValueSemantics()
                .getExamples()
                .stream();
    }
