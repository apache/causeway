...
public class PropertyLayoutMultiLinePage_updateWithMetaAnnotationOverridden {

    private final PropertyLayoutMultiLinePage page;

//tag::meta-annotation-overridden[]
    @MemberSupport public PropertyLayoutMultiLinePage act(
