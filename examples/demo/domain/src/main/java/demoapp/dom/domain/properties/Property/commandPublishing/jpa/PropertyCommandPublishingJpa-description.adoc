...
Editing the `name` property will result in a command representing the property edit being persisted; these are listed in the collection at the bottom of the page.
...
..PropertyCommandPublishing.java
----
include::../PropertyCommandPublishing.java[tags=published]
----
...
..PropertyCommandPublishing.java
----
include::../PropertyCommandPublishing.java[tags=not-published]
----
<.> makes the property editable...
...
+
[source,java,indent=0]
.PropertyCommandPublishing_changeNamePublished.java
----
include::../PropertyCommandPublishing_publishedCommands.java[tags=class]
----
