...
public class WrapperCharacters implements HasAsciiDocDescription {
    ...
    public WrapperCharacterVm openViewModel(final java.lang.Character initialValue) {
    ...
    @Inject
    @XmlTransient
    ValueHolderRepository<java.lang.Character, ? extends WrapperCharacterEntity> entities;
