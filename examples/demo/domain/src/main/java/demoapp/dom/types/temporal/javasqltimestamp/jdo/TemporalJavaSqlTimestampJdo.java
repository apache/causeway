...
@DomainObject(
        objectType = "demo.TemporalJavaSqlTimestampJdo"
)
public class TemporalJavaSqlTimestampJdo                                          // <.>
        implements HasAsciiDocDescription, TemporalJavaSqlTimestampHolder {

//end::class[]
    public TemporalJavaSqlTimestampJdo(java.sql.Timestamp initialValue) {
        this.readOnlyProperty = initialValue;
        this.readWriteProperty = initialValue;
    }

//tag::class[]
    @Title(prepend = "java.sql.Timestamp (wrapper) JDO entity: ")
