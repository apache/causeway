...
The link:https://causeway.apache.org/refguide/2.0.0-SNAPSHOT/applib/index/annotation/Action.html#restrictto[@Action#restrictTo] element specifies whether the action should be available only in prototype mode, or at all times.
...
This page is a view model that defines three actions, each of which defines a different `restrictTo` element:
