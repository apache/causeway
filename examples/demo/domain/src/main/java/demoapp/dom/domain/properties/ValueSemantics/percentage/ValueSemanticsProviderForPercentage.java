...
public class ValueSemanticsProviderForPercentage extends BigDecimalValueSemantics {

        @Override
        public String htmlPresentation(final ValueSemanticsProvider.Context context, final BigDecimal value) {
            return value.multiply(BigDecimal.valueOf(100)).setScale(2, RoundingMode.HALF_EVEN) + "%";
        }
}
