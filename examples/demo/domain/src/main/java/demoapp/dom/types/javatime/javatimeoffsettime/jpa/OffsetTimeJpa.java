...
@Named("demo.OffsetTimeEntity")
@DomainObject
@NoArgsConstructor                                                             // <.>
public class OffsetTimeJpa
        extends OffsetTimeEntity {

//end::class[]
    public OffsetTimeJpa(final OffsetTime initialValue) {
...
//tag::class[]
    ...
    @Title(prepend = "OffsetTime JPA entity: ")
