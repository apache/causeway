...
The `snapshot` attribute of the `@Property` annotation specifies whether a property should be included in an XML snapshot, as created by the `XmlSnapshotService`.
...
[source,java,indent=0]
----
include::PropertySnapshotPage.java[tags=meta-annotated-included]
----
+
...
[source,java,indent=0]
----
include::PropertySnapshotPage.java[tags=meta-annotated-excluded]
----
+
where the meta-annotation is:
+
...
<app:PropertySnapshotVm
    ...
    causeway:fqn="demoapp.dom.domain.properties.Property.snapshot.PropertySnapshotPage"
    causeway:oid="demo.PropertySnapshotVm:..."
    causeway:plural="Property Snapshot Vms"
    causeway:singular="Property Snapshot Vm"
    xsi:schemaLocation="... demoapp.dom.domain.properties.Property.snapshot.PropertySnapshotPage.xsd">
