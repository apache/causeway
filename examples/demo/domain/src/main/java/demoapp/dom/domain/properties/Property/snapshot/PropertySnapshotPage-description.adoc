...
The link:https://causeway.apache.org/refguide/2.0.0-RC1/applib/index/annotation/Property.html#snapshot[@Property#snapshot] attribute can be used to explicitly specifies whether a property should be included or excluded from the XML snapshot.
...
The "takeXmlSnapshot" action can be used to generate to download the generated XML as a file.
