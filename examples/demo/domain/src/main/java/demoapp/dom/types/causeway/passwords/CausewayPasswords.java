...
import demoapp.dom.types.causeway.passwords.vm.CausewayPasswordVm;

@XmlRootElement(name = "root")
@XmlType
@XmlAccessorType(XmlAccessType.FIELD)
@Named("demo.CausewayPasswords")
@DomainObject(nature=Nature.VIEW_MODEL, editing=Editing.ENABLED)
//@Log4j2
public class CausewayPasswords implements HasAsciiDocDescription {
    ...
    @Collection
    public List<? extends CausewayPasswordEntity> getEntities() {
        return entities.all();
    }

    @Inject
    @XmlTransient
    ValueHolderRepository<Password, ? extends CausewayPasswordEntity> entities;
