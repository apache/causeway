...
----
include::PropertyHiddenPage.java[tags=annotation]
----
...
[source,java,indent=0]
----
include::PropertyHiddenPage.java[tags=variants-everywhere]
----
...
[source,java,indent=0]
----
include::PropertyHiddenPage.java[tags=variants-anywhere]
----
...
[source,java,indent=0]
----
include::PropertyHiddenPage.java[tags=meta-annotated]
----
...
[source,java,indent=0]
----
include::PropertyHiddenPage_mixinPropertyWithMetaAnnotation.java[tags=class]
----
<.> hint is inherited from the meta-annotation
...
[source,java,indent=0]
----
include::PropertyHiddenPage.java[tags=meta-annotated-overridden]
----
...
[source,java,indent=0]
----
include::PropertyHiddenPage_mixinPropertyWithMetaAnnotationOverridden.java[tags=meta-annotation-overridden]
----
<.> hint from meta-annotation ...
