...
The link:https://causeway.apache.org/refguide/2.0.0-RC1/applib/index/annotation/ActionLayout.html#cssclass[@ActionLayout#cssClass] allows a CSS style (or styles) to be defined.
