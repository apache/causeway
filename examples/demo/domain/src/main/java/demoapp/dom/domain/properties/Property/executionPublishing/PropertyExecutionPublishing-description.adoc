...
..PropertyExecutionPublishing.java
----
include::PropertyExecutionPublishing.java[tags=published]
----
...
..PropertyExecutionPublishing.java
----
include::PropertyExecutionPublishing.java[tags=not-published]
----
<.> makes the property editable...
...
+
[source,java,indent=0]
.PropertyExecutionPublishing_changeNamePublished.java
----
include::PropertyExecutionPublishing_publishedExecutions.java[tags=class]
----
