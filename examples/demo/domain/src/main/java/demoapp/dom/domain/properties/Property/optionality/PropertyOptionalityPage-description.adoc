...
The `optionality` attribute specifies that a property or parameter is either optional or mandatory:
...
----
include::PropertyOptionalityPage.java[tags=annotation]
----
...
The `optionality` attribute can also be specified using a custom meta-annotation:
...
[source,java,indent=0]
----
include::PropertyOptionalityPage.java[tags=meta-annotated]
----
...
[source,java,indent=0]
----
include::PropertyOptionalityPage.java[tags=meta-annotated-overridden]
----
