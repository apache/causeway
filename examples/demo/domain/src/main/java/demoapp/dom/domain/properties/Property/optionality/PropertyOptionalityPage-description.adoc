...
The link:https://causeway.apache.org/refguide/2.0.0-RC1/applib/index/annotation/Property.html#optionality[@Property#optionality]  attribute specifies that a property or parameter is either optional or mandatory:
