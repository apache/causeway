...
The link:https://causeway.apache.org/refguide/2.0.0-SNAPSHOT/applib/index/annotation/Property.html#optionality[@Property#optionality]  attribute specifies that a property or parameter is either optional or mandatory:
...
If using JPA or JDO entities, the framework will infer the optionality semantics automatically.

WARNING: link:https://issues.apache.org/jira/browse/CAUSEWAY-3437[CAUSEWAY-3437] is to extend the framework to infer optionality from these JPA/JDO/JAXB equivalents.
