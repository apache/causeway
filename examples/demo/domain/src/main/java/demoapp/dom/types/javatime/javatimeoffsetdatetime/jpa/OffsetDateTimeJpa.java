...
@Table(
      schema = "demo",
      name = "OffsetDateTimeJpa"
)
@EntityListeners(CausewayEntityListener.class)
@Named("demo.OffsetDateTimeEntity")
@DomainObject
@NoArgsConstructor                                                             // <.>
public class OffsetDateTimeJpa
        extends OffsetDateTimeEntity {

//end::class[]
    public OffsetDateTimeJpa(final OffsetDateTime initialValue) {
...
//tag::class[]
    ...
    @Title(prepend = "OffsetDateTime JPA entity: ")
