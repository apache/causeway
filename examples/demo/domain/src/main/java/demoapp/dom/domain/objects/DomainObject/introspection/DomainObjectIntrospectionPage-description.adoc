...
[NOTE]
====
entities using this type do not render correctly in collections - properties are not shown as columns.
Tracking with https://issues.apache.org/jira/browse/CAUSEWAY-3471[CAUSEWAY-3471]
====
