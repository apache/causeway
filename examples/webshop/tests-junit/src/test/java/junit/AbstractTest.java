...
import objstore.dflt.todo.HandsetRepositoryDefault;

import org.junit.After;
import org.junit.Before;
import org.junit.runner.RunWith;

import dom.todo.HandsetRepository;
...
@Services({ @Service(HandsetRepositoryDefault.class) })
public abstract class AbstractTest {
    ...
    /**
     * The {@link WrapperFactory#wrap(Object) wrapped} equivalent of the {@link #setFoobarRepository(HandsetRepository)
     * injected} {@link HandsetRepository}.
     */
    protected HandsetRepository toDoItemRepository;
    ...
    public void setFoobarRepository(final HandsetRepository toDoItemRepository) {
