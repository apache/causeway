package org.apache.isis.extensions.bdd.testapp.claims.service.claim;

import java.util.List;

import org.apache.isis.applib.AbstractFactoryAndRepository;
import org.apache.isis.extensions.bdd.testapp.claims.dom.claim.Claim;
import org.apache.isis.extensions.bdd.testapp.claims.dom.claim.ClaimRepository;
...
public class ClaimRepositoryInMemory extends AbstractFactoryAndRepository implements ClaimRepository {
	...
	public Claim newClaimWithDescription(Claimant claimant, String description) {
		Claim newClaim = newClaim(claimant);
