 ...
 * MethodInfos on the <code>Element</code> interface to retrieve either an 
 * <code>Attr</code> object by name or an attribute value by name. In XML, 
 * where an attribute value may contain entity references, an 
 * <code>Attr</code> object should be retrieved to examine the possibly 
 * fairly complex sub-tree representing the attribute value. On the other 
 * hand, in HTML, where all attributes have simple string values, MethodInfos to 
 * directly access an attribute value can safely be used as a convenience.In 
 * DOM Level 2, the MethodInfo <code>normalize</code> is inherited from the 
...
public interface Element extends Node {
     ...
     * the <code>setAttributeNS</code> MethodInfo.
     ...
     * <code>removeAttributeNS</code> MethodInfo.
     ...
     * use the <code>getAttributeNodeNS</code> MethodInfo.
     ...
     * URI, use the <code>setAttributeNodeNS</code> MethodInfo.
