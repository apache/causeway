 ...
 * MethodInfos for dealing with children, not all objects implementing the 
...
public interface Node {
     ...
     * defaulted attributes, but this MethodInfo does not copy any text it 
     ...
     *   which can be passed to the MethodInfo <code>hasFeature</code> on 
     ...
     * MethodInfo, such as <code>createElement</code> from the 
