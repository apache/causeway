...
Namespace org.nakedobjects.dotnet
    ...
    Public MustInherit Class DotNetAcceptanceTestCase
        ...
        Protected loadedObjects As ClearableLoadedObjectsHashtable
...
#Region "setUp() and tearDown()"
        ...
        Public Overrides Sub setUp()
            ...
            Try
                ...
                'loadedObjects = new org.nakedobjects.xat.ClearableLoadedObjectsHashtable()
                ...
                'NakedObjects.getObjectManager().setLoadedObjects(loadedObjects)
            ...
            For Each noSpec As NakedObjectSpecification In noSpecs
                ...
                If noSpec.isObject() Then
                    ...
                    Dim view As TestClass = _
                        myTestObjectFactory.createTestClass( _
                            ClientSession.getSession(), cls)
