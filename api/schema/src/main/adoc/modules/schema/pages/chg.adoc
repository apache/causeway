...
An instance of the DTO (corresponding to this schema) is used within the xref:system:generated:index/applib/services/publishing/spi/ExecutionSubscriber.adoc[ExecutionSubscriber] SPI, identifying changed objects that are to be
