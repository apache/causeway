...
An instance of the DTO (corresponding to this schema) is used within the xref:refguide:applib-svc:PublisherService.adoc[`PublisherService`] SPI, identifying changed objects that are to be
