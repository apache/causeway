...
<3> the object type, corresponding to either the xref:system:generated:index/applib/annotation/DomainObject.adoc#objectType[`@DomainObject#objectType()`] attribute, or to the (JDO)
