...
public abstract class ObjectRemovingEvent<S> extends AbstractLifecycleEvent<S> {
     ...
     * {@link org.apache.causeway.applib.annotation.DomainObject#removingLifecycleEvent()} annotation attribute.  Whether this
     * raises an event or not depends upon the <tt>causeway.core.meta-model.annotation.domain-object.removing-lifecycle-event.post-for-default</tt>
