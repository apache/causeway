 ...
 *
 * <p>One resume event should be posted for each matching {@link PauseCommandLoggingEvent}.
 * Command logging implementations should tolerate unmatched resume events without allowing pause depth to become
 * negative.
 *
 * @since 4.0 {@index}
 */
