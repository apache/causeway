 ...
 *
 * <p>Every pause event should be paired with a {@link ResumeCommandLoggingEvent}, preferably from a
 * {@code finally} block.
 * Command logging implementations may support nested pauses by tracking pause depth.
 *
 * @since 4.0 {@index}
 */
