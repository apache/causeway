...
public abstract class ObjectUpdatedEvent<S> extends AbstractLifecycleEvent<S> {
     ...
     * {@link org.apache.causeway.applib.annotation.DomainObject#updatedLifecycleEvent()} annotation attribute.  Whether this
     * raises an event or not depends upon the <tt>causeway.core.meta-model.annotation.domain-object.updated-lifecycle-event.post-for-default</tt>
