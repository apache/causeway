...
/**
 * Clone of org.apache.isis.applib.jaxb.JavaTimeXMLGregorianCalendarMarshalling.
 * @deprecated Joda time support is meant to be phased out.
 */
@Deprecated
@UtilityClass
class _JodaTimeHelper {
