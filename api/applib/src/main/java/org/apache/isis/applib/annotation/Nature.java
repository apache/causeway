...
public enum Nature {
     ...
     *             </p>
     *             <p>
     *                 The service itself isn't rendered anywhere, but its actions can be invoked through the {@link org.apache.isis.applib.services.wrapper.WrapperFactory}.
     *                 (Or as a variant, it might expose a {@link Programmatic} API and then delegate to its own action via the {@link org.apache.isis.applib.services.wrapper.WrapperFactory}.
     *             </p>
     *         </li>
     *         <li>
     *             <p>
     ...
     *             </p>
     *             <p>
     *                 Again, either the calling module is expected to use the {@link org.apache.isis.applib.services.wrapper.WrapperFactory} when invoking
     ...
     *                 whereby the facade service exposes a {@link Programmatic} API and then delegates to its own action via the {@link org.apache.isis.applib.services.wrapper.WrapperFactory}.
     *             </p>
     *         </li>
     *     </ul>
     * </p>
