...
public final class Clob implements NamedWithMimeType {
     ...
     * @see #tryRead(String, org.apache.isis.applib.value.NamedWithMimeType.CommonMimeType, DataSource, Charset)
     */
    ...
    /**
     * Shortcut for {@link #tryRead(String, org.apache.isis.applib.value.NamedWithMimeType.CommonMimeType, File, Charset)}
