...
W.ll return `false` if failed to send
...
See the xref:refguide:config:sections/isis.core.runtime-services.adoc#isis.core.runtime-services.email.port[configuration guide] for further details.
