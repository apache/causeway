...
As an alternative, you could also use link:http://www.datanucleus.org/products/accessplatform_4_0/jdo/jdoql_typesafe.html[JDO typesafe queries] through the xref:refguide:applib-svc:.IsisJdoSupport.adoc[`IsisJdoSupport`] service.
...
For more details, see xref:refguide:applib-svc:.IsisJdoSupport.adoc[`IsisJdoSupport`].
====
