...
----
<1> Uses the xref:refguide:applib-svc:.BookmarkService.adoc[`BookmarkService`] to convert the domain object's internal identifier into a serializable `OidDto`.
