...
[NOTE]
====
It ought to be possible to implement an xref:refguide:applib-svc:.ExceptionRecognizer.adoc[`ExceptionRecognizer`]s that would allow the above boilerplate to be removed.
