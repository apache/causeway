...
This is only done for actions/properties annotated appropriate (with xref:refguide:applib-ant:Action.adoc#exectionPublishing[`@Action#exectionPublishing()`] or xref:refguide:applib-ant:Property.adoc#exectionPublishing[`@Property#exectionPublishing()`]).
+
...
Only domain objects specified to be published with xref:refguide:applib-ant:DomainObject.adoc#entityChangePublishing[`@DomainObject#entityChangePublishing()`] are published. +
+
[NOTE]
====
