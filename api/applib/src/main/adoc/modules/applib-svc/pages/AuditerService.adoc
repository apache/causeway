...
* the xref:extensions:ROOT:about.adoc[AuditerServiceUsingJdo] in the xref:extensions:ROOT:about.adoc[Extensions catalog] persists each audit record in a relational table.
