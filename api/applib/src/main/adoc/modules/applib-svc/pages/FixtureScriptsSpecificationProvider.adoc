...
The `FixtureScriptsSpecificationProvider` configures the xref:refguide:applib-svc:.FixtureScripts.adoc[`FixtureScripts`] domain service, providing the location to search for fixture scripts and other settings.
