...
[source,java]
----
include::refguide:applib-svc:example$services/appfeat/ApplicationMemberType.java[tags=*]
----
...
The default implementation of this service uses the internal `o.a.i.core.metamodel.services.appfeat.ApplicationFeatureFactory` service to instantiate `ApplicationFeature` instances.
