...
[source,java]
----
include::refguide:applib-svc:example$services/userprof/UserProfileService.java[tags="refguide"]
----
...
//
//image::reference-services-spi/UserProfileService/todoapp.png[width="800px"]
