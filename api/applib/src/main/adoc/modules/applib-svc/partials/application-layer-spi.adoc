...
|xref:refguide:applib-svc:application-layer-spi/BackgroundCommandService.adoc[`o.a.i.applib.` +
`services.background` +
...
|xref:refguide:applib-svc:application-layer-spi/CommandService.adoc[`o.a.i.applib.` +
...
|xref:refguide:applib-svc:application-layer-spi/HealthCheckService.adoc[`o.a.i.applib.` +
`services.health` +
`HealthCheckService`]
...
|xref:refguide:applib-svc:application-layer-spi/HomePageProviderService.adoc[`o.a.i.applib.` +
`services.homepage` +
...
``o.a.i.core`` +
``isis-core-runtime``
|Used by the default implementation of xref:refguide:applib-svc:presentation-layer-spi/RoutingService.adoc[`RoutingService`].
