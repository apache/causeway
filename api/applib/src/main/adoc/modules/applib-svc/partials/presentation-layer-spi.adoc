...
``o.a.i.core`` +
``isis-core-applib``
|The default implementation will return the home page (per xref:refguide:applib-svc:application-layer-spi/HomePageResolverService.adoc[`HomePageResolverService`]) if a void or null is returned. +
