...
Any xref:refguide:applib-ant:Property.adoc#notPersisted[`@Property#notPersisted()`] properties will be excluded from the memento, as will any properties excluded from the metamodel using xref:refguide:applib-ant:Programmatic.adoc[`@Programmatic`].
