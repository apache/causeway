...
This means it won't appear in any UI or more generally in serializations obtained using the metamodel, for example xref:refguide:applib-svc:integration-api/XmlSnapshotService.adoc[snapshot]s.
