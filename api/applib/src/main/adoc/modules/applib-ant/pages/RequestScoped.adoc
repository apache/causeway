...
One of the built-in domain services that uses this annotation is xref:refguide:applib-svc:core-domain-api/Scratchpad.adoc[`Scratchpad`], intended to allow the arbitrary sharing of data between objects.  Here is the full source code of this service is:
