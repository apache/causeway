...
The `created()` lifecycle callback method is called when a  domain object has just been instantiated using xref:system:generated:index/applib/services/factory/FactoryService.adoc[`FactoryService`]
