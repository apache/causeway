...
|created()
|called when an object has just been created using xref:refguide:applib-svc:FactoryService.adoc[`FactoryService#create(..)`] or xref:refguide:applib-svc:RepositoryService.adoc[`RepositoryService#detachedEntity(...)`]
