...
The business rules described above (xref:business-rules.adoc#visibility[visibility], xref:business-rules.adoc#usability[usability], xref:business-rules.adoc#validity[validity]) are business rules that enforce preconditions
