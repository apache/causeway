...
Entities are persistent domain objects, with their persistence handled an ORM (such as xref:pjdo:ROOT:about.adoc[JDO/DataNucleus]).
...
Domain entities are generally decorated with both ORM and Apache Isis annotations.
