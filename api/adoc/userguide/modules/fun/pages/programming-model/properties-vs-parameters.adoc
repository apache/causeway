...
WARNING: TODO: v2 - Meta-annotations; can specify both, those that don't apply are just ignored.
...
The table in the xref:userguide:fun:programming-model.adoc#properties-vs-parameters[Properties vs Parameters] below provides a handy reference of each.
