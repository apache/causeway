...
[NOTE]
====
The support for xref:refguide:applib-ant:about.adoc#deprecated[disallowing deprecated annotations] is also implemented using the metamodel validator.
====
...
//[TIP]
//====
//Isis' xref:refguide:mvn:about.adoc[Maven plugin] will also validate the domain object model during build time.
//====
