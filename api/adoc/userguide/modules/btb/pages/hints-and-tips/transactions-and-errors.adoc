...
The framework provides the xref:refguide:applib-svc:MessageService.adoc[`MessageService`] as a means to return an out-of-band
...
To handle this the xref:refguide:applib-svc:ExceptionRecognizer.adoc[`ExceptionRecognizer`] SPI can be used.  The
