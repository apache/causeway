...
One way to implement this idea is to provide a custom implementation of the xref:refguide:applib-svc:presentation-layer-spi/RoutingService.adoc[`RoutingService`] SPI domain service.
