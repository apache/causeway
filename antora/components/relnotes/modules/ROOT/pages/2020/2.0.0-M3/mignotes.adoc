...
CAUTION: this example is now out of date; more recent releases have moved changed the name and package of some of these adapter classes.
...
CAUTION: these examples are now out-of-date, superceded by later milestone releases.
