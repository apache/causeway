...
The `ContentNegotiationService` is itself called by the (default implementation of) xref:rg:fis:presentation-layer/RepresentationService.adoc[`RepresentationService`].