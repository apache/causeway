...
|xref:rg:fis:application-layer/AuthenticationSessionProvider.adoc[`o.a.i.core.commons.` +
`authentication.` +
...
|xref:rg:fis:application-layer/CommandDtoServiceInternal.adoc[`o.a.i.c.m.s.command` +
...
|xref:rg:fis:application-layer/InteractionDtoServiceInternal.adoc[`o.a.i.c.m.s.ixn` +
