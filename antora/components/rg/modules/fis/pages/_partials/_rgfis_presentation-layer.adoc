...
|xref:../rgfis/rgfis.adoc#_rgfis_presentation-layer_ContentNegotiationService[`o.a.i.v.ro.` +
`rendering.service.conneg.` +
`ContentNegotiationService`]
|Encodes the algorithm that delegates to any registered xref:../rgsvc/rgsvc.adoc#_rgsvc_presentation-layer-spi_ContentMappingService[`ContentMappingService`]s.
|`ContentNegotiationService-` +
`XRoDomainType` +
``o.a.i.core`` +
...
|xref:../rgfis/rgfis.adoc#_rgfis_presentation-layer_RepresentationService[`o.a.i.v.ro.` +
`rendering.service.` +
`RepresentationService`]
|Generates the representations, delegating to any registered xref:../rgfis/rgfis.adoc#_rgfis_presentation-layer_ContentNegotiationService[`ContentNegotiationService`]s.
|`RepresentationService-` +
`ForRestfulObjects` +
``o.a.i.core`` +
`isis-core-viewer-restfulobjects-rendering`
