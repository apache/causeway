[[_rgfis_application-layer_AuthenticationSessionProvider]]
...
If xref:rg:svc:rgsvc.adoc#_rgsvc_testing_SudoService[`SudoService`] has been used to temporarily override the user and/or roles, then this service will report the overridden values.
