...
|xref:rg:fis:rgfis.adoc#_rgfis_application-layer_AuthenticationSessionProvider[`o.a.i.core.commons.` +
`authentication.` +
...
|xref:rg:fis:rgfis.adoc#_rgfis_application-layer_CommandDtoServiceInternal[`o.a.i.c.m.s.command` +
...
xref:rg:ant:rgant.adoc#_rgant-Action_command[`@Action#commandExecuteIn()`] or
xref:rg:ant:rgant.adoc#_rgant-Property_command[`@Property#commandExecuteIn()`].
|`CommandDtoService-` +
...
|xref:rg:fis:rgfis.adoc#_rgfis_application-layer_InteractionDtoServiceInternal[`o.a.i.c.m.s.ixn` +
`InteractionDtoServiceInternal`]
|Creates DTO for the current execution of an action invocation or property edit, for use either as a reified command or for implementations of the xref:rg:svc:rgsvc.adoc#_rgsvc_persistence-layer-spi_PublisherService[`PublisherService`].
|`CommandDtoService-` +
`InternalServiceDefault` +
``isis-core-metamodel``
|
...
include::partial$_rgfis_application-layer_AuthenticationSessionProvider.adoc[leveloffset=+1]
include::partial$_rgfis_application-layer_CommandDtoServiceInternal.adoc[leveloffset=+1]
include::partial$_rgfis_application-layer_InteractionDtoServiceInternal.adoc[leveloffset=+1]
