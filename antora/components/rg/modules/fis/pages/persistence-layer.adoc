...
|xref:rg:fis:persistence-layer/AuditingServiceInternal.adoc[`o.a.i.c.r.s.auditing.` +
`AuditingServiceInternal`]
|Co-ordinates between
xref:rg:fis:persistence-layer/ChangedObjectsServiceInternal.adoc[`ChangedObjectsServiceInternal`] and
xref:rg:fis:spi/AuditerService.adoc[`AuditerService`].
|concrete class.
|


|xref:rg:fis:persistence-layer/ChangedObjectsServiceInternal.adoc[`o.a.i.c.r.s.changes.` +
...
|xref:rg:fis:persistence-layer/PersistenceSessionServiceInternal.adoc[`o.a.i.c.m.s.` +
`persistsession.` +
...
|xref:rg:fis:persistence-layer/PublishingServiceInternal.adoc[`o.a.i.c.m.s.publishing.` +
