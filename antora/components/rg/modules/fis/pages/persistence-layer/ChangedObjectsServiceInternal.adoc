...
This is then used by various other  (internal) domain services, notably xref:rg:fis:persistence-layer/AuditingServiceInternal.adoc[`AuditingServiceInternal`] and xref:rg:fis:persistence-layer/PublishingServiceInternal.adoc[`PublishingServiceInternal`].
...
<3> Used by xref:rg:fis:persistence-layer/PublishingServiceInternal.adoc[`PublishingServiceInternal`] to obtain details of and
counters of all objects changed within the transaction.
<4> Used by xref:rg:fis:persistence-layer/AuditingServiceInternal.adoc[`AuditingServiceInternal`] to obtain all pairs of
...
Both the xref:rg:fis:persistence-layer/AuditingServiceInternal.adoc[`AuditingServiceInternal`] and xref:rg:fis:persistence-layer/PublishingServiceInternal.adoc[`PublishingServiceInternal`] (internal) domain services query this object.
