...
The implementations are specific to the particular viewer (xref:ug:vw:ugvw.adoc#[Wicket viewer] or xref:ug:vro:about.adoc[Restful Objects viewer]) so the domain code must guard against them being unavailable in some cases.
