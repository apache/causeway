...
A more complex example could use a xref:ug:fun:building-blocks/types-of-domain-objects/view-models.adoc[view model] to enable bulk updates to a set of objects. The view model's job is to gather track of the items to be updated:
