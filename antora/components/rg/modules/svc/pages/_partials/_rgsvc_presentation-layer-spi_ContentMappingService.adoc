...
The `CommandWithDto` interface is a subtype of `Command` for implementations that can be reified into xref:rg:cms:rgcms.adoc#_rgcms_schema-cmd[`CommandDto`] XML instances.
