...
The `ActionInvocationContext` domain service is a xref:rg:ant:rgant.adoc#_rgant-RequestScoped[`@RequestScoped`] service intended to support the implementation of "bulk" actions annotated with xref:rg:ant:rgant.adoc#_rgant-Action_invokeOn[`@Action#invokeOn()`].
