...
<8> obtain an implementation of `CommandDtoProcessor` (if any) as per an xref:rg:ant:rgant.adoc#_rgant-Action_command[`@Action#commandDtoProcessor()`] or xref:rg:ant:rgant.adoc#_rgant-Property_command[`@Property#commandDtoProcessor()`].
+
