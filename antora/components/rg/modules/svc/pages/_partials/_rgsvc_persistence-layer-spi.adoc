...
|xref:rg:svc:rgsvc.adoc#_rgsvc_persistence-layer-spi_AuditerService[`o.a.i.applib.` +
`services.audit` +
`AuditerService`]
...
|xref:rg:svc:rgsvc.adoc#_rgsvc_persistence-layer-spi_PublisherService[`o.a.i.applib.` +
`services.publish` +
`PublisherService`]
...
|xref:rg:svc:rgsvc.adoc#_rgsvc_persistence-layer-spi_UserRegistrationService[`o.a.i.applib.` +
`services.userreg` +
...
Where an implementation is available (on the classpath) then it is always registered automatically (that is, they are all (with one exception) annotated with xref:rg:ant:rgant.adoc#_rgant-DomainService[`@DomainService`].



include::partial$_rgsvc_persistence-layer-spi_AuditerService.adoc[leveloffset=+1]
include::partial$_rgsvc_persistence-layer-spi_PublisherService.adoc[leveloffset=+1]
include::partial$_rgsvc_persistence-layer-spi_UserRegistrationService.adoc[leveloffset=+1]
