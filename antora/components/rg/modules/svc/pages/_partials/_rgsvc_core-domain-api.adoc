...
|xref:rg:svc:rgsvc.adoc#_rgsvc_core-domain-api_ClockService[`o.a.i.applib.` +
`services.clock` +
`ClockService`]
...
|xref:rg:svc:rgsvc.adoc#_rgsvc_core-domain-api_ConfigurationService[`o.a.i.applib.` +
`services.config` +
...
|xref:rg:svc:rgsvc.adoc#_rgsvc_core-domain-api_EventBusService[`o.a.i.applib.` +
`services.eventbus` +
`EventBusService`]
|Programmatically post events to the internal event bus.  Also used by Apache Isis itself to broadcast domain events:

* xref:rg:ant:rgant.adoc#_rgant-Action_domainEvent[`Action#domainEvent()`]
* xref:rg:ant:rgant.adoc#_rgant-Property_domainEvent[`Property#domainEvent()`]
* xref:rg:ant:rgant.adoc#_rgant-Collection_domainEvent[`Collection#domainEvent()`]
|`EventBusServiceJdo` +
``o.a.i.core`` +
``isis-core-runtime``
|

|xref:rg:svc:rgsvc.adoc#_rgsvc_core-domain-api_FactoryService[`o.a.i.applib.` +
`services.factory` +
`FactoryService`]
...
|xref:rg:svc:rgsvc.adoc#_rgsvc_core-domain-api_Scratchpad[`o.a.i.applib.` +
`services.scratchpad` +
`Scratchpad`]
...
|xref:rg:svc:rgsvc.adoc#_rgsvc_core-domain-api_UserService[`o.a.i.applib.` +
`services.xactn` +
`UserService`]
...
include::partial$_rgsvc_core-domain-api_ClockService.adoc[leveloffset=+1]
include::partial$_rgsvc_core-domain-api_ConfigurationService.adoc[leveloffset=+1]
include::partial$_rgsvc_core-domain-api_EventBusService.adoc[leveloffset=+1]
include::partial$_rgsvc_core-domain-api_FactoryService.adoc[leveloffset=+1]
include::partial$_rgsvc_core-domain-api_Scratchpad.adoc[leveloffset=+1]
include::partial$_rgsvc_core-domain-api_UserService.adoc[leveloffset=+1]
