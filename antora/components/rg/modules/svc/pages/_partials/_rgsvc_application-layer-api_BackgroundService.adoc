[[_rgsvc_application-layer-api_BackgroundService]]
= `BackgroundService2`
...
include::partial$_rgsvc_application-layer-api_BackgroundService_BackgroundCommandExecution.adoc[leveloffset=+1]
include::partial$_rgsvc_application-layer-api_BackgroundService_Quartz.adoc[leveloffset=+1]
