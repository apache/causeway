...
|xref:../rgsvc/rgsvc.adoc#_rgsvc_presentation-layer-spi_ContentMappingService[`o.a.i.applb.` +
`services.conmap` +
...
|xref:../rgsvc/rgsvc.adoc#_rgsvc_presentation-layer-spi_EmailNotificationService[`o.a.i.applib.` +
`services.userreg` +
`EmailNotificationService`]
|Notify a user during xref:../rgsvc/rgsvc.adoc#_rgsvc_persistence-layer-spi_UserRegistrationService[self-registration] of users.
|`EmailNotificationService-` +
`Default` +
``o.a.i.core`` +
``isis-core-runtime``
...
|xref:../rgsvc/rgsvc.adoc#_rgsvc_presentation-layer-spi_ErrorReportingService[`o.a.i.applib.` +
`services.error` +
...
|xref:../rgsvc/rgsvc.adoc#_rgsvc_presentation-layer-spi_GridSystemService[`o.a.i.applib.` +
`services.grid` +
`GridSystemService`]
...
|xref:../rgsvc/rgsvc.adoc#_rgsvc_presentation-layer-spi_GridLoaderService[`o.a.i.applib.` +
`services.grid` +
`GridLoaderService`]
...
|xref:../rgsvc/rgsvc.adoc#_rgsvc_presentation-layer-spi_GridService[`o.a.i.applib.` +
`services.grid` +
`GridService`]
|A facade on top of both xref:../rgsvc/rgsvc.adoc#_rgsvc_presentation-layer-spi_GridLoaderService[`GridLoaderService`] and
xref:../rgsvc/rgsvc.adoc#_rgsvc_presentation-layer-spi_GridSystemService[`GridSystemService`], thus being able to return normalized
...
|xref:../rgsvc/rgsvc.adoc#_rgsvc_presentation-layer-spi_HintStore[`o.a.i.applib.` +
`services.hint` +
`HintStore`]
...
|xref:../rgsvc/rgsvc.adoc#_rgsvc_presentation-layer-spi_LocaleProvider[`o.a.i.applib.` +
`services.i18n` +
`LocaleProvider`]
|Request-scoped service to return the locale of the current user, in support of i18n (ie so that the app's UI, messages and exceptions can be translated to the required locale by the xref:../rgsvc/rgsvc.adoc#_rgsvc_presentation-layer-spi_TranslationService[`TranslationService`].
...
|xref:../rgsvc/rgsvc.adoc#_rgsvc_presentation-layer-spi_RoutingService[`o.a.i.applib.` +
`services.routing` +
`RoutingService`]
...
``o.a.i.core`` +
``isis-core-applib``
|The default implementation will return the home page (per xref:../rgsvc/rgsvc.adoc#_rgsvc_application-layer-spi_HomePageProviderService[`HomePageProviderService`]) if a void or null is returned. +
Used by the xref:../ugvw/ugvw.adoc#[Wicket viewer] only.



|xref:../rgsvc/rgsvc.adoc#_rgsvc_presentation-layer-spi_TableColumnOrderService[`o.a.i.applib.` +
`services.tablecol` +
`TableColumn-` +
`OrderService`]
...
|xref:../rgsvc/rgsvc.adoc#_rgsvc_presentation-layer-spi_TranslationService[`o.a.i.applib.` +
`services.i18n` +
`TranslationService`]
|Translate an app's UI, messages and exceptions for the current user (as per the locale provided by xref:../rgsvc/rgsvc.adoc#_rgsvc_presentation-layer-spi_LocaleProvider[`LocalProvider`].
...
|xref:../rgsvc/rgsvc.adoc#_rgsvc_presentation-layer-spi_TranslationsResolver[`o.a.i.applib.` +
`services.i18n` +
`TranslationsResolver`]
|Obtain translations for a particuar phrase and locale, in support of i18n (ie so that the app's UI, messages and exceptions can be translated to the required locale by the xref:../rgsvc/rgsvc.adoc#_rgsvc_presentation-layer-spi_TranslationService[`TranslationService`]
...
|xref:../rgsvc/rgsvc.adoc#_rgsvc_presentation-layer-spi_UrlEncodingService[`o.a.i.applib.` +
...
|xref:../rgsvc/rgsvc.adoc#_rgsvc_presentation-layer-spi_UserProfileService[`o.a.i.applib.` +
`services.userprof` +
`UserProfileService`]
