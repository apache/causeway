[[_rgsvc_metadata-api_LayoutService]]
= `LayoutService`
...
[[__rgsvc_metadata-api_LayoutService_api-and-implementation]]
== API & Implementation
...
* the xref:rg:ant:rgant.adoc#_rgcms_classes_mixins_Object[`Object` mixin] provides the ability to download the XML layout for
...
[[__rgsvc_metadata-api_LayoutService_related-domain-services]]
