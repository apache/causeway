...
|xref:rg:svc:rgsvc.adoc#_rgsvc_metadata-api_ApplicationFeatureRepository[`o.a.i.applib.` +
`services.appfeat` +
...
|xref:rg:svc:rgsvc.adoc#_rgsvc_metadata-api_LayoutService[`o.a.i.applib.` +
`services.layout` +
`LayoutService`]
...
|xref:rg:svc:rgsvc.adoc#_rgsvc_metadata-api_MetamodelService[`o.a.i.applib.` +
`services.metamodel` +
`MetaModelService`]
...
|xref:rg:svc:rgsvc.adoc#_rgsvc_metadata-api_ServiceRegistry[`o.a.i.applib.` +
`services.registry` +
`ServiceRegistry`]
...
|xref:rg:svc:rgsvc.adoc#_rgsvc_metadata-api_SwaggerService[`o.a.i.applib.` +
`services.swagger` +
`SwaggerService`]
...
include::partial$_rgsvc_metadata-api_ApplicationFeatureRepository.adoc[leveloffset=+1]
include::partial$_rgsvc_metadata-api_LayoutService.adoc[leveloffset=+1]
include::partial$_rgsvc_metadata-api_MetamodelService.adoc[leveloffset=+1]
include::partial$_rgsvc_metadata-api_ServiceRegistry.adoc[leveloffset=+1]
include::partial$_rgsvc_metadata-api_SwaggerService.adoc[leveloffset=+1]
