[[_rgsvc_testing_SwitchUserService]]
...
[NOTE]
====
This service is deprecated; use xref:ug:tst:ugtst.adoc#_ugtst_fixture-scripts[fixture scripts] and the
xref:rg:svc:rgsvc.adoc#_rgsvc_testing_SudoService[`SudoService`] instead.
====
