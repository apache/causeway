...
----
<1> an instance of a xref:rg:cms:rgcms.adoc#_rgcms_schema_cmd[`CommandDto`] capturing the details of the action invocation or property edit to be retained (eg persisted to a database) so that it can be executed at a later time
