...
As noted in the introduction, a common use case for this service is in the implementation of the xref:rg:cms:classes/super/AbstractViewModel.adoc[`ViewModel`] interface.
