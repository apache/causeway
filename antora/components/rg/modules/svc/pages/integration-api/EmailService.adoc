...
These configuration properties can be specified either in `isis.properties` or in an xref:ug:btb:ugbtb.adoc#_ugbtb_deployment_externalized-configuration[external configuration file], or programmatically using the xref:rg:cms:classes/AppManifest-bootstrapping.adoc[`AppManifest`].
