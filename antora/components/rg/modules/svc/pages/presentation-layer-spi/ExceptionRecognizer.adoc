...
Both the viewers interprets this correctly (the xref:ug:vw:ugvw.adoc#[Wicket viewer] as a suitable error page, the xref:ug:vro:about.adoc[Restful Objects viewer] as a 404 status return code).
