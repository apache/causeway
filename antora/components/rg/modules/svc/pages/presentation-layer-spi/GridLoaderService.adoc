...
<4> returns a new instance of a xref:rg:cms:classes/layout/component.adoc[`Grid`] for the specified domain class, eg as loaded from a `layout.xml` file.  If none exists, will return null (and the calling xref:rg:svc:presentation-layer-spi/GridService.adoc[`GridService`] will use xref:rg:svc:presentation-layer-spi/GridSystemService.adoc[`GridSystemService`] to obtain a default grid for the domain class).
