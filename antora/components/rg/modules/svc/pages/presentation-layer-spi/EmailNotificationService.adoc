...
The `EmailNotificationService` supports the xref:ug:vw:features/user-registration.adoc[user registration] (self sign-up) features of the xref:ug:vw:ugvw.adoc#[Wicket viewer] whereby a user can sign-up to access an application by providing a valid email address.
