...
Currently the routing service is used only by the xref:ug:vw:ugvw.adoc#[Wicket viewer]; it is ignored by the xref:ug:vro:about.adoc[Restful Objects] viewer.
