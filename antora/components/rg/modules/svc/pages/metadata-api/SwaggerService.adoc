...
xref:ug:fun:building-blocks/types-of-domain-objects/view-models.adoc[view model]s and to domain services with a xref:rg:ant:DomainService/nature.adoc[nature] of `VIEW_REST_ONLY`.
