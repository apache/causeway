...
xref:rg:fis:rgfis.adoc#_rgfis_spi_PublisherServiceInternal[`PublisherServiceInternal`] domain service.  This is only done for actions/properties annotated appropriate (with xref:rg:ant:Action/publishing.adoc[`@Action#publishing()`] or xref:rg:ant:Property/publishing.adoc[`@Property#publishing()`]).
+
