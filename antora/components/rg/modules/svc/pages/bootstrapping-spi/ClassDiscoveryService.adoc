...
This service is used by the xref:rg:cms:classes/super/FixtureScripts.adoc[`FixtureScripts`] service to automatically locate any xref:rg:cms:classes/super/FixtureScript.adoc[`FixtureScript`] implementations.
