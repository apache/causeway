...
Viewers are specified by way of the filters and servlets in the xref:ug:btb:web-xml.adoc[`web.xml`] file; these are not bootstrapped by the framework, rather it is the other way around.
