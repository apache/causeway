...
This is done using an xref:rg:cms:classes/super/AppManifest.adoc[`AppManifest`], specified either programmatically or through the configuration properties.
