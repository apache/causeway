...
<4> catalog file indicates the location of the referenced xref:../rgcms/rgcms.adoc#_rgcms_schema-common[common schema] XSDs.
...
reference for the Apache Isis xref:../rgcms/rgcms.adoc#_rgcms_schema-common[common schema] is likely to be needed:
