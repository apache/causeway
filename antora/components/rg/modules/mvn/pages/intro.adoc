...
For example, the xref:arch:simpleapp:about.adoc[SimpleApp]'s
manifest is:
...
The xref:arch:simpleapp:about.adoc[SimpleApp archetype] reflects these recommendations for the `validate` and `swagger` goals.
