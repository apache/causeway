...
For example, the xref:ug:fun:getting-started/simpleapp-archetype.adoc[SimpleApp]'s
manifest is:
...
The xref:ug:fun:getting-started/simpleapp-archetype.adoc[SimpleApp archetype] reflects these recommendations for the `validate` and `swagger` goals.
