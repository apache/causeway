...
* xref:rg:cms:classes/domainevent/ActionDomainEvent.adoc[`ActionDomainEvent`]
* xref:rg:cms:classes/domainevent/PropertyDomainEvent.adoc[`PropertyDomainEvent`]
* xref:rg:cms:classes/domainevent/CollectionDomainEvent.adoc[`CollectionDomainEvent`]
