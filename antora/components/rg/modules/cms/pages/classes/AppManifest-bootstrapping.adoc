...
[NOTE]
====
The recommendations in this section no longer apply if using the xref:rg:cms:classes/AppManifest2-bootstrapping/bootstrapping.adoc[`AppManifest2`] interface and ``Module``s to bootstrap your application.
====
