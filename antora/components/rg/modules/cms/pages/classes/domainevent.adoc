...
|xref:rg:cms:classes/domainevent/AbstractDomainEvent.adoc[`o.a.i.applib.` +
`AbstractDomainEvent`]
|``o.a.i.core`` +
``events.domain`` +
``isis-core-applib``
...
|xref:rg:cms:classes/domainevent/ActionDomainEvent.adoc[`o.a.i.applib.` +
`ActionDomainEvent`]
|``o.a.i.core`` +
``events.domain`` +
``isis-core-applib``
...
|xref:rg:cms:classes/domainevent/CollectionDomainEvent.adoc[`o.a.i.applib.` +
...
|xref:rg:cms:classes/domainevent/PropertyDomainEvent.adoc[`o.a.i.applib.` +
`PropertyDomainEvent`]
|``o.a.i.core`` +
``events.domain`` +
``isis-core-applib``
