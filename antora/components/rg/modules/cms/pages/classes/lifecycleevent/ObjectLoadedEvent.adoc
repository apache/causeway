...
Subclass of xref:rg:cms:classes/lifecycleevent/AbstractLifecycleEvent.adoc[`AbstractLifecycleEvent`], broadcast when an object is retrieved from the database.
