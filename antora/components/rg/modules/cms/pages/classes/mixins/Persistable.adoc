...
A number of other xref:rg:cms:classes/mixins/Object.adoc[mixins] also contribute properties or actions to the "Metadata" fieldset.
...
----
<1> returns the XML text wrapped up in a xref:rg:cms:classes/value-types/Clob.adoc[`Clob`].
