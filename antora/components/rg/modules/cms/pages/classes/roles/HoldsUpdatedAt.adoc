...
Entities that implement this interface often also implement xref:rg:cms:classes/roles/HoldsUpdatedBy.adoc[`HoldsUpdatedBy`] role interface; as a convenience the xref:rg:cms:classes/roles/Timestampable.adoc[`Timestampable`] interface combines the two roles.
