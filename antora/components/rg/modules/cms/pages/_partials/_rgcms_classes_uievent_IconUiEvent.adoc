...
[NOTE]
====
If the domain object defines its own xref:rg:cms:rgcms.adoc#_rgcms_methods_reserved_iconName[`iconName()`] supporting method,
or if it has the
xref:rg:ant:rgant.adoc#_rgant-DomainObjectLayout#cssClassFa[`@DomainObjectLayout#cssClassFa()`] attribute, then
