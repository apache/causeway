...
include::partial$_rgcms_classes_contributee_HasTransactionId.adoc[leveloffset=+1]
include::partial$_rgcms_classes_contributee_HasUserName.adoc[leveloffset=+1]
