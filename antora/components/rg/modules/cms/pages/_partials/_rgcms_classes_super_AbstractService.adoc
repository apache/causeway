...
Instead annotate with xref:rg:ant:rgant.adoc#_rgant_DomainService[`@DomainService`] and specify its xref:rg:ant:rgant.adoc#_rgant_DomainService_objectType[`#objectType()`]
