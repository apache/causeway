[[_rgcms_classes_domainevent_CollectionDomainEvent]]
...
Subclass of xref:rg:cms:rgcms.adoc#_rgcms_classes_domainevent_AbstractDomainEvent[`AbstractDomainEvent`] for collections.
...
----
<1> The `Default` nested static class is the default for the xref:rg:ant:rgant.adoc#_rgant-Collection_domainEvent[`@Collection#domainEvent()`] annotation attribute.
