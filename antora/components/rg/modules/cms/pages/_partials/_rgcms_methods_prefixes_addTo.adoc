...
[NOTE]
====
Directly mutable collections are not currently supported by the xref:ug:vw:ugvw.adoc#[Wicket viewer].  The suggested workaround is to simply define an action.
====
