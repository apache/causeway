...
Subclass of xref:rg:cms:rgcms.adoc#_rgcms_classes_domainevent_AbstractDomainEvent[`AbstractDomainEvent`] for actions.
...
* link back to the xref:rg:svc:rgsvc.adoc#_rgsvc_application-layer-api_CommandContext[`CommandContext`] service's `Command` object
...
----
<1> The `Default` nested static class is the default for the xref:rg:ant:rgant.adoc#_rgant-Action_domainEvent[`@Action#domainEvent()`]
...
<4> Deprecated, use xref:rg:svc:rgsvc.adoc#_rgsvc_application-layer-api_CommandContext[`CommandContext`] or (better)  xref:rg:svc:rgsvc.adoc#_rgsvc_application-layer-api_InteractionContext[`InteractionContext`]instead.
