...
* second, as references to the target of a command representing the _intention_ to invoke an action or edit a property, as described by the xref:rg:cms:rgcms.adoc#_rgcms_schema-cmd["cmd" (command)] schema.
+
...
* third, as references to the target of an interaction capturing the actual execution of an action invocation or property edit, as described by the xref:rg:cms:rgcms.adoc#_rgcms_schema-ixn["ixn" (interaction)] schema.
