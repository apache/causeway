...
[TIP]
====
Alternatively, consider using a xref:rg:svc:core-domain-api/EventBusService.adoc[event bus] xref:rg:cms:classes/super/AbstractSubscriber.adoc[subscriber] on the xref:rg:cms:classes/lifecycleevent/ObjectCreatedEvent.adoc[`ObjectCreatedEvent`].
====
