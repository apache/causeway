...
----
<1> simple xref:rg:cms:classes/utility/TitleBuffer.adoc[utility class] to help construct the title string
...
* xref:rg:cms:methods/reserved/iconName.adoc[`iconName()`]
* xref:rg:cms:methods/reserved/cssClass.adoc[`cssClass()`]
* xref:rg:cms:methods/reserved/layout.adoc[`layout()`]
