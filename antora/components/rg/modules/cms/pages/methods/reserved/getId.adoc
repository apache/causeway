...
* in the serialization of `OidDto` in the xref:rg:cms:rgcms.adoc#_rgcms_schema_cmd[command] and xref:rg:cms:rgcms.adoc#_rgcms_schema_ixn[interaction] schemas
