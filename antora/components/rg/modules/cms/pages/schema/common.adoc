...
With it, we have the ability to lookup any arbitrary object.  Further discussion and examples can be found xref:ug:fun:building-blocks/identifiers/oid.adoc[here].
