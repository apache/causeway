...
The `paramsDto` type is defined xref:rg:cms:rgcms.adoc#__rgcms_schema_cmd_ancillary[below].
...
Note also that there is a corresponding xref:rg:cms:rgcms.adoc#__rgcms_schema_ixn_memberExecutionDto[`memberExecutionDto`]
...
xref:rg:cms:rgcms.adoc#_rgcms_schema_common["common"] schema.
