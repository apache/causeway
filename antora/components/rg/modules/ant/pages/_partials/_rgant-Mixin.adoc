...
For further discussion on using mixins, see xref:ug:fun:ugfun.adoc#_ugfun_building-blocks_types-of-domain-objects_mixins[mixins] in the user guide.
...
|xref:rg:ant:rgant.adoc#_rgant-Mixin_method[`method()`]
...
xref:rg:ant:rgant.adoc#_rgant-DomainObject_nature[`@DomainObject#nature()`] annotation with a nature of `MIXIN`.


include::partial$_rgant-Mixin_method.adoc[leveloffset=+1]
