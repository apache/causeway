...
* if set to `AS_CONFIGURED`, then the default behaviour is as specified by the `isis.viewer.wicket.redirectEvenIfSameObject` xref:ug:vw:ugvw.adoc#_ugvw_configuration-properties[configuration property]).
