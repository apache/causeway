...
For more on sidebar vs modal dialogs, see xref:ug:vw:ugvw.adoc#_ugvw_features_sidebar-vs-modal-dialogs[Wicket viewer features].

The prompt style is influenced by two xref:ug:vw:ugvw.adoc#_ugvw_configuration-properties[configuration properties]:
