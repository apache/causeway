...
In such cases, though, it would probably make more sense to annotate the action as either xref:rg:ant:rgant.adoc#_rgant-Action_hidden[hidden] or indeed xref:rg:ant:rgant.adoc#_rgant-Programmatic[`@Programmatic`].
