...
This is as an alternative to implementing xref:rg:cms:rgcms.adoc#_rgcms_methods_reserved_layout[`layout()`] reserved method.
...
This attribute can also be applied to xref:rg:ant:rgant.adoc#_rgant-ViewModelLayout_layoutUiEvent[view models].
