...
This attribute is also supported for  xref:rg:ant:rgant.adoc#_rgant-Action_bookmarking[domain objects].

(In the Wicket viewer), a link to a bookmarked object is shown in the bookmarks panel:

image::reference-annotations/DomainObjectLayout/bookmarking.png[width="720px",link="{_imagesdir}reference-annotations/DomainObjectLayout/bookmarking.png"]
...
image::reference-annotations/DomainObjectLayout/bookmarking-nested.png[width="720px",link="{_imagesdir}reference-annotations/DomainObjectLayout/bookmarking-nested.png"]
...
This attribute can also be applied to xref:rg:ant:rgant.adoc#_rgant-ViewModelLayout_bookmarking[view models].
