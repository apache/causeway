...
It is also recognized for xref:ug:fun:building-blocks/types-of-domain-objects/view-models.adoc[view models] (eg annotated with xref:rg:ant:ViewModel.adoc[`@ViewModel`]).
