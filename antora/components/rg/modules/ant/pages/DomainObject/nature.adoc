...
+
Equivalent to annotating with xref:rg:ant:Mixin.adoc[`@Mixin`].  For further discussion on using mixins, see xref:ug:fun:building-blocks/types-of-domain-objects/mixins.adoc[mixins] in the user guide.
...
These limitations do _not_ apply to xref:ug:fun:programming-model/view-models/jaxb.adoc[JAXB] view models.
