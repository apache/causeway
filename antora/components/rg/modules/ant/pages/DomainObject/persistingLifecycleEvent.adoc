...
While you can roll your own, note that the framework provides built-in support for this use case through the xref:rg:cms:classes/roles/Timestampable.adoc[`Timestampable`] role interface.
====
