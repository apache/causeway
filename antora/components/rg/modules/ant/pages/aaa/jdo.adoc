...
`NotPersistent`]
|Used to determine whether to enforce or skip some xref:ug:btb:programming-model/custom-validator.adoc[metamodel validation] for `@Column` versus equivalent Isis annotations.
