...
To get an idea of how these are rendered (in the xref:ug:vw:ugvw.adoc#[Wicket viewer]), see xref:rg:ant:PropertyLayout/labelPosition.adoc[PropertyLayout#labelPosition()].
