...
[TIP]
====
It is also possible to use xref:rg:ant:CollectionLayout/hidden.adoc[`@CollectionLayout#hidden()`] or using xref:ug:vw:ugvw.adoc#_ugvw_layout_file-based[file-based layout] such that the collection can be hidden at the view layer.
