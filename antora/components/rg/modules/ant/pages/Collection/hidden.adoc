...
[TIP]
====
It is also possible to use xref:rg:ant:rgant.adoc#_rgant-CollectionLayout_hidden[`@CollectionLayout#hidden()`] or using xref:ug:vw:ugvw.adoc#_ugvw_layout_file-based[file-based layout] such that the collection can be hidden at the view layer.
...
The xref:ug:vro:ugvro.adoc#[RestfulObjects viewer] by default suppress collections when rendering a domain object.
====
