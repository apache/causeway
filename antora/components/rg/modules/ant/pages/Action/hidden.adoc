...
[TIP]
====
It is also possible to use xref:rg:ant:ActionLayout/hidden.adoc[`@ActionLayout#hidden()`] or xref:ug:vw:ugvw.adoc#_ugvw_layout_file-based[file-based layouts] such that the action can be hidden at the view layer.
