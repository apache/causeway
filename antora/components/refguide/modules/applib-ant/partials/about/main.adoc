...
[TIP]
====
Most UI semantics can also be specified using xref:userguide:ROOT:ui.adoc#object-layout[dynamic object layout].
====
...
|Purpose
|Layer
|xref:userguide:ROOT:ui.adoc#object-layout[File-based layout]?
