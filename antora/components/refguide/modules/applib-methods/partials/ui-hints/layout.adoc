...
Every object has a xref:userguide:ROOT:ui.adoc#object-layout[layout] .
...
xref:refguide:applib:index/annotation/DomainObjectLayout.adoc[@DomainObjectLayout] and the like, but it much more commonly specified using an xref:userguide:ROOT:ui.adoc#object-layout [XML layout file].
