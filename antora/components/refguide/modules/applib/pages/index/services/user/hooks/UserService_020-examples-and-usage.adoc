...
* xref:system:generated:index/applib/services/user/UserMemento.adoc[UserMemento]
* xref:system:generated:index/applib/services/user/RoleMemento.adoc[RoleMemento]
