...
The xref:system:generated:index/applib/annotation/ActionLayout.adoc#cssClassFa[cssClassFa()] element is used to specify the name of a link:http://fortawesome.github.io/Font-Awesome/icons/[Font Awesome icon] name, to be rendered on the action's representation as a button or menu item.
The related xref:system:generated:index/applib/annotation/ActionLayout.adoc#cssClassFaPosition[cssClassFaPosition()] element specifies the positioning of the icon, to the left or the right of the text.
