...
The `describedAs` attribute is used to provide a short description of the action parameter to the user.  In the xref:vw:ROOT:about.adoc[Wicket viewer] it is displayed as a 'tool tip'.  The `describedAs` attribute can also be specified for xref:system:generated:index/applib/annotation/CollectionLayout.adoc#describedAs[collections],  xref:system:generated:index/applib/annotation/PropertyLayout.adoc#describedAs[properties], xref:system:generated:index/applib/annotation/ActionLayout.adoc#describedAs[actions] and xref:system:generated:index/applib/annotation/DomainObjectLayout.adoc#describedAs[domain objects].
