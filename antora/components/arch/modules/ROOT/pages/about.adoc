...
* the xref:helloworld:ROOT:about.adoc[helloworld] archetype is a single Maven module that contains the absolute minimum; there are not tests or fixture scripts, just a single entity and domain service
