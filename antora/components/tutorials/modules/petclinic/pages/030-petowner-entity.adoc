...
Confirm that "Pet Owners > List" now shows the additional properties as columns.
...
Prototyping involves a lot of iteration, meaning make a change, re-run the app, in the app re-create some example objects, inspect the result.

One way to create objects is from the Prototyping menu; you might already have been doing this.
