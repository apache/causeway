...
If using Tomcat, update the `CATALINA_OPTS` variable.  (This variable is also updated if xref:ug:btb:deployment/externalized-configuration.adoc#log4j[configuring logging to run externally]).
