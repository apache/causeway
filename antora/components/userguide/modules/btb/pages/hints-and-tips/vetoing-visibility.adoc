...
NOTE: FIXME - a write-up of the "vetoing subscriber" design pattern, eg as described in the  xref:refguide:applib-svc:integration-api/BookmarkService.adoc[`BookmarkService`]
