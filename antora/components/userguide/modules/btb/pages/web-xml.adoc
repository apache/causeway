...
Typically they will be logon pages, or for health checks (as per xref:refguide:applib-svc:application-layer-spi/HealthCheckService.adoc[`HealthCheckService`] SPI.
