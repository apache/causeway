...
For example, some folk advocate that pattern names such as "Repository" or "Factory" should not appear in class names because they are not part of the xref:userguide:fun:background-context-and-theory.adoc#ubiquitous-language[ubiquitous language].
