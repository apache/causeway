...
* the layout of application menu items (inferred from xref:domain-services.adoc#domain-services[domain services])

* the layout of domain objects (xref:domain-services.adoc#domain-entities[domain entities] and xref:view-models.adoc[view models]) allow the positioning of the xref:object-members.adoc[object members] into columns and tabs
...
include::partial$ui/names-and-descriptions.adoc[leveloffset=+1]
include::partial$ui/object-titles-and-icons.adoc[leveloffset=+1]
include::partial$ui/action-icons-and-css.adoc[leveloffset=+1]

include::partial$ui/menubars-layout.adoc[leveloffset=+1]
include::partial$ui/object-layout.adoc[leveloffset=+1]

include::partial$ui/table-columns.adoc[leveloffset=+1]
