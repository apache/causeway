...
If you want to visualize an array of value types in Apache Isis, then one option is to wrap value in a view model, as explained xref:ug:btb:about.adoc#simulating-collections-of-values[elsewhere].
