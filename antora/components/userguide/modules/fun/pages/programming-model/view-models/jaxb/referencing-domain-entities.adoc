...
And this class is similar to the xref:refguide:applib-svc:integration-api/BookmarkService.adoc[`BookmarkService`]: it knows how to create an `OidDto` from an object reference.
