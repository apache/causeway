...
A property is an instance variable of a domain object, of a scalar type, that holds some state in either a xref:userguide:fun:domain-services.adoc#domain-entities[domain entity] or a xref:userguide:fun:view-models.adoc[view model].
