...
As well as defining a xref:userguide:fun:background-context-and-theory.adoc#metamodel[metamodel] of the structure (domain classes) of its domain objects, Apache Causeway also manages the runtime instances of said domain objects.
