...
The xref:userguide:fun:background-context-and-theory.adoc#cqrs[CQRS architecture] is often combined with _Event Sourcing_ pattern, though they are separate ideas.
