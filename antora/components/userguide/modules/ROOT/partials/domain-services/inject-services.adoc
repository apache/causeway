...
== Injecting `InteractionScope`d services
...
A small number of framework-provided services are annotated using xref:refguide:applib:index/annotation/InteractionScope.adoc[@InteractionScope].
