...
This is covered in more detail in xref:userguide:ROOT:business-rules.adoc[business rules].
====
...
Whether it is present or not depends to some extent on your preferred style: the UI semantics can be specified either in code within this annotation, or can be specified through the companion xref:userguide:ROOT:ui.adoc#layout-file-styles[layout file].

[TIP]
====
Details on how to actually write properties in practice (the programming model) can be found xref:userguide:ROOT:object-members.adoc#properties[here].
====
...
[TIP]
====
Details on how to actually write collections in practice (the programming model) can be found xref:userguide:ROOT:object-members.adoc#collections[here].
====
...
While xref:userguide:ROOT:object-members.adoc#properties[properties] and xref:userguide:ROOT:object-members.adoc#collections[collections] define the state held by a domain object (its "know what" responsibilities), actions define the object's behaviour (its "know how-to" responsibilities).
...
The use of `@ActionLayout` is optional, the UI semantics can be specified either in code within this annotation, or can be specified through the companion xref:userguide:ROOT:ui.adoc#layout-file-styles[layout file].
...
[TIP]
====
Details on how to actually write actions in practice (the programming model) can be found xref:userguide:ROOT:object-members.adoc#actions[here].
====
