...
xref:userguide:ROOT:ui-layout-and-hints.adoc#object-titles-and-icons[Normally] the code to return title and icon of an object is part of the domain object's implementation.
