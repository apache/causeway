...
In addition, the framework builds up the metamodel for each domain object using xref:userguide:ROOT:ui.adoc#object-layout[layout hints], such as `Customer.layout.xml`.
