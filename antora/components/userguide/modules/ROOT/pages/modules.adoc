...
These events can affect both the UI (eg hiding or disabling xref:object-members.adoc[object members], or allowing or vetoing interactions).
...
(See the xref:modules.adoc[modules] page for more discussion on the alternatives).
