...
This guide introduces the xref:userguide:fun:background-context-and-theory.adoc[core concepts] and provides an xref:userguide:fun:overview.adoc[overview] of the building blocks of Apache Causeway applications.

It next describes the basics of the Apache Causeway' programming model: xref:userguide:fun:domain-services.adoc[domain entities and services], xref:userguide:fun:object-members.adoc[object members], xref:userguide:fun:ui.adoc[UI layout and hints], xref:userguide:fun:business-rules.adoc[business rules] and xref:userguide:fun:drop-downs-and-defaults.adoc[drop downs and defaults].
This includes a discussion on xref:userguide:fun:domain-services.adoc#object-management-crud[the basic CRUD operations].
