...
Also check out the xref:reference:about.adoc[] which provides a working example of much of the Causeway programming model; you can access a live instance link:https://demo-wicket-jpa-snapshot.apps.causeway.dev/[here].
====
