...
What this capability enables is rapid development, enabling a fast feedback loop with your users.
This is the core of our philosophy.
And in that spirit, this user guide aims to get you developing applications as quickly as possible.

[TIP]
.Quick start resources
====
If you prefer to "do" rather to than "read", do also check out the xref:docs:starters:helloworld.adoc[] and xref:docs:starters:simpleapp.adoc[] starter apps.

Also check out the xref:docs:demo:about.adoc[] which provides working example of much of the Causeway programming model; you can access a live instance link:https://demo-wicket-jpa-snapshot.apps.causeway.dev/[here].
====

This user guide starts with a xref:userguide:ROOT:overview.adoc[10,000ft overview] of the main building blocks that make up the framework.
