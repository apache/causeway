...
* the layout of domain objects (xref:domain-entities.adoc[domain entities] and xref:view-models.adoc[view models]) allow the positioning of the xref:object-members.adoc[object members] into columns and tabs
