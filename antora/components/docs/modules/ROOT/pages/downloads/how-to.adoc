...
* https://www.apache.org/dyn/closer.cgi/causeway/causeway-core/causeway-{page-causewayprev}-source-release.zip[causeway-{page-causewayprev}] (https://www.apache.org/dist/causeway/causeway-core/causeway-{page-causewayprev}-source-release.zip.asc[asc], https://www.apache.org/dist/causeway/causeway-core/causeway-{page-causewayprev}-source-release.zip.md5[md5])
...
----
pgpk -a KEYS
pgpv causeway-{page-causewayprev}-source-release.zip.asc causeway-{page-causewayprev}-source-release.zip
----
...
----
pgp -ka KEYS
pgp causeway-{page-causewayprev}-source-release.zip.asc causeway-{page-causewayprev}-source-release.zip
----
...
----
gpg --import KEYS
gpg -verify causeway-{page-causewayprev}-source-release.zip.asc causeway-{page-causewayprev}-source-release.zip
----
