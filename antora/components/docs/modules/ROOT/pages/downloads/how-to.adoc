...
* https://www.apache.org/dyn/closer.cgi/isis/isis-core/isis-{isisnext}-source-release.zip[isis-{isisnext}] (https://www.apache.org/dist/isis/isis-core/isis-{isisnext}-source-release.zip.asc[asc], https://www.apache.org/dist/isis/isis-core/isis-{isisnext}-source-release.zip.md5[md5])
...
----
pgpk -a KEYS
pgpv isis-{isisnext}-source-release.zip.asc isis-{isisnext}-source-release.zip
----
...
----
pgp -ka KEYS
pgp isis-{isisnext}-source-release.zip.asc isis-{isisnext}-source-release.zip
----
...
----
gpg --import KEYS
gpg -verify isis-{isisnext}-source-release.zip.asc isis-{isisnext}-source-release.zip
----
