...
* the release manager performing post-release tasks, for either a successful or an xref:support:cgcom:post-release-unsuccessful.adoc[unsuccessful] vote (former documented below)
