...
* the release manager performing post-release tasks, for either a xref:support:cgcom:post-release-successful.adoc[successful] or an unsuccessful vote (latter documented below).
