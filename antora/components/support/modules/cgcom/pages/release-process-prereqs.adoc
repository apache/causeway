...
Ensure that Java 7 is installed and the toolchains plugin is configured, as described in the xref:support:dg:building-isis/configure-maven-toolchains-plugin.adoc[contributors' guide].
