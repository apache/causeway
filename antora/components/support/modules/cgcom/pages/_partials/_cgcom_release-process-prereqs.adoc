...
This section (appendix) describes the prerequisites for the xref:support:cgcom:cgcom.adoc#_cgcom_release-process[release process].
...
See the page on xref:support:cgcom:cgcom.adoc#_cgcom_key-generation[key generation] for more details.
