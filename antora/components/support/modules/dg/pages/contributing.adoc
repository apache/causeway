...
This page explains how you can contribute to Apache Isis. You'll probably also want xref:support:dg:ide.adoc[set up your IDE] and learn xref:support:dg:building-apache-isis.adoc[how to build Apache Isis].
...
Next, make changes to your files using the usual commands (see also our xref:support:dg:git-cookbook.adoc[git cookbook] section):
