...
This page explains how you can contribute to Apache Isis. You'll probably also want xref:support:dg:ide.adoc[set up your IDE] and learn xref:support:dg:building-isis.adoc[how to build Apache Isis].
