...
Chances are it is already set up from running the xref:arch:helloworld:about.adoc[HelloWorld] or the xref:arch:simpleapp:about.adoc[SimpleApp] archetype.
