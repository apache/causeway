...
* xref:support:cgcom:policies/git-policy.adoc[Git policy]
...
The xref:support:dg:dg.adoc#_dg_contributing[contributing] page describes the workflow for non-committers.  The xref:support:cgcom:policies/git-policy.adoc[Git policy] page describes a workflow for Apache Isis **committers**.
