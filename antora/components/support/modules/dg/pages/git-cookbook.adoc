...
* xref:support:dg:building-apache-isis.adoc[building Apache Isis]
* xref:support:dg:contributing.adoc[Contributing]
...
The xref:support:dg:contributing.adoc[contributing] page describes the workflow for non-committers.  The xref:support:cgcom:policies/git-policy.adoc[Git policy] page describes a workflow for Apache Isis **committers**.
