...
Since this can only be done by Apache Isis committers, the process for doing this is described in the xref:support:cgcom:asciidoc-publish-procedure.adoc[committers' guide].
