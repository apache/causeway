...
so that it can emit additional bytecode (eg for the getter and setter).  See xref:support:dg:ide/intellij.adoc#other-settings-compiler[here] for details of setting up in IntelliJ (Eclipse has very similar support).
