...
class EntityChangeTrackerDefault {
  EntityChangeTrackerDefault(EntityPropertyChangePublisher entityPropertyChangePublisher, EntityChangesPublisher entityChangesPublisher, Provider<InteractionLayerTracker> interactionProviderProvider, PreAndPostValueEvaluatorService preAndPostValueEvaluatorService)
  int getOrder()
  void destroy()
