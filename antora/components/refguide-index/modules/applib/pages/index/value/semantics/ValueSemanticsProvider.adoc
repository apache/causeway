...
interface ValueSemanticsProvider<T> {
  ...
  UserLocale getUserLocale(ValueSemanticsProvider.@Nullable Context context)     // <.>
  Function<T, String> pipe(Function<T, String> toString, UnaryOperator<String> postprocessor)     // <.>
  boolean isEnumType()
...
--
<.> xref:#getUserLocale_ValueSemanticsProvider_Context[getUserLocale(ValueSemanticsProvider_Context)]
<.> xref:#pipe_Function_UnaryOperator[pipe(Function, UnaryOperator)]
+
--
...
[#getUserLocale_ValueSemanticsProvider_Context]
=== getUserLocale(ValueSemanticsProvider_Context)

[#pipe_Function_UnaryOperator]
=== pipe(Function, UnaryOperator)
