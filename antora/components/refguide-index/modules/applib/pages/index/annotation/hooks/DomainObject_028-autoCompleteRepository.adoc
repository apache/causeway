...
The optional xref:refguide:applib:index/annotation/DomainObject.adoc#autoCompleteAction[autoCompleteAction()] element allows the name of this method to be overridden.
