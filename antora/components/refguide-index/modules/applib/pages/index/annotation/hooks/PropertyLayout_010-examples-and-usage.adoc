...
[TIP]
====
As an alternative to using the `@PropertyLayout` annotation, a xref:userguide:ROOT:ui.adoc#object-layout[file-based layout] can be used (and is generally to be preferred since it is more flexible/powerful).
====
