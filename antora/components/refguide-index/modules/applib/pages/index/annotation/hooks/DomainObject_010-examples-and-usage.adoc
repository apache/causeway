...
Although there are several ways to instantiate a xref:userguide:fun:view-models.adoc[view model], we recommend that they are instantiated using an N-arg constructor that initializes all relevant state.
