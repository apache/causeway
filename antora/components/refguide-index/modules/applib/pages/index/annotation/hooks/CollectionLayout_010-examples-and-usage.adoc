...
[TIP]
====
As an alternative to using the `@CollectionLayout` annotation, a xref:userguide:ROOT:ui.adoc#object-layout[file-based layout] can be used (and is generally to be preferred since it is more flexible/powerful).
====
...
As alternative to using the annotation, the dynamic xref:userguide:ROOT:ui.adoc#object-layout[file-based layout] can generally be used instead.
