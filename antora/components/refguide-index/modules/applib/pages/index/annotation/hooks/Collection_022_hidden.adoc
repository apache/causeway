...
It is also possible to use xref:refguide:applib:index/annotation/CollectionLayout.adoc#hidden[@CollectionLayout#hidden] or using xref:userguide:ROOT:ui.adoc#object-layout[file-based layout] such that the collection can be hidden at the view layer.
