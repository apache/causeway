...
The core framework (xref:core:metamodel:about.adoc[MetaModel] module) provides a default implementation, `o.a.c.core.metamodel.services.appfeat.ApplicationFeatureRepositoryDefault`.
