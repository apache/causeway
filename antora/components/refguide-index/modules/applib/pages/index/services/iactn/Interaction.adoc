...
The xref:refguide:applib:index/services/iactn/Interaction.adoc[Interaction] can be used to obtain the xref:refguide:applib:index/services/command/Command.adoc[Command] object representing the top-level invocation action/property edit.
