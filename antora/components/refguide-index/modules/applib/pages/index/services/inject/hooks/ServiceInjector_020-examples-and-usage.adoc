...
* xref:refguide:applib:index/services/repository/RepositoryService.adoc#detachedEntity__T[RepositoryService#detachedEntity()]

* xref:refguide:applib:index/services/factory/FactoryService.adoc#detachedEntity__T[FactoryService#detachedEntity()]
