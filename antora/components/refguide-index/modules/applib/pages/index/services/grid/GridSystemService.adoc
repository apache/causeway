...
This is done using existing metadata, most notably that of the _org.apache.isis.applib.annotations.MemberOrder_ annotation. Such a grid, if persisted as the layout XML file for the domain class, allows the _org.apache.isis.applib.annotations.MemberOrder_ annotation to be removed from the source code of the domain class (but other annotations must be retained).
...
Such a grid, if persisted as the layout XML file for the domain class, allows all layout annotations ( _org.apache.isis.applib.annotations.ActionLayout_ , _org.apache.isis.applib.annotations.PropertyLayout_ , _org.apache.isis.applib.annotations.CollectionLayout_ ) to be removed from the source code of the domain class.
...
Such a grid, if persisted as the layout XML file for the domain class, requires that the _org.apache.isis.applib.annotations.MemberOrder_ annotation is retained in the source code of said class in order to bind members to the regions of the grid.
