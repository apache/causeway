...
+
enumerates the mode that the translation service is currently in, as per xref:refguide:applib:index/services/i18n/TranslationService.adoc#getMode__[getMode()].
