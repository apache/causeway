...
+
exposes xref:refguide:applib:index/services/metamodel/MetaModelService.adoc#exportMetaModel__Config[exportMetaModel] as an action in the user interface.
