...
Typically domain objects will have little need to interact with the xref:refguide:applib:index/services/iactn/InteractionContext.adoc[InteractionContext] and xref:refguide:applib:index/services/iactn/Interaction.adoc[Interaction] directly.
...
* xref:refguide:applib:index/services/iactn/Interaction.adoc[Interaction], as provided by the xref:refguide:applib:index/services/iactn/InteractionContext.adoc[InteractionContext]
