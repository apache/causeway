...
+
--
Provides a lookup by class of a domain class' object type, as defined by _DomainObject#logicalTypeName()_ (or any other mechanism that corresponds to Causeway' `ObjectTypeFacet` ).
--
