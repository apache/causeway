...
--
<.> xref:#lookupRegisteredBeanById_String[lookupRegisteredBeanById(String)]
+
--
Returns a registered bean of given _name_ .
--
<.> xref:#lookupRegisteredBeanByIdElseFail_String[lookupRegisteredBeanByIdElseFail(String)]
+
--
...
[#lookupRegisteredBeanById_String]
=== lookupRegisteredBeanById(String)

Returns a registered bean of given _name_ .

[#lookupRegisteredBeanByIdElseFail_String]
