= HomePageResolverService _(interface)_
...
This service simply provides access to the home page object (if any) annotated with xref:refguide:applib:index/annotations/HomePage.adoc[HomePage] .
