...
Provides a UI to allow domain model metadata (obtained from xref:refguide:applib:index/services/metamodel/MetaModelService.adoc[MetaModelService] ) to be downloaded.
