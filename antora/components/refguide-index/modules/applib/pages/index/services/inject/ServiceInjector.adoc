...
Resolves injection points using the _org.apache.causeway.applib.services.registry.ServiceRegistry_ (in other words provides a domain service instance to all fields and setters that are annotated with _javax.inject.Inject_ ).
