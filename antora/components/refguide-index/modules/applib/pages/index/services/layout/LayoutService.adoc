...
interface LayoutService {
  Optional<LayoutKey> layoutKey(Object domainObject)     // <.>
...
<.> xref:#layoutKey_Object[layoutKey(Object)]
...
--
<.> xref:#objectLayout_LayoutKey_LayoutExportStyle_CommonMimeType[objectLayout(LayoutKey, LayoutExportStyle, CommonMimeType)]
+
--
...
[#objectLayout_LayoutKey_LayoutExportStyle_CommonMimeType]
=== objectLayout(LayoutKey, LayoutExportStyle, CommonMimeType)
