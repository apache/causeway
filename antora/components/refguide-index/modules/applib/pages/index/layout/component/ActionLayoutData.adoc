...
Describes the layout of a single action, broadly corresponding to _org.apache.isis.applib.annotations.ActionLayout_ .
...
class ActionLayoutData {
  ...
  org.apache.isis.applib.annotations.ActionLayout.Position getPosition()
  void setPosition(org.apache.isis.applib.annotations.ActionLayout.Position position)
