...
class ExecutionPublisherDefault {
  ExecutionPublisherDefault(InteractionLayerTracker iaTracker, List<ExecutionSubscriber> subscribers, CausewayObservationIntegration observationIntegration)
  void destroy()
