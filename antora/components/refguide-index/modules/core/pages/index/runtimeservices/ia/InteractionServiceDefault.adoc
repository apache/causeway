...
Default implementation of xref:refguide:applib:index/services/iactn/InteractionService.adoc[InteractionService] , keeping track of the current xref:refguide:applib:index/services/iactn/Interaction.adoc[Interaction]
...
class InteractionServiceDefault {
  InteractionServiceDefault(ConfigurableBeanFactory beanFactory, ServiceInjector serviceInjector, TransactionServiceSpring transactionServiceSpring, ClockService clockService, Provider<CommandPublisher> commandPublisherProvider, ExecutionContext executionContext, CausewayObservationIntegration observationIntegration)
  int getInteractionLayerCount()
  Interaction openInteraction()
  Interaction openInteraction(InteractionContext interactionContextToUse)
