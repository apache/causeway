...
<.> xref:#beforeEnteringTransactionalBoundary_Interaction[beforeEnteringTransactionalBoundary(Interaction)]
+
--
INTERACTION BEGIN BOUNDARY
--
<.> xref:#onTransactionEnded_TransactionAfterCompletionEvent[onTransactionEnded(TransactionAfterCompletionEvent)]
+
--
TRANSACTION END BOUNDARY
--
<.> xref:#afterLeavingTransactionalBoundary_Interaction[afterLeavingTransactionalBoundary(Interaction)]
+
--
...
[#beforeEnteringTransactionalBoundary_Interaction]
=== beforeEnteringTransactionalBoundary(Interaction)

INTERACTION BEGIN BOUNDARY

[#onTransactionEnded_TransactionAfterCompletionEvent]
=== onTransactionEnded(TransactionAfterCompletionEvent)

TRANSACTION END BOUNDARY

[#afterLeavingTransactionalBoundary_Interaction]
