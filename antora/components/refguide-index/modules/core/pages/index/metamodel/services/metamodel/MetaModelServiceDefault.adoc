...
record MetaModelServiceDefault {
  ...
  Stream<Identifier> parentedAssociationsForColumnRendering(Object parentDomainObject, Identifier collectionId, AssociationsLookup columnQueryMode)
  Stream<Identifier> standaloneAssociationsForColumnRendering(LogicalType logicalType, AssociationsLookup columnQueryMode)
