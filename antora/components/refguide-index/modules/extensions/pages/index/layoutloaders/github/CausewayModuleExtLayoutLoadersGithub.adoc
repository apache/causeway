...
class CausewayModuleExtLayoutLoadersGithub {
  ...
  RestClient restClientForGithubSearch(CausewayConfiguration causewayConfiguration)     // <.>
  RestClient restClientForGithubContent(CausewayConfiguration causewayConfiguration)     // <.>
}
----

<.> xref:#restClientForGithubSearch_CausewayConfiguration[restClientForGithubSearch(CausewayConfiguration)]
+
--
Returns a template configured to search for a file in the git repo.
--
<.> xref:#restClientForGithubContent_CausewayConfiguration[restClientForGithubContent(CausewayConfiguration)]
+
--
...
[#restClientForGithubSearch_CausewayConfiguration]
=== restClientForGithubSearch(CausewayConfiguration)
...
[#restClientForGithubContent_CausewayConfiguration]
=== restClientForGithubContent(CausewayConfiguration)
