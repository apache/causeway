...
interface CommandLogEntryRepository {
  ...
  List<CommandLogEntry> findForegroundSinceTimestamp(Timestamp since)
  List<CommandLogEntry> findForegroundSinceTimestamp(Timestamp since, Integer limitIfAny)
  List<CommandLogEntry> findForegroundBeforeTimestamp(Timestamp before, Integer limitIfAny)
  ...
  List<CommandLogEntry> saveForReplay(List<CommandDto> commandDtoList)
...
--
<.> xref:#findForegroundSinceTimestampAndWithReplayPendingOrFailed_Timestamp[findForegroundSinceTimestampAndWithReplayPendingOrFailed(Timestamp)]
+
--
Command Replay feature: Can replay or retry.
--
<.> xref:#findSinceAndWithReplayOkOrExcluded_Timestamp[findSinceAndWithReplayOkOrExcluded(Timestamp)]
+
--
...
[#findForegroundSinceTimestampAndWithReplayPendingOrFailed_Timestamp]
=== findForegroundSinceTimestampAndWithReplayPendingOrFailed(Timestamp)

Command Replay feature: Can replay or retry.

[#findSinceAndWithReplayOkOrExcluded_Timestamp]
=== findSinceAndWithReplayOkOrExcluded(Timestamp)
