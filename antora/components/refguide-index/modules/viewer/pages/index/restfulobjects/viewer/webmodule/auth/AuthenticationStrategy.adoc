...
Decouples the `CausewayRestfulObjectsInteractionFilter` from the mechanism of obtaining the xref:refguide:applib:index/services/iactn/InteractionContext.adoc[InteractionContext] .
...
+
--
Returns a still-valid xref:refguide:applib:index/services/iactn/InteractionContext.adoc[InteractionContext] or _null_
--
...
+
--
Binds the request to a still-valid xref:refguide:applib:index/services/iactn/InteractionContext.adoc[InteractionContext] if applicable
--
