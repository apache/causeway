...
<.> xref:#fixtureScriptsSpecificationProvider_IsisConfiguration[fixtureScriptsSpecificationProvider(IsisConfiguration)]
+
--
...
[#fixtureScriptsSpecificationProvider_IsisConfiguration]
