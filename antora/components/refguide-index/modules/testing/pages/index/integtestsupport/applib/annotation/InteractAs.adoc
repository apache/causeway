...
Offers an alternative to xref:refguide:applib:index/services/iactn/InteractionService.adoc[InteractionService] 's imperative approach to switch the xref:refguide:applib:index/services/iactn/InteractionContext.adoc[InteractionContext] for a given block of _JUnit_ test code.
