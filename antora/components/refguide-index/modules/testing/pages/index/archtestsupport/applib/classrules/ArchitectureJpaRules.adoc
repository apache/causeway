...
--
<.> xref:#every_jpa_Entity_must_be_annotated_as_an_IsisEntityListener_[every_jpa_Entity_must_be_annotated_as_an_IsisEntityListener()]
+
--
...
[#every_jpa_Entity_must_be_annotated_as_an_IsisEntityListener_]
