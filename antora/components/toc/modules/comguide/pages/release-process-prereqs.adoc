...
This section (appendix) describes the prerequisites for the xref:toc:comguide:release-process.adoc[release process].
...
See the page on xref:toc:comguide:key-generation.adoc[key generation] for more details.
