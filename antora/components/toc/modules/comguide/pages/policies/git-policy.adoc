...
For non-committers we typically expect more detail again; see the xref:toc:devguide:contributing.adoc[contributing] page for the longer format recommended for contributors to use.