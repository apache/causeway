...
* the release manager performing post-release tasks, for either a successful or an xref:toc:comguide:post-release-unsuccessful.adoc[unsuccessful] vote (former documented below)
