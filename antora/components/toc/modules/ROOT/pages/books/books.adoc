...
[[__books_DDD-using-NO]]
== Domain Driven Design using Naked Objects

Dan Haywood, Pragmatic Bookshelf 2009

image::books/dhnako.jpg[width="167px",link="{_imagesdir}books/dhnako.jpg"]
...
It is implemented by Apache Isis' xref:../../guides/ugvro/ugvro.adoc#[Restful Objects] viewer, and is also implemented by another (non-Apache) open source project, http://nakedobjects.codeplex.com[Naked Objects MVC].
