...
image::isis-in-pictures/010-login.png[width="800px",link="{imagesdir}/isis-in-pictures/010-login.png"]
...
image::isis-in-pictures/020-install-fixtures.png[width="800px",link="{imagesdir}/isis-in-pictures/020-install-fixtures.png"]
...
image::isis-in-pictures/030-dashboard-view-model.png[width="800px",link="{imagesdir}/isis-in-pictures/030-dashboard-view-model.png"]
...
image::isis-in-pictures/040-domain-entity.png[width="800px",link="{imagesdir}/isis-in-pictures/040-domain-entity.png"]
...
image::isis-in-pictures/050-edit-property.png[width="800px",link="{imagesdir}/isis-in-pictures/050-edit-property.png"]
...
image::isis-in-pictures/060-invoke-action.png[width="800px",link="{imagesdir}/isis-in-pictures/060-invoke-action.png"]
...
image::isis-in-pictures/065-contributions.png[width="800px",link="{imagesdir}/isis-in-pictures/065-contributions.png"]
...
image::isis-in-pictures/070-pluggable-views.png[width="800px",link="{imagesdir}/isis-in-pictures/070-pluggable-views.png"]
...
image::isis-in-pictures/080-gmap3-view.png[width="800px",link="{imagesdir}/isis-in-pictures/080-gmap3-view.png"]
...
image::isis-in-pictures/090-fullcalendar2-view.png[width="800px",link="{imagesdir}/isis-in-pictures/090-fullcalendar2-view.png"]
...
image::isis-in-pictures/100-excel-view-and-docx.png[width="800px",link="{imagesdir}/isis-in-pictures/100-excel-view-and-docx.png"]
...
image::isis-in-pictures/110-docx.png[width="800px",link="{imagesdir}/isis-in-pictures/110-docx.png"]
...
image::isis-in-pictures/120-auditing.png[width="800px",link="{imagesdir}/isis-in-pictures/120-auditing.png"]
...
image::isis-in-pictures/130-security.png[width="800px",link="{imagesdir}/isis-in-pictures/130-security.png"]
...
image::isis-in-pictures/140-i18n.png[width="800px",link="{imagesdir}/isis-in-pictures/140-i18n.png"]
...
image::isis-in-pictures/150-appsettings.png[width="800px",link="{imagesdir}/isis-in-pictures/150-appsettings.png"]
...
image::isis-in-pictures/160-switch-tenancy.png[width="800px",link="{imagesdir}/isis-in-pictures/160-switch-tenancy.png"]
...
image::isis-in-pictures/170-me.png[width="800px",link="{imagesdir}/isis-in-pictures/170-me.png"]



Assuming they have been granted permissions, this allows a user to access an entity representing their own user account:

image::isis-in-pictures/180-app-user-entity.png[width="800px",link="{imagesdir}/isis-in-pictures/180-app-user-entity.png"]
...
image::isis-in-pictures/190-switch-theme.png[width="800px",link="{imagesdir}/isis-in-pictures/190-switch-theme.png"]
...
image::isis-in-pictures/200-rest-api.png[width="800px",link="{imagesdir}/isis-in-pictures/200-rest-api.png"]
...
image::isis-in-pictures/205-swagger-ui.png[width="800px",link="{imagesdir}/isis-in-pictures/205-swagger-ui.png"]
...
image::isis-in-pictures/210-fixture-scripts.png[width="500px",link="{imagesdir}/isis-in-pictures/210-fixture-scripts.png"]
...
image::isis-in-pictures/220-testing-happy-case.png[width="400px",link="{imagesdir}/isis-in-pictures/220-testing-happy-case.png"]
...
image::isis-in-pictures/230-testing-wrapper-factory.png[width="550px",link="{imagesdir}/isis-in-pictures/230-testing-wrapper-factory.png"]
...
image::isis-in-pictures/240-domain-events.png[width="400px",link="{imagesdir}/isis-in-pictures/240-domain-events.png"]
...
image::isis-in-pictures/250-domain-event-subscriber.png[width="450px",link="{imagesdir}/isis-in-pictures/250-domain-event-subscriber.png"]
...
image::isis-in-pictures/260-domain-event-test.png[width="850px",link="{imagesdir}/isis-in-pictures/260-domain-event-test.png"]
