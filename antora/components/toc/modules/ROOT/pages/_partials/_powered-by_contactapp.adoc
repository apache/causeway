...
Apache Isis' support for xref:ug:fun:ugfun.adoc#_ugfun_programming-model_view-models_jaxb[JAXB view models]
and in particular the http://isis.apache.org/guides/ugvro/ugvro.html#__ugvro_simplified-representations_apache-isis-profile[simplified REST representations] introduced in v1.12.0.  The result is code that is easy to follow and enhance.
