...
* as per xref:ug:vro:simplified-representations/configuration-properties.adoc[the documentation], configure the Restful Objects viewer to generate a simplified object representation: +
+
[source,ini]
----
