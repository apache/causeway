...
* specify a xref:ug:fun:ui-hints/object-titles-and-icons.adoc[title]
* specify an xref:ug:fun:ui-hints/object-titles-and-icons.adoc[icon]
...
* add some xref:ug:fun:programming-model/properties.adoc[value properties]; also:
...
* add some xref:ug:fun:programming-model/properties.adoc[reference properties]
...
* Add a xref:ug:fun:programming-model/collections.adoc[collection] to one of the entities
...
* to create objects, xref:ug:fun:programming-model/inject-services.adoc[inject] associated domain service
...
It's also possible to use Font Awesome icons for the xref:ug:fun:ui-hints/object-titles-and-icons.adoc[domain object icon].
