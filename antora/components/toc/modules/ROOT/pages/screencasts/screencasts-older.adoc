...
Learn more xref:support:dg:dg.adoc#[here]
...
Learn more xref:support:dg:dg.adoc#_dg_ide_intellij[here]
...
_Configuring the command and auditing add-on modules for the xref:ug:fun:ugfun.adoc#_ugfun_getting-started_simpleapp-archetype[SimpleApp]._ +
...
_Configuring the security add-on module for for the xref:ug:fun:ugfun.adoc#_ugfun_getting-started_simpleapp-archetype[SimpleApp]._ +
