...
The GRC platform currently has more than 5600 automated tests, about 2000 being xref:testing:specsupport:about.adoc[BDD tests] and 3600 xref:testing:integ-test-support:about.adoc[integration tests], all leveraging Apache Isis' extensive testing capabilities.
