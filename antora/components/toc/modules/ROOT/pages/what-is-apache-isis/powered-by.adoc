...
include::partial$_powered-by_estatio.adoc[leveloffset=+1]
include::partial$_powered-by_gesconsultor-grc.adoc[leveloffset=+1]
include::partial$_powered-by_contactapp.adoc[leveloffset=+1]
include::partial$_powered-by_cqnz.adoc[leveloffset=+1]
//include::partial$_powered-by_commapp.adoc[leveloffset=+1]
include::partial$_powered-by_transport-planner.adoc[leveloffset=+1]
