...
_Configuring the command and auditing add-on modules for the xref:arch:simpleapp:about.adoc[SimpleApp]._ +
...
_Configuring the security add-on module for for the xref:arch:simpleapp:about.adoc[SimpleApp]._ +
