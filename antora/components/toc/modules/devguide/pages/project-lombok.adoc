...
In the future we might extend/fork Lombok so that it understands Isis' own annotations (ie xref:refguide:applib-ant:Property.adoc[`@Property`] and xref:refguide:applib-ant:Collection.adoc[`@Collection`])
