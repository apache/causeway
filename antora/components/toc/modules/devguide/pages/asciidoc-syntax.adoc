...
|....
xref:toc:devguide:asciidoc/links-and-xrefs#.adoc[background]
....
|xref:toc:devguide:asciidoc/links-and-xrefs.adoc[background]
...
For example, this xref:toc:devguide:about.adoc[developers' guide] document is broken into several files:
