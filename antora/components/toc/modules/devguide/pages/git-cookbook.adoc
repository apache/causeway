...
* xref:toc:comguide:policies/git-policy.adoc[Git policy]
...
The xref:toc:devguide:contributing.adoc[contributing] page describes the workflow for non-committers.  The xref:toc:comguide:policies/git-policy.adoc[Git policy] page describes a workflow for Apache Isis **committers**.
