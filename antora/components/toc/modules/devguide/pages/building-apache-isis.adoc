...
Releases however are xref:toc:comguide:cutting-a-release.adoc[cut] using Java 7, leveraging the link:http://maven.apache.org/plugins/maven-toolchains-plugin/[Maven toolchains plugin]).
