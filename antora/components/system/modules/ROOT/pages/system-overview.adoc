...
* org.apache.isis.testdomain.applayer.ApplicationLayerTestFactory$PreCommitListener
* org.apache.isis.testdomain.applayer.publishing.CommandSubscriberForTesting
...
* org.apache.isis.testdomain.applayer.publishing.ExecutionSubscriberForTesting
