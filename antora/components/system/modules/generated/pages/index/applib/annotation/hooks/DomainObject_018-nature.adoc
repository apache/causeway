...
The xref:system:generated:index/applib/annotation/DomainObject.adoc#nature[nature()] element is used to characterize the domain object as either an entity (part of the domain layer) or as a view model (part of the application layer).
