...
+
--
Whether action invocations, captured as xref:applib/services/command/Command[Command] s, should be published to xref:applib/services/publishing/spi/CommandSubscriber[CommandSubscriber] s.
--
...
+
--
Whether _Interaction.Execution_ s (triggered by action invocations), should be published to xref:applib/services/publishing/spi/ExecutionSubscriber[ExecutionSubscriber] s.
--
...
--
<.> `[teal]#*_restrictTo_*#` : `xref:applib/annotation/RestrictTo[RestrictTo]`
+
--
...
--
<.> `[teal]#*_semantics_*#` : `xref:applib/annotation/SemanticsOf[SemanticsOf]`
+
--
...
+
--
For downloading xref:applib/value/Blob[Blob] or xref:applib/value/Clob[Clob] , optionally restrict the files accepted (eg `.xslx` ).
