...
<.> `[teal]#*_tr_*#(String pattern, Object... paramArgs)` : `xref:applib/services/i18n/TranslatableString[TranslatableString]`
+
--
A translatable string with a single pattern for both singular and plural forms.
--
<.> `[teal]#*_trn_*#(String singularPattern, String pluralPattern, int number, Object... paramArgs)` : `xref:applib/services/i18n/TranslatableString[TranslatableString]`
+
--
...
--
<.> `[teal]#*translate*#(xref:applib/services/i18n/TranslationService[TranslationService] translationService, String context)` : `String`
+
--
