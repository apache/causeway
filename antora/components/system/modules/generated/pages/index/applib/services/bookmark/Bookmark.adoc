...
<.> `[teal]#*_parse_*#(String str)` : `Optional<xref:applib/services/bookmark/Bookmark[Bookmark]>`
+
--
...
+
--
The canonical form of the xref:applib/services/bookmark/Bookmark[Bookmark] , that is " _#getObjectType() objectType_ _#SEPARATOR_ _#getIdentifier()_ ".
