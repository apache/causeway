...
<.> `[teal]#*UserMemento*#(String name, Stream<xref:applib/services/user/RoleMemento[RoleMemento]> roles)`
+
--
Creates a new user with the specified name and assigned roles.
--
<.> `[teal]#*_system_*#()` : `xref:applib/services/user/UserMemento[UserMemento]`
+
--
The framework's internal user with unrestricted privileges.
--
<.> `[teal]#*_ofName_*#(String name)` : `xref:applib/services/user/UserMemento[UserMemento]`
+
--
Creates a new user with the specified name and no roles.
--
<.> `[teal]#*_ofNameAndRoles_*#(String name, xref:applib/services/user/RoleMemento[RoleMemento]... roles)` : `xref:applib/services/user/UserMemento[UserMemento]`
+
--
Creates a new user with the specified name and assigned roles.
--
<.> `[teal]#*_ofNameAndRoleNames_*#(String name, String... roleNames)` : `xref:applib/services/user/UserMemento[UserMemento]`
+
--
Creates a new user with the specified name and assigned role names.
--
<.> `[teal]#*_ofNameAndRoleNames_*#(String name, Stream<String> roleNames)` : `xref:applib/services/user/UserMemento[UserMemento]`
+
--
Creates a new user with the specified name and assigned role names.
--
