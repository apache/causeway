...
--
<.> `[teal]#*getDomainModel*#()` : `xref:applib/services/metamodel/DomainModel[DomainModel]`
+
--
Returns a list of representations of each of member of each domain class.

Used by xref:applib/services/metamodel/MetaModelServiceMenu[MetaModelServiceMenu] to return a downloadable CSV.
