...
--
<.> `[teal]#*_bounding_*#` : `xref:applib/annotation/Bounding[Bounding]`
+
--
...
--
<.> `[teal]#*_entityChangePublishing_*#` : `xref:applib/annotation/Publishing[Publishing]`
+
--
...
--
<.> `[teal]#*_nature_*#` : `xref:applib/annotation/Nature[Nature]`
+
--
