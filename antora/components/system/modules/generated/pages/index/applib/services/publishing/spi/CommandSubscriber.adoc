...
Part of the _Publishing SPI_ . A component to receive xref:applib/services/command/Command[Command] s (with publishing enabled) that just completed.
...
<.> `[teal]#*onCompleted*#(xref:applib/services/command/Command[Command] command)` : `void`
+
--
