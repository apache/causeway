...
<.> `[teal]#*_bookmarking_*#` : `xref:applib/annotation/BookmarkPolicy[BookmarkPolicy]`
+
--
...
+
--
Which subclass of xref:applib/events/ui/CssClassUiEvent[CssClassUiEvent] should be used to obtain a CSS class.
...
+
--
Which subclass of xref:applib/events/ui/LayoutUiEvent[LayoutUiEvent] should be used to obtain a layout.
...
+
--
Which subclass of xref:applib/events/ui/TitleUiEvent[TitleUiEvent] should be used to obtain a title.
