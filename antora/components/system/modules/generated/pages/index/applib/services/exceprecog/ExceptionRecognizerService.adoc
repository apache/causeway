...
<.> `[teal]#*getExceptionRecognizers*#()` : `Can<xref:applib/services/exceprecog/ExceptionRecognizer[ExceptionRecognizer]>`
...
--
<.> `[teal]#*recognizeFromSelected*#(Can<xref:applib/services/exceprecog/ExceptionRecognizer[ExceptionRecognizer]> recognizers, Exception ex)` : `Optional<Recognition>`
+
--
