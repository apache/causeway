...
+
--
The xref:applib/services/commanddto/processor/CommandDtoProcessor[CommandDtoProcessor] to process this command's DTO.

The processor itself is used by xref:applib/services/commanddto/conmap/ContentMappingServiceForCommandDto[ContentMappingServiceForCommandDto] and xref:applib/services/commanddto/conmap/ContentMappingServiceForCommandsDto[ContentMappingServiceForCommandsDto] to dynamically transform the DTOs.
--
<.> `[teal]#*_commandPublishing_*#` : `xref:applib/annotation/Publishing[Publishing]`
+
--
Whether property edits, captured as xref:applib/services/command/Command[Command] s, should be published to xref:applib/services/publishing/spi/CommandSubscriber[CommandSubscriber] s.
--
...
--
<.> `[teal]#*_executionPublishing_*#` : `xref:applib/annotation/Publishing[Publishing]`
+
--
Whether _Interaction.Execution_ s (triggered property edits), should be dispatched to xref:applib/services/publishing/spi/ExecutionSubscriber[ExecutionSubscriber] s.
--
<.> `[teal]#*_fileAccept_*#` : `String`
+
--
For uploading xref:applib/value/Blob[Blob] or xref:applib/value/Clob[Clob] , optionally restrict the files accepted (eg `.xslx` ).
...
--
<.> `[teal]#*_mementoSerialization_*#` : `xref:applib/annotation/MementoSerialization[MementoSerialization]`
+
--
...
--
<.> `[teal]#*_optionality_*#` : `xref:applib/annotation/Optionality[Optionality]`
+
--
...
--
<.> `[teal]#*_projecting_*#` : `xref:applib/annotation/Projecting[Projecting]`
+
--
