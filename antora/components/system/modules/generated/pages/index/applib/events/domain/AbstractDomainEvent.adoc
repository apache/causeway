...
Because the xref:applib/events/EventObjectBase[EventObjectBase] superclass prohibits a null source, a dummy value is temporarily used.
--
...
Not API, set by the framework.
--
<.> `[teal]#*setIdentifier*#(xref:applib/Identifier[Identifier] identifier)` : `void`
+
--
...
<.> `[teal]#*disable*#(xref:applib/services/i18n/TranslatableString[TranslatableString] reason)` : `void`
<.> `[teal]#*invalidate*#(String reason)` : `void`
<.> `[teal]#*invalidate*#(xref:applib/services/i18n/TranslatableString[TranslatableString] reason)` : `void`
...
--
<.> `[teal]#*veto*#(xref:applib/services/i18n/TranslatableString[TranslatableString] translatableReason)` : `void`
+
--
