...
--
<.> `[teal]#*__isis_executionModes*#()` : `ImmutableEnumSet<xref:applib/services/wrapper/control/ExecutionMode[ExecutionMode]>`
+
--
The _EnumSetexecution modes_ inferred from the xref:applib/services/wrapper/control/SyncControl[SyncControl] with which this wrapper was _WrapperFactory#wrap(Object, SyncControl) created_ .
