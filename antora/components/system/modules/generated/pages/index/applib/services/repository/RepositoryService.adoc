...
<.> `[teal]#*getEntityState*#(Object object)` : `xref:applib/services/repository/EntityState[EntityState]`
+
--
...
--
<.> `[teal]#*allMatches*#<T>(xref:applib/query/Query[Query]<T> query)` : `List<T>`
+
--
Returns all the instances that match the given xref:applib/query/Query[Query] .
...
--
<.> `[teal]#*uniqueMatch*#<T>(xref:applib/query/Query[Query]<T> query)` : `Optional<T>`
+
--
...
--
<.> `[teal]#*firstMatch*#<T>(xref:applib/query/Query[Query]<T> query)` : `Optional<T>`
+
--
