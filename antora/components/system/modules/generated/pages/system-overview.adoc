...
xref:commons/having/HasUniqueId[HasUniqueId], xref:commons/having/HasUsername[HasUsername]
|===
...
xref:applib/AbstractViewModel[AbstractViewModel], xref:applib/ApplicationException[ApplicationException], xref:applib/FatalException[FatalException], xref:applib/Identifier[Identifier], xref:applib/NonRecoverableException[NonRecoverableException], xref:applib/PersistFailedException[PersistFailedException], xref:applib/RecoverableException[RecoverableException], xref:applib/RecreatableDomainObject[RecreatableDomainObject], xref:applib/RepositoryException[RepositoryException], xref:applib/ViewModel[ViewModel], xref:applib/adapters/AbstractValueSemanticsProvider[AbstractValueSemanticsProvider], xref:applib/adapters/DefaultsProvider[DefaultsProvider], xref:applib/adapters/EncoderDecoder[EncoderDecoder], xref:applib/adapters/EncodingException[EncodingException], xref:applib/adapters/Parser[Parser], xref:applib/adapters/ParsingException[ParsingException], xref:applib/adapters/ValueSemanticsProvider[ValueSemanticsProvider], xref:applib/annotation/ActionLayout[ActionLayout], xref:applib/annotation/Action[Action], xref:applib/annotation/BookmarkPolicy[BookmarkPolicy], xref:applib/annotation/Bounding[Bounding], xref:applib/annotation/CollectionLayout[CollectionLayout], xref:applib/annotation/Collection[Collection], xref:applib/annotation/Defaulted[Defaulted], xref:applib/annotation/DomainObjectLayout[DomainObjectLayout], xref:applib/annotation/DomainObject[DomainObject], xref:applib/annotation/DomainServiceLayout[DomainServiceLayout], xref:applib/annotation/DomainService[DomainService], xref:applib/annotation/Editing[Editing], xref:applib/annotation/EntityChangeKind[EntityChangeKind], xref:applib/annotation/EqualByContent[EqualByContent], xref:applib/annotation/Facets[Facets], xref:applib/annotation/HomePage[HomePage], xref:applib/annotation/IsisInteractionScope[IsisInteractionScope], xref:applib/annotation/LabelPosition[LabelPosition], xref:applib/annotation/MemberOrder[MemberOrder], xref:applib/annotation/MementoSerialization[MementoSerialization], xref:applib/annotation/MinLength[MinLength], xref:applib/annotation/Module[Module], xref:applib/annotation/NatureOfService[NatureOfService], xref:applib/annotation/Nature[Nature], xref:applib/annotation/Navigable[Navigable], xref:applib/annotation/Optionality[Optionality], xref:applib/annotation/OrderPrecedence[OrderPrecedence], xref:applib/annotation/ParameterLayout[ParameterLayout], xref:applib/annotation/Parameter[Parameter], xref:applib/annotation/Programmatic[Programmatic], xref:applib/annotation/Projecting[Projecting], xref:applib/annotation/PromptStyle[PromptStyle], xref:applib/annotation/PropertyLayout[PropertyLayout], xref:applib/annotation/Property[Property], xref:applib/annotation/Publishing[Publishing], xref:applib/annotation/Redirect[Redirect], xref:applib/annotation/RenderDay[RenderDay], xref:applib/annotation/Repainting[Repainting], xref:applib/annotation/RestrictTo[RestrictTo], xref:applib/annotation/SemanticsOf[SemanticsOf], xref:applib/annotation/Title[Title], xref:applib/annotation/Value[Value], xref:applib/annotation/Where[Where], xref:applib/client/SuppressionType[SuppressionType], xref:applib/clock/VirtualClock[VirtualClock], xref:applib/events/EventObjectBase[EventObjectBase], xref:applib/events/domain/AbstractDomainEvent[AbstractDomainEvent], xref:applib/events/domain/ActionDomainEvent[ActionDomainEvent], xref:applib/events/domain/CollectionDomainEvent[CollectionDomainEvent], xref:applib/events/domain/PropertyDomainEvent[PropertyDomainEvent], xref:applib/events/lifecycle/AbstractLifecycleEvent[AbstractLifecycleEvent], xref:applib/events/lifecycle/ObjectCreatedEvent[ObjectCreatedEvent], xref:applib/events/lifecycle/ObjectLoadedEvent[ObjectLoadedEvent], xref:applib/events/lifecycle/ObjectPersistedEvent[ObjectPersistedEvent], xref:applib/events/lifecycle/ObjectPersistingEvent[ObjectPersistingEvent], xref:applib/events/lifecycle/ObjectRemovingEvent[ObjectRemovingEvent], xref:applib/events/lifecycle/ObjectUpdatedEvent[ObjectUpdatedEvent], xref:applib/events/lifecycle/ObjectUpdatingEvent[ObjectUpdatingEvent], xref:applib/events/ui/AbstractUiEvent[AbstractUiEvent], xref:applib/events/ui/CssClassUiEvent[CssClassUiEvent], xref:applib/events/ui/LayoutUiEvent[LayoutUiEvent], xref:applib/events/ui/TitleUiEvent[TitleUiEvent], xref:applib/graph/Edge[Edge], xref:applib/graph/SimpleEdge[SimpleEdge], xref:applib/graph/Vertex[Vertex], xref:applib/graph/tree/TreeAdapter[TreeAdapter], xref:applib/graph/tree/TreeNode[TreeNode], xref:applib/graph/tree/TreePath[TreePath], xref:applib/graph/tree/TreeState[TreeState], xref:applib/jaxb/JavaSqlJaxbAdapters[JavaSqlJaxbAdapters], xref:applib/jaxb/JavaTimeJaxbAdapters[JavaTimeJaxbAdapters], xref:applib/jaxb/JavaUtilJaxbAdapters[JavaUtilJaxbAdapters], xref:applib/jaxb/PersistentEntitiesAdapter[PersistentEntitiesAdapter], xref:applib/jaxb/PersistentEntityAdapter[PersistentEntityAdapter], xref:applib/layout/component/ActionLayoutData[ActionLayoutData], xref:applib/layout/component/HasBookmarking[HasBookmarking], xref:applib/layout/component/HasCssClassFa[HasCssClassFa], xref:applib/layout/component/HasCssClass[HasCssClass], xref:applib/layout/component/HasDescribedAs[HasDescribedAs], xref:applib/layout/component/HasHidden[HasHidden], xref:applib/layout/grid/bootstrap3/HasCssId[HasCssId], xref:applib/mixins/timestamp/HoldsUpdatedAt[HoldsUpdatedAt], xref:applib/mixins/timestamp/HoldsUpdatedBy[HoldsUpdatedBy], xref:applib/query/QueryFindAllInstances[QueryFindAllInstances], xref:applib/query/Query[Query], xref:applib/services/DomainChangeRecord[DomainChangeRecord], xref:applib/services/MethodReferences[MethodReferences], xref:applib/services/RepresentsInteractionMemberExecution[RepresentsInteractionMemberExecution], xref:applib/services/TransactionScopeListener[TransactionScopeListener], xref:applib/services/acceptheader/AcceptHeaderService[AcceptHeaderService], xref:applib/services/appfeat/ApplicationFeatureRepository[ApplicationFeatureRepository], xref:applib/services/appfeat/ApplicationMemberType[ApplicationMemberType], xref:applib/services/bookmark/BookmarkHolder[BookmarkHolder], xref:applib/services/bookmark/BookmarkService[BookmarkService], xref:applib/services/bookmark/Bookmark[Bookmark], xref:applib/services/bookmarkui/BookmarkUiService[BookmarkUiService], xref:applib/services/clock/ClockService[ClockService], xref:applib/services/command/CommandExecutorService[CommandExecutorService], xref:applib/services/command/CommandOutcomeHandler[CommandOutcomeHandler], xref:applib/services/command/Command[Command], xref:applib/services/commanddto/HasCommandDto[HasCommandDto], xref:applib/services/commanddto/conmap/ContentMappingServiceForCommandDto[ContentMappingServiceForCommandDto], xref:applib/services/commanddto/conmap/ContentMappingServiceForCommandsDto[ContentMappingServiceForCommandsDto], xref:applib/services/commanddto/conmap/UserDataKeys[UserDataKeys], xref:applib/services/commanddto/processor/CommandDtoProcessor[CommandDtoProcessor], xref:applib/services/commanddto/processor/spi/CommandDtoProcessorServiceIdentity[CommandDtoProcessorServiceIdentity], xref:applib/services/commanddto/processor/spi/CommandDtoProcessorService[CommandDtoProcessorService], xref:applib/services/confview/ConfigurationProperty[ConfigurationProperty], xref:applib/services/confview/ConfigurationViewService[ConfigurationViewService], xref:applib/services/conmap/ContentMappingService[ContentMappingService], xref:applib/services/email/EmailService[EmailService], xref:applib/services/error/ErrorDetails[ErrorDetails], xref:applib/services/error/ErrorReportingService[ErrorReportingService], xref:applib/services/error/Ticket[Ticket], xref:applib/services/eventbus/EventBusService[EventBusService], xref:applib/services/exceprecog/ExceptionRecognizerService[ExceptionRecognizerService], xref:applib/services/exceprecog/ExceptionRecognizer[ExceptionRecognizer], xref:applib/services/exceprecog/TranslatableException[TranslatableException], xref:applib/services/factory/FactoryService[FactoryService], xref:applib/services/grid/GridLoaderService[GridLoaderService], xref:applib/services/grid/GridService[GridService], xref:applib/services/grid/GridSystemService[GridSystemService], xref:applib/services/health/HealthCheckService[HealthCheckService], xref:applib/services/health/Health[Health], xref:applib/services/hint/HintStore[HintStore], xref:applib/services/homepage/HomePageResolverService[HomePageResolverService], xref:applib/services/i18n/LocaleProvider[LocaleProvider], xref:applib/services/i18n/TranslatableString[TranslatableString], xref:applib/services/i18n/TranslationService[TranslationService], xref:applib/services/i18n/TranslationsResolver[TranslationsResolver], xref:applib/services/iactn/ExecutionContext[ExecutionContext], xref:applib/services/iactn/InteractionContext[InteractionContext], xref:applib/services/iactn/Interaction[Interaction], xref:applib/services/inject/ServiceInjector[ServiceInjector], xref:applib/services/jaxb/JaxbService[JaxbService], xref:applib/services/layout/LayoutServiceMenu[LayoutServiceMenu], xref:applib/services/layout/LayoutService[LayoutService], xref:applib/services/linking/DeepLinkService[DeepLinkService], xref:applib/services/menu/MenuBarsLoaderService[MenuBarsLoaderService], xref:applib/services/menu/MenuBarsService[MenuBarsService], xref:applib/services/message/MessageService[MessageService], xref:applib/services/metamodel/BeanSort[BeanSort], xref:applib/services/metamodel/DomainMember[DomainMember], xref:applib/services/metamodel/DomainModel[DomainModel], xref:applib/services/metamodel/MetaModelServiceMenu[MetaModelServiceMenu], xref:applib/services/metamodel/MetaModelService[MetaModelService], xref:applib/services/metrics/MetricsService[MetricsService], xref:applib/services/publishing/log/CommandLogger[CommandLogger], xref:applib/services/publishing/log/EntityChangesLogger[EntityChangesLogger], xref:applib/services/publishing/log/EntityPropertyChangeLogger[EntityPropertyChangeLogger], xref:applib/services/publishing/log/ExecutionLogger[ExecutionLogger], xref:applib/services/publishing/spi/CommandSubscriber[CommandSubscriber], xref:applib/services/publishing/spi/EntityChangesSubscriber[EntityChangesSubscriber], xref:applib/services/publishing/spi/EntityChanges[EntityChanges], xref:applib/services/publishing/spi/EntityPropertyChangeSubscriber[EntityPropertyChangeSubscriber], xref:applib/services/publishing/spi/EntityPropertyChange[EntityPropertyChange], xref:applib/services/publishing/spi/ExecutionSubscriber[ExecutionSubscriber], xref:applib/services/queryresultscache/QueryResultCacheControl[QueryResultCacheControl], xref:applib/services/queryresultscache/QueryResultsCache[QueryResultsCache], xref:applib/services/registry/ServiceRegistry[ServiceRegistry], xref:applib/services/repository/EntityState[EntityState], xref:applib/services/repository/RepositoryService[RepositoryService], xref:applib/services/routing/RoutingService[RoutingService], xref:applib/services/scratchpad/Scratchpad[Scratchpad], xref:applib/services/session/SessionLoggingServiceLogging[SessionLoggingServiceLogging], xref:applib/services/session/SessionLoggingService[SessionLoggingService], xref:applib/services/sudo/SudoService[SudoService], xref:applib/services/swagger/SwaggerService[SwaggerService], xref:applib/services/tablecol/TableColumnOrderService[TableColumnOrderService], xref:applib/services/title/TitleService[TitleService], xref:applib/services/urlencoding/UrlEncodingService[UrlEncodingService], xref:applib/services/user/RoleMemento[RoleMemento], xref:applib/services/user/UserMemento[UserMemento], xref:applib/services/user/UserService[UserService], xref:applib/services/userprof/UserProfileService[UserProfileService], xref:applib/services/userreg/EmailNotificationService[EmailNotificationService], xref:applib/services/userreg/UserDetails[UserDetails], xref:applib/services/userreg/UserRegistrationService[UserRegistrationService], xref:applib/services/userreg/events/EmailRegistrationEvent[EmailRegistrationEvent], xref:applib/services/userreg/events/PasswordResetEvent[PasswordResetEvent], xref:applib/services/wrapper/DisabledException[DisabledException], xref:applib/services/wrapper/HiddenException[HiddenException], xref:applib/services/wrapper/InvalidException[InvalidException], xref:applib/services/wrapper/WrapperFactory[WrapperFactory], xref:applib/services/wrapper/WrappingObject[WrappingObject], xref:applib/services/wrapper/control/AsyncControl[AsyncControl], xref:applib/services/wrapper/control/ControlAbstract[ControlAbstract], xref:applib/services/wrapper/control/ExceptionHandler[ExceptionHandler], xref:applib/services/wrapper/control/ExecutionMode[ExecutionMode], xref:applib/services/wrapper/control/SyncControl[SyncControl], xref:applib/services/wrapper/events/ActionArgumentEvent[ActionArgumentEvent], xref:applib/services/wrapper/events/ActionInvocationEvent[ActionInvocationEvent], xref:applib/services/wrapper/events/ActionUsabilityEvent[ActionUsabilityEvent], xref:applib/services/wrapper/events/ActionVisibilityEvent[ActionVisibilityEvent], xref:applib/services/wrapper/events/CollectionAccessEvent[CollectionAccessEvent], xref:applib/services/wrapper/events/CollectionAddToEvent[CollectionAddToEvent], xref:applib/services/wrapper/events/CollectionMethodEvent[CollectionMethodEvent], xref:applib/services/wrapper/events/CollectionRemoveFromEvent[CollectionRemoveFromEvent], xref:applib/services/wrapper/events/CollectionUsabilityEvent[CollectionUsabilityEvent], xref:applib/services/wrapper/events/InteractionEvent[InteractionEvent], xref:applib/services/wrapper/events/ObjectTitleEvent[ObjectTitleEvent], xref:applib/services/wrapper/events/ObjectValidityEvent[ObjectValidityEvent], xref:applib/services/wrapper/events/ObjectVisibilityEvent[ObjectVisibilityEvent], xref:applib/services/wrapper/events/ParseValueEvent[ParseValueEvent], xref:applib/services/wrapper/events/PropertyAccessEvent[PropertyAccessEvent], xref:applib/services/wrapper/events/PropertyModifyEvent[PropertyModifyEvent], xref:applib/services/wrapper/events/PropertyUsabilityEvent[PropertyUsabilityEvent], xref:applib/services/wrapper/events/PropertyVisibilityEvent[PropertyVisibilityEvent], xref:applib/services/wrapper/events/ProposedHolderEvent[ProposedHolderEvent], xref:applib/services/wrapper/events/UsabilityEvent[UsabilityEvent], xref:applib/services/wrapper/events/ValidityEvent[ValidityEvent], xref:applib/services/wrapper/events/VisibilityEvent[VisibilityEvent], xref:applib/services/wrapper/listeners/InteractionAdapter[InteractionAdapter], xref:applib/services/wrapper/listeners/InteractionListener[InteractionListener], xref:applib/services/xactn/TransactionId[TransactionId], xref:applib/services/xactn/TransactionService[TransactionService], xref:applib/services/xactn/TransactionState[TransactionState], xref:applib/services/xactn/Transaction[Transaction], xref:applib/services/xml/XmlService[XmlService], xref:applib/services/xmlsnapshot/XmlSnapshotService.Snapshot.Builder[XmlSnapshotService.Snapshot.Builder], xref:applib/services/xmlsnapshot/XmlSnapshotService.Snapshot[XmlSnapshotService.Snapshot], xref:applib/services/xmlsnapshot/XmlSnapshotService[XmlSnapshotService], xref:applib/snapshot/SnapshottableWithInclusions[SnapshottableWithInclusions], xref:applib/spec/AbstractSpecification2[AbstractSpecification2], xref:applib/spec/AbstractSpecification[AbstractSpecification], xref:applib/spec/Specification2[Specification2], xref:applib/spec/SpecificationAnd[SpecificationAnd], xref:applib/spec/SpecificationNot[SpecificationNot], xref:applib/spec/SpecificationOr[SpecificationOr], xref:applib/spec/Specification[Specification], xref:applib/util/Enums[Enums], xref:applib/util/Equality[Equality], xref:applib/util/Hashing[Hashing], xref:applib/util/JaxbUtil[JaxbUtil], xref:applib/util/ToString[ToString], xref:applib/util/schema/ChangesDtoUtils[ChangesDtoUtils], xref:applib/util/schema/CommandDtoUtils[CommandDtoUtils], xref:applib/util/schema/CommonDtoUtils[CommonDtoUtils], xref:applib/value/Blob[Blob], xref:applib/value/Clob[Clob], xref:applib/value/HasHtml[HasHtml], xref:applib/value/LocalResourcePath[LocalResourcePath], xref:applib/value/Markup[Markup], xref:applib/value/NamedWithMimeType[NamedWithMimeType], xref:applib/value/Password[Password]
...
xref:core/runtime/persistence/changetracking/EntityChangeTrackerDefault[EntityChangeTrackerDefault]
...
xref:core/runtimeservices/xml/XmlServiceDefault[XmlServiceDefault], xref:core/runtimeservices/xmlsnapshot/XmlSnapshotServiceDefault[XmlSnapshotServiceDefault]
