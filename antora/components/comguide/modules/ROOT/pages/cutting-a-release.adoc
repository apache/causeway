...
// * `v3-jpa` and `v3-jdo` ; and also `v4-jpa` and `v4-jdo`
* `v3-jpa` and `v3-jdo`
+
...
// * `v3-jpa-SNAPSHOT` and `v3-jdo-SNAPSHOT` ; and also `v4-jpa-SNAPSHOT` and `v4-jdo-SNAPSHOT`
* `v3-jpa-SNAPSHOT` and `v3-jdo-SNAPSHOT`
+
