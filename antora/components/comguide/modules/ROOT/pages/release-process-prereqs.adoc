...
* Create a symlink to the `causeway-tooling-cli` jar file
+
[source,bash]
----
mkdir -p tooling/cli/target
pushd tooling/cli/target
ln -s ../../../../../apache-causeway-committers/causewaystuff/tooling/cli/target/causewaystuff-tooling-cli-spring-boot.jar causeway-tooling-cli.jar
popd
----
+
