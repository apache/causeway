...
+
See link:https://github.com/apache-causeway-committers/causewaystuff/blob/main/tooling/cli/README.adoc[causewaystuff] documentation for more details.
...
Optionally, restore the original `site.yml` file.
However, you might want to leave it as is in case there is a requirement to regenerate the website.
In any case, when the next release comes around, we will delete this branch anyway.
