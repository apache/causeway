...
This page describes how we deploy the xref:docs:starters:simpleapp.adoc[], xref:docs:starters:helloworld.adoc[HelloWorld App] and the xref:referenceapp:about.adoc[] each night, to a Azure App Container Apps (a PaaS based on top of k8s).
