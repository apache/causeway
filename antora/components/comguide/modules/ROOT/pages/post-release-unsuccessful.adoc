...
[source,bash,subs="attributes+"]
----
git push --delete origin release-{page-causewayrelv2}-RC1     # <.>
git push --delete origin causeway-{page-causewayrelv2}-RC1        # <.>
git tag -d causeway-{page-causewayrelv2}                          # <.>
git tag -d causeway-{page-causewayrelv2}-RC1
----
