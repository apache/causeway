...
image::hints-and-tips/view-model-fail.png[width="800px",link="{_imagesdir}hints-and-tips/view-model-fail.png"]
...
image::hints-and-tips/view-model-success.png[width="800px",link="{_imagesdir}hints-and-tips/view-model-success.png"]
