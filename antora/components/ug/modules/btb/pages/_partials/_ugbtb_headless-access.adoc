...
This section tackles the topic of enabling access to an Apache Isis application directly, or at least, not through either the xref:ug:vw:ugvw.adoc#[Wicket] or xref:ug:vro:ugvro.adoc#[Restful] viewers.
