...
* Set up a xref:rg:cms:classes/domainevent.adoc[domain event] xref:rg:cms:rgcms.adoc#_rgcms_classes_super_AbstractSubscriber[subscriber] that can veto the changes.
