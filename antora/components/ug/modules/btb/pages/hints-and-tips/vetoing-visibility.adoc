...
NOTE: FIXME - a write-up of the "vetoing subscriber" design pattern, eg as described in the  xref:rg:svc:rgsvc.adoc#_rgsvc_integration-api_BookmarkService[`BookmarkService`]
