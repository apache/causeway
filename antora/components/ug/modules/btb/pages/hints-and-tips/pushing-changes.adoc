...
<3> the xref:rg:cms:methods/prefixes/addTo.adoc[`addTo...()`] method increments the derived properties
<4> the xref:rg:cms:methods/prefixes/removeFrom.adoc[`removeFrom...()`] method similarly decrements the derived properties
