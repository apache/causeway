...
In the xref:ug:fun:getting-started/simpleapp-archetype.adoc[SimpleApp archetype] this is defined under the "neo4j" profile so can be activated using `-P neo4j`.
...
* run the xref:ug:fun:getting-started/simpleapp-archetype.adoc[SimpleApp archetype] (v1.8.0)
