...
In the xref:arch:simpleapp:about.adoc[SimpleApp archetype] this is defined under the "neo4j" profile so can be activated using `-P neo4j`.
...
* run the xref:arch:simpleapp:about.adoc[SimpleApp archetype] (v1.8.0)
