...
|`--manifest`
|FQCN
|Fully qualified class name of the xref:rg:cms:rgcms.adoc#_rgcms_classes_super_AppManifest[`AppManifest`] to use to bootstrap the system. +
...
|`--fixture`
|FQCN
|Fully qualified class name of the fixture (extending xref:rg:cms:rgcms.adoc#_rgcms_classes_super_FixtureScript[`FixtureScript`]) to be run to setup data. +
