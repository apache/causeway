...
This is intended to support deployment through Docker, as discussed xref:ug:btb:deployment/docker.adoc[next].
====
...
[TIP]
====
Subsequent sections explain how to externalize configuration for xref:ug:btb:deployment/tomcat.adoc[Tomcat] and for xref:ug:btb:deployment/docker.adoc[Docker].
====
