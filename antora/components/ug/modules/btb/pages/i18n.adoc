...
However, Apache Isis can be configured to read config files from an xref:ug:btb:deployment/externalized-configuration.adoc[external directory]; this is also supported for translations.
