...
image::testing/wrapper-factory.png[width="600px",link="{_imagesdir}testing/wrapper-factory.png"]
...
[NOTE]
====
In this respect the wrapper is more functional than the xref:ug:vw:ugvw.adoc#[Wicket viewer] (which does not expose the ability to mutate collections directly).
====
