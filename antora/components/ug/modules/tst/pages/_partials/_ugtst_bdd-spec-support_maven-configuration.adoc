...
Apache Isis' BDD spec support is automatically configured if you use the xref:ug:fun:ugfun.adoc#_ugfun_getting-started_simpleapp-archetype[SimpleApp archetype].
