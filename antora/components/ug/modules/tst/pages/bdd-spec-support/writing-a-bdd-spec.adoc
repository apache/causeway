...
Here's an example of a feature from the xref:arch:simpleapp:about.adoc[SimpleApp archetype]:
...
(Commented out) configuration for this is provided in the xref:arch:simpleapp:about.adoc[SimpleApp archetype].
