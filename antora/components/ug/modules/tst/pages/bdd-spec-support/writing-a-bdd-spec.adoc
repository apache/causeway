...
Here's an example of a feature from the xref:ug:fun:getting-started/simpleapp-archetype.adoc[SimpleApp archetype]:
...
(Commented out) configuration for this is provided in the xref:ug:fun:getting-started/simpleapp-archetype.adoc[SimpleApp archetype].
