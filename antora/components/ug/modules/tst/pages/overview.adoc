...
The solution that Apache Isis provides is a domain service called xref:rg:cms:classes/super/FixtureScripts.adoc[Fixture Scripts], that defines a pattern and supporting classes to help ensure that the "data setup" for your tests are reusable and maintainable over time.
