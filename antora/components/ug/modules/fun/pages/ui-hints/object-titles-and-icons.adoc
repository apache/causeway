...
Alternatively, the title can be provided simply by implementing the xref:rg:cms:methods/reserved/title.adoc[`title()`] reserved method.
...
To customise the icon on an instance-by-instance basis, we implement the reserved xref:rg:cms:methods/reserved/iconName.adoc[`iconName()`] method.
...
To customise the icon on an instance-by-instance basis, we implement the reserved xref:rg:cms:methods/reserved/cssClass.adoc[`cssClass()`] method.
