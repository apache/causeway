...
When an object is loaded from the database the framework will emit `ObjectLoadedEvent` xref:ug:fun:building-blocks/events/lifecycle-events.adoc[lifecycle event].
