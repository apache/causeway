...
This guide introduces the xref:ug:fun:core-concepts.adoc[core concepts] and the xref:ug:fun:building-blocks.adoc[building blocks] of Apache Isis, and tells you how to xref:ug:fun:getting-started/helloworld-archetype.adoc[get started] with a Maven archetype.
