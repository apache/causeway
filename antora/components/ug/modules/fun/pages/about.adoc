...
This guide introduces the xref:ug:fun:ugfun.adoc#_ugfun_core-concepts[core concepts] and ideas behind Apache Isis,
and tells you how to xref:ug:fun:ugfun.adoc#_ugfun_getting-started[get started] with a Maven archetype.

It also describes a number of xref:ug:fun:ugfun.adoc#_ugfun_how-tos[how-to]s, describes how to influence the
xref:ug:vw:ugvw.adoc#_ugvw_layout[UI layout] of your domain objects (this is ultimately just a type of metadata), and it
