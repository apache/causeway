...
A final nature is `VIEW_REST_ONLY` which is for domain services whose functionality is surfaced only by the xref:ug:vro:about.adoc[RestfulObjects viewer].
