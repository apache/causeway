...
* similarly within implementations of xref:rg:svc:application-layer-spi/CommandService.adoc[`CommandService`] to persist `Command`
objects

* similarly within implementations of xref:rg:svc:persistence-layer-spi/PublisherService.adoc[`PublisherService`]
...
Deep links meanwhile can be obtained from the xref:rg:svc:presentation-api/DeepLinkService.adoc[`DeepLinkService`].
