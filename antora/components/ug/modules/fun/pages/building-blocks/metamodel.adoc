...
Notably the metamodel is xref:ug:btb:programming-model.adoc[extensible]; it is possible to teach Apache Isis new programming conventions/rules (and conversely to remove those that are built in).
