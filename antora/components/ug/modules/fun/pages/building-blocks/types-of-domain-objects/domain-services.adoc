...
+
This is discussed in more detail below, in the section on xref:ug:fun:building-blocks/events.adoc[events].
...
xref:ug:fun:programming-model/domain-services.adoc[here].
====
