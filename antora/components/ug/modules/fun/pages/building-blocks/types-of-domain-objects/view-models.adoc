...
Then build out the minimum domain entities to support that use case (refining the xref:ug:fun:core-concepts/philosophy/domain-driven-design/ubiquitous-language.adoc[ubiquitous language] as you go).
