...
You will notice that the URL for view models (as shown in xref:ug:vw:ugvw.adoc#[Wicket viewer] or xref:ug:vro:about.adoc[RestfulObjects viewer]) tends to be quite long.
