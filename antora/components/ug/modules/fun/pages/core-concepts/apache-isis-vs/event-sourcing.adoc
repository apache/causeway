...
The former are dispatched and consumed in-process and within the same transaction, and for this reason the xref:rg:cms:classes/super/AbstractSubscriber.adoc[subscribers] can also veto the events.
