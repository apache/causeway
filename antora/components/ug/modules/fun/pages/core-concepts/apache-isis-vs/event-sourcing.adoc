...
The xref:ug:fun/core-concepts/apache-isis-vs/cqrs.adoc[CQRS architecture] is often combined with _Event Sourcing_ pattern, though they are separate ideas.
