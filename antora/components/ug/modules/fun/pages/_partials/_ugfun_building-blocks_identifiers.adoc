...
include::partial$_ugfun_building-blocks_identifiers_title-and-icon.adoc[leveloffset=+1]

include::partial$_ugfun_building-blocks_identifiers_oid.adoc[leveloffset=+1]
