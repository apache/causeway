...
image::programming-model/todoapp-Dashboard.png[width="px",link="{_imagesdir}programming-model/todoapp-Dashboard.png"]

For this we annotate the collection using xref:rg:ant:rgant.adoc#_rgant-CollectionLayout_defaultView[`@CollectionLayout#defaultView()`]; for example
