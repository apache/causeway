...
The framework will call any `public` method annotated with xref:rg:ant:rgant.adoc#_rgant-PostConstruct[`@PostConstruct`] with either no arguments of an argument of type `Map<String,String>`.
...
Shutdown is similar; the framework will call any method annotated with xref:rg:ant:rgant.adoc#_rgant-PreDestroy[`@PreDestroy`].
