...
This is an important capability to help keep large applications xref:ug:btb:ugbtb.adoc#_ugbtb_decoupling[decoupled].
...
include::partial$_ugfun_building-blocks_types-of-domain-objects_domain-entities.adoc[leveloffset=+1]
include::partial$_ugfun_building-blocks_types-of-domain-objects_domain-services.adoc[leveloffset=+1]
include::partial$_ugfun_building-blocks_types-of-domain-objects_view-models.adoc[leveloffset=+1]
include::partial$_ugfun_building-blocks_types-of-domain-objects_mixins.adoc[leveloffset=+1]
