...
Domain services acting as event subscribers can subscribe to xref:ug:fun:ugfun.adoc#_ugfun_building-blocks_events_domain-events[domain], xref:ug:fun:ugfun.adoc#_ugfun_building-blocks_events_ui-events[UI] and xref:ug:fun:ugfun.adoc#_ugfun_building-blocks_events_lifecycle-events[lifecycle] events, influencing the rendering and behaviour of other objects.
