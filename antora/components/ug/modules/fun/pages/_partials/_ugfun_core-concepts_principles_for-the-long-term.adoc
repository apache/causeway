...
image::core-concepts/philosophy/decoupled-applications.png[width="800px",link="{_imagesdir}core-concepts/philosophy/decoupled-applications.png"]
...
+
Both xref:rg:svc:rgsvc.adoc#[framework-defined domain services] and application-defined services (eg repositories and factories) are injected everywhere, using the regular xref:rg:ant:rgant.adoc#_rgant-Inject[`@javax.inject.Inject`] annotation.
