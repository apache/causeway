...
This is a slight simplification; there are a number of other method prefixes (such as `hide` or `validate`) that represent xref:ug:fun:business-rules.adoc[business rules]); these also not treated as actions.
