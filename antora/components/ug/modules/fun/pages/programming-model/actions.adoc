...
While xref:ug:fun:programming-model/properties.adoc[properties] and xref:ug:fun:programming-model/collections.adoc[collections] define the state held by a domain object (its "know what" responsibilities), actions define the object's behaviour (its "know how-to" responsibilities).
...
See also xref:ug:fun:programming-model/properties-vs-parameters.adoc[properties vs parameters].
