...
This is done using either a supporting xref:rg:cms:methods/prefixes/choices.adoc[`choices`] or xref:rg:cms:methods/prefixes/autoComplete.adoc[`autoComplete`] method.
