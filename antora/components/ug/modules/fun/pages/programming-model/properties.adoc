...
A property is an instance variable of a domain object, of a scalar type, that holds some state about either a xref:ug:fun:programming-model/domain-entities.adoc[domain entity] or a xref:ug:fun:programming-model/view-models.adoc[view model].
...
It's ok for a xref:ug:fun:programming-model/domain-entities.adoc[domain entity] to reference another domain entity, and for a xref:ug:fun:programming-model/view-models.adoc[view model] to reference both view model and domain entities.
