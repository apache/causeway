...
The xref:ug:fun:getting-started/helloworld-archetype.adoc[HelloWorld] and xref:ug:fun:getting-started/simpleapp-archetype.adoc[SimpleApp] archetypes use this approach.
...
The table in the xref:ug:fun:programming-model/properties-vs-parameters.adoc[Properties vs Parameters] section provides a handy reference of each.
