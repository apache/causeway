...
It provides an implementation of the xref:rg:svc:rgsvc.adoc#_rgsvc_persistence-layer-spi_PublisherService[`PublisherService`], but which simply publishes instances of xref:rg:cms:rgcms.adoc#_rgcms_schema_ixn[`InteractionDto`] to an ActiveMQ queue.
