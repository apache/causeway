...
A xref:ug:fun:building-blocks/types-of-domain-objects/mixins.adoc[mixin] acts like a trait or extension method, allowing one module to contribute behaviour or derived state to another object.
