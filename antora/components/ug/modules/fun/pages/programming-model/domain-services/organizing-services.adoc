...
* `VIEW_MENU_ONLY` indicates that the actions should appear on the menu of the xref:ug:vw:about.adoc[Wicket viewer], and as top-level actions for the REST API provided by the xref:ug:vro:about.adoc[Restful Objects viewer]
