...
about using contributions and mixins to keep your domain application decoupled can be found xref:ug:fun:building-blocks/types-of-domain-objects/mixins.adoc[here] and xref:ug:fun:programming-model/domain-services/contributions.adoc[contributed services]).
