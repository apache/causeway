...
The framework defines many additional services (such as xref:rg:svc:persistence-layer-api/RepositoryService.adoc[`RepositoryService`]); these are injected in exactly the same manner.
