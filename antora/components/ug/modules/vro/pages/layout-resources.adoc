...
Note that because of dynamic icons (the xref:rg:cms:methods/reserved/iconName.adoc[`iconName()`] supporting method) the image returned can vary on an instance-by-instance basis.
