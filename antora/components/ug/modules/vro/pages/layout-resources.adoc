...
For example, the xref:ug:fun:getting-started/helloworld-archetype.adoc[Hello World archetype] has the following layout:
...
For example, in the xref:ug:fun:getting-started/helloworld-archetype.adoc[Hello World archetype] the `HelloWorld` domain object has a layout defined by `HelloWorld.layout.xml`.
