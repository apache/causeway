...
xref:ug:vro:ugvro.adoc#__ugvro_simplified-representations_domain-object[above] is returned.
...
xref:ug:vro:ugvro.adoc#__ugvro_simplified-representations_object-collection[(parented) object collection], though with a
