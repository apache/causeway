...
[TIP]
====
Both the xref:ug:fun:getting-started/helloworld-archetype.adoc[HelloWorld] and xref:ug:fun:getting-started/simpleapp-archetype.adoc[SimpleApp] archetypes are pre-configured to use Apache Shiro, so much of what follows may well have been set up already.
====
...
For example, the xref:ug:fun:getting-started/helloworld-archetype.adoc[HelloWorld archetype] bootstraps using:
