...
image::security/security-apis-impl/configure-isis-to-use-bypass.PNG[width="600px",link="{_imagesdir}security/security-apis-impl/configure-isis-to-use-bypass.PNG"]
