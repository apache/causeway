...
image::security/security-apis-impl/configure-shiro-to-use-custom-jdbc-realm.png[width="600px",link="{_imagesdir}security/security-apis-impl/configure-shiro-to-use-custom-jdbc-realm.png"]
