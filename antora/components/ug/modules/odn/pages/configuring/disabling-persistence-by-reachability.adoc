...
One scenario in particular where this performance issues can arise is if your entities implement the `java.lang.Comparable` interface, and you have used Apache Isis' xref:rg:cms:classes/utility/ObjectContracts.adoc[`ObjectContracts`] utility class.
