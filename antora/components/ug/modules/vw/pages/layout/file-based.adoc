...
If using an Apache Isis xref:arch:helloworld:about.adoc[HelloWorld] xref:arch:simpleapp:about.adoc[SimpleApp] archetypes, then the POM is already correctly configured.
