...
If using an Apache Isis xref:ug:fun:getting-started/helloworld-archetype.adoc[HelloWorld] xref:ug:fun:getting-started/simpleapp-archetype.adoc[SimpleApp] archetypes, then the POM is already correctly configured.
