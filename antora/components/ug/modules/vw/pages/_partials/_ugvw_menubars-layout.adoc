...
image::application-menu/layout-menus.png[width="800px",link="{_imagesdir}application-menu/layout-menus.png"]
...
image::application-menu/dividers.png[width="400px",link="{_imagesdir}application-menu/dividers.png"]
...
image::application-menu/tertiary.png[width="300px",link="{_imagesdir}application-menu/tertiary.png"]
