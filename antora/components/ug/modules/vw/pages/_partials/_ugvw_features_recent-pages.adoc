...
image::recent-pages/recent-pages.png[width="800px",link="{_imagesdir}recent-pages/recent-pages.png"]


[NOTE]
====
Note that this screenshot show an earlier version of the xref:ug:vw:ugvw.adoc#[Wicket viewer] UI (specifically, pre 1.8.0).
====
