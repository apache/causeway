[[_ugvw_features_titles-in-tables]]
= Titles in Tables
...
image::how-tos/ui-hints/object-titles-and-icons/cust-order-product.png[width="579px",link="{_imagesdir}how-tos/ui-hints/object-titles-and-icons/cust-order-product.png"]
...
[TIP]
====
It is also possible to configure the Wicket viewer to xref:ug:vw:ugvw.adoc#_ugvw_configuration-properties_presentation[abbreviate titles or suppress them] completely.
====
