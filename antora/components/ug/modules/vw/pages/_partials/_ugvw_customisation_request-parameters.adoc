...
image::embedded-view/regular.png[width="720px",link="{_imagesdir}embedded-view/regular.png"]


With the header and footer both suppressed only the main content is shown:

image::embedded-view/no-header-no-footer.png[width="720px",link="{_imagesdir}embedded-view/no-header-no-footer.png"]
