...
public class NameBasedMapper extends MySqlMapper implements ObjectMapper {
    ...
    private void loadInternalCollection(long id, Field field, InternalCollection collection) throws ResolveException, SQLException {
        NakedClass cls = collection.forParent().getNakedClass();
        NakedClass elementCls = NakedObjectManager.getInstance().getNakedClass(collection.getType().getName());
