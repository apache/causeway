...
public interface ObjectMapper {
    ...
    NakedObject getObject(DatabaseConnector connector, Oid oid, NakedObjectSpecification hint) throws ObjectNotFoundException,
    ...
    void resolveCollection(DatabaseConnector connector, NakedObject object, NakedObjectField field);
 ...
 * implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the GNU General License for
 * more details.
 * 
 * You should have received a copy of the GNU General License along with this program; if not, write to the
