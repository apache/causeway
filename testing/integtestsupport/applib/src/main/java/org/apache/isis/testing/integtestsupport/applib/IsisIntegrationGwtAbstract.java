 ...
 *
 * <p>
 *     Unlike {@link IsisIntegrationTestAbstract}, this class is not {@link ExtendWith extended with} {@link IsisInteractionHandler},
 *     which means that there is <i>no</i> {@link org.apache.isis.applib.services.iactn.Interaction} set up implicitly.
 *     Instead the {@link #given(Callable)}, {@link #when(Callable)} and {@link #then(Callable)} (and their various overrides) can be used
 *     with the provided {@link Callable} or {@link ThrowingRunnable} being called within its own {@link org.apache.isis.applib.services.iactn.Interaction}.
 * </p>
 *
 * <p>
 *     Note that this means that references to entities must be re-retrieved within each given/when/then phase.
 *     {@link org.apache.isis.applib.services.bookmark.Bookmark}s and the {@link org.apache.isis.applib.services.bookmark.BookmarkService} can be a good way to do perform this re-retrieval.
 * </p>
 *
 * @since 2.0 {@index}
 * @see IsisIntegrationTestAbstract
 */
@ExtendWith({ExceptionRecognizerTranslate.class})
public abstract class IsisIntegrationGwtAbstract extends IsisIntegrationTestBase {
