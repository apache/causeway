...
WARNING: TODO: move this description earlier, standard format.
...
NOTE: although originally intended for use with JUnit4, it can also used in JUnit5 tests; details below.
