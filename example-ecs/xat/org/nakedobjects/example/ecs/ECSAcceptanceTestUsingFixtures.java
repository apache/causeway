...
public class ECSAcceptanceTestUsingFixtures extends JavaAcceptanceTestCase {

    public static void main(java.lang.String[] args) {
        junit.textui.TestRunner.run(ECSAcceptanceTestUsingFixtures.class);
    }
    
    public ECSAcceptanceTestUsingFixtures(String name) {
        super(name);
    }
