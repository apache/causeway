...
import test.org.nakedobjects.object.repository.object.persistence.NakedObjectStoreFieldsTestCase;


public class CacheObjectStoreFieldsTest extends NakedObjectStoreFieldsTestCase {
    String DIR = "tmp/test";

    public CacheObjectStoreFieldsTest(String name) {
		super(name);
	}
