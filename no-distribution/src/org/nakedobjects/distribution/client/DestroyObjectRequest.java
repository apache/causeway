...
public class DestroyObjectRequest extends ObjectRequest {
    private final static long serialVersionUID = 1L;
    
    public DestroyObjectRequest(NakedObject object) {
        super(object);
    }
    ...
    protected void generateResponse(RequestContext server) {
        try {
            ...
            server.getObjectManager().destroyObject(object);
    ...
    public String toString() {
        return "DestroyObject [" + id + ",oid=" + externalOid + "]";
    }
}
