...
public class NumberOfInstancesRequest extends AbstractInstancesRequest {
    private final static long serialVersionUID = 1L;

    public NumberOfInstancesRequest(NakedClass cls) {
        super(cls);
    }

    void generateResponse(RequestContext server, NakedObject pattern) {
        NakedObjectManager objectManager = server.getObjectManager();
        response = new Integer(objectManager.numberOfInstances((NakedClass) pattern));
    }
    ...
    public String toString() {
        return "Number of instances [" + super.toString() + "]";
    }
}
