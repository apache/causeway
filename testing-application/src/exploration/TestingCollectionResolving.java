...
import fixtures.ShortFixture;


public class TestingCollectionResolving {
    private static final Logger LOG = Logger.getLogger(TestingCollectionResolving.class);
    ...
    public static void main(String[] args) throws ConfigurationException {
        ...
        try {
            ...
            MemoryObjectStore tos = new MemoryObjectStore();
            ...
            fixtureBuilder.addFixture(new ShortFixture());
