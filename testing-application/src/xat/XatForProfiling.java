...
public class XatForProfiling extends JavaAcceptanceTestCase {

    public static void main(java.lang.String[] args) {
        PropertyConfigurator.configure("xat.properties");
        
        TestSuite suite = new TestSuite();
        suite.addTestSuite(XatForProfiling.class);
      //  suite.addTestSuite(XatForProfiling.class);
      //  suite.addTestSuite(XatForProfiling.class);
        junit.textui.TestRunner.run(suite);
    }
    
    public XatForProfiling(String name) {
        super(name);
    }
     ...
     protected void setUpFixtures() {
         ...
         */
                 ...
                 for (int i = 0; i < 1000; i++) {
                     ...
                     l.getKnownAs().setValue("location " + i);
                     l.setCity(boston);
	                 c.addToLocations(l);
                }
             }
