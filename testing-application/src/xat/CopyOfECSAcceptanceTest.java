...
public class CopyOfECSAcceptanceTest extends JavaAcceptanceTestCase {

    public static void main(java.lang.String[] args) {
        TestSuite suite = new TestSuite();
        suite.addTestSuite(CopyOfECSAcceptanceTest.class);
        suite.addTestSuite(CopyOfECSAcceptanceTest.class);
        suite.addTestSuite(CopyOfECSAcceptanceTest.class);
        junit.textui.TestRunner.run(suite);
    }
    
    public CopyOfECSAcceptanceTest(String name) {
        super(name);
    }
     ...
     public void testInvokeAction() {
         TestObject harry = getTestClass(Customer.class.getName()).findInstance("Harry");

         TestObject home = harry.getField("locations", "Home");
     ...
     public void testGettingCollectionElement() {
         TestObject harry = getTestClass(Customer.class.getName()).findInstance("Harry");

         harry.invokeActionReturnCollection("locations", NO_PARAMETERS);
//         TestObject home = fred.getField("locations", "Home");
  ...
  //       home.getField("city");
     ...
     public void testGetCities() {
         ...
         TestClass city = getTestClass(City.class.getName());
         
         TestCollection collection = city.instances();
