...
public class SimpleValidity implements Validity {
    private String fieldName;
    private StringBuffer unusableReason;
    private boolean isEmpty;

    public SimpleValidity(boolean isEmpty, String fieldName) {
        this.isEmpty = isEmpty;
        this.fieldName = fieldName;
    }

    public void cannotBeEmpty() {
        invalidOnCondition(isEmpty, fieldName + " must have a value");
    }
