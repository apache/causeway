...
public class MultilineTextStringAdapter extends AbstractNakedValue implements MultilineStringValue {
    private final MultilineTextString adaptee;
    
    public MultilineTextStringAdapter(final MultilineTextString adaptee) {
    ...
    public String toString() {
        ...
        str.append("string", adaptee.stringValue());
        return str.toString();
    }
