...
public class Smoke_IntegTest extends DomainAppIntegTestAbstract {
    ...
    public void create_() throws Exception {
        ...
        // when
        wrap(mixin(SimpleObject._updateName.class, fred)).${symbol_dollar}${symbol_dollar}("Freddy");
        transactionService.flushTransaction();
        ...
        // when
        wrap(mixin(SimpleObject._delete.class, fred)).${symbol_dollar}${symbol_dollar}();
        transactionService.flushTransaction();
