...
object FR_PROPERTY_DESCRIPTION : Response() {
    override val url = "http://localhost:8080/restful/domain-types/causewayApplib.FixtureResult/properties/className"
    override val str = """{
        "id": "className",
        "memberType": "property",
        "links": [
            {
                "rel": "self",
                "href": "http://localhost:8080/restful/domain-types/causewayApplib.FixtureResult/properties/className",
                "method": "GET",
