...
object ACTIONS_OPEN_SWAGGER_UI : Response(){
    override val url = "http://localhost:8080/restful/services/causewayApplib.SwaggerServiceMenu/actions/openSwaggerUi/invoke"
    override val str = """{
    "links": [
        {
            "rel": "self",
            "href": "http://localhost:8080/restful/services/causewayApplib.SwaggerServiceMenu/actions/openSwaggerUi/invoke",
            "method": "GET",
