...
object HTTP_ERROR : Response(){
    ...
    override val url = "http://localhost:8080/restful/services/causewayApplib.FixtureScriptsDefault/actions/runFixtureScript/invoke"
    override val str = """{
	"httpStatusCode": 400,
	...
	"detail": {
		...
		"element": [
			...
			"org.apache.causeway.viewer.restfulobjects.rendering.util.Util.read(Util.java:94)",
			"org.apache.causeway.viewer.restfulobjects.rendering.util.Util.readQueryStringAsMap(Util.java:76)",
			"org.apache.causeway.viewer.restfulobjects.server.ResourceContext.requestArgsAsMap(ResourceContext.java:197)",
			"org.apache.causeway.viewer.restfulobjects.server.ResourceContext.getQueryStringAsJsonRepr(ResourceContext.java:170)",
			"org.apache.causeway.viewer.restfulobjects.server.ResourceContext.init(ResourceContext.java:134)",
			"org.apache.causeway.viewer.restfulobjects.server.ResourceContext.<init>(ResourceContext.java:129)",
			"org.apache.causeway.viewer.restfulobjects.server.resources.ResourceAbstract.init(ResourceAbstract.java:123)",
			"org.apache.causeway.viewer.restfulobjects.server.resources.ResourceAbstract.init(ResourceAbstract.java:108)",
			"org.apache.causeway.viewer.restfulobjects.server.resources.DomainServiceResourceServerside.invokeAction(DomainServiceResourceServerside.java:254)",
